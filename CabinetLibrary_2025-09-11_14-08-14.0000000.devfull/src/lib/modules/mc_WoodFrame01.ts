...
//#region Imports
import { cbp_mc_WoodFrame01, dc_mc_WoodFrame01, adc_mc_WoodFrame01 } from '../internal/modules/mc_WoodFrame01'
...
export function mc_WoodFrame01_createBuildPlan(this: cbp_mc_WoodFrame01):void {
  internal_enterModuleCreateBuildPlan('mc_WoodFrame01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_WoodFrame01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_WoodFrame01_afterDataCompletion(this: adc_mc_WoodFrame01):void {
  internal_enterModuleAfterDataCompletion('mc_WoodFrame01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_WoodFrame01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_WoodFrame01_manufacturerDataCompletion(this: dc_mc_WoodFrame01):void {
  internal_enterModuleManufacturerDataCompletion('mc_WoodFrame01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_WoodFrame01_MANUFACTURERDATACOMPLETION
