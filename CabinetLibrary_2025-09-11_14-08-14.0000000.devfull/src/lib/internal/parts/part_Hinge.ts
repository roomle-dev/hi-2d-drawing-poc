...
export interface IP_part_Hinge_PartVarsReadOnly extends IPartBase {
  parent: IModBaseProp;
}

export interface IP_part_Hinge_PartVarsWritable extends IP_part_Hinge_PartVarsReadOnly {
}

export class P_part_Hinge extends PartBase implements IP_part_Hinge_PartVarsWritable {
  constructor(parent: IModBaseProp, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_Hinge', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._threedModel = { _3dUrl: 'https://tecconfig.homag.cloud/cdn/5ebb30e7-78fb-4155-be66-20fb7a8cacbe/library/cabinetlibrary/images/7118e50f-85da-465b-bd1e-813175a15d4a_sidelefthingepart_1.obj?sv=2023-11-03&st=2025-08-30T00%3A00%3A00Z&se=2025-10-02T00%3A00%3A00Z&sr=b&sp=r&sig=x5cGIYfqyCWSKDb%2FqyPwTjvRII6%2B2GgET2KYJLVvuBw%3D', _3dParameters: undefined, _3dObjectId: 'bGlicmFyeS9jYWJpbmV0bGlicmFyeS9pbWFnZXMvNzExOGU1MGYtODVkYS00NjViLWJkMWUtODEzMTc1YTE1ZDRhX3NpZGVsZWZ0aGluZ2VwYXJ0XzEub2Jq' };
  }
