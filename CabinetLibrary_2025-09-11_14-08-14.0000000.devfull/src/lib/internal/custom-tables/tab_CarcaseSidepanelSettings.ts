...
export interface cti_tab_CarcaseSidepanelSettings {
  readonly in_ModuleName? : string;
  readonly in_SidepanelType? : string;
  readonly in_Side? : string;
  readonly in_AdditionalInfo01? : string;
}

export interface ctm_tab_CarcaseSidepanelSettings {
}

export interface cto_tab_CarcaseSidepanelSettings extends ctm_tab_CarcaseSidepanelSettings {
  readonly _id : number;
  ...
  readonly Backwall? : string;
}

export interface ICT_tab_CarcaseSidepanelSettings
extends cti_tab_CarcaseSidepanelSettings, cto_tab_CarcaseSidepanelSettings {}

export class ct2_tab_CarcaseSidepanelSettings {

public findExactly(
     in_ModuleName: string|undefined,
     in_SidepanelType: string|undefined,
     in_Side: string|undefined,
     in_AdditionalInfo01: string|undefined,
): cto_tab_CarcaseSidepanelSettings | undefined {
  const res = ct_tab_CarcaseSidepanelSettings.find((p) => 
p.in_ModuleName === in_ModuleName
 && p.in_SidepanelType === in_SidepanelType
 && p.in_Side === in_Side
...
public find(
predicate: (value: cti_tab_CarcaseSidepanelSettings) => boolean
): cto_tab_CarcaseSidepanelSettings | undefined {
  for (let index = 0; index < ct_tab_CarcaseSidepanelSettings.length; index++){
    const element = ct_tab_CarcaseSidepanelSettings[index];
...
export var ct_tab_CarcaseSidepanelSettings :ICT_tab_CarcaseSidepanelSettings[] = [
{
 _id: 25,
 in_ModuleName: "mc_Storageunit01",
 in_SidepanelType: "NoSpAtOutSp",
 in_Side: "Left",
 in_AdditionalInfo01: "All",
 LibrarySolution: true,
 UsedModule: "mc_StorageunitSidepanel01",
 ConstructionTablePartName: "part_Sidepanelleft",
 InsertModule: false,
 PartType: "NoSp",
 Backwall: "NoSp"
}
,{
 ...
 LibrarySolution: true,
 UsedModule: "mc_StorageunitSidepanel01",
 ConstructionTablePartName: "part_Sidepanelright",
 InsertModule: false,
 PartType: "NoSp",
 Backwall: "NoSp"
}
...
,{
 _id: 29,
 in_ModuleName: "mc_Storageunit01",
 in_SidepanelType: "NoSpAtOutSpOversized",
 in_Side: "Left",
 in_AdditionalInfo01: "All",
 LibrarySolution: true,
 UsedModule: "mc_StorageunitSidepanel01",
