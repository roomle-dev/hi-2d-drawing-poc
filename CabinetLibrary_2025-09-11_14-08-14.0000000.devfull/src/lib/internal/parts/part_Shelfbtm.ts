...
import { P_part_LegDrill, IP_part_LegDrill_PartVarsReadOnly } from './part_LegDrill'
...
import { IPartParentsNonNull_mc_StorageunitShelfbtm01 } from '../mod-interfaces'

export interface IP_part_Shelfbtm_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_StorageunitShelfbtm01;
...
export interface IP_part_Shelfbtm_PartVarsWritable extends IP_part_Shelfbtm_PartVarsReadOnly {
...
export class P_part_Shelfbtm extends PartBase implements IP_part_Shelfbtm_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_StorageunitShelfbtm01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_Shelfbtm', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XZY';
  }
  parent: IPartParentsNonNull_mc_StorageunitShelfbtm01; // module which created this part
  ...
  checkAttributes() {
    ...
    if (this.#pa_HardwareQty1 === undefined) {
      logError('Attribute pa_HardwareQty1 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareQty2 === undefined) {
      logError('Attribute pa_HardwareQty2 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareQty3 === undefined) {
      logError('Attribute pa_HardwareQty3 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareQty4 === undefined) {
      logError('Attribute pa_HardwareQty4 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareQty5 === undefined) {
      logError('Attribute pa_HardwareQty5 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier1 === undefined) {
      logError('Attribute pa_HardwareSupplier1 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier2 === undefined) {
      logError('Attribute pa_HardwareSupplier2 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier3 === undefined) {
      logError('Attribute pa_HardwareSupplier3 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier4 === undefined) {
      logError('Attribute pa_HardwareSupplier4 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier5 === undefined) {
      logError('Attribute pa_HardwareSupplier5 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle1 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle1 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle2 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle2 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle3 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle3 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle4 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle4 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle5 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle5 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_CarcaseConnectionRightBtm === undefined) {
      logError('Attribute pa_CarcaseConnectionRightBtm not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_CarcaseConnectionLeftBtm === undefined) {
      logError('Attribute pa_CarcaseConnectionLeftBtm not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareColor === undefined) {
      logError('Attribute pa_HardwareColor not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_TypeElement === undefined) {
      logError('Attribute pa_TypeElement not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_ParentName === undefined) {
      logError('Attribute pa_ParentName not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionBtmVert === undefined) {
      logError('Attribute pa_FittingConnectionBtmVert not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_CarcasePartConnectionBtmVert === undefined) {
      logError('Attribute pa_CarcasePartConnectionBtmVert not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionRightBtm === undefined) {
      logError('Attribute pa_FittingConnectionRightBtm not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionLeftBtm === undefined) {
      logError('Attribute pa_FittingConnectionLeftBtm not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_TopColor === undefined) {
      logError('Attribute pa_TopColor not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_BtmColor === undefined) {
      logError('Attribute pa_BtmColor not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      logError('Attribute pa_EdgeFrontColor not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftColor === undefined) {
      logError('Attribute pa_EdgeLeftColor not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackColor === undefined) {
      logError('Attribute pa_EdgeBackColor not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightColor === undefined) {
      logError('Attribute pa_EdgeRightColor not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontType === undefined) {
      logError('Attribute pa_EdgeFrontType not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftType === undefined) {
      logError('Attribute pa_EdgeLeftType not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackType === undefined) {
      logError('Attribute pa_EdgeBackType not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightType === undefined) {
      logError('Attribute pa_EdgeRightType not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeJointType === undefined) {
      logError('Attribute pa_EdgeJointType not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_GrainDirection === undefined) {
      logError('Attribute pa_GrainDirection not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_Program === undefined) {
      logError('Attribute pa_Program not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_BomId === undefined) {
      logError('Attribute pa_BomId not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_AdditionalInfo1 === undefined) {
      logError('Attribute pa_AdditionalInfo1 not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_ColorGrainGroup === undefined) {
      logError('Attribute pa_ColorGrainGroup not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_ColorOutsideGrainGroup === undefined) {
      logError('Attribute pa_ColorOutsideGrainGroup not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_GrainLogic === undefined) {
      logError('Attribute pa_GrainLogic not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_ProgramGrainGroup === undefined) {
      logError('Attribute pa_ProgramGrainGroup not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
    if (this.#pa_ProgramOutsideGrainGroup === undefined) {
      logError('Attribute pa_ProgramOutsideGrainGroup not set in part part_Shelfbtm (id: ' + this._id + ')');
    }
  ...
  createBomElements() {
    ...
    const partSelf = this;
      ...
      if (partSelf._g?.basic_CreateBom == 'Library') { // ####################### CUSTOM SCRIPTS ########################
        ...
        const _bom = new class BOM164 extends BOM_ElementType_bomout_Board {
          constructor() { super(partSelf); }
          set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly) {
            const part = partSelf;
...
GlobalFunc.process_BoardBom(this, part, elementType, elementCategory, parentBomId)
  ...
  override createBomTouchElements(touch: PartTouch, partNext: PartBase, posRel: CollisionDataRel) {
      try {
      // ncout_Group: 335: part_Sidepanelleft FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Sidepanelleft) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          ...
          const _bom = new class BOMT335 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelleft_PartVarsReadOnly, posRel:CollisionDataRel) {
...
//
// Description:
// Connection between Shelfbtm and Sidepanelleft
// Touch FromLeft
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._description = "Connection with sidepanel left";
      ...
      try {
      // ncout_Group: 336: part_Sidepanelright FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Sidepanelright) {
        let part2 = <P_part_Sidepanelright>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT336 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelright_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//
// Description:
// Connection between Shelfbtm and Sidepanelright
// Touch FromRight
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with sidepanel right";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 340: part_LegDrill FromBottom
    if (touch == PartTouch.FromBottom && partNext instanceof P_part_LegDrill) {
        let part2 = <P_part_LegDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT340 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_LegDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
               // ####################### CUSTOM SCRIPTS ########################
GlobalFunc.ncout_LegDrill(this, partSelf, part2, posRel)
               // ################### END CUSTOM SCRIPTS ########################
              internal_leaveBomPartMasterDataTouches();
            }
          }
          _bom._parentId = partSelf._id;
          _bom._description = "Drillings for legs";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 367: part_Sidepanelleft FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_Sidepanelleft) {
        let part2 = <P_part_Sidepanelleft>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT367 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelleft_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 368: part_Sidepanelright FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_Sidepanelright) {
        let part2 = <P_part_Sidepanelright>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT368 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelright_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 373: part_CleatVert FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_CleatVert) {
        let part2 = <P_part_CleatVert>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT373 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_CleatVert_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//
// Description:
// Connection between Shelfbtm and CleatVert
// Touch FromTop
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with cleat";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 400: part_Sidepanelmiddle FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_Sidepanelmiddle) {
        let part2 = <P_part_Sidepanelmiddle>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT400 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelmiddle_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//
// Description:
// Connection between Shelfbtm and Sidepanelmiddle
// Touch FromLeft
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with side panel middle from top";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 435: part_PushtoopenDrill FromFront
    if (touch == PartTouch.FromFront && partNext instanceof P_part_PushtoopenDrill) {
        let part2 = <P_part_PushtoopenDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT435 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_PushtoopenDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
GlobalFunc.ops_PushtoopenDrill('Carcase', this, partSelf, part2, posRel);
      ...
      try {
      // ncout_Group: 452: part_PushtoopenMountingPlateDrill FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_PushtoopenMountingPlateDrill) {
        let part2 = <P_part_PushtoopenMountingPlateDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT452 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_PushtoopenMountingPlateDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
GlobalFunc.ops_PushtoopenDrill('Carcase', this, partSelf, part2, posRel);
      ...
      try {
      // ncout_Group: 479: part_Panelblind FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_Panelblind) {
        let part2 = <P_part_Panelblind>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT479 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Panelblind_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//
// Description:
// Connection between Shelfbtm and Panel blind
// Touch FromTop
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 507: part_HingeDrill FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_HingeDrill) {
        let part2 = <P_part_HingeDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT507 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_HingeDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//====================================================================
  ...
  {  
    ...
    DrillVert.nc_YA = partSelf._dimz - (partSelf._dimz - insertPoint.InsertionPointX - x.XA + (part2.pa_FrontGapCarcase - part2.pa_HingeGapCarcase));
    ...
    // Add drawing
    let drilling01 = partSelf.add3DElement('Drilling01', DrillVert, posRel.x + insertPoint.InsertionPointY + x.YA, posRel.y, partSelf._dimz - insertPoint.InsertionPointX - x.XA + (part2.pa_FrontGapCarcase - part2.pa_HingeGapCarcase), x.DU, - x.TI, x.DU );
    drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'y');
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Drillings for Mounting Plate";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 572: part_Backwall Collision
    if (touch == PartTouch.Collision && partNext instanceof P_part_Backwall) {
        let part2 = <P_part_Backwall>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT572 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Backwall_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
               // ####################### CUSTOM SCRIPTS ########################
GlobalFunc.ops_BackwallGroove(this, partSelf, part2, posRel, 'BackwallGrooveShelfbtm', 'Horizontal');
               // ################### END CUSTOM SCRIPTS ########################
              internal_leaveBomPartMasterDataTouches();
            }
          }
      ...
      try {
      // ncout_Group: 587: part_Sidepanelmiddle FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Sidepanelmiddle) {
        let part2 = <P_part_Sidepanelmiddle>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT587 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelmiddle_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with sidepanel middle from left";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 589: part_Sidepanelmiddle FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Sidepanelmiddle) {
        let part2 = <P_part_Sidepanelmiddle>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT589 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelmiddle_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with sidepanel middle from right";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 627: part_FillerHardwareProcessing FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_FillerHardwareProcessing) {
        let part2 = <P_part_FillerHardwareProcessing>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT627 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelfbtm_PartVarsReadOnly, touch: PartTouch, part2: IP_part_FillerHardwareProcessing_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//====================================================================
  ...
  if (part2.pa_HardwareIdentifier == 'CarcaseConnector' || part2.pa_HardwareIdentifier == 'FrontAndCarcaseConnector') {
    ...
    drillings.forEach(x => {
      ...
      // Add drawing
      let drilling01 = partSelf.add3DElement('Drilling01', DrillVert, posRel.x - insertPoint.InsertionPointY - x.YA, posRel.y + part2._dimy, posRel.z + part2._dimz - insertPoint.InsertionPointX - x.XA, x.DU, - x.TI, x.DU);
      drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU / 2 + '" /></svg>', 'y');
    });
  }
               // ################### END CUSTOM SCRIPTS ########################
