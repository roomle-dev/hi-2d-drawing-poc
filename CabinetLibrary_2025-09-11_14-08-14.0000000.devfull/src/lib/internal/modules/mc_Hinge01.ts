...
import { IModParents_mc_Door01_mc_HingeGroup01 } from '../mod-interfaces'
import { IP_part_HingeDoor_PartVarsWritable, P_part_HingeDoor } from '../parts/part_HingeDoor'
import { IP_part_HingeCarcase_PartVarsWritable, P_part_HingeCarcase } from '../parts/part_HingeCarcase'
import { IP_part_HingeDrill_PartVarsWritable, P_part_HingeDrill } from '../parts/part_HingeDrill'
import { IP_part_HingeDrillFHF_PartVarsWritable, P_part_HingeDrillFHF } from '../parts/part_HingeDrillFHF'
import { IModuleNonNull_mc_Hinge01,IModParents_mc_Hinge01,IPartParentsNonNull_mc_Hinge01} from '../mod-interfaces'
import {IModVar_mod_CarcaseId,IModVarNonNull_mod_CarcaseId,IModVar_mod_CarcaseWidth,IModVarNonNull_mod_CarcaseWidth,IModVar_mod_DoorType,IModVarNonNull_mod_DoorType,IModVar_mod_FrontId,IModVarNonNull_mod_FrontId,IModVar_mod_FrontType,IModVarNonNull_mod_FrontType,IModVar_mod_SidepanelleftThk,IModVarNonNull_mod_SidepanelleftThk,IModVar_mod_SidepanelrightThk,IModVarNonNull_mod_SidepanelrightThk,IModVar_mod_HingeType,IModVarNonNull_mod_HingeType,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_HingeInfo,IModVarNonNull_mod_HingeInfo,IModVar_mod_FrontGapCarcase,IModVarNonNull_mod_FrontGapCarcase,IModVar_mod_FrontGapVert,IModVarNonNull_mod_FrontGapVert,IModVar_mod_DoorDirection,IModVarNonNull_mod_DoorDirection,IModVar_mod_Height,IModVarNonNull_mod_Height,IModVar_mod_FrontGapHor,IModVarNonNull_mod_FrontGapHor} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_CarcaseId, IMatrix_mod_CarcaseWidth, IMatrix_mod_DoorType, IMatrix_mod_FrontId, IMatrix_mod_FrontType, IMatrix_mod_SidepanelleftThk, IMatrix_mod_SidepanelrightThk, IMatrix_mod_HingeType, IMatrix_mod_ModuleName, IMatrix_mod_FrontGapCarcase, IMatrix_mod_FrontGapVert, IMatrix_mod_DoorDirection, IMatrix_mod_Height, IMatrix_mod_FrontGapHor} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_HingeDoor, IPartAdd_part_HingeCarcase, IPartAdd_part_HingeDrill, IPartAdd_part_HingeDrillFHF } from '../part-add-interfaces';
import { mc_Hinge01_createBuildPlan, mc_Hinge01_afterDataCompletion, mc_Hinge01_manufacturerDataCompletion } from '../../modules/mc_Hinge01';

export interface cbp_mc_Hinge01 extends IModBaseProp
, IPartAdd_part_HingeDoor, IPartAdd_part_HingeCarcase, IPartAdd_part_HingeDrill, IPartAdd_part_HingeDrillFHF, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_DoorType, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_HingeType, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_HingeInfo, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_DoorDirection, IModVarNonNull_mod_Height, IModVarNonNull_mod_FrontGapHor {
  parent: IModParents_mc_Door01_mc_HingeGroup01;
...
export interface dc_mc_Hinge01 extends IModBaseProp
, IModVar_mod_CarcaseId, IModVar_mod_CarcaseWidth, IModVar_mod_DoorType, IModVar_mod_FrontId, IModVar_mod_FrontType, IModVar_mod_SidepanelleftThk, IModVar_mod_SidepanelrightThk, IModVar_mod_HingeType, IModVar_mod_ModuleName, IModVar_mod_HingeInfo, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapVert, IModVar_mod_DoorDirection, IModVar_mod_Height, IModVar_mod_FrontGapHor {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Hinge01;
  parent: IModParents_mc_Door01_mc_HingeGroup01;
}

export interface adc_mc_Hinge01 extends IModBaseProp
, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_DoorType, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_HingeType, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_HingeInfo, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_DoorDirection, IModVarNonNull_mod_Height, IModVarNonNull_mod_FrontGapHor {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
}

export class OD_M_mc_Hinge01 extends OD_Base  implements dc_mc_Hinge01
,IModParents_mc_Hinge01
,IModVar_mod_CarcaseId,IModVar_mod_CarcaseWidth,IModVar_mod_DoorType,IModVar_mod_FrontId,IModVar_mod_FrontType,IModVar_mod_SidepanelleftThk,IModVar_mod_SidepanelrightThk,IModVar_mod_HingeType,IModVar_mod_ModuleName,IModVar_mod_HingeInfo,IModVar_mod_FrontGapCarcase,IModVar_mod_FrontGapVert,IModVar_mod_DoorDirection,IModVar_mod_Height,IModVar_mod_FrontGapHor
 {
  constructor(parent: IModParents_mc_Door01_mc_HingeGroup01, manufacturerMode?:boolean) {
    super('mc_Hinge01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Hinge01_NonNull(this);
  }
  parent: IModParents_mc_Door01_mc_HingeGroup01;
  _selfNonNull: OD_M_mc_Hinge01_NonNull;

  override variants:string[] = ['mod_CarcaseId','mod_CarcaseWidth','mod_DoorType','mod_FrontId','mod_FrontType','mod_SidepanelleftThk','mod_SidepanelrightThk','mod_HingeType','mod_ModuleName','mod_HingeInfo','mod_FrontGapCarcase','mod_FrontGapVert','mod_DoorDirection','mod_Height','mod_FrontGapHor',];
  ...
  #manufacturerDataCompletionInternal = mc_Hinge01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Hinge01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Hinge01{
    ...
    const adc = new OD_M_mc_Hinge01_NonNull(this);
    return adc;
  }
  ...
  addpart_HingeDoor(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HingeDoor_PartVarsWritable {
    var c = new P_part_HingeDoor(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_HingeCarcase(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HingeCarcase_PartVarsWritable {
    var c = new P_part_HingeCarcase(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_HingeDrill(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HingeDrill_PartVarsWritable {
    var c = new P_part_HingeDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_HingeDrillFHF(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HingeDrillFHF_PartVarsWritable {
    var c = new P_part_HingeDrillFHF(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Hinge01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Hinge01_NonNull implements cbp_mc_Hinge01, adc_mc_Hinge01 ,IPartParentsNonNull_mc_Hinge01 {
  constructor(parent: OD_M_mc_Hinge01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Hinge01;
  ...
  #createBuildPlanInternal = mc_Hinge01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Hinge01_afterDataCompletion;
  ...
  parent: IModParents_mc_Door01_mc_HingeGroup01;
  addpart_HingeDoor(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HingeDoor_PartVarsWritable {
    return this.#internalParent.addpart_HingeDoor(x, y, z, dimx, dimy, dimz);
  }
  addpart_HingeCarcase(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HingeCarcase_PartVarsWritable {
    return this.#internalParent.addpart_HingeCarcase(x, y, z, dimx, dimy, dimz);
  }
  addpart_HingeDrill(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HingeDrill_PartVarsWritable {
    return this.#internalParent.addpart_HingeDrill(x, y, z, dimx, dimy, dimz);
  }
  addpart_HingeDrillFHF(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HingeDrillFHF_PartVarsWritable {
    return this.#internalParent.addpart_HingeDrillFHF(x, y, z, dimx, dimy, dimz);
  }
