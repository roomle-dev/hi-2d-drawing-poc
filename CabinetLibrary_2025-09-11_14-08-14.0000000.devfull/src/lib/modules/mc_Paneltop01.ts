...
//#region Imports
import { cbp_mc_Paneltop01, dc_mc_Paneltop01, adc_mc_Paneltop01 } from '../internal/modules/mc_Paneltop01'
...
export function mc_Paneltop01_createBuildPlan(this: cbp_mc_Paneltop01):void {
  internal_enterModuleCreateBuildPlan('mc_Paneltop01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Paneltop01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_Paneltop01_afterDataCompletion(this: adc_mc_Paneltop01):void {
  internal_enterModuleAfterDataCompletion('mc_Paneltop01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Paneltop01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Paneltop01_manufacturerDataCompletion(this: dc_mc_Paneltop01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Paneltop01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Paneltop01_MANUFACTURERDATACOMPLETION
