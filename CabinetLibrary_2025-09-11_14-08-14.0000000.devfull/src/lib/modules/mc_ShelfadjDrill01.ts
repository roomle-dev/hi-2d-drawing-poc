...
//#region Imports
import { cbp_mc_ShelfadjDrill01, dc_mc_ShelfadjDrill01, adc_mc_ShelfadjDrill01 } from '../internal/modules/mc_ShelfadjDrill01'
...
export function mc_ShelfadjDrill01_createBuildPlan(this: cbp_mc_ShelfadjDrill01):void {
  internal_enterModuleCreateBuildPlan('mc_ShelfadjDrill01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_ShelfadjDrill01_CREATEBUILDPLAN
// Schuler Consulting
// Create: March 2024
...
//
// Description: 
// CreateBuildPlan of mc_ShelfadjDrill01
// Add Drillcube for adjustable shelves
//
// Revisions:
// 
//===================================================
...
let DrillCube=this.addpart_ShelfadjDrill(0,0,0,this.mod_Width,this.mod_Height,this.mod_Depth);
// ###############################################################
// ################### END CUSTOM SCRIPTS ########################
// ###############################################################
  } 
...
// ---------------------------------------------------------------
export function mc_ShelfadjDrill01_afterDataCompletion(this: adc_mc_ShelfadjDrill01):void {
  internal_enterModuleAfterDataCompletion('mc_ShelfadjDrill01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_ShelfadjDrill01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_ShelfadjDrill01_manufacturerDataCompletion(this: dc_mc_ShelfadjDrill01):void {
  internal_enterModuleManufacturerDataCompletion('mc_ShelfadjDrill01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_ShelfadjDrill01_MANUFACTURERDATACOMPLETION
