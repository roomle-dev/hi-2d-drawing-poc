...
//#region Imports
import { cbp_mc_Bracket01, dc_mc_Bracket01, adc_mc_Bracket01 } from '../internal/modules/mc_Bracket01'
...
export function mc_Bracket01_createBuildPlan(this: cbp_mc_Bracket01):void {
  internal_enterModuleCreateBuildPlan('mc_Bracket01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Bracket01_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: May 2025
  // By Stefano Cortese
...
// ---------------------------------------------------------------
export function mc_Bracket01_afterDataCompletion(this: adc_mc_Bracket01):void {
  internal_enterModuleAfterDataCompletion('mc_Bracket01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Bracket01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Bracket01_manufacturerDataCompletion(this: dc_mc_Bracket01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Bracket01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Bracket01_MANUFACTURERDATACOMPLETION
