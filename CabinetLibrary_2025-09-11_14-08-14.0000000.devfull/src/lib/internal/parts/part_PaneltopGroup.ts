...
export interface IP_part_PaneltopGroup_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_Paneltop01;
}

export interface IP_part_PaneltopGroup_PartVarsWritable extends IP_part_PaneltopGroup_PartVarsReadOnly {
}

export class P_part_PaneltopGroup extends PartBase implements IP_part_PaneltopGroup_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Paneltop01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_PaneltopGroup', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XZY';
    this._noNCData = true;
    this._hidden = true;
