...
export interface cti_tab_FridgeMapping {
  readonly in_Supplier? : string;
  readonly in_FridgeId? : string;
}

export interface ctm_tab_FridgeMapping {
}

export interface cto_tab_FridgeMapping extends ctm_tab_FridgeMapping {
  readonly _id : number;
  readonly ConstructionId? : string;
  readonly GraphicId? : string;
}

export interface ICT_tab_FridgeMapping
extends cti_tab_FridgeMapping, cto_tab_FridgeMapping {}

export class ct2_tab_FridgeMapping {

public findExactly(
     in_Supplier: string|undefined,
     in_FridgeId: string|undefined,
): cto_tab_FridgeMapping | undefined {
  const res = ct_tab_FridgeMapping.find((p) => 
p.in_Supplier === in_Supplier
 && p.in_FridgeId === in_FridgeId
);
return res;
}

public find(
predicate: (value: cti_tab_FridgeMapping) => boolean
): cto_tab_FridgeMapping | undefined {
  for (let index = 0; index < ct_tab_FridgeMapping.length; index++){
    const element = ct_tab_FridgeMapping[index];
...
export var ct_tab_FridgeMapping :ICT_tab_FridgeMapping[] = [
{
 _id: 1,
 in_Supplier: "Siemens",
 in_FridgeId: "KI86SHDD0",
 ConstructionId: "KI86SHDD0",
 GraphicId: "KI86SHDD0"
}
,{
 _id: 2,
 in_Supplier: "Siemens",
 in_FridgeId: "KI82LADD0",
 ConstructionId: "KI82LADD0",
 GraphicId: "KI82LADD0"
}
,{
 _id: 3,
 in_Supplier: "Siemens",
 in_FridgeId: "KI41FADD0",
 ConstructionId: "KI41FADD0",
 GraphicId: "KI41FADD0"
}
,{
 _id: 4,
 in_Supplier: "None",
 in_FridgeId: "None",
 ConstructionId: "FridgeDefault",
 GraphicId: "FridgeDefault"
}
];
