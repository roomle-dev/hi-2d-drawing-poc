...
export interface cti_tab_CarcaseSlopedCeilingDimension {
  readonly in_Construction? : string;
  readonly in_DimensionLogic? : string;
}

export interface ctm_tab_CarcaseSlopedCeilingDimension {
}

export interface cto_tab_CarcaseSlopedCeilingDimension extends ctm_tab_CarcaseSlopedCeilingDimension {
  readonly _id : number;
  TopDepth(m: any /* WARNING: No parent found; assuming 'any' */, BackHeight:number, Angle:number):number;
  Height(m: any /* WARNING: No parent found; assuming 'any' */, BackHeight:number, Angle:number):number;
}

export interface ICT_tab_CarcaseSlopedCeilingDimension
extends cti_tab_CarcaseSlopedCeilingDimension, cto_tab_CarcaseSlopedCeilingDimension {}

export class ct2_tab_CarcaseSlopedCeilingDimension {

public findExactly(
     in_Construction: string|undefined,
     in_DimensionLogic: string|undefined,
): cto_tab_CarcaseSlopedCeilingDimension | undefined {
  const res = ct_tab_CarcaseSlopedCeilingDimension.find((p) => 
p.in_Construction === in_Construction
 && p.in_DimensionLogic === in_DimensionLogic
);
return res;
}

public find(
predicate: (value: cti_tab_CarcaseSlopedCeilingDimension) => boolean
): cto_tab_CarcaseSlopedCeilingDimension | undefined {
  for (let index = 0; index < ct_tab_CarcaseSlopedCeilingDimension.length; index++){
    const element = ct_tab_CarcaseSlopedCeilingDimension[index];
...
export var ct_tab_CarcaseSlopedCeilingDimension :ICT_tab_CarcaseSlopedCeilingDimension[] = [
{
 _id: 25,
 in_Construction: "Construction01",
 in_DimensionLogic: "BasedInTopDepth",
  TopDepth(m: any /* WARNING: No parent found; assuming 'any' */, BackHeight:number, Angle:number):number {
    return m.mod_TopDepth;
  }
,
  Height(m: any /* WARNING: No parent found; assuming 'any' */, BackHeight:number, Angle:number):number {
    return BackHeight + GlobalFunc.calc_pythagoreanTheorem(Angle - 90, m.mod_Depth - m.mod_TopDepth, 0, 0)[2];
  }
...
,{
 _id: 26,
 in_Construction: "Construction01",
 in_DimensionLogic: "BasedInHeight",
  TopDepth(m: any /* WARNING: No parent found; assuming 'any' */, BackHeight:number, Angle:number):number {
    return m.mod_Depth - GlobalFunc.calc_pythagoreanTheorem(Angle- 90, 0, m.mod_Height - BackHeight, 0)[1];
  }
,
  Height(m: any /* WARNING: No parent found; assuming 'any' */, BackHeight:number, Angle:number):number {
    return m.mod_Height;
...
,{
 _id: 27,
 in_Construction: "Construction02",
 in_DimensionLogic: "BasedInTopDepth",
  TopDepth(m: any /* WARNING: No parent found; assuming 'any' */, BackHeight:number, Angle:number):number {
    return m.mod_TopDepth;
  }
...
,{
 _id: 29,
 in_Construction: "Construction03",
 in_DimensionLogic: "BasedInTopDepth",
  TopDepth(m: any /* WARNING: No parent found; assuming 'any' */, BackHeight:number, Angle:number):number {
    return m.mod_TopDepth;
  }
