...
//#region Imports
import { cbp_mc_ShelfadjGlass01, dc_mc_ShelfadjGlass01, adc_mc_ShelfadjGlass01 } from '../internal/modules/mc_ShelfadjGlass01'
...
export function mc_ShelfadjGlass01_createBuildPlan(this: cbp_mc_ShelfadjGlass01):void {
  internal_enterModuleCreateBuildPlan('mc_ShelfadjGlass01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_ShelfadjGlass01_CREATEBUILDPLAN
// Schuler Consulting
// Create: Feb 2024
...
// ---------------------------------------------------------------
export function mc_ShelfadjGlass01_afterDataCompletion(this: adc_mc_ShelfadjGlass01):void {
  internal_enterModuleAfterDataCompletion('mc_ShelfadjGlass01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_ShelfadjGlass01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_ShelfadjGlass01_manufacturerDataCompletion(this: dc_mc_ShelfadjGlass01):void {
  internal_enterModuleManufacturerDataCompletion('mc_ShelfadjGlass01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_ShelfadjGlass01_MANUFACTURERDATACOMPLETION
