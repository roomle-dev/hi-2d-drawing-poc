...
import { IPartParentsNonNull_mc_Countertop01 } from '../mod-interfaces'

export interface IP_part_Countertop_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_Countertop01;
  get pa_BomId(): string;
...
export interface IP_part_Countertop_PartVarsWritable extends IP_part_Countertop_PartVarsReadOnly {
  ...
  set pa_CountertopInfo(value: string);
...
export class P_part_Countertop extends PartBase implements IP_part_Countertop_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Countertop01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_Countertop', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XZY';
  }
  parent: IPartParentsNonNull_mc_Countertop01; // module which created this part
  ...
  res.set('pa_CountertopInfo', this.#pa_CountertopInfo);
  ...
  setAttributes() {
    ...
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // part_Countertop_ValueScript
    if (this.#pa_BomId === undefined) {
      this.pa_BomId = this.parent.mod_CountertopId;
    }
    if (this.#pa_EdgeBackColor === undefined) {
      this.pa_EdgeBackColor = this.parent.mod_CountertopColor;
    }
    if (this.#pa_EdgeBackType === undefined) {
      this.pa_EdgeBackType = 'NOE';
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      this.pa_EdgeFrontColor = this.parent.mod_CountertopColor;
    }
    ...
    if (this.#pa_EdgeLeftColor === undefined) {
      this.pa_EdgeLeftColor = this.parent.mod_CountertopColor;
    }
    if (this.#pa_EdgeLeftType === undefined) {
      this.pa_EdgeLeftType = 'FRE';
    }
    if (this.#pa_EdgeRightColor === undefined) {
      this.pa_EdgeRightColor = this.parent.mod_CountertopColor;
    }
    if (this.#pa_GrainDirection === undefined) {
      this.pa_GrainDirection = 'Neutral';
    }
    if (this.#pa_TopColor === undefined) {
      this.pa_TopColor = this.parent.mod_CountertopColor;
    }
    if (this.#pa_BtmColor === undefined) {
      this.pa_BtmColor = this.parent.mod_CountertopColor;
    }
    if (this.#pa_Program === undefined) {
      this.pa_Program = this.parent.mod_CountertopProgram;
    }
    ...
    if (this.#pa_ColorGrainGroup === undefined) {
      this.pa_ColorGrainGroup = this.parent.mod_CountertopColor_matrix.GrainGroupId;
    }
    if (this.#pa_GrainLogic === undefined) {
      this.pa_GrainLogic = this.parent.mod_GrainLogic;
    }
    if (this.#pa_ProgramGrainGroup === undefined) {
      this.pa_ProgramGrainGroup = this.parent.mod_CountertopProgram_matrix.GrainGroupId;
    }
    if (this.#pa_TypeElement === undefined) {
      this.pa_TypeElement = 'All';
    }
    // ###############################################################
    // ################### END CUSTOM SCRIPTS ########################
    // ###############################################################
  ...
  checkAttributes() {
    ...
    if (this.#pa_BomId === undefined) {
      logError('Attribute pa_BomId not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackColor === undefined) {
      logError('Attribute pa_EdgeBackColor not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackType === undefined) {
      logError('Attribute pa_EdgeBackType not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      logError('Attribute pa_EdgeFrontColor not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontType === undefined) {
      logError('Attribute pa_EdgeFrontType not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeJointType === undefined) {
      logError('Attribute pa_EdgeJointType not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftColor === undefined) {
      logError('Attribute pa_EdgeLeftColor not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftType === undefined) {
      logError('Attribute pa_EdgeLeftType not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightColor === undefined) {
      logError('Attribute pa_EdgeRightColor not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_GrainDirection === undefined) {
      logError('Attribute pa_GrainDirection not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_TopColor === undefined) {
      logError('Attribute pa_TopColor not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_BtmColor === undefined) {
      logError('Attribute pa_BtmColor not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_Program === undefined) {
      logError('Attribute pa_Program not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightType === undefined) {
      logError('Attribute pa_EdgeRightType not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_AdditionalInfo1 === undefined) {
      logError('Attribute pa_AdditionalInfo1 not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_CountertopInfo === undefined) {
      logError('Attribute pa_CountertopInfo not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_ColorGrainGroup === undefined) {
      logError('Attribute pa_ColorGrainGroup not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_GrainLogic === undefined) {
      logError('Attribute pa_GrainLogic not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_ProgramGrainGroup === undefined) {
      logError('Attribute pa_ProgramGrainGroup not set in part part_Countertop (id: ' + this._id + ')');
    }
    if (this.#pa_TypeElement === undefined) {
      logError('Attribute pa_TypeElement not set in part part_Countertop (id: ' + this._id + ')');
    }
  ...
  createBomElements() {
    ...
    const partSelf = this;
      ...
      if (partSelf._g?.basic_CreateBom == 'Library') { // ####################### CUSTOM SCRIPTS ########################
        ...
        const _bom = new class BOM181 extends BOM_ElementType_bomout_Board {
          constructor() { super(partSelf); }
          set(partSelf: IP_part_Countertop_PartVarsReadOnly) {
            const part = partSelf;
...
GlobalFunc.process_BoardBom(this, part, elementType, elementCategory, parentBomId)
        ...
        _bom._description = "Output Parts / board";
        _bom.set(partSelf);
  ...
  override createBomTouchElementsEnd() : void { 
      try {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          ...
          const _bom = new class BOMT579 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Countertop_PartVarsReadOnly) {
...
//======================================================================
  ...
  edges.nc_EdgesRight = partSelf.pa_EdgeRightType == "FRE" ? "visible" : "invisible";
          ...
          _bom._description = "Insert all the processings via attributes on the part";
          _bom.set(partSelf);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
  ...
  get pa_CountertopInfo(): string { return this.#pa_CountertopInfo!; }
  set pa_CountertopInfo(val:string) { this.#pa_CountertopInfo = val; }
  #pa_CountertopInfo?: string;
