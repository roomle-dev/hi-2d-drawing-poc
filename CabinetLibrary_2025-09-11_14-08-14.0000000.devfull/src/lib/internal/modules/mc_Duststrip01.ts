...
import { IModParents_mc_Door01 } from '../mod-interfaces'
import { IP_part_Duststrip_PartVarsWritable, P_part_Duststrip } from '../parts/part_Duststrip'
import { IModuleNonNull_mc_Duststrip01,IModParents_mc_Duststrip01,IPartParentsNonNull_mc_Duststrip01} from '../mod-interfaces'
import {IModVar_mod_VertDividerType,IModVarNonNull_mod_VertDividerType,IModVar_mod_DoorType,IModVarNonNull_mod_DoorType,IModVar_mod_CarcaseId,IModVarNonNull_mod_CarcaseId,IModVar_mod_FrontGapCarcase,IModVarNonNull_mod_FrontGapCarcase,IModVar_mod_FrontGapHor,IModVarNonNull_mod_FrontGapHor,IModVar_mod_FrontGapHorTop,IModVarNonNull_mod_FrontGapHorTop,IModVar_mod_FrontGapVert,IModVarNonNull_mod_FrontGapVert,IModVar_mod_FrontId,IModVarNonNull_mod_FrontId,IModVar_mod_FrontType,IModVarNonNull_mod_FrontType,IModVar_mod_FrontDesign,IModVarNonNull_mod_FrontDesign,IModVar_mod_FrontThk,IModVarNonNull_mod_FrontThk,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_FrontHeight,IModVarNonNull_mod_FrontHeight,IModVar_mod_FrontWidth,IModVarNonNull_mod_FrontWidth,IModVar_mod_FrontColor,IModVarNonNull_mod_FrontColor,IModVar_mod_FrontProgram,IModVarNonNull_mod_FrontProgram,IModVar_mod_Originpos,IModVarNonNull_mod_Originpos,IModVar_mod_HardwareId,IModVarNonNull_mod_HardwareId,IModVar_mod_CarcaseSpaceDimension,IModVarNonNull_mod_CarcaseSpaceDimension} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_VertDividerType, IMatrix_mod_DoorType, IMatrix_mod_CarcaseId, IMatrix_mod_FrontGapCarcase, IMatrix_mod_FrontGapHor, IMatrix_mod_FrontGapHorTop, IMatrix_mod_FrontGapVert, IMatrix_mod_FrontId, IMatrix_mod_FrontType, IMatrix_mod_FrontDesign, IMatrix_mod_FrontThk, IMatrix_mod_ModuleName, IMatrix_mod_FrontHeight, IMatrix_mod_FrontWidth, IMatrix_mod_FrontColor, IMatrix_mod_FrontProgram, IMatrix_mod_HardwareId} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_Duststrip } from '../part-add-interfaces';
import { mc_Duststrip01_createBuildPlan, mc_Duststrip01_afterDataCompletion, mc_Duststrip01_manufacturerDataCompletion } from '../../modules/mc_Duststrip01';

export interface cbp_mc_Duststrip01 extends IModBaseProp
, IPartAdd_part_Duststrip, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_DoorType, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_HardwareId, IModVarNonNull_mod_CarcaseSpaceDimension {
...
export interface dc_mc_Duststrip01 extends IModBaseProp
, IModVar_mod_VertDividerType, IModVar_mod_DoorType, IModVar_mod_CarcaseId, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapHorTop, IModVar_mod_FrontGapVert, IModVar_mod_FrontId, IModVar_mod_FrontType, IModVar_mod_FrontDesign, IModVar_mod_FrontThk, IModVar_mod_ModuleName, IModVar_mod_FrontHeight, IModVar_mod_FrontWidth, IModVar_mod_FrontColor, IModVar_mod_FrontProgram, IModVar_mod_Originpos, IModVar_mod_HardwareId, IModVar_mod_CarcaseSpaceDimension {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Duststrip01;
  parent: IModParents_mc_Door01;
}

export interface adc_mc_Duststrip01 extends IModBaseProp
, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_DoorType, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_HardwareId, IModVarNonNull_mod_CarcaseSpaceDimension {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
}

export class OD_M_mc_Duststrip01 extends OD_Base  implements dc_mc_Duststrip01
,IModParents_mc_Duststrip01
,IModVar_mod_VertDividerType,IModVar_mod_DoorType,IModVar_mod_CarcaseId,IModVar_mod_FrontGapCarcase,IModVar_mod_FrontGapHor,IModVar_mod_FrontGapHorTop,IModVar_mod_FrontGapVert,IModVar_mod_FrontId,IModVar_mod_FrontType,IModVar_mod_FrontDesign,IModVar_mod_FrontThk,IModVar_mod_ModuleName,IModVar_mod_FrontHeight,IModVar_mod_FrontWidth,IModVar_mod_FrontColor,IModVar_mod_FrontProgram,IModVar_mod_Originpos,IModVar_mod_HardwareId,IModVar_mod_CarcaseSpaceDimension
 {
  constructor(parent: IModParents_mc_Door01, manufacturerMode?:boolean) {
    super('mc_Duststrip01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Duststrip01_NonNull(this);
  }
  parent: IModParents_mc_Door01;
  _selfNonNull: OD_M_mc_Duststrip01_NonNull;

  override variants:string[] = ['mod_VertDividerType','mod_DoorType','mod_CarcaseId','mod_FrontGapCarcase','mod_FrontGapHor','mod_FrontGapHorTop','mod_FrontGapVert','mod_FrontId','mod_FrontType','mod_FrontDesign','mod_FrontThk','mod_ModuleName','mod_FrontHeight','mod_FrontWidth','mod_FrontColor','mod_FrontProgram','mod_Originpos','mod_HardwareId','mod_CarcaseSpaceDimension',];
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_Duststrip01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_Duststrip01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Duststrip01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Duststrip01{
    ...
    const adc = new OD_M_mc_Duststrip01_NonNull(this);
    return adc;
  }
  ...
  addpart_Duststrip(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Duststrip_PartVarsWritable {
    var c = new P_part_Duststrip(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Duststrip01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Duststrip01_NonNull implements cbp_mc_Duststrip01, adc_mc_Duststrip01 ,IPartParentsNonNull_mc_Duststrip01 {
  constructor(parent: OD_M_mc_Duststrip01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Duststrip01;
  ...
  #createBuildPlanInternal = mc_Duststrip01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Duststrip01_afterDataCompletion;
  ...
  parent: IModParents_mc_Door01;
  addpart_Duststrip(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Duststrip_PartVarsWritable {
    return this.#internalParent.addpart_Duststrip(x, y, z, dimx, dimy, dimz);
  }
