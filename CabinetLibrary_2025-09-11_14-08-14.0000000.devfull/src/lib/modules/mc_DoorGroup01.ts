...
//#region Imports
import { cbp_mc_DoorGroup01, dc_mc_DoorGroup01, adc_mc_DoorGroup01 } from '../internal/modules/mc_DoorGroup01'
...
export function mc_DoorGroup01_createBuildPlan(this: cbp_mc_DoorGroup01):void {
  internal_enterModuleCreateBuildPlan('mc_DoorGroup01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_DoorGroup01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_DoorGroup01_afterDataCompletion(this: adc_mc_DoorGroup01):void {
  internal_enterModuleAfterDataCompletion('mc_DoorGroup01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_DoorGroup01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_DoorGroup01_manufacturerDataCompletion(this: dc_mc_DoorGroup01):void {
  internal_enterModuleManufacturerDataCompletion('mc_DoorGroup01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_DoorGroup01_MANUFACTURERDATACOMPLETION
