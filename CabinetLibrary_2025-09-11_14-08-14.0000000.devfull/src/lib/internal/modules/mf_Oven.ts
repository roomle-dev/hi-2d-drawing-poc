...
import { OD_M_mc_Oven01, dc_mc_Oven01 } from './mc_Oven01'
import { IModuleNonNull_mf_Oven,IModParents_mf_Oven,IPartParentsNonNull_mf_Oven} from '../mod-interfaces'
import {IModVar_mod_CarcaseId,IModVarNonNull_mod_CarcaseId,IModVar_mod_CarcaseDepth,IModVarNonNull_mod_CarcaseDepth,IModVar_mod_CarcaseHeight,IModVarNonNull_mod_CarcaseHeight,IModVar_mod_CarcaseWidth,IModVarNonNull_mod_CarcaseWidth,IModVar_mod_ParentName,IModVarNonNull_mod_ParentName,IModVar_mod_ShelffixedThk,IModVarNonNull_mod_ShelffixedThk,IModVar_mod_SidepanelleftThk,IModVarNonNull_mod_SidepanelleftThk,IModVar_mod_SidepanelrightThk,IModVarNonNull_mod_SidepanelrightThk,IModVar_mod_Originpos,IModVarNonNull_mod_Originpos,IModVar_mod_FrontPosStart,IModVarNonNull_mod_FrontPosStart,IModVar_mod_TypeElement,IModVarNonNull_mod_TypeElement,IModVar_mod_FrontId,IModVarNonNull_mod_FrontId,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_ShelffixedInfoList,IModVarNonNull_mod_ShelffixedInfoList,IModVar_mod_FrontAreaInfoList,IModVarNonNull_mod_FrontAreaInfoList,IModVar_mod_OvenSupplier1,IModVarNonNull_mod_OvenSupplier1,IModVar_mod_OvenGap1,IModVarNonNull_mod_OvenGap1,IModVar_mod_OvenId1,IModVarNonNull_mod_OvenId1,IModVar_mod_OvenSupplier3,IModVarNonNull_mod_OvenSupplier3,IModVar_mod_OvenSupplier2,IModVarNonNull_mod_OvenSupplier2,IModVar_mod_OvenGap2,IModVarNonNull_mod_OvenGap2,IModVar_mod_OvenId2,IModVarNonNull_mod_OvenId2,IModVar_mod_OvenGap3,IModVarNonNull_mod_OvenGap3,IModVar_mod_OvenId3,IModVarNonNull_mod_OvenId3,IModVar_mod_OvenShelffixedOverhangTop,IModVarNonNull_mod_OvenShelffixedOverhangTop,IModVar_mod_OvenGap4,IModVarNonNull_mod_OvenGap4,IModVar_mod_FrontGapHor,IModVarNonNull_mod_FrontGapHor} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_CarcaseId, IMatrix_mod_CarcaseDepth, IMatrix_mod_CarcaseHeight, IMatrix_mod_CarcaseWidth, IMatrix_mod_ParentName, IMatrix_mod_ShelffixedThk, IMatrix_mod_SidepanelleftThk, IMatrix_mod_SidepanelrightThk, IMatrix_mod_FrontPosStart, IMatrix_mod_TypeElement, IMatrix_mod_FrontId, IMatrix_mod_ModuleName, IMatrix_mod_OvenSupplier1, IMatrix_mod_OvenGap1, IMatrix_mod_OvenId1, IMatrix_mod_OvenSupplier3, IMatrix_mod_OvenSupplier2, IMatrix_mod_OvenGap2, IMatrix_mod_OvenId2, IMatrix_mod_OvenGap3, IMatrix_mod_OvenId3, IMatrix_mod_OvenShelffixedOverhangTop, IMatrix_mod_OvenGap4, IMatrix_mod_FrontGapHor} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { mf_Oven_createBuildPlan, mf_Oven_afterDataCompletion, mf_Oven_manufacturerDataCompletion } from '../../modules/mf_Oven';

export interface cbp_mf_Oven extends IModBaseProp
...
export interface dc_mf_Oven extends IModBaseProp
, IModVar_mod_CarcaseId, IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseHeight, IModVar_mod_CarcaseWidth, IModVar_mod_ParentName, IModVar_mod_ShelffixedThk, IModVar_mod_SidepanelleftThk, IModVar_mod_SidepanelrightThk, IModVar_mod_Originpos, IModVar_mod_FrontPosStart, IModVar_mod_TypeElement, IModVar_mod_FrontId, IModVar_mod_ModuleName, IModVar_mod_ShelffixedInfoList, IModVar_mod_FrontAreaInfoList, IModVar_mod_OvenSupplier1, IModVar_mod_OvenGap1, IModVar_mod_OvenId1, IModVar_mod_OvenSupplier3, IModVar_mod_OvenSupplier2, IModVar_mod_OvenGap2, IModVar_mod_OvenId2, IModVar_mod_OvenGap3, IModVar_mod_OvenId3, IModVar_mod_OvenShelffixedOverhangTop, IModVar_mod_OvenGap4, IModVar_mod_FrontGapHor {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mf_Oven;
  parent: IModParents_mr_StorageunitSingle;
  addOD_M_mc_Oven01(index?: number): dc_mc_Oven01;
}

export interface adc_mf_Oven extends IModBaseProp
, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_ShelffixedInfoList, IModVarNonNull_mod_FrontAreaInfoList, IModVarNonNull_mod_OvenSupplier1, IModVarNonNull_mod_OvenGap1, IModVarNonNull_mod_OvenId1, IModVarNonNull_mod_OvenSupplier3, IModVarNonNull_mod_OvenSupplier2, IModVarNonNull_mod_OvenGap2, IModVarNonNull_mod_OvenId2, IModVarNonNull_mod_OvenGap3, IModVarNonNull_mod_OvenId3, IModVarNonNull_mod_OvenShelffixedOverhangTop, IModVarNonNull_mod_OvenGap4, IModVarNonNull_mod_FrontGapHor {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  addOD_M_mc_Oven01(index?: number): dc_mc_Oven01;
...
export class OD_M_mf_Oven extends OD_Base  implements dc_mf_Oven
,IModParents_mf_Oven
,IModVar_mod_CarcaseId,IModVar_mod_CarcaseDepth,IModVar_mod_CarcaseHeight,IModVar_mod_CarcaseWidth,IModVar_mod_ParentName,IModVar_mod_ShelffixedThk,IModVar_mod_SidepanelleftThk,IModVar_mod_SidepanelrightThk,IModVar_mod_Originpos,IModVar_mod_FrontPosStart,IModVar_mod_TypeElement,IModVar_mod_FrontId,IModVar_mod_ModuleName,IModVar_mod_ShelffixedInfoList,IModVar_mod_FrontAreaInfoList,IModVar_mod_OvenSupplier1,IModVar_mod_OvenGap1,IModVar_mod_OvenId1,IModVar_mod_OvenSupplier3,IModVar_mod_OvenSupplier2,IModVar_mod_OvenGap2,IModVar_mod_OvenId2,IModVar_mod_OvenGap3,IModVar_mod_OvenId3,IModVar_mod_OvenShelffixedOverhangTop,IModVar_mod_OvenGap4,IModVar_mod_FrontGapHor
 {
  constructor(parent: IModParents_mr_StorageunitSingle, manufacturerMode?:boolean) {
    super('mf_Oven', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mf_Oven_NonNull(this);
  }
  parent: IModParents_mr_StorageunitSingle;
  _selfNonNull: OD_M_mf_Oven_NonNull;

  override variants:string[] = ['mod_CarcaseId','mod_CarcaseDepth','mod_CarcaseHeight','mod_CarcaseWidth','mod_ParentName','mod_ShelffixedThk','mod_SidepanelleftThk','mod_SidepanelrightThk','mod_Originpos','mod_FrontPosStart','mod_TypeElement','mod_FrontId','mod_ModuleName','mod_ShelffixedInfoList','mod_FrontAreaInfoList','mod_OvenSupplier1','mod_OvenGap1','mod_OvenId1','mod_OvenSupplier3','mod_OvenSupplier2','mod_OvenGap2','mod_OvenId2','mod_OvenGap3','mod_OvenId3','mod_OvenShelffixedOverhangTop','mod_OvenGap4','mod_FrontGapHor',];
  ...
  get mod_OvenSupplier1(): string | undefined { return this.#mod_OvenSupplier1}
  set mod_OvenSupplier1(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_OvenSupplier1' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_OvenSupplier1 === value) return;
    this.#mod_OvenSupplier1 = value;
  }

  mod_OvenSupplier1_matrix?: IMatrix_mod_OvenSupplier1;
  #mod_OvenGap1?: number;
  get mod_OvenGap1(): number | undefined { return this.#mod_OvenGap1}
  set mod_OvenGap1(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_OvenGap1' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_OvenGap1 === value) return;
    this.#mod_OvenGap1 = value;
  }

  mod_OvenGap1_matrix?: IMatrix_mod_OvenGap1;
  #mod_OvenId1?: string;
  get mod_OvenId1(): string | undefined { return this.#mod_OvenId1}
  set mod_OvenId1(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_OvenId1' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_OvenId1 === value) return;
    this.#mod_OvenId1 = value;
  }

  mod_OvenId1_matrix?: IMatrix_mod_OvenId1;
  #mod_OvenSupplier3?: string;
  get mod_OvenSupplier3(): string | undefined { return this.#mod_OvenSupplier3}
  set mod_OvenSupplier3(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_OvenSupplier3' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_OvenSupplier3 === value) return;
    this.#mod_OvenSupplier3 = value;
  }

  mod_OvenSupplier3_matrix?: IMatrix_mod_OvenSupplier3;
  #mod_OvenSupplier2?: string;
  get mod_OvenSupplier2(): string | undefined { return this.#mod_OvenSupplier2}
  set mod_OvenSupplier2(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_OvenSupplier2' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_OvenSupplier2 === value) return;
    this.#mod_OvenSupplier2 = value;
  }

  mod_OvenSupplier2_matrix?: IMatrix_mod_OvenSupplier2;
  #mod_OvenGap2?: number;
  get mod_OvenGap2(): number | undefined { return this.#mod_OvenGap2}
  set mod_OvenGap2(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_OvenGap2' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_OvenGap2 === value) return;
    this.#mod_OvenGap2 = value;
  }

  mod_OvenGap2_matrix?: IMatrix_mod_OvenGap2;
  #mod_OvenId2?: string;
  get mod_OvenId2(): string | undefined { return this.#mod_OvenId2}
  set mod_OvenId2(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_OvenId2' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_OvenId2 === value) return;
    this.#mod_OvenId2 = value;
  }

  mod_OvenId2_matrix?: IMatrix_mod_OvenId2;
  #mod_OvenGap3?: number;
  get mod_OvenGap3(): number | undefined { return this.#mod_OvenGap3}
  set mod_OvenGap3(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_OvenGap3' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_OvenGap3 === value) return;
    this.#mod_OvenGap3 = value;
  }

  mod_OvenGap3_matrix?: IMatrix_mod_OvenGap3;
  #mod_OvenId3?: string;
  get mod_OvenId3(): string | undefined { return this.#mod_OvenId3}
  set mod_OvenId3(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_OvenId3' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_OvenId3 === value) return;
    this.#mod_OvenId3 = value;
  }

  mod_OvenId3_matrix?: IMatrix_mod_OvenId3;
  #mod_OvenShelffixedOverhangTop?: number;
  get mod_OvenShelffixedOverhangTop(): number | undefined { return this.#mod_OvenShelffixedOverhangTop}
  set mod_OvenShelffixedOverhangTop(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_OvenShelffixedOverhangTop' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_OvenShelffixedOverhangTop === value) return;
    this.#mod_OvenShelffixedOverhangTop = value;
  }

  mod_OvenShelffixedOverhangTop_matrix?: IMatrix_mod_OvenShelffixedOverhangTop;
  #mod_OvenGap4?: number;
  get mod_OvenGap4(): number | undefined { return this.#mod_OvenGap4}
  set mod_OvenGap4(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_OvenGap4' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_OvenGap4 === value) return;
    this.#mod_OvenGap4 = value;
  }

  mod_OvenGap4_matrix?: IMatrix_mod_OvenGap4;
  ...
  res.set('mod_OvenSupplier1', this.mod_OvenSupplier1);
  res.set('mod_OvenGap1', this.mod_OvenGap1);
  res.set('mod_OvenId1', this.mod_OvenId1);
  res.set('mod_OvenSupplier3', this.mod_OvenSupplier3);
  res.set('mod_OvenSupplier2', this.mod_OvenSupplier2);
  res.set('mod_OvenGap2', this.mod_OvenGap2);
  res.set('mod_OvenId2', this.mod_OvenId2);
  res.set('mod_OvenGap3', this.mod_OvenGap3);
  res.set('mod_OvenId3', this.mod_OvenId3);
  res.set('mod_OvenShelffixedOverhangTop', this.mod_OvenShelffixedOverhangTop);
  res.set('mod_OvenGap4', this.mod_OvenGap4);
  ...
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_OvenSupplier1');
    const val = _toString(json['attributes']['mod_OvenSupplier1'], 'mod_OvenSupplier1');
    internal_leaveValidateVariant();
    this.mod_OvenSupplier1 = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_OvenGap1');
    const val = _toFloat(json['attributes']['mod_OvenGap1'], 'mod_OvenGap1');
    internal_leaveValidateVariant();
    this.mod_OvenGap1 = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_OvenId1');
    const val = _toString(json['attributes']['mod_OvenId1'], 'mod_OvenId1');
    internal_leaveValidateVariant();
    this.mod_OvenId1 = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_OvenSupplier3');
    const val = _toString(json['attributes']['mod_OvenSupplier3'], 'mod_OvenSupplier3');
    internal_leaveValidateVariant();
    this.mod_OvenSupplier3 = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_OvenSupplier2');
    const val = _toString(json['attributes']['mod_OvenSupplier2'], 'mod_OvenSupplier2');
    internal_leaveValidateVariant();
    this.mod_OvenSupplier2 = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_OvenGap2');
    const val = _toFloat(json['attributes']['mod_OvenGap2'], 'mod_OvenGap2');
    internal_leaveValidateVariant();
    this.mod_OvenGap2 = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_OvenId2');
    const val = _toString(json['attributes']['mod_OvenId2'], 'mod_OvenId2');
    internal_leaveValidateVariant();
    this.mod_OvenId2 = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_OvenGap3');
    const val = _toFloat(json['attributes']['mod_OvenGap3'], 'mod_OvenGap3');
    internal_leaveValidateVariant();
    this.mod_OvenGap3 = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_OvenId3');
    const val = _toString(json['attributes']['mod_OvenId3'], 'mod_OvenId3');
    internal_leaveValidateVariant();
    this.mod_OvenId3 = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_OvenShelffixedOverhangTop');
    const val = _toFloat(json['attributes']['mod_OvenShelffixedOverhangTop'], 'mod_OvenShelffixedOverhangTop');
    internal_leaveValidateVariant();
    this.mod_OvenShelffixedOverhangTop = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_OvenGap4');
    const val = _toFloat(json['attributes']['mod_OvenGap4'], 'mod_OvenGap4');
    internal_leaveValidateVariant();
    this.mod_OvenGap4 = val; }
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mf_Oven";
    }
    if (this.mod_OvenSupplier1 === undefined) {
      this.mod_OvenSupplier1 = "None";
    }
    if (this.mod_OvenGap1 === undefined) {
      this.mod_OvenGap1 = 0;
    }
    if (this.mod_OvenId1 === undefined) {
      this.mod_OvenId1 = "None";
    }
    if (this.mod_OvenSupplier3 === undefined) {
      this.mod_OvenSupplier3 = "None";
    }
    if (this.mod_OvenSupplier2 === undefined) {
      this.mod_OvenSupplier2 = "None";
    }
    if (this.mod_OvenGap2 === undefined) {
      this.mod_OvenGap2 = 0;
    }
    if (this.mod_OvenId2 === undefined) {
      this.mod_OvenId2 = "None";
    }
    if (this.mod_OvenGap3 === undefined) {
      this.mod_OvenGap3 = 0;
    }
    if (this.mod_OvenId3 === undefined) {
      this.mod_OvenId3 = "None";
    }
    if (this.mod_OvenShelffixedOverhangTop === undefined) {
      this.mod_OvenShelffixedOverhangTop = 3;
    }
    if (this.mod_OvenGap4 === undefined) {
      this.mod_OvenGap4 = 0;
    }
  ...
  #manufacturerDataCompletionInternal = mf_Oven_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mf_Oven_NonNull(this);
  ...
  seal(): IModuleNonNull_mf_Oven{
    ...
    const adc = new OD_M_mf_Oven_NonNull(this);
    return adc;
  }

  addOD_M_mc_Oven01(index?: number): dc_mc_Oven01 {
    var m = new OD_M_mc_Oven01(this);
    m.dataCompletion();
  ...
  override validateSelections():void {
    ...
    this.mod_OvenSupplier1_matrix = VariantValidation.mod_OvenSupplier1(this, this);
    this.mod_OvenGap1_matrix = VariantValidation.mod_OvenGap1(this, this);
    this.mod_OvenId1_matrix = VariantValidation.mod_OvenId1(this, this);
    this.mod_OvenSupplier3_matrix = VariantValidation.mod_OvenSupplier3(this, this);
    this.mod_OvenSupplier2_matrix = VariantValidation.mod_OvenSupplier2(this, this);
    this.mod_OvenGap2_matrix = VariantValidation.mod_OvenGap2(this, this);
    this.mod_OvenId2_matrix = VariantValidation.mod_OvenId2(this, this);
    this.mod_OvenGap3_matrix = VariantValidation.mod_OvenGap3(this, this);
    this.mod_OvenId3_matrix = VariantValidation.mod_OvenId3(this, this);
    this.mod_OvenShelffixedOverhangTop_matrix = VariantValidation.mod_OvenShelffixedOverhangTop(this, this);
    this.mod_OvenGap4_matrix = VariantValidation.mod_OvenGap4(this, this);
    this.mod_FrontGapHor_matrix = VariantValidation.mod_FrontGapHor(this, this);
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mf_Oven_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mf_Oven_NonNull implements cbp_mf_Oven, adc_mf_Oven ,IPartParentsNonNull_mf_Oven {
  constructor(parent: OD_M_mf_Oven) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mf_Oven;
  ...
  #createBuildPlanInternal = mf_Oven_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mf_Oven_afterDataCompletion;
  ...
  get mod_OvenSupplier1(): string  {
    return this.#internalParent.mod_OvenSupplier1!;
  }
  get mod_OvenGap1(): number  {
    return this.#internalParent.mod_OvenGap1!;
  }
  get mod_OvenId1(): string  {
    return this.#internalParent.mod_OvenId1!;
  }
  get mod_OvenSupplier3(): string  {
    return this.#internalParent.mod_OvenSupplier3!;
  }
  get mod_OvenSupplier2(): string  {
    return this.#internalParent.mod_OvenSupplier2!;
  }
  get mod_OvenGap2(): number  {
    return this.#internalParent.mod_OvenGap2!;
  }
  get mod_OvenId2(): string  {
    return this.#internalParent.mod_OvenId2!;
  }
  get mod_OvenGap3(): number  {
    return this.#internalParent.mod_OvenGap3!;
  }
  get mod_OvenId3(): string  {
    return this.#internalParent.mod_OvenId3!;
  }
  get mod_OvenShelffixedOverhangTop(): number  {
    return this.#internalParent.mod_OvenShelffixedOverhangTop!;
  }
  get mod_OvenGap4(): number  {
    return this.#internalParent.mod_OvenGap4!;
  }
  get mod_FrontGapHor(): number  {
    return this.#internalParent.mod_FrontGapHor!;
  }
  addOD_M_mc_Oven01(index?: number): dc_mc_Oven01 {
    return this.#internalParent.addOD_M_mc_Oven01(index);
  }
}
