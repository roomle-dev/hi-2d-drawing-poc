...
export interface cti_tab_EdgeFrameSettings {
...
export interface ctm_tab_EdgeFrameSettings {
}

export interface cto_tab_EdgeFrameSettings extends ctm_tab_EdgeFrameSettings {
  readonly _id : number;
  readonly EdgeFrontColor? : string;
  readonly EdgeLeftColor? : string;
  readonly EdgeBackColor? : string;
  readonly EdgeRightColor? : string;
  readonly EdgeFrontType? : string;
  readonly EdgeLeftType? : string;
  readonly EdgeBackType? : string;
  readonly EdgeRightType? : string;
  readonly EdgeJointType? : string;
}

export interface ICT_tab_EdgeFrameSettings
extends cti_tab_EdgeFrameSettings, cto_tab_EdgeFrameSettings {}

export class ct2_tab_EdgeFrameSettings {
...
): cto_tab_EdgeFrameSettings | undefined {
  const res = ct_tab_EdgeFrameSettings.find((p) => 
...
public find(
predicate: (value: cti_tab_EdgeFrameSettings) => boolean
): cto_tab_EdgeFrameSettings | undefined {
  for (let index = 0; index < ct_tab_EdgeFrameSettings.length; index++){
    const element = ct_tab_EdgeFrameSettings[index];
...
export var ct_tab_EdgeFrameSettings :ICT_tab_EdgeFrameSettings[] = [
{
 _id: 4,
 ...
 EdgeFrontColor: "LikeFrontColor",
 EdgeLeftColor: "LikeFrontColor",
 EdgeBackColor: "LikeFrontColor",
 EdgeRightColor: "LikeFrontColor",
 EdgeFrontType: "FRE",
 EdgeLeftType: "FRE",
 EdgeBackType: "FRE",
 EdgeRightType: "FRE",
