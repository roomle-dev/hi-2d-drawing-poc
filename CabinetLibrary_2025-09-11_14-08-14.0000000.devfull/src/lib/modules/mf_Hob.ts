...
//#region Imports
import { cbp_mf_Hob, dc_mf_Hob, adc_mf_Hob } from '../internal/modules/mf_Hob'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_Hob01, OD_M_mc_Hob01 } from '../internal/modules/mc_Hob01'
...
export function mf_Hob_createBuildPlan(this: cbp_mf_Hob):void {
  internal_enterModuleCreateBuildPlan('mf_Hob', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mf_Hob_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mf_Hob_afterDataCompletion(this: adc_mf_Hob):void {
  internal_enterModuleAfterDataCompletion('mf_Hob', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_Hob_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mf_Hob_manufacturerDataCompletion(this: dc_mf_Hob):void {
  internal_enterModuleManufacturerDataCompletion('mf_Hob', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_Hob_MANUFACTURERDATACOMPLETION
