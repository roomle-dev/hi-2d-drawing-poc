...
//#region Imports
import { cbp_mf_FillerFront, dc_mf_FillerFront, adc_mf_FillerFront } from '../internal/modules/mf_FillerFront'
...
export function mf_FillerFront_createBuildPlan(this: cbp_mf_FillerFront):void {
  internal_enterModuleCreateBuildPlan('mf_FillerFront', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mf_FillerFront_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mf_FillerFront_afterDataCompletion(this: adc_mf_FillerFront):void {
  internal_enterModuleAfterDataCompletion('mf_FillerFront', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_FillerFront_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mf_FillerFront_manufacturerDataCompletion(this: dc_mf_FillerFront):void {
  internal_enterModuleManufacturerDataCompletion('mf_FillerFront', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_FillerFront_MANUFACTURERDATACOMPLETION
