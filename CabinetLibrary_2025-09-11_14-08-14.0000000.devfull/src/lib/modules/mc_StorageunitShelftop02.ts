...
//#region Imports
import { cbp_mc_StorageunitShelftop02, dc_mc_StorageunitShelftop02, adc_mc_StorageunitShelftop02 } from '../internal/modules/mc_StorageunitShelftop02'
...
export function mc_StorageunitShelftop02_createBuildPlan(this: cbp_mc_StorageunitShelftop02):void {
  internal_enterModuleCreateBuildPlan('mc_StorageunitShelftop02', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_StorageunitShelftop02_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: March 2025
  // By Ludwig Weber
  ...
  if (this.mod_ShelftopConstruction == 'Heatshelf') {
    ...
    GlobalFunc.process_AddMaterial(Elem, 'shelf', this.mod_CarcaseColor, this.mod_CarcaseColor, this.mod_CarcaseEdgeColor, this.mod_CarcaseEdgeColor, 'None', false, false);
...
// ---------------------------------------------------------------
export function mc_StorageunitShelftop02_afterDataCompletion(this: adc_mc_StorageunitShelftop02):void {
  internal_enterModuleAfterDataCompletion('mc_StorageunitShelftop02', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitShelftop02_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_StorageunitShelftop02_manufacturerDataCompletion(this: dc_mc_StorageunitShelftop02):void {
  internal_enterModuleManufacturerDataCompletion('mc_StorageunitShelftop02', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitShelftop02_MANUFACTURERDATACOMPLETION
