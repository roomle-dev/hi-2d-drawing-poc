...
import { IModParents_mr_Shelves } from '../mod-interfaces'
import { IP_part_Shelves_PartVarsWritable, P_part_Shelves } from '../parts/part_Shelves'
import { IModuleNonNull_mc_Shelves01,IModParents_mc_Shelves01,IPartParentsNonNull_mc_Shelves01} from '../mod-interfaces'
import {IModVar_mod_Width,IModVarNonNull_mod_Width,IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_ShelvesThk,IModVarNonNull_mod_ShelvesThk,IModVar_mod_ShelvesColor,IModVarNonNull_mod_ShelvesColor,IModVar_mod_ShelvesBrackets,IModVarNonNull_mod_ShelvesBrackets,IModVar_mod_ShelvesBracketsColor,IModVarNonNull_mod_ShelvesBracketsColor} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_Width, IMatrix_mod_Depth, IMatrix_mod_ShelvesThk, IMatrix_mod_ShelvesColor, IMatrix_mod_ShelvesBrackets, IMatrix_mod_ShelvesBracketsColor} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_Shelves } from '../part-add-interfaces';
import { mc_Shelves01_createBuildPlan, mc_Shelves01_afterDataCompletion, mc_Shelves01_manufacturerDataCompletion } from '../../modules/mc_Shelves01';

export interface cbp_mc_Shelves01 extends IModBaseProp
, IPartAdd_part_Shelves, IModVarNonNull_mod_Width, IModVarNonNull_mod_Depth, IModVarNonNull_mod_ShelvesThk, IModVarNonNull_mod_ShelvesColor, IModVarNonNull_mod_ShelvesBrackets, IModVarNonNull_mod_ShelvesBracketsColor {
  parent: IModParents_mr_Shelves;
...
export interface dc_mc_Shelves01 extends IModBaseProp
, IModVar_mod_Width, IModVar_mod_Depth, IModVar_mod_ShelvesThk, IModVar_mod_ShelvesColor, IModVar_mod_ShelvesBrackets, IModVar_mod_ShelvesBracketsColor {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Shelves01;
  parent: IModParents_mr_Shelves;
}

export interface adc_mc_Shelves01 extends IModBaseProp
...
export class OD_M_mc_Shelves01 extends OD_Base  implements dc_mc_Shelves01
,IModParents_mc_Shelves01
,IModVar_mod_Width,IModVar_mod_Depth,IModVar_mod_ShelvesThk,IModVar_mod_ShelvesColor,IModVar_mod_ShelvesBrackets,IModVar_mod_ShelvesBracketsColor
 {
  constructor(parent: IModParents_mr_Shelves, manufacturerMode?:boolean) {
    super('mc_Shelves01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Shelves01_NonNull(this);
  }
  parent: IModParents_mr_Shelves;
  _selfNonNull: OD_M_mc_Shelves01_NonNull;

  override variants:string[] = ['mod_Width','mod_Depth','mod_ShelvesThk','mod_ShelvesColor','mod_ShelvesBrackets','mod_ShelvesBracketsColor',];
  #mod_Width?: number;
  ...
  get mod_ShelvesThk(): number | undefined { return this.#mod_ShelvesThk}
  set mod_ShelvesThk(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_ShelvesThk' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_ShelvesThk === value) return;
    this.#mod_ShelvesThk = value;
  }

  mod_ShelvesThk_matrix?: IMatrix_mod_ShelvesThk;
  #mod_ShelvesColor?: string;
  get mod_ShelvesColor(): string | undefined { return this.#mod_ShelvesColor}
  set mod_ShelvesColor(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_ShelvesColor' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_ShelvesColor === value) return;
    this.#mod_ShelvesColor = value;
  }

  mod_ShelvesColor_matrix?: IMatrix_mod_ShelvesColor;
  #mod_ShelvesBrackets?: string;
  get mod_ShelvesBrackets(): string | undefined { return this.#mod_ShelvesBrackets}
  set mod_ShelvesBrackets(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_ShelvesBrackets' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_ShelvesBrackets === value) return;
    this.#mod_ShelvesBrackets = value;
  }

  mod_ShelvesBrackets_matrix?: IMatrix_mod_ShelvesBrackets;
  #mod_ShelvesBracketsColor?: string;
  get mod_ShelvesBracketsColor(): string | undefined { return this.#mod_ShelvesBracketsColor}
  set mod_ShelvesBracketsColor(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_ShelvesBracketsColor' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_ShelvesBracketsColor === value) return;
    this.#mod_ShelvesBracketsColor = value;
  }

  mod_ShelvesBracketsColor_matrix?: IMatrix_mod_ShelvesBracketsColor;
  override getAttributes() : Map<string,any> { 
    let res = new Map<string,any>();
  res.set('mod_Width', this.mod_Width);
  res.set('mod_Depth', this.mod_Depth);
  res.set('mod_ShelvesThk', this.mod_ShelvesThk);
  res.set('mod_ShelvesColor', this.mod_ShelvesColor);
  res.set('mod_ShelvesBrackets', this.mod_ShelvesBrackets);
  res.set('mod_ShelvesBracketsColor', this.mod_ShelvesBracketsColor);
    return res;
  }
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    internal_leaveValidateVariant();
    this.mod_Depth = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_ShelvesThk');
    const val = _toFloat(json['attributes']['mod_ShelvesThk'], 'mod_ShelvesThk');
    internal_leaveValidateVariant();
    this.mod_ShelvesThk = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_ShelvesColor');
    const val = _toString(json['attributes']['mod_ShelvesColor'], 'mod_ShelvesColor');
    internal_leaveValidateVariant();
    this.mod_ShelvesColor = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_ShelvesBrackets');
    const val = _toString(json['attributes']['mod_ShelvesBrackets'], 'mod_ShelvesBrackets');
    internal_leaveValidateVariant();
    this.mod_ShelvesBrackets = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_ShelvesBracketsColor');
    const val = _toString(json['attributes']['mod_ShelvesBracketsColor'], 'mod_ShelvesBracketsColor');
    internal_leaveValidateVariant();
    this.mod_ShelvesBracketsColor = val; }
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_ShelvesThk === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_ShelvesThk')) {
          let pv = <IModVar_mod_ShelvesThk>s;
          if (pv.mod_ShelvesThk !== undefined) {
            this.mod_ShelvesThk = (<IModVar_mod_ShelvesThk>s).mod_ShelvesThk;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_ShelvesColor === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_ShelvesColor')) {
          let pv = <IModVar_mod_ShelvesColor>s;
          if (pv.mod_ShelvesColor !== undefined) {
            this.mod_ShelvesColor = (<IModVar_mod_ShelvesColor>s).mod_ShelvesColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_ShelvesBrackets === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_ShelvesBrackets')) {
          let pv = <IModVar_mod_ShelvesBrackets>s;
          if (pv.mod_ShelvesBrackets !== undefined) {
            this.mod_ShelvesBrackets = (<IModVar_mod_ShelvesBrackets>s).mod_ShelvesBrackets;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_ShelvesBracketsColor === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_ShelvesBracketsColor')) {
          let pv = <IModVar_mod_ShelvesBracketsColor>s;
          if (pv.mod_ShelvesBracketsColor !== undefined) {
            this.mod_ShelvesBracketsColor = (<IModVar_mod_ShelvesBracketsColor>s).mod_ShelvesBracketsColor;
            break;
          };
        }
        s = s.parentBase;
  ...
  #manufacturerDataCompletionInternal = mc_Shelves01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Shelves01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Shelves01{
    ...
    const adc = new OD_M_mc_Shelves01_NonNull(this);
    return adc;
  }
  ...
  override validateSelections():void {
    ...
    this.mod_ShelvesThk_matrix = VariantValidation.mod_ShelvesThk(this, this);
    this.mod_ShelvesColor_matrix = VariantValidation.mod_ShelvesColor(this, this);
    this.mod_ShelvesBrackets_matrix = VariantValidation.mod_ShelvesBrackets(this, this);
    this.mod_ShelvesBracketsColor_matrix = VariantValidation.mod_ShelvesBracketsColor(this, this);
  }
  addpart_Shelves(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Shelves_PartVarsWritable {
    var c = new P_part_Shelves(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Shelves01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Shelves01_NonNull implements cbp_mc_Shelves01, adc_mc_Shelves01 ,IPartParentsNonNull_mc_Shelves01 {
  constructor(parent: OD_M_mc_Shelves01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Shelves01;
  ...
  #createBuildPlanInternal = mc_Shelves01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Shelves01_afterDataCompletion;
  ...
  parent: IModParents_mr_Shelves;
  addpart_Shelves(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Shelves_PartVarsWritable {
    return this.#internalParent.addpart_Shelves(x, y, z, dimx, dimy, dimz);
  }
  ...
  get mod_ShelvesThk(): number  {
    return this.#internalParent.mod_ShelvesThk!;
  }
  get mod_ShelvesColor(): string  {
    return this.#internalParent.mod_ShelvesColor!;
  }
  get mod_ShelvesColor_matrix(): IMatrix_mod_ShelvesColor {
    return this.#internalParent.mod_ShelvesColor_matrix!;
  }
  get mod_ShelvesBrackets(): string  {
    return this.#internalParent.mod_ShelvesBrackets!;
  }
  get mod_ShelvesBrackets_matrix(): IMatrix_mod_ShelvesBrackets {
    return this.#internalParent.mod_ShelvesBrackets_matrix!;
  }
  get mod_ShelvesBracketsColor(): string  {
    return this.#internalParent.mod_ShelvesBracketsColor!;
  }
}
