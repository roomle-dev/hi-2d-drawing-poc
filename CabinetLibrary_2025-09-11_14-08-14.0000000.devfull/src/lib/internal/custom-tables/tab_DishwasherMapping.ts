...
export interface cti_tab_DishwasherMapping {
  readonly in_Supplier? : string;
  readonly in_DishwasherId? : string;
}

export interface ctm_tab_DishwasherMapping {
}

export interface cto_tab_DishwasherMapping extends ctm_tab_DishwasherMapping {
  readonly _id : number;
  readonly ConstructionId? : string;
  readonly GraphicId? : string;
}

export interface ICT_tab_DishwasherMapping
extends cti_tab_DishwasherMapping, cto_tab_DishwasherMapping {}

export class ct2_tab_DishwasherMapping {

public findExactly(
     in_Supplier: string|undefined,
     in_DishwasherId: string|undefined,
): cto_tab_DishwasherMapping | undefined {
  const res = ct_tab_DishwasherMapping.find((p) => 
p.in_Supplier === in_Supplier
 && p.in_DishwasherId === in_DishwasherId
);
return res;
}

public find(
predicate: (value: cti_tab_DishwasherMapping) => boolean
): cto_tab_DishwasherMapping | undefined {
  for (let index = 0; index < ct_tab_DishwasherMapping.length; index++){
    const element = ct_tab_DishwasherMapping[index];
...
export var ct_tab_DishwasherMapping :ICT_tab_DishwasherMapping[] = [
{
 _id: 1,
 in_Supplier: "Siemens",
 in_DishwasherId: "SN55ZS07CE",
 ConstructionId: "SN55ZS07CE",
 GraphicId: "SN55ZS07CE"
}
,{
 _id: 2,
 in_Supplier: "Siemens",
 in_DishwasherId: "SN87TX02CE",
 ConstructionId: "SN87TX02CE",
 GraphicId: "SN87TX02CE"
}
,{
 _id: 3,
 in_Supplier: "Siemens",
 in_DishwasherId: "SR55ZS10ME",
 ConstructionId: "SR55ZS10ME",
 GraphicId: "SR55ZS10ME"
}
,{
 _id: 4,
 in_Supplier: "Siemens",
 in_DishwasherId: "SR65YX08ME",
 ConstructionId: "SR65YX08ME",
 GraphicId: "SR65YX08ME"
}
,{
 _id: 5,
 in_Supplier: "None",
 in_DishwasherId: "None",
 ConstructionId: "SN87TX02CE",
 GraphicId: "SN87TX02CE"
}
];
