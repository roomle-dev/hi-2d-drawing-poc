...
//#region Imports
import { cbp_mc_Drawer01, dc_mc_Drawer01, adc_mc_Drawer01 } from '../internal/modules/mc_Drawer01'
...
import { dc_mc_DrawerBox01, OD_M_mc_DrawerBox01 } from '../internal/modules/mc_DrawerBox01'
...
export function mc_Drawer01_createBuildPlan(this: cbp_mc_Drawer01):void {
  internal_enterModuleCreateBuildPlan('mc_Drawer01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Drawer01_CREATEBUILDPLAN
// Schuler Consulting
// Create: Nov 2022
// By Ludwig Weber
...
// ---------------------------------------------------------------
export function mc_Drawer01_afterDataCompletion(this: adc_mc_Drawer01):void {
  internal_enterModuleAfterDataCompletion('mc_Drawer01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Drawer01_AFTERDATACOMPLETION
  ...
  let retDrawerInfo = GlobalFunc.find_FrontConstruction(this.mod_FrontProgram, this.mod_FrontDesign, 'Drawer', this.mod_FrontWidth, this.mod_FrontHeight, this.mod_HandleDesign_matrix.HandleDesignGroup!, handlePosType);
  ...
  let Drawer: any;
  let DrawerDesign = retDrawerInfo.FrontModuleId;
  ...
  Drawer.mod_Width = retDrawerInfo.Width(this); 
  Drawer.mod_Height = retDrawerInfo.Height(this); 
  Drawer.mod_Depth = retDrawerInfo.Thickness;
  Drawer.mod_FrontType = "Drawer";

  // setOrigin
  Drawer.setOrigin(retDrawerInfo.WidthPos(this),retDrawerInfo.HeightPos(this),retDrawerInfo.DepthPos(this)); 
  let SealedDrawer = Drawer.seal();
  ...
  else if (this.mod_HandleDesign_matrix.HandleType == "Handle") 
  {
    ...
    // Set values to the attributes of the child
    Handle.mod_Width = retDrawerInfo.Width(this); 
    Handle.mod_Height = retDrawerInfo.Height(this); 
    ...
    // setOrigin
    Handle.setOrigin(retDrawerInfo.WidthPos(this), retDrawerInfo.HeightPos(this), retDrawerInfo.DepthPos(this)); 
  ...
  if(this.mod_DrawerBoxDesign_matrix.DrawerBoxType == 'DrawerBox'){
    ...
    // Set values to the attributes of the child
    DrawerBox.mod_FrontWidth = retDrawerInfo.Width(this); 
    DrawerBox.mod_FrontHeight = retDrawerInfo.Height(this); 
    ...
    DrawerBox.mod_Height = CarcaseSpaceDimension.HeightFreeSpace < retDrawerInfo.Height(this) ? CarcaseSpaceDimension.HeightFreeSpace : retDrawerInfo.Height(this) - InsertionPosY;
...
// ---------------------------------------------------------------
export function mc_Drawer01_manufacturerDataCompletion(this: dc_mc_Drawer01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Drawer01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Drawer01_MANUFACTURERDATACOMPLETION
