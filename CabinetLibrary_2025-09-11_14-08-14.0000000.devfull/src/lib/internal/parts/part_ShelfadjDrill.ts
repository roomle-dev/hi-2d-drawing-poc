...
import { IPartParentsNonNull_mc_ShelfadjDrill01 } from '../mod-interfaces'

export interface IP_part_ShelfadjDrill_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_ShelfadjDrill01;
  get pa_ShelfadjDrillDistance(): number;
  get pa_ShelfadjSidepanelDrillDescriptor(): string;
  get pa_ShelfadjBackwallDrillDescriptor(): string;
  get pa_ShelfadjBackwallProcessingId(): string;
  get pa_ShelfadjSidepanelProcessingMiddleId(): string;
  get pa_ShelfadjSidepanelProcessingBackId(): string;
  get pa_ShelfadjSidepanelProcessingFrontId(): string;
  get pa_ShelfadjVertDividerProcessingId(): string;
  get pa_ShelfadjVertdividerDrillDescriptor(): string;
}

export interface IP_part_ShelfadjDrill_PartVarsWritable extends IP_part_ShelfadjDrill_PartVarsReadOnly {
  set pa_ShelfadjDrillDistance(value: number);
  set pa_ShelfadjSidepanelDrillDescriptor(value: string);
  set pa_ShelfadjBackwallDrillDescriptor(value: string);
  set pa_ShelfadjBackwallProcessingId(value: string);
  set pa_ShelfadjSidepanelProcessingMiddleId(value: string);
  set pa_ShelfadjSidepanelProcessingBackId(value: string);
  set pa_ShelfadjSidepanelProcessingFrontId(value: string);
  set pa_ShelfadjVertDividerProcessingId(value: string);
  set pa_ShelfadjVertdividerDrillDescriptor(value: string);
}

export class P_part_ShelfadjDrill extends PartBase implements IP_part_ShelfadjDrill_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_ShelfadjDrill01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_ShelfadjDrill', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  parent: IPartParentsNonNull_mc_ShelfadjDrill01; // module which created this part
  override getAttributes() : Map<string,any> { 
    let res = new Map<string,any>();
  res.set('pa_ShelfadjDrillDistance', this.#pa_ShelfadjDrillDistance);
  res.set('pa_ShelfadjSidepanelDrillDescriptor', this.#pa_ShelfadjSidepanelDrillDescriptor);
  res.set('pa_ShelfadjBackwallDrillDescriptor', this.#pa_ShelfadjBackwallDrillDescriptor);
  res.set('pa_ShelfadjBackwallProcessingId', this.#pa_ShelfadjBackwallProcessingId);
  res.set('pa_ShelfadjSidepanelProcessingMiddleId', this.#pa_ShelfadjSidepanelProcessingMiddleId);
  res.set('pa_ShelfadjSidepanelProcessingBackId', this.#pa_ShelfadjSidepanelProcessingBackId);
  res.set('pa_ShelfadjSidepanelProcessingFrontId', this.#pa_ShelfadjSidepanelProcessingFrontId);
  res.set('pa_ShelfadjVertDividerProcessingId', this.#pa_ShelfadjVertDividerProcessingId);
  res.set('pa_ShelfadjVertdividerDrillDescriptor', this.#pa_ShelfadjVertdividerDrillDescriptor);
    return res;
  }
  setAttributes() {
    try {
    ...
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // part_ShelfadjDrill_ValueScript
    if (this.#pa_ShelfadjDrillDistance === undefined) {
      this.pa_ShelfadjDrillDistance = this.parent.mod_ShelfadjDrillDistance;
    }
    if (this.#pa_ShelfadjSidepanelDrillDescriptor === undefined) {
      this.pa_ShelfadjSidepanelDrillDescriptor = this.parent.mod_ShelfadjSidepanelDrillDescriptor;
    }
    if (this.#pa_ShelfadjBackwallDrillDescriptor === undefined) {
      this.pa_ShelfadjBackwallDrillDescriptor = this.parent.mod_ShelfadjBackwallDrillDescriptor;
    }
    if (this.#pa_ShelfadjBackwallProcessingId === undefined) {
      this.pa_ShelfadjBackwallProcessingId = this.parent.mod_ShelfadjBackwallProcessingId;
    }
    if (this.#pa_ShelfadjSidepanelProcessingMiddleId === undefined) {
      this.pa_ShelfadjSidepanelProcessingMiddleId = this.parent.mod_ShelfadjSidepanelProcessingMiddleId;
    }
    if (this.#pa_ShelfadjSidepanelProcessingBackId === undefined) {
      this.pa_ShelfadjSidepanelProcessingBackId = this.parent.mod_ShelfadjSidepanelProcessingBackId;
    }
    if (this.#pa_ShelfadjSidepanelProcessingFrontId === undefined) {
      this.pa_ShelfadjSidepanelProcessingFrontId = this.parent.mod_ShelfadjSidepanelProcessingFrontId;
    }
    if (this.#pa_ShelfadjVertDividerProcessingId === undefined) {
      this.pa_ShelfadjVertDividerProcessingId = this.parent.mod_ShelfadjVertDividerProcessingId;
    }
    if (this.#pa_ShelfadjVertdividerDrillDescriptor === undefined) {
      this.pa_ShelfadjVertdividerDrillDescriptor = this.parent.mod_ShelfadjVertdividerDrillDescriptor;
    }
    // ###############################################################
    // ################### END CUSTOM SCRIPTS ########################
    // ###############################################################
  ...
  checkAttributes() {
    ...
    if (this.#pa_ShelfadjDrillDistance === undefined) {
      logError('Attribute pa_ShelfadjDrillDistance not set in part part_ShelfadjDrill (id: ' + this._id + ')');
    }
    if (this.#pa_ShelfadjSidepanelDrillDescriptor === undefined) {
      logError('Attribute pa_ShelfadjSidepanelDrillDescriptor not set in part part_ShelfadjDrill (id: ' + this._id + ')');
    }
    if (this.#pa_ShelfadjBackwallDrillDescriptor === undefined) {
      logError('Attribute pa_ShelfadjBackwallDrillDescriptor not set in part part_ShelfadjDrill (id: ' + this._id + ')');
    }
    if (this.#pa_ShelfadjBackwallProcessingId === undefined) {
      logError('Attribute pa_ShelfadjBackwallProcessingId not set in part part_ShelfadjDrill (id: ' + this._id + ')');
    }
    if (this.#pa_ShelfadjSidepanelProcessingMiddleId === undefined) {
      logError('Attribute pa_ShelfadjSidepanelProcessingMiddleId not set in part part_ShelfadjDrill (id: ' + this._id + ')');
    }
    if (this.#pa_ShelfadjSidepanelProcessingBackId === undefined) {
      logError('Attribute pa_ShelfadjSidepanelProcessingBackId not set in part part_ShelfadjDrill (id: ' + this._id + ')');
    }
    if (this.#pa_ShelfadjSidepanelProcessingFrontId === undefined) {
      logError('Attribute pa_ShelfadjSidepanelProcessingFrontId not set in part part_ShelfadjDrill (id: ' + this._id + ')');
    }
    if (this.#pa_ShelfadjVertDividerProcessingId === undefined) {
      logError('Attribute pa_ShelfadjVertDividerProcessingId not set in part part_ShelfadjDrill (id: ' + this._id + ')');
    }
    if (this.#pa_ShelfadjVertdividerDrillDescriptor === undefined) {
      logError('Attribute pa_ShelfadjVertdividerDrillDescriptor not set in part part_ShelfadjDrill (id: ' + this._id + ')');
    }
  ...
  get pa_ShelfadjDrillDistance(): number { return this.#pa_ShelfadjDrillDistance!; }
  set pa_ShelfadjDrillDistance(val:number) { this.#pa_ShelfadjDrillDistance = val; }
  #pa_ShelfadjDrillDistance?: number;
  get pa_ShelfadjSidepanelDrillDescriptor(): string { return this.#pa_ShelfadjSidepanelDrillDescriptor!; }
  set pa_ShelfadjSidepanelDrillDescriptor(val:string) { this.#pa_ShelfadjSidepanelDrillDescriptor = val; }
  #pa_ShelfadjSidepanelDrillDescriptor?: string;
  get pa_ShelfadjBackwallDrillDescriptor(): string { return this.#pa_ShelfadjBackwallDrillDescriptor!; }
  set pa_ShelfadjBackwallDrillDescriptor(val:string) { this.#pa_ShelfadjBackwallDrillDescriptor = val; }
  #pa_ShelfadjBackwallDrillDescriptor?: string;
  get pa_ShelfadjBackwallProcessingId(): string { return this.#pa_ShelfadjBackwallProcessingId!; }
  set pa_ShelfadjBackwallProcessingId(val:string) { this.#pa_ShelfadjBackwallProcessingId = val; }
  #pa_ShelfadjBackwallProcessingId?: string;
  get pa_ShelfadjSidepanelProcessingMiddleId(): string { return this.#pa_ShelfadjSidepanelProcessingMiddleId!; }
  set pa_ShelfadjSidepanelProcessingMiddleId(val:string) { this.#pa_ShelfadjSidepanelProcessingMiddleId = val; }
  #pa_ShelfadjSidepanelProcessingMiddleId?: string;
  get pa_ShelfadjSidepanelProcessingBackId(): string { return this.#pa_ShelfadjSidepanelProcessingBackId!; }
  set pa_ShelfadjSidepanelProcessingBackId(val:string) { this.#pa_ShelfadjSidepanelProcessingBackId = val; }
  #pa_ShelfadjSidepanelProcessingBackId?: string;
  get pa_ShelfadjSidepanelProcessingFrontId(): string { return this.#pa_ShelfadjSidepanelProcessingFrontId!; }
  set pa_ShelfadjSidepanelProcessingFrontId(val:string) { this.#pa_ShelfadjSidepanelProcessingFrontId = val; }
  #pa_ShelfadjSidepanelProcessingFrontId?: string;
  get pa_ShelfadjVertDividerProcessingId(): string { return this.#pa_ShelfadjVertDividerProcessingId!; }
  set pa_ShelfadjVertDividerProcessingId(val:string) { this.#pa_ShelfadjVertDividerProcessingId = val; }
  #pa_ShelfadjVertDividerProcessingId?: string;
  get pa_ShelfadjVertdividerDrillDescriptor(): string { return this.#pa_ShelfadjVertdividerDrillDescriptor!; }
  set pa_ShelfadjVertdividerDrillDescriptor(val:string) { this.#pa_ShelfadjVertdividerDrillDescriptor = val; }
  #pa_ShelfadjVertdividerDrillDescriptor?: string;
}
