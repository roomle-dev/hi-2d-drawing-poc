...
export interface cti_tab_BracketConstruction {
  readonly in_ConstructionId? : string;
  readonly in_ShelfThk : number;
  readonly in_ShelfDepthMin : number;
  readonly in_ShelfDepthMax : number;
  readonly in_ShelfLenghtMin : number;
  readonly in_ShelfLenghtMax : number;
}

export interface ctm_tab_BracketConstruction {
}

export interface cto_tab_BracketConstruction extends ctm_tab_BracketConstruction {
  readonly _id : number;
  readonly BracketNo : number;
  readonly Position1? : string;
  readonly Position2? : string;
  readonly Position3? : string;
  readonly Position4? : string;
  readonly Position5? : string;
  readonly Position6? : string;
  TestColumn(m: any):number|undefined;
}

export interface ICT_tab_BracketConstruction
extends cti_tab_BracketConstruction, cto_tab_BracketConstruction {}

export class ct2_tab_BracketConstruction {

public findExactly(
     in_ConstructionId: string|undefined,
     in_ShelfThk: number,
     in_ShelfDepthMin: number,
     in_ShelfDepthMax: number,
     in_ShelfLenghtMin: number,
     in_ShelfLenghtMax: number,
): cto_tab_BracketConstruction | undefined {
  const res = ct_tab_BracketConstruction.find((p) => 
p.in_ConstructionId === in_ConstructionId
 && p.in_ShelfThk === in_ShelfThk
 && p.in_ShelfDepthMin === in_ShelfDepthMin
 && p.in_ShelfDepthMax === in_ShelfDepthMax
 && p.in_ShelfLenghtMin === in_ShelfLenghtMin
 && p.in_ShelfLenghtMax === in_ShelfLenghtMax
);
return res;
}

public find(
predicate: (value: cti_tab_BracketConstruction) => boolean
): cto_tab_BracketConstruction | undefined {
  for (let index = 0; index < ct_tab_BracketConstruction.length; index++){
    const element = ct_tab_BracketConstruction[index];
...
export var ct_tab_BracketConstruction :ICT_tab_BracketConstruction[] = [
{
 _id: 10,
 in_ConstructionId: "brARRAS5",
 in_ShelfThk: 19,
 in_ShelfDepthMin: 0,
 in_ShelfDepthMax: 400,
 in_ShelfLenghtMin: 0,
 in_ShelfLenghtMax: 900,
 BracketNo: 2,
 Position1: "50",
 Position2: "this.mod_Width-50",
 Position3: "",
 Position4: "",
 Position5: "",
 Position6: "",
...
,{
 ...
 in_ShelfDepthMin: 0,
 in_ShelfDepthMax: 400,
 in_ShelfLenghtMin: 901,
 in_ShelfLenghtMax: 1650,
 BracketNo: 3,
 Position1: "50",
 Position2: "this.mod_Width/2",
 Position3: "this.mod_Width-50",
 Position4: "",
 Position5: "",
 Position6: "",
  TestColumn(m: any):number|undefined {
...
,{
 ...
 in_ShelfDepthMin: 0,
 in_ShelfDepthMax: 400,
 in_ShelfLenghtMin: 1651,
 in_ShelfLenghtMax: 2400,
 BracketNo: 4,
 Position1: "50",
 Position2: "this.mod_Width/3",
 Position3: "this.mod_Width/3*2",
 Position4: "this.mod_Width-50",
 Position5: "",
 Position6: "",
  TestColumn(m: any):number|undefined {
    return ;
...
,{
 ...
 in_ShelfDepthMin: 0,
 in_ShelfDepthMax: 400,
 in_ShelfLenghtMin: 2401,
 in_ShelfLenghtMax: 2900,
 BracketNo: 5,
 Position1: "50",
 Position2: "this.mod_Width/4",
 Position3: "this.mod_Width/2",
 Position4: "this.mod_Width/4*3",
 Position5: "this.mod_Width-50",
 Position6: "",
  TestColumn(m: any):number|undefined {
    return ;
  }
...
,{
 _id: 14,
 in_ConstructionId: "brTucano",
 in_ShelfThk: 19,
 in_ShelfDepthMin: 0,
 in_ShelfDepthMax: 400,
 in_ShelfLenghtMin: 0,
 in_ShelfLenghtMax: 600,
 BracketNo: 2,
 Position1: "50",
 Position2: "this.mod_Width-50",
 Position3: "",
...
,{
 ...
 in_ShelfDepthMin: 0,
 in_ShelfDepthMax: 400,
 in_ShelfLenghtMin: 601,
 in_ShelfLenghtMax: 1100,
 BracketNo: 3,
 Position1: "50",
 Position2: "this.mod_Width/2",
 Position3: "this.mod_Width-50",
...
,{
 ...
 in_ShelfDepthMin: 0,
 in_ShelfDepthMax: 400,
 in_ShelfLenghtMin: 1101,
 in_ShelfLenghtMax: 1800,
 BracketNo: 4,
 Position1: "50",
 Position2: "this.mod_Width/3",
 Position3: "this.mod_Width/3*2",
...
,{
 ...
 in_ShelfThk: 19,
 in_ShelfDepthMin: 0,
 in_ShelfDepthMax: 300,
 in_ShelfLenghtMin: 1801,
 in_ShelfLenghtMax: 2500,
 BracketNo: 5,
 Position1: "50",
 Position2: "this.mod_Width/4",
 Position3: "this.mod_Width/2",
 Position4: "this.mod_Width/4",
 Position5: "this.mod_Width-50",
 Position6: "",
  TestColumn(m: any):number|undefined {
    return ;
...
,{
 ...
 in_ShelfDepthMin: 0,
 in_ShelfDepthMax: 400,
 in_ShelfLenghtMin: 2501,
 in_ShelfLenghtMax: 2900,
 BracketNo: 6,
 Position1: "50",
 Position2: "this.mod_Width/5",
 Position3: "this.mod_Width/5*2",
 Position4: "this.mod_Width/5*3",
 Position5: "this.mod_Width/5*4",
 Position6: "this.mod_Width-50",
  TestColumn(m: any):number|undefined {
    return m.mod_Width-50;
  }
