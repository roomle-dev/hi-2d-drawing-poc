...
import { P_part_DrawerShelfbtmConnectorDrilling, IP_part_DrawerShelfbtmConnectorDrilling_PartVarsReadOnly } from './part_DrawerShelfbtmConnectorDrilling'
...
export interface IP_part_DrawerPanelWoodFrame_PartVarsReadOnly extends IPartBase {
...
export interface IP_part_DrawerPanelWoodFrame_PartVarsWritable extends IP_part_DrawerPanelWoodFrame_PartVarsReadOnly {
...
export class P_part_DrawerPanelWoodFrame extends PartBase implements IP_part_DrawerPanelWoodFrame_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_PanelWoodFrame01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_DrawerPanelWoodFrame', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  ...
  setAttributes() {
    ...
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // part_DrawerPanelWoodFrame_ValueScript
    ...
    if (this.#pa_EdgeBackColor === undefined) {
      this.pa_EdgeBackColor = this.parent.mod_FrontColor;
    }
    ...
    if (this.#pa_FramePartsWidthHor === undefined) {
      this.pa_FramePartsWidthHor = this.parent.mod_FramePartsWidthHor;
    }
    if (this.#pa_FramePartsWidthVert === undefined) {
      this.pa_FramePartsWidthVert = this.parent.mod_FramePartsWidthVert;
    }
    if (this.#pa_PanelWoodFrameType === undefined) {
      this.pa_PanelWoodFrameType = this.parent.mod_PanelWoodFrameType;
    }
  ...
  checkAttributes() {
    ...
    if (this.#pa_BomId === undefined) {
      logError('Attribute pa_BomId not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_BtmColor === undefined) {
      logError('Attribute pa_BtmColor not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackColor === undefined) {
      logError('Attribute pa_EdgeBackColor not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackType === undefined) {
      logError('Attribute pa_EdgeBackType not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      logError('Attribute pa_EdgeFrontColor not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontType === undefined) {
      logError('Attribute pa_EdgeFrontType not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeJointType === undefined) {
      logError('Attribute pa_EdgeJointType not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftColor === undefined) {
      logError('Attribute pa_EdgeLeftColor not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftType === undefined) {
      logError('Attribute pa_EdgeLeftType not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightColor === undefined) {
      logError('Attribute pa_EdgeRightColor not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightType === undefined) {
      logError('Attribute pa_EdgeRightType not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_GrainDirection === undefined) {
      logError('Attribute pa_GrainDirection not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_Program === undefined) {
      logError('Attribute pa_Program not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_TopColor === undefined) {
      logError('Attribute pa_TopColor not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_Weight === undefined) {
      logError('Attribute pa_Weight not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FramePartsWidthHor === undefined) {
      logError('Attribute pa_FramePartsWidthHor not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FramePartsWidthVert === undefined) {
      logError('Attribute pa_FramePartsWidthVert not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_PanelWoodFrameType === undefined) {
      logError('Attribute pa_PanelWoodFrameType not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrameFillingThk === undefined) {
      logError('Attribute pa_FrameFillingThk not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrameFillingMaterial === undefined) {
      logError('Attribute pa_FrameFillingMaterial not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_TypeElement === undefined) {
      logError('Attribute pa_TypeElement not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_AdditionalInfo1 === undefined) {
      logError('Attribute pa_AdditionalInfo1 not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrameFillingWoodColor === undefined) {
      logError('Attribute pa_FrameFillingWoodColor not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrontGlassColor === undefined) {
      logError('Attribute pa_FrontGlassColor not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
  ...
  createBomElements() {
    ...
    const partSelf = this;
      ...
      if (partSelf._g?.basic_CreateBom == 'Library') { // ####################### CUSTOM SCRIPTS ########################
        ...
        const _bom = new class BOM198 extends BOM_ElementType_bomout_Group {
          constructor() { super(partSelf); }
          set(partSelf: IP_part_DrawerPanelWoodFrame_PartVarsReadOnly) {
            const part = partSelf;
...
//====================================================================
  ...
  override createBomTouchElements(touch: PartTouch, partNext: PartBase, posRel: CollisionDataRel) {
      try {
      // ncout_Group: 492: part_HandleDrill FromFront
    if (touch == PartTouch.FromFront && partNext instanceof P_part_HandleDrill) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          ...
          const _bom = new class BOMT492 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_DrawerPanelWoodFrame_PartVarsReadOnly, touch: PartTouch, part2: IP_part_HandleDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
...
GlobalFunc.ncout_HandleDrill(this, partSelf, part2, posRel)
      ...
      try {
      // ncout_Group: 493: part_DrawerBoxDrilling FromBack
    if (touch == PartTouch.FromBack && partNext instanceof P_part_DrawerBoxDrilling) {
        let part2 = <P_part_DrawerBoxDrilling>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT493 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_DrawerPanelWoodFrame_PartVarsReadOnly, touch: PartTouch, part2: IP_part_DrawerBoxDrilling_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//====================================================================
// For each drilling (insert the drillings) left box connector
//====================================================================
...
//====================================================================
// For each drilling (insert the drillings) right box connector
//====================================================================

drillings.forEach(x => 
  {  
    // Position of the drill
    let PosX=posRel.x + part2._dimx - x.XA;
    let PosY=posRel.y + x.YA;
    let PosZ=0;
    ...
    drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'z');
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Drillings for front connector of drawer boxes";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 494: part_DrawerShelfbtmConnectorDrilling FromBack
    if (touch == PartTouch.FromBack && partNext instanceof P_part_DrawerShelfbtmConnectorDrilling) {
        let part2 = <P_part_DrawerShelfbtmConnectorDrilling>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT494 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_DrawerPanelWoodFrame_PartVarsReadOnly, touch: PartTouch, part2: IP_part_DrawerShelfbtmConnectorDrilling_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//====================================================================
// For each drilling (insert the drillings) bottom shelf connector
//====================================================================
...
{  
  ...
  drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'z');
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Drillings for bottom shelf connector of drawer boxes";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
  ...
  override createBomTouchElementsEnd() : void { 
      try {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT535 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_DrawerPanelWoodFrame_PartVarsReadOnly) {
