...
export interface cti_tab_SlopedCeilingSettings {
  readonly in_Construction? : string;
}

export interface ctm_tab_SlopedCeilingSettings {
}

export interface cto_tab_SlopedCeilingSettings extends ctm_tab_SlopedCeilingSettings {
  readonly _id : number;
  readonly CarcaseConnectionLeftBtm? : string;
  readonly CarcaseConnectionLeftTop? : string;
  readonly CarcaseConnectionRightTop? : string;
  readonly CarcaseConnectionRightBtm? : string;
  readonly CarcaseShelftopConstruction? : string;
  readonly ShelftopHor_PartBack? : string;
  readonly ShelftopAngle_PartFront? : string;
  readonly ShelftopAngle_PartBack? : string;
  readonly BackwallThk : number;
  readonly BackwallPos : number;
  readonly CarcaseBackwallConstruction? : string;
  SidePanelTopDepth(m: any /* WARNING: No parent found; assuming 'any' */):number;
  SidePanelBackHeight(m: any /* WARNING: No parent found; assuming 'any' */):number;
}

export interface ICT_tab_SlopedCeilingSettings
extends cti_tab_SlopedCeilingSettings, cto_tab_SlopedCeilingSettings {}

export class ct2_tab_SlopedCeilingSettings {

public findExactly(
     in_Construction: string|undefined,
): cto_tab_SlopedCeilingSettings | undefined {
  const res = ct_tab_SlopedCeilingSettings.find((p) => 
p.in_Construction === in_Construction
);
return res;
}

public find(
predicate: (value: cti_tab_SlopedCeilingSettings) => boolean
): cto_tab_SlopedCeilingSettings | undefined {
  for (let index = 0; index < ct_tab_SlopedCeilingSettings.length; index++){
    const element = ct_tab_SlopedCeilingSettings[index];
...
export var ct_tab_SlopedCeilingSettings :ICT_tab_SlopedCeilingSettings[] = [
{
 _id: 1,
 in_Construction: "Construction01",
 CarcaseConnectionLeftBtm: "SideCShelf",
 CarcaseConnectionLeftTop: "SideCShelf",
 CarcaseConnectionRightTop: "SideCShelf",
 CarcaseConnectionRightBtm: "SideCShelf",
 CarcaseShelftopConstruction: "SlopedCeilingShelfTop",
 ShelftopHor_PartBack: "SlopedCeilingShelftopAngleMitre",
 ShelftopAngle_PartFront: "Mitre",
 ShelftopAngle_PartBack: "Mitre",
 BackwallThk: 19,
 BackwallPos: 19.5,
 CarcaseBackwallConstruction: "Inlayed_LBRT",
  SidePanelTopDepth(m: any /* WARNING: No parent found; assuming 'any' */):number {
...
,{
 _id: 2,
 in_Construction: "Construction01.1",
 CarcaseConnectionLeftBtm: "SideCShelf",
 CarcaseConnectionLeftTop: "ShelfCSide",
 CarcaseConnectionRightTop: "ShelfCSide",
 CarcaseConnectionRightBtm: "SideCShelf",
 CarcaseShelftopConstruction: "SlopedCeilingShelfTop",
 ShelftopHor_PartBack: "SlopedCeilingShelftopAngleMitre",
 ShelftopAngle_PartFront: "Mitre",
 ...
 BackwallThk: 19,
 BackwallPos: 19,
 CarcaseBackwallConstruction: "Inlayed_T",
  SidePanelTopDepth(m: any /* WARNING: No parent found; assuming 'any' */):number {
    return (m.mod_TopDepth - m.g.basic_SidepanelOffsetFront - (GlobalFunc.calc_pythagoreanTheorem((270 - m.mod_SlopeAngle) / 2, 0, m.mod_ShelftopThk, 0)[1]));
  }
,
  SidePanelBackHeight(m: any /* WARNING: No parent found; assuming 'any' */):number {
    return (m.mod_Height - (GlobalFunc.calc_pythagoreanTheorem(m.mod_SlopeAngle - 90, (m.mod_Depth - (m.mod_TopDepth - m.g.basic_SidepanelOffsetFront - (GlobalFunc.calc_pythagoreanTheorem((270 - m.mod_SlopeAngle) / 2, 0, m.mod_ShelftopThk, 0)[1]))), 0, 0)[2]));
  }
