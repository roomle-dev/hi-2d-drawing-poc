...
export interface IP_part_Railverttopback_PartVarsReadOnly extends IPartBase {
...
export interface IP_part_Railverttopback_PartVarsWritable extends IP_part_Railverttopback_PartVarsReadOnly {
...
export class P_part_Railverttopback extends PartBase implements IP_part_Railverttopback_PartVarsWritable {
...
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_Railverttopback', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
  ...
  setAttributes() {
    ...
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // part_Railverttopback_ValueScript
  ...
  checkAttributes() {
    ...
    if (this.#pa_CarcaseConnectionLeftTop === undefined) {
      logError('Attribute pa_CarcaseConnectionLeftTop not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_CarcaseConnectionRightTop === undefined) {
      logError('Attribute pa_CarcaseConnectionRightTop not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionRightTop === undefined) {
      logError('Attribute pa_FittingConnectionRightTop not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionLeftTop === undefined) {
      logError('Attribute pa_FittingConnectionLeftTop not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareColor === undefined) {
      logError('Attribute pa_HardwareColor not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_ParentName === undefined) {
      logError('Attribute pa_ParentName not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_TypeElement === undefined) {
      logError('Attribute pa_TypeElement not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_TopColor === undefined) {
      logError('Attribute pa_TopColor not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_BtmColor === undefined) {
      logError('Attribute pa_BtmColor not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      logError('Attribute pa_EdgeFrontColor not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftColor === undefined) {
      logError('Attribute pa_EdgeLeftColor not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackColor === undefined) {
      logError('Attribute pa_EdgeBackColor not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightColor === undefined) {
      logError('Attribute pa_EdgeRightColor not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontType === undefined) {
      logError('Attribute pa_EdgeFrontType not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftType === undefined) {
      logError('Attribute pa_EdgeLeftType not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackType === undefined) {
      logError('Attribute pa_EdgeBackType not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightType === undefined) {
      logError('Attribute pa_EdgeRightType not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeJointType === undefined) {
      logError('Attribute pa_EdgeJointType not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_GrainDirection === undefined) {
      logError('Attribute pa_GrainDirection not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_Program === undefined) {
      logError('Attribute pa_Program not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_BomId === undefined) {
      logError('Attribute pa_BomId not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_AdditionalInfo1 === undefined) {
      logError('Attribute pa_AdditionalInfo1 not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_ColorGrainGroup === undefined) {
      logError('Attribute pa_ColorGrainGroup not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_GrainLogic === undefined) {
      logError('Attribute pa_GrainLogic not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_ColorOutsideGrainGroup === undefined) {
      logError('Attribute pa_ColorOutsideGrainGroup not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_ProgramGrainGroup === undefined) {
      logError('Attribute pa_ProgramGrainGroup not set in part part_Railverttopback (id: ' + this._id + ')');
    }
    if (this.#pa_ProgramOutsideGrainGroup === undefined) {
      logError('Attribute pa_ProgramOutsideGrainGroup not set in part part_Railverttopback (id: ' + this._id + ')');
    }
  ...
  createBomElements() {
    ...
    const partSelf = this;
      ...
      if (partSelf._g?.basic_CreateBom == 'Library') { // ####################### CUSTOM SCRIPTS ########################
        ...
        const _bom = new class BOM167 extends BOM_ElementType_bomout_Board {
          constructor() { super(partSelf); }
          set(partSelf: IP_part_Railverttopback_PartVarsReadOnly) {
            const part = partSelf;
...
GlobalFunc.process_BoardBom(this, part, elementType, elementCategory, parentBomId)
  ...
  override createBomTouchElements(touch: PartTouch, partNext: PartBase, posRel: CollisionDataRel) {
      try {
      // ncout_Group: 371: part_Sidepanelleft FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Sidepanelleft) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          ...
          const _bom = new class BOMT371 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Railverttopback_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelleft_PartVarsReadOnly, posRel:CollisionDataRel) {
...
//
// Description:
// Connection between Rail vertical top back and Sidepanelleft
// Touch FromLeft
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 372: part_Sidepanelright FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Sidepanelright) {
        let part2 = <P_part_Sidepanelright>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT372 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Railverttopback_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelright_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//
// Description:
// Connection between Rail vertical top back and Sidepanelright
// Touch FromRight
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 616: part_Sidepanelmiddle FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Sidepanelmiddle) {
        let part2 = <P_part_Sidepanelmiddle>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT616 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Railverttopback_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelmiddle_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
// Schuler Consulting
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 618: part_Sidepanelmiddle FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Sidepanelmiddle) {
        let part2 = <P_part_Sidepanelmiddle>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT618 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Railverttopback_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelmiddle_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
