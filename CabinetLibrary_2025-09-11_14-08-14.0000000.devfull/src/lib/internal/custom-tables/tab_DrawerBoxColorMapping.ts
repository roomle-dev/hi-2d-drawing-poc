...
export interface cti_tab_DrawerBoxColorMapping {
  readonly in_HardwareColor? : string;
}

export interface ctm_tab_DrawerBoxColorMapping {
}

export interface cto_tab_DrawerBoxColorMapping extends ctm_tab_DrawerBoxColorMapping {
  readonly _id : number;
  readonly DrawerBoxColor? : string;
  readonly DrawerBoxBoardColor? : string;
  readonly DrawerBoxGrainGroupId? : string;
  readonly EdgeTypeShelfFront? : string;
  readonly EdgeTypeShelfBack? : string;
  readonly EdgeTypeShelfLeft? : string;
  readonly EdgeTypeShelfRight? : string;
  readonly EdgeJointTypeShelf? : string;
  readonly EdgeTypeBackwallFront? : string;
  readonly EdgeTypeBackwallBack? : string;
  readonly EdgeTypeBackwallLeft? : string;
  readonly EdgeTypeBackwallRight? : string;
  readonly EdgeJointTypeBackwall? : string;
}

export interface ICT_tab_DrawerBoxColorMapping
extends cti_tab_DrawerBoxColorMapping, cto_tab_DrawerBoxColorMapping {}

export class ct2_tab_DrawerBoxColorMapping {

public findExactly(
     in_HardwareColor: string|undefined,
): cto_tab_DrawerBoxColorMapping | undefined {
  const res = ct_tab_DrawerBoxColorMapping.find((p) => 
...
public find(
predicate: (value: cti_tab_DrawerBoxColorMapping) => boolean
): cto_tab_DrawerBoxColorMapping | undefined {
  for (let index = 0; index < ct_tab_DrawerBoxColorMapping.length; index++){
    const element = ct_tab_DrawerBoxColorMapping[index];
...
export var ct_tab_DrawerBoxColorMapping :ICT_tab_DrawerBoxColorMapping[] = [
{
 _id: 5,
 in_HardwareColor: "DarkColor",
 DrawerBoxColor: "Orion",
 DrawerBoxBoardColor: "215",
 DrawerBoxGrainGroupId: "Grain",
 EdgeTypeShelfFront: "CBE",
 EdgeTypeShelfBack: "CBE",
 EdgeTypeShelfLeft: "CBE",
 EdgeTypeShelfRight: "CBE",
 EdgeJointTypeShelf: "VV",
 EdgeTypeBackwallFront: "CFE",
 EdgeTypeBackwallBack: "CBE",
 EdgeTypeBackwallLeft: "CBE",
 EdgeTypeBackwallRight: "CBE",
 EdgeJointTypeBackwall: "VV"
}
,{
 _id: 6,
 in_HardwareColor: "LightColor",
 DrawerBoxColor: "Inox",
 DrawerBoxBoardColor: "178",
 DrawerBoxGrainGroupId: "NoGrain",
 EdgeTypeShelfFront: "CBE",
 EdgeTypeShelfBack: "CBE",
 EdgeTypeShelfLeft: "CBE",
 EdgeTypeShelfRight: "CBE",
...
,{
 ...
 DrawerBoxColor: "White",
 DrawerBoxBoardColor: "190",
 DrawerBoxGrainGroupId: "NoGrain",
 EdgeTypeShelfFront: "CBE",
 EdgeTypeShelfBack: "CBE",
 EdgeTypeShelfLeft: "CBE",
...
,{
 ...
 DrawerBoxColor: "Terra",
 DrawerBoxBoardColor: "199",
 DrawerBoxGrainGroupId: "NoGrain",
 EdgeTypeShelfFront: "CBE",
 EdgeTypeShelfBack: "CBE",
 EdgeTypeShelfLeft: "CBE",
