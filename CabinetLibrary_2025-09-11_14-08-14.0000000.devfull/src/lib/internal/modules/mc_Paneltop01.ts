...
import { IP_part_CeilingFillerFittingPanel_PartVarsWritable, P_part_CeilingFillerFittingPanel } from '../parts/part_CeilingFillerFittingPanel'
...
import { IModuleNonNull_mc_Paneltop01,IModParents_mc_Paneltop01,IPartParentsNonNull_mc_Paneltop01} from '../mod-interfaces'
...
import { mc_Paneltop01_createBuildPlan, mc_Paneltop01_afterDataCompletion, mc_Paneltop01_manufacturerDataCompletion } from '../../modules/mc_Paneltop01';
...
export interface adc_mc_Paneltop01 extends IModBaseProp
...
,IModVar_mod_Width,IModVar_mod_Depth,IModVar_mod_CeilingFillerFittingPanelDepth,IModVar_mod_CeilingFillerFittingPanelThk,IModVar_mod_CeilingFillerHeight,IModVar_mod_CeilingFillerThk,IModVar_mod_PaneltopColor,IModVar_mod_PaneltopConstruction,IModVar_mod_PaneltopProgram,IModVar_mod_PaneltopEdgeBackColor,IModVar_mod_PaneltopEdgeFrontColor,IModVar_mod_PaneltopEdgeRightColor,IModVar_mod_PaneltopEdgeLeftColor,IModVar_mod_PaneltopEdgeVisFront,IModVar_mod_PaneltopEdgeVisBack,IModVar_mod_PaneltopOversizeBack,IModVar_mod_PaneltopEdgeVisLeft,IModVar_mod_PaneltopEdgeVisRight,IModVar_mod_PaneltopThk,IModVar_mod_PaneltopOverhangFront,IModVar_mod_ParentName,IModVar_mod_ModuleName,IModVar_mod_PaneltopId,IModVar_mod_FrontGapHor,IModVar_mod_FrontGapCarcase,IModVar_mod_GrainLogic
 {
  ...
  get mod_PaneltopId(): string | undefined { return this.#mod_PaneltopId}
  set mod_PaneltopId(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_PaneltopId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_PaneltopId === value) return;
    this.#mod_PaneltopId = value;
  }

  mod_PaneltopId_matrix?: IMatrix_mod_PaneltopId;
  ...
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_PaneltopId');
    const val = _toString(json['attributes']['mod_PaneltopId'], 'mod_PaneltopId');
    internal_leaveValidateVariant();
    this.mod_PaneltopId = val; }
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_PaneltopColor === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopColor')) {
          let pv = <IModVar_mod_PaneltopColor>s;
          if (pv.mod_PaneltopColor !== undefined) {
            this.mod_PaneltopColor = (<IModVar_mod_PaneltopColor>s).mod_PaneltopColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PaneltopConstruction === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopConstruction')) {
          let pv = <IModVar_mod_PaneltopConstruction>s;
          if (pv.mod_PaneltopConstruction !== undefined) {
            this.mod_PaneltopConstruction = (<IModVar_mod_PaneltopConstruction>s).mod_PaneltopConstruction;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PaneltopProgram === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopProgram')) {
          let pv = <IModVar_mod_PaneltopProgram>s;
          if (pv.mod_PaneltopProgram !== undefined) {
            this.mod_PaneltopProgram = (<IModVar_mod_PaneltopProgram>s).mod_PaneltopProgram;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PaneltopEdgeBackColor === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopEdgeBackColor')) {
          let pv = <IModVar_mod_PaneltopEdgeBackColor>s;
          if (pv.mod_PaneltopEdgeBackColor !== undefined) {
            this.mod_PaneltopEdgeBackColor = (<IModVar_mod_PaneltopEdgeBackColor>s).mod_PaneltopEdgeBackColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PaneltopEdgeFrontColor === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopEdgeFrontColor')) {
          let pv = <IModVar_mod_PaneltopEdgeFrontColor>s;
          if (pv.mod_PaneltopEdgeFrontColor !== undefined) {
            this.mod_PaneltopEdgeFrontColor = (<IModVar_mod_PaneltopEdgeFrontColor>s).mod_PaneltopEdgeFrontColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PaneltopEdgeRightColor === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopEdgeRightColor')) {
          let pv = <IModVar_mod_PaneltopEdgeRightColor>s;
          if (pv.mod_PaneltopEdgeRightColor !== undefined) {
            this.mod_PaneltopEdgeRightColor = (<IModVar_mod_PaneltopEdgeRightColor>s).mod_PaneltopEdgeRightColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PaneltopEdgeLeftColor === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopEdgeLeftColor')) {
          let pv = <IModVar_mod_PaneltopEdgeLeftColor>s;
          if (pv.mod_PaneltopEdgeLeftColor !== undefined) {
            this.mod_PaneltopEdgeLeftColor = (<IModVar_mod_PaneltopEdgeLeftColor>s).mod_PaneltopEdgeLeftColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PaneltopEdgeVisFront === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopEdgeVisFront')) {
          let pv = <IModVar_mod_PaneltopEdgeVisFront>s;
          if (pv.mod_PaneltopEdgeVisFront !== undefined) {
            this.mod_PaneltopEdgeVisFront = (<IModVar_mod_PaneltopEdgeVisFront>s).mod_PaneltopEdgeVisFront;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PaneltopEdgeVisBack === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopEdgeVisBack')) {
          let pv = <IModVar_mod_PaneltopEdgeVisBack>s;
          if (pv.mod_PaneltopEdgeVisBack !== undefined) {
            this.mod_PaneltopEdgeVisBack = (<IModVar_mod_PaneltopEdgeVisBack>s).mod_PaneltopEdgeVisBack;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PaneltopOversizeBack === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopOversizeBack')) {
          let pv = <IModVar_mod_PaneltopOversizeBack>s;
          if (pv.mod_PaneltopOversizeBack !== undefined) {
            this.mod_PaneltopOversizeBack = (<IModVar_mod_PaneltopOversizeBack>s).mod_PaneltopOversizeBack;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PaneltopEdgeVisLeft === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopEdgeVisLeft')) {
          let pv = <IModVar_mod_PaneltopEdgeVisLeft>s;
          if (pv.mod_PaneltopEdgeVisLeft !== undefined) {
            this.mod_PaneltopEdgeVisLeft = (<IModVar_mod_PaneltopEdgeVisLeft>s).mod_PaneltopEdgeVisLeft;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PaneltopEdgeVisRight === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopEdgeVisRight')) {
          let pv = <IModVar_mod_PaneltopEdgeVisRight>s;
          if (pv.mod_PaneltopEdgeVisRight !== undefined) {
            this.mod_PaneltopEdgeVisRight = (<IModVar_mod_PaneltopEdgeVisRight>s).mod_PaneltopEdgeVisRight;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PaneltopThk === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopThk')) {
          let pv = <IModVar_mod_PaneltopThk>s;
          if (pv.mod_PaneltopThk !== undefined) {
            this.mod_PaneltopThk = (<IModVar_mod_PaneltopThk>s).mod_PaneltopThk;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PaneltopOverhangFront === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PaneltopOverhangFront')) {
          let pv = <IModVar_mod_PaneltopOverhangFront>s;
          if (pv.mod_PaneltopOverhangFront !== undefined) {
            this.mod_PaneltopOverhangFront = (<IModVar_mod_PaneltopOverhangFront>s).mod_PaneltopOverhangFront;
            break;
          };
        }
        s = s.parentBase;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_Paneltop01";
    }
    if (this.mod_PaneltopId === undefined) {
      this.mod_PaneltopId = "None";
    }
...
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
      // CUSTOMSCRIPT_mc_Paneltop01_mod_ParentName_SETDEFAULT
...
// ###############################################################
  ...
  #manufacturerDataCompletionInternal = mc_Paneltop01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Paneltop01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Paneltop01{
    ...
    const adc = new OD_M_mc_Paneltop01_NonNull(this);
    return adc;
  }
  ...
  override validateSelections():void {
    ...
    this.mod_PaneltopId_matrix = VariantValidation.mod_PaneltopId(this, this);
  ...
  addpart_CeilingFillerFittingPanel(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_CeilingFillerFittingPanel_PartVarsWritable {
    var c = new P_part_CeilingFillerFittingPanel(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_CeilingFillerPanel(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_CeilingFillerPanel_PartVarsWritable {
    var c = new P_part_CeilingFillerPanel(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_PaneltopGroup(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PaneltopGroup_PartVarsWritable {
    var c = new P_part_PaneltopGroup(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_Paneltop(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Paneltop_PartVarsWritable {
    var c = new P_part_Paneltop(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Paneltop01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Paneltop01_NonNull implements cbp_mc_Paneltop01, adc_mc_Paneltop01 ,IPartParentsNonNull_mc_Paneltop01 {
  constructor(parent: OD_M_mc_Paneltop01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Paneltop01;
  ...
  #createBuildPlanInternal = mc_Paneltop01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Paneltop01_afterDataCompletion;
  ...
  parent: IModParents_mr_Paneltop;
  addpart_CeilingFillerFittingPanel(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_CeilingFillerFittingPanel_PartVarsWritable {
    return this.#internalParent.addpart_CeilingFillerFittingPanel(x, y, z, dimx, dimy, dimz);
  }
  addpart_CeilingFillerPanel(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_CeilingFillerPanel_PartVarsWritable {
    return this.#internalParent.addpart_CeilingFillerPanel(x, y, z, dimx, dimy, dimz);
  }
  addpart_PaneltopGroup(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PaneltopGroup_PartVarsWritable {
    return this.#internalParent.addpart_PaneltopGroup(x, y, z, dimx, dimy, dimz);
  }
  addpart_Paneltop(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Paneltop_PartVarsWritable {
    return this.#internalParent.addpart_Paneltop(x, y, z, dimx, dimy, dimz);
  }
  ...
  get mod_PaneltopId(): string  {
    return this.#internalParent.mod_PaneltopId!;
  }
