...
export interface cti_tab_PullOutSettings {
  readonly in_CabinetType? : string;
  readonly in_FrontAngle : number;
  readonly in_CarcaseFreeSpaceWidthMin : number;
  readonly in_CarcaseFreeSpaceWidthMax : number;
  readonly in_CarcaseFreeSpaceDepthMin : number;
  readonly in_CarcaseFreeSpaceDepthMax : number;
  readonly in_CarcaseFreeSpaceHeightMin : number;
  readonly in_CarcaseFreeSpaceHeightMax : number;
}

export interface ctm_tab_PullOutSettings {
}

export interface cto_tab_PullOutSettings extends ctm_tab_PullOutSettings {
  readonly _id : number;
  readonly Priority : number;
  readonly PullOutType? : string;
}

export interface ICT_tab_PullOutSettings
extends cti_tab_PullOutSettings, cto_tab_PullOutSettings {}

export class ct2_tab_PullOutSettings {

public findExactly(
     in_CabinetType: string|undefined,
     in_FrontAngle: number,
     in_CarcaseFreeSpaceWidthMin: number,
     in_CarcaseFreeSpaceWidthMax: number,
     in_CarcaseFreeSpaceDepthMin: number,
     in_CarcaseFreeSpaceDepthMax: number,
     in_CarcaseFreeSpaceHeightMin: number,
     in_CarcaseFreeSpaceHeightMax: number,
): cto_tab_PullOutSettings | undefined {
  const res = ct_tab_PullOutSettings.find((p) => 
p.in_CabinetType === in_CabinetType
 && p.in_FrontAngle === in_FrontAngle
 && p.in_CarcaseFreeSpaceWidthMin === in_CarcaseFreeSpaceWidthMin
 && p.in_CarcaseFreeSpaceWidthMax === in_CarcaseFreeSpaceWidthMax
 && p.in_CarcaseFreeSpaceDepthMin === in_CarcaseFreeSpaceDepthMin
 && p.in_CarcaseFreeSpaceDepthMax === in_CarcaseFreeSpaceDepthMax
 && p.in_CarcaseFreeSpaceHeightMin === in_CarcaseFreeSpaceHeightMin
 && p.in_CarcaseFreeSpaceHeightMax === in_CarcaseFreeSpaceHeightMax
);
return res;
}

public find(
predicate: (value: cti_tab_PullOutSettings) => boolean
): cto_tab_PullOutSettings | undefined {
  for (let index = 0; index < ct_tab_PullOutSettings.length; index++){
    const element = ct_tab_PullOutSettings[index];
...
export var ct_tab_PullOutSettings :ICT_tab_PullOutSettings[] = [
{
 _id: 1,
 in_CabinetType: "mr_StorageunitSingle",
 in_FrontAngle: 90,
 in_CarcaseFreeSpaceWidthMin: 112,
 in_CarcaseFreeSpaceWidthMax: 200,
 in_CarcaseFreeSpaceDepthMin: 489,
 in_CarcaseFreeSpaceDepthMax: 560,
 in_CarcaseFreeSpaceHeightMin: 540,
 in_CarcaseFreeSpaceHeightMax: 699,
 Priority: 1,
 PullOutType: "Basket"
}
,{
 ...
 in_CarcaseFreeSpaceDepthMin: 489,
 in_CarcaseFreeSpaceDepthMax: 560,
 in_CarcaseFreeSpaceHeightMin: 755,
 in_CarcaseFreeSpaceHeightMax: 799,
 Priority: 1,
 PullOutType: "Basket"
}
,{
 ...
 in_CarcaseFreeSpaceWidthMin: 112,
 in_CarcaseFreeSpaceWidthMax: 200,
 in_CarcaseFreeSpaceDepthMin: 259,
 in_CarcaseFreeSpaceDepthMax: 488.99,
 in_CarcaseFreeSpaceHeightMin: 470,
 in_CarcaseFreeSpaceHeightMax: 539.99,
 Priority: 1,
 PullOutType: "Basket"
}
,{
 ...
 in_CarcaseFreeSpaceWidthMin: 112,
 in_CarcaseFreeSpaceWidthMax: 200,
 in_CarcaseFreeSpaceDepthMin: 481,
 in_CarcaseFreeSpaceDepthMax: 560,
 in_CarcaseFreeSpaceHeightMin: 540,
 in_CarcaseFreeSpaceHeightMax: 699,
 Priority: 2,
 PullOutType: "BakingTrayHolder"
}
,{
 _id: 5,
 in_CabinetType: "mr_StorageunitSingle",
 ...
 in_CarcaseFreeSpaceDepthMin: 489,
 in_CarcaseFreeSpaceDepthMax: 560,
 in_CarcaseFreeSpaceHeightMin: 590,
 in_CarcaseFreeSpaceHeightMax: 754.99,
 Priority: 3,
 PullOutType: "TowelRail"
}
];
