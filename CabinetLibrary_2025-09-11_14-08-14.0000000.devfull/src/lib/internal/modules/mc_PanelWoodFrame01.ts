...
import { IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01 } from '../mod-interfaces'
import { IP_part_PanelWoodFrameTop_PartVarsWritable, P_part_PanelWoodFrameTop } from '../parts/part_PanelWoodFrameTop'
import { IP_part_PanelWoodFrameLeft_PartVarsWritable, P_part_PanelWoodFrameLeft } from '../parts/part_PanelWoodFrameLeft'
import { IP_part_PanelWoodFrameBtm_PartVarsWritable, P_part_PanelWoodFrameBtm } from '../parts/part_PanelWoodFrameBtm'
import { IP_part_PanelWoodFrameRight_PartVarsWritable, P_part_PanelWoodFrameRight } from '../parts/part_PanelWoodFrameRight'
import { IP_part_PanelWoodFrameFilling_PartVarsWritable, P_part_PanelWoodFrameFilling } from '../parts/part_PanelWoodFrameFilling'
import { IP_part_DrawerPanelWoodFrame_PartVarsWritable, P_part_DrawerPanelWoodFrame } from '../parts/part_DrawerPanelWoodFrame'
import { IP_part_DoorPanelWoodFrame_PartVarsWritable, P_part_DoorPanelWoodFrame } from '../parts/part_DoorPanelWoodFrame'
import { IP_part_FlipliftPanelWoodFrame_PartVarsWritable, P_part_FlipliftPanelWoodFrame } from '../parts/part_FlipliftPanelWoodFrame'
import { IP_part_FixedfrontPanelWoodFrame_PartVarsWritable, P_part_FixedfrontPanelWoodFrame } from '../parts/part_FixedfrontPanelWoodFrame'
...
import {IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_FramePartsWidthHor,IModVarNonNull_mod_FramePartsWidthHor,IModVar_mod_FramePartsWidthVert,IModVarNonNull_mod_FramePartsWidthVert,IModVar_mod_FrontDesign,IModVarNonNull_mod_FrontDesign,IModVar_mod_FrontColor,IModVarNonNull_mod_FrontColor,IModVar_mod_FrontEdgeColor,IModVarNonNull_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVarNonNull_mod_FrontEdgeThk,IModVar_mod_FrontId,IModVarNonNull_mod_FrontId,IModVar_mod_FrontpanelWeightCalculations,IModVarNonNull_mod_FrontpanelWeightCalculations,IModVar_mod_FrontProgram,IModVarNonNull_mod_FrontProgram,IModVar_mod_FrontType,IModVarNonNull_mod_FrontType,IModVar_mod_HandleDesign,IModVarNonNull_mod_HandleDesign,IModVar_mod_HandlePosType,IModVarNonNull_mod_HandlePosType,IModVar_mod_Height,IModVarNonNull_mod_Height,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_PartInfo,IModVarNonNull_mod_PartInfo,IModVar_mod_Width,IModVarNonNull_mod_Width,IModVar_mod_PanelWoodFrameFillingType,IModVarNonNull_mod_PanelWoodFrameFillingType,IModVar_mod_PanelWoodFrameType,IModVarNonNull_mod_PanelWoodFrameType,IModVar_mod_TypeElement,IModVarNonNull_mod_TypeElement,IModVar_mod_DoorDirection,IModVarNonNull_mod_DoorDirection,IModVar_mod_FlipliftType,IModVarNonNull_mod_FlipliftType,IModVar_mod_FrontGlassColor,IModVarNonNull_mod_FrontGlassColor,IModVar_mod_FrameFillingWoodColor,IModVarNonNull_mod_FrameFillingWoodColor,IModVar_mod_FrameFillingColor,IModVarNonNull_mod_FrameFillingColor} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_Depth, IMatrix_mod_FramePartsWidthHor, IMatrix_mod_FramePartsWidthVert, IMatrix_mod_FrontDesign, IMatrix_mod_FrontColor, IMatrix_mod_FrontEdgeColor, IMatrix_mod_FrontEdgeThk, IMatrix_mod_FrontId, IMatrix_mod_FrontProgram, IMatrix_mod_FrontType, IMatrix_mod_HandleDesign, IMatrix_mod_HandlePosType, IMatrix_mod_Height, IMatrix_mod_ModuleName, IMatrix_mod_PartInfo, IMatrix_mod_Width, IMatrix_mod_PanelWoodFrameFillingType, IMatrix_mod_PanelWoodFrameType, IMatrix_mod_TypeElement, IMatrix_mod_DoorDirection, IMatrix_mod_FlipliftType, IMatrix_mod_FrontGlassColor, IMatrix_mod_FrameFillingWoodColor, IMatrix_mod_FrameFillingColor} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_PanelWoodFrameTop, IPartAdd_part_PanelWoodFrameLeft, IPartAdd_part_PanelWoodFrameBtm, IPartAdd_part_PanelWoodFrameRight, IPartAdd_part_PanelWoodFrameFilling, IPartAdd_part_DrawerPanelWoodFrame, IPartAdd_part_DoorPanelWoodFrame, IPartAdd_part_FlipliftPanelWoodFrame, IPartAdd_part_FixedfrontPanelWoodFrame, IPartAdd_part_DishwasherPanelWoodFrame } from '../part-add-interfaces';
import { mc_PanelWoodFrame01_createBuildPlan, mc_PanelWoodFrame01_afterDataCompletion, mc_PanelWoodFrame01_manufacturerDataCompletion } from '../../modules/mc_PanelWoodFrame01';
...
, IPartAdd_part_PanelWoodFrameTop, IPartAdd_part_PanelWoodFrameLeft, IPartAdd_part_PanelWoodFrameBtm, IPartAdd_part_PanelWoodFrameRight, IPartAdd_part_PanelWoodFrameFilling, IPartAdd_part_DrawerPanelWoodFrame, IPartAdd_part_DoorPanelWoodFrame, IPartAdd_part_FlipliftPanelWoodFrame, IPartAdd_part_FixedfrontPanelWoodFrame, IPartAdd_part_DishwasherPanelWoodFrame, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FramePartsWidthHor, IModVarNonNull_mod_FramePartsWidthVert, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontpanelWeightCalculations, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_Height, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_PartInfo, IModVarNonNull_mod_Width, IModVarNonNull_mod_PanelWoodFrameFillingType, IModVarNonNull_mod_PanelWoodFrameType, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_DoorDirection, IModVarNonNull_mod_FlipliftType, IModVarNonNull_mod_FrontGlassColor, IModVarNonNull_mod_FrameFillingWoodColor, IModVarNonNull_mod_FrameFillingColor {
  parent: IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01;
...
, IModVar_mod_Depth, IModVar_mod_FramePartsWidthHor, IModVar_mod_FramePartsWidthVert, IModVar_mod_FrontDesign, IModVar_mod_FrontColor, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontId, IModVar_mod_FrontpanelWeightCalculations, IModVar_mod_FrontProgram, IModVar_mod_FrontType, IModVar_mod_HandleDesign, IModVar_mod_HandlePosType, IModVar_mod_Height, IModVar_mod_ModuleName, IModVar_mod_PartInfo, IModVar_mod_Width, IModVar_mod_PanelWoodFrameFillingType, IModVar_mod_PanelWoodFrameType, IModVar_mod_TypeElement, IModVar_mod_DoorDirection, IModVar_mod_FlipliftType, IModVar_mod_FrontGlassColor, IModVar_mod_FrameFillingWoodColor, IModVar_mod_FrameFillingColor {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
...
export interface adc_mc_PanelWoodFrame01 extends IModBaseProp
, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FramePartsWidthHor, IModVarNonNull_mod_FramePartsWidthVert, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontpanelWeightCalculations, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_Height, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_PartInfo, IModVarNonNull_mod_Width, IModVarNonNull_mod_PanelWoodFrameFillingType, IModVarNonNull_mod_PanelWoodFrameType, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_DoorDirection, IModVarNonNull_mod_FlipliftType, IModVarNonNull_mod_FrontGlassColor, IModVarNonNull_mod_FrameFillingWoodColor, IModVarNonNull_mod_FrameFillingColor {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
}

export class OD_M_mc_PanelWoodFrame01 extends OD_Base  implements dc_mc_PanelWoodFrame01
,IModParents_mc_PanelWoodFrame01
,IModVar_mod_Depth,IModVar_mod_FramePartsWidthHor,IModVar_mod_FramePartsWidthVert,IModVar_mod_FrontDesign,IModVar_mod_FrontColor,IModVar_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVar_mod_FrontId,IModVar_mod_FrontpanelWeightCalculations,IModVar_mod_FrontProgram,IModVar_mod_FrontType,IModVar_mod_HandleDesign,IModVar_mod_HandlePosType,IModVar_mod_Height,IModVar_mod_ModuleName,IModVar_mod_PartInfo,IModVar_mod_Width,IModVar_mod_PanelWoodFrameFillingType,IModVar_mod_PanelWoodFrameType,IModVar_mod_TypeElement,IModVar_mod_DoorDirection,IModVar_mod_FlipliftType,IModVar_mod_FrontGlassColor,IModVar_mod_FrameFillingWoodColor,IModVar_mod_FrameFillingColor
 {
  constructor(parent: IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01, manufacturerMode?:boolean) {
    super('mc_PanelWoodFrame01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_PanelWoodFrame01_NonNull(this);
  }
  parent: IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01;
  _selfNonNull: OD_M_mc_PanelWoodFrame01_NonNull;

  override variants:string[] = ['mod_Depth','mod_FramePartsWidthHor','mod_FramePartsWidthVert','mod_FrontDesign','mod_FrontColor','mod_FrontEdgeColor','mod_FrontEdgeThk','mod_FrontId','mod_FrontpanelWeightCalculations','mod_FrontProgram','mod_FrontType','mod_HandleDesign','mod_HandlePosType','mod_Height','mod_ModuleName','mod_PartInfo','mod_Width','mod_PanelWoodFrameFillingType','mod_PanelWoodFrameType','mod_TypeElement','mod_DoorDirection','mod_FlipliftType','mod_FrontGlassColor','mod_FrameFillingWoodColor','mod_FrameFillingColor',];
  #mod_Depth?: number;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_PanelWoodFrame01";
    }
    if (this.mod_PartInfo === undefined) {
      this.mod_PartInfo = "part_DoorLeftPanelWoodFrame";
    }
    if (this.mod_Width === undefined) {
      this.mod_Width = 600;
    }
    if (this.mod_DoorDirection === undefined) {
      this.mod_DoorDirection = "Left";
    }
  ...
  #manufacturerDataCompletionInternal = mc_PanelWoodFrame01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_PanelWoodFrame01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_PanelWoodFrame01{
    ...
    const adc = new OD_M_mc_PanelWoodFrame01_NonNull(this);
    return adc;
  }
  ...
  addpart_PanelWoodFrameTop(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PanelWoodFrameTop_PartVarsWritable {
    var c = new P_part_PanelWoodFrameTop(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_PanelWoodFrameLeft(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PanelWoodFrameLeft_PartVarsWritable {
    var c = new P_part_PanelWoodFrameLeft(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_PanelWoodFrameBtm(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PanelWoodFrameBtm_PartVarsWritable {
    var c = new P_part_PanelWoodFrameBtm(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_PanelWoodFrameRight(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PanelWoodFrameRight_PartVarsWritable {
    var c = new P_part_PanelWoodFrameRight(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_PanelWoodFrameFilling(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PanelWoodFrameFilling_PartVarsWritable {
    var c = new P_part_PanelWoodFrameFilling(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_DrawerPanelWoodFrame(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_DrawerPanelWoodFrame_PartVarsWritable {
    var c = new P_part_DrawerPanelWoodFrame(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_DoorPanelWoodFrame(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_DoorPanelWoodFrame_PartVarsWritable {
    var c = new P_part_DoorPanelWoodFrame(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_FlipliftPanelWoodFrame(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FlipliftPanelWoodFrame_PartVarsWritable {
    var c = new P_part_FlipliftPanelWoodFrame(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_FixedfrontPanelWoodFrame(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FixedfrontPanelWoodFrame_PartVarsWritable {
    var c = new P_part_FixedfrontPanelWoodFrame(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_DishwasherPanelWoodFrame(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_DishwasherPanelWoodFrame_PartVarsWritable {
    var c = new P_part_DishwasherPanelWoodFrame(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_PanelWoodFrame01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_PanelWoodFrame01_NonNull implements cbp_mc_PanelWoodFrame01, adc_mc_PanelWoodFrame01 ,IPartParentsNonNull_mc_PanelWoodFrame01 {
  constructor(parent: OD_M_mc_PanelWoodFrame01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_PanelWoodFrame01;
  ...
  #createBuildPlanInternal = mc_PanelWoodFrame01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_PanelWoodFrame01_afterDataCompletion;
  ...
  parent: IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01;
  addpart_PanelWoodFrameTop(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PanelWoodFrameTop_PartVarsWritable {
    return this.#internalParent.addpart_PanelWoodFrameTop(x, y, z, dimx, dimy, dimz);
  }
  addpart_PanelWoodFrameLeft(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PanelWoodFrameLeft_PartVarsWritable {
    return this.#internalParent.addpart_PanelWoodFrameLeft(x, y, z, dimx, dimy, dimz);
  }
  addpart_PanelWoodFrameBtm(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PanelWoodFrameBtm_PartVarsWritable {
    return this.#internalParent.addpart_PanelWoodFrameBtm(x, y, z, dimx, dimy, dimz);
  }
  addpart_PanelWoodFrameRight(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PanelWoodFrameRight_PartVarsWritable {
    return this.#internalParent.addpart_PanelWoodFrameRight(x, y, z, dimx, dimy, dimz);
  }
  addpart_PanelWoodFrameFilling(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PanelWoodFrameFilling_PartVarsWritable {
    return this.#internalParent.addpart_PanelWoodFrameFilling(x, y, z, dimx, dimy, dimz);
  }
  addpart_DrawerPanelWoodFrame(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_DrawerPanelWoodFrame_PartVarsWritable {
    return this.#internalParent.addpart_DrawerPanelWoodFrame(x, y, z, dimx, dimy, dimz);
  }
  addpart_DoorPanelWoodFrame(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_DoorPanelWoodFrame_PartVarsWritable {
    return this.#internalParent.addpart_DoorPanelWoodFrame(x, y, z, dimx, dimy, dimz);
  }
  addpart_FlipliftPanelWoodFrame(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FlipliftPanelWoodFrame_PartVarsWritable {
    return this.#internalParent.addpart_FlipliftPanelWoodFrame(x, y, z, dimx, dimy, dimz);
  }
  addpart_FixedfrontPanelWoodFrame(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FixedfrontPanelWoodFrame_PartVarsWritable {
    return this.#internalParent.addpart_FixedfrontPanelWoodFrame(x, y, z, dimx, dimy, dimz);
  }
  addpart_DishwasherPanelWoodFrame(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_DishwasherPanelWoodFrame_PartVarsWritable {
    return this.#internalParent.addpart_DishwasherPanelWoodFrame(x, y, z, dimx, dimy, dimz);
  }
