...
import { IPartParentsNonNull_mc_Hob01 } from '../mod-interfaces'

export interface IP_part_CountertopCutout_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_Hob01;
}

export interface IP_part_CountertopCutout_PartVarsWritable extends IP_part_CountertopCutout_PartVarsReadOnly {
}

export class P_part_CountertopCutout extends PartBase implements IP_part_CountertopCutout_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Hob01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_CountertopCutout', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  parent: IPartParentsNonNull_mc_Hob01; // module which created this part
