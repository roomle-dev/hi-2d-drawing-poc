...
//#region Imports
import { cbp_mc_LightSystem01, dc_mc_LightSystem01, adc_mc_LightSystem01 } from '../internal/modules/mc_LightSystem01'
...
export function mc_LightSystem01_createBuildPlan(this: cbp_mc_LightSystem01):void {
  internal_enterModuleCreateBuildPlan('mc_LightSystem01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_LightSystem01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_LightSystem01_afterDataCompletion(this: adc_mc_LightSystem01):void {
  internal_enterModuleAfterDataCompletion('mc_LightSystem01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_LightSystem01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_LightSystem01_manufacturerDataCompletion(this: dc_mc_LightSystem01):void {
  internal_enterModuleManufacturerDataCompletion('mc_LightSystem01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_LightSystem01_MANUFACTURERDATACOMPLETION
