...
,IModVar_mod_CarcaseId,IModVar_mod_CarcaseVisTop,IModVar_mod_Depth,IModVar_mod_Height,IModVar_mod_ShelftopConstruction,IModVar_mod_Width,IModVar_mod_CarcaseColor,IModVar_mod_CarcaseOutsideColor,IModVar_mod_CarcaseEdgeBackColor,IModVar_mod_CarcaseEdgeColor,IModVar_mod_CarcaseEdgeFrontColor,IModVar_mod_CarcaseProgram,IModVar_mod_CarcaseOutsideProgram,IModVar_mod_EdgeFrontType,IModVar_mod_EdgeBackType,IModVar_mod_EdgeLeftType,IModVar_mod_EdgeRightType,IModVar_mod_EdgeJointType,IModVar_mod_ModuleName,IModVar_mod_CarcaseConnectionLeftTop,IModVar_mod_CarcaseConnectionRightTop,IModVar_mod_TypeElement,IModVar_mod_HardwareColor,IModVar_mod_ParentName,IModVar_mod_FittingConnectionLeftTop,IModVar_mod_FittingConnectionRightTop,IModVar_mod_FittingConnectionTopVert,IModVar_mod_CarcasePartConnectionTopVert,IModVar_mod_BackHeight,IModVar_mod_CarcaseDepth,IModVar_mod_SlopeAngle,IModVar_mod_SlopedCeilingConstruction,IModVar_mod_CarcaseHeight,IModVar_mod_TopDepth,IModVar_mod_PartInfo,IModVar_mod_GrainLogic
 {
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_PartInfo === undefined) {
      this.mod_PartInfo = "part_SlopedCeilingShelftopHor";
    }
  ...
  #manufacturerDataCompletionInternal = mc_StorageunitShelftop04_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_StorageunitShelftop04_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_StorageunitShelftop04{
    ...
    const adc = new OD_M_mc_StorageunitShelftop04_NonNull(this);
    return adc;
  }
  ...
  addpart_SlopedCeilingShelftopAngle(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_SlopedCeilingShelftopAngle_PartVarsWritable {
    var c = new P_part_SlopedCeilingShelftopAngle(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_SlopedCeilingShelftopHor(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_SlopedCeilingShelftopHor_PartVarsWritable {
    var c = new P_part_SlopedCeilingShelftopHor(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_StorageunitShelftop04_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_StorageunitShelftop04_NonNull implements cbp_mc_StorageunitShelftop04, adc_mc_StorageunitShelftop04 ,IPartParentsNonNull_mc_StorageunitShelftop04 {
  constructor(parent: OD_M_mc_StorageunitShelftop04) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_StorageunitShelftop04;
  ...
  #createBuildPlanInternal = mc_StorageunitShelftop04_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_StorageunitShelftop04_afterDataCompletion;
  ...
  parent: IModParents_mc_Storageunit01;
  addpart_SlopedCeilingShelftopAngle(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_SlopedCeilingShelftopAngle_PartVarsWritable {
    return this.#internalParent.addpart_SlopedCeilingShelftopAngle(x, y, z, dimx, dimy, dimz);
  }
  addpart_SlopedCeilingShelftopHor(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_SlopedCeilingShelftopHor_PartVarsWritable {
    return this.#internalParent.addpart_SlopedCeilingShelftopHor(x, y, z, dimx, dimy, dimz);
  }
