...
import { P_part_FlipliftHardwareFrontpanelDrilling, IP_part_FlipliftHardwareFrontpanelDrilling_PartVarsReadOnly } from './part_FlipliftHardwareFrontpanelDrilling'
import { P_part_HingeDrillFHF, IP_part_HingeDrillFHF_PartVarsReadOnly } from './part_HingeDrillFHF'
...
export interface IP_part_FlipliftPanelWoodFrame_PartVarsReadOnly extends IPartBase {
  ...
  get pa_FrontConstructionInfo(): cto_tab_FrontConstruction|undefined;
  get pa_GrainDirection(): string;
  get pa_Program(): string;
  get pa_TopColor(): string;
  get pa_Weight(): number;
  get pa_FrameFillingMaterial(): string;
  get pa_FrameFillingThk(): number;
  get pa_FramePartsWidthHor(): number;
  get pa_FramePartsWidthVert(): number;
  get pa_PanelWoodFrameType(): string;
  get pa_FlipliftType(): string;
  get pa_AdditionalInfo1(): string;
  get pa_FrameFillingWoodColor(): string;
  get pa_FrontGlassColor(): string;
}

export interface IP_part_FlipliftPanelWoodFrame_PartVarsWritable extends IP_part_FlipliftPanelWoodFrame_PartVarsReadOnly {
  ...
  set pa_FrontConstructionInfo(value: cto_tab_FrontConstruction|undefined);
  set pa_GrainDirection(value: string);
  set pa_Program(value: string);
  set pa_TopColor(value: string);
  set pa_Weight(value: number);
  set pa_FrameFillingMaterial(value: string);
  set pa_FrameFillingThk(value: number);
  set pa_FramePartsWidthHor(value: number);
  set pa_FramePartsWidthVert(value: number);
  set pa_PanelWoodFrameType(value: string);
  set pa_FlipliftType(value: string);
  set pa_AdditionalInfo1(value: string);
  set pa_FrameFillingWoodColor(value: string);
  set pa_FrontGlassColor(value: string);
}

export class P_part_FlipliftPanelWoodFrame extends PartBase implements IP_part_FlipliftPanelWoodFrame_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_PanelWoodFrame01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_FlipliftPanelWoodFrame', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  ...
  res.set('pa_FrontConstructionInfo', this.#pa_FrontConstructionInfo);
  res.set('pa_GrainDirection', this.#pa_GrainDirection);
  res.set('pa_Program', this.#pa_Program);
  res.set('pa_TopColor', this.#pa_TopColor);
  res.set('pa_Weight', this.#pa_Weight);
  res.set('pa_FrameFillingMaterial', this.#pa_FrameFillingMaterial);
  res.set('pa_FrameFillingThk', this.#pa_FrameFillingThk);
  res.set('pa_FramePartsWidthHor', this.#pa_FramePartsWidthHor);
  res.set('pa_FramePartsWidthVert', this.#pa_FramePartsWidthVert);
  res.set('pa_PanelWoodFrameType', this.#pa_PanelWoodFrameType);
  res.set('pa_FlipliftType', this.#pa_FlipliftType);
  res.set('pa_AdditionalInfo1', this.#pa_AdditionalInfo1);
  res.set('pa_FrameFillingWoodColor', this.#pa_FrameFillingWoodColor);
  res.set('pa_FrontGlassColor', this.#pa_FrontGlassColor);
    return res;
  }
  setAttributes() {
    try {
    ...
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // part_FlipliftPanelWoodFrame_ValueScript
    if (this.#pa_BomId === undefined) {
      this.pa_BomId = this.parent.mod_FrontId;
    }
    if (this.#pa_BtmColor === undefined) {
      this.pa_BtmColor = this.parent.mod_FrontColor;
    }
    if (this.#pa_EdgeBackColor === undefined) {
      this.pa_EdgeBackColor = this.parent.mod_FrontEdgeColor;
    }
    if (this.#pa_EdgeBackType === undefined) {
      this.pa_EdgeBackType = 'FRE';
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      this.pa_EdgeFrontColor = this.parent.mod_FrontEdgeColor;
    }
    if (this.#pa_EdgeFrontType === undefined) {
      this.pa_EdgeFrontType = 'FRE';
    }
    if (this.#pa_EdgeJointType === undefined) {
      this.pa_EdgeJointType = 'VVVV';
    }
    if (this.#pa_EdgeLeftColor === undefined) {
      this.pa_EdgeLeftColor = this.parent.mod_FrontEdgeColor;
    }
    if (this.#pa_EdgeLeftType === undefined) {
      this.pa_EdgeLeftType = 'FRE';
    }
    if (this.#pa_EdgeRightColor === undefined) {
      this.pa_EdgeRightColor = this.parent.mod_FrontEdgeColor;
    }
    if (this.#pa_EdgeRightType === undefined) {
      this.pa_EdgeRightType = 'FRE';
    }
    if (this.#pa_GrainDirection === undefined) {
      this.pa_GrainDirection = 'Neutral';
    }
    if (this.#pa_Program === undefined) {
      this.pa_Program = this.parent.mod_FrontProgram;
    }
    if (this.#pa_TopColor === undefined) {
      this.pa_TopColor = this.parent.mod_FrontColor;
    }
    if (this.#pa_FrameFillingMaterial === undefined) {
      this.pa_FrameFillingMaterial = this.parent.mod_PanelWoodFrameFillingType_matrix.Material!;
    }
    if (this.#pa_FrameFillingThk === undefined) {
      this.pa_FrameFillingThk = this.parent.mod_PanelWoodFrameFillingType_matrix.MaterialThk!;
    }
    if (this.#pa_FlipliftType === undefined) {
      this.pa_FlipliftType = this.parent.mod_FlipliftType;
    }
    if (this.#pa_AdditionalInfo1 === undefined) {
      this.pa_AdditionalInfo1 = 'None';
    }
    if (this.#pa_FrameFillingWoodColor === undefined) {
      this.pa_FrameFillingWoodColor = this.parent.mod_FrameFillingWoodColor;
    }
    if (this.#pa_FrontGlassColor === undefined) {
      this.pa_FrontGlassColor = this.parent.mod_FrontGlassColor;
    }
    // ###############################################################
    // ################### END CUSTOM SCRIPTS ########################
    // ###############################################################
  ...
  checkAttributes() {
    ...
    if (this.#pa_BomId === undefined) {
      logError('Attribute pa_BomId not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_BtmColor === undefined) {
      logError('Attribute pa_BtmColor not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackColor === undefined) {
      logError('Attribute pa_EdgeBackColor not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackType === undefined) {
      logError('Attribute pa_EdgeBackType not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      logError('Attribute pa_EdgeFrontColor not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontType === undefined) {
      logError('Attribute pa_EdgeFrontType not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeJointType === undefined) {
      logError('Attribute pa_EdgeJointType not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftColor === undefined) {
      logError('Attribute pa_EdgeLeftColor not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftType === undefined) {
      logError('Attribute pa_EdgeLeftType not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightColor === undefined) {
      logError('Attribute pa_EdgeRightColor not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightType === undefined) {
      logError('Attribute pa_EdgeRightType not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_GrainDirection === undefined) {
      logError('Attribute pa_GrainDirection not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_Program === undefined) {
      logError('Attribute pa_Program not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_TopColor === undefined) {
      logError('Attribute pa_TopColor not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_Weight === undefined) {
      logError('Attribute pa_Weight not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrameFillingMaterial === undefined) {
      logError('Attribute pa_FrameFillingMaterial not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrameFillingThk === undefined) {
      logError('Attribute pa_FrameFillingThk not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FramePartsWidthHor === undefined) {
      logError('Attribute pa_FramePartsWidthHor not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FramePartsWidthVert === undefined) {
      logError('Attribute pa_FramePartsWidthVert not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_PanelWoodFrameType === undefined) {
      logError('Attribute pa_PanelWoodFrameType not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FlipliftType === undefined) {
      logError('Attribute pa_FlipliftType not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_AdditionalInfo1 === undefined) {
      logError('Attribute pa_AdditionalInfo1 not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrameFillingWoodColor === undefined) {
      logError('Attribute pa_FrameFillingWoodColor not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrontGlassColor === undefined) {
      logError('Attribute pa_FrontGlassColor not set in part part_FlipliftPanelWoodFrame (id: ' + this._id + ')');
    }
  ...
  createBomElements() {
    ...
    const partSelf = this;
      ...
      if (partSelf._g?.basic_CreateBom == 'Library') { // ####################### CUSTOM SCRIPTS ########################
        ...
        const _bom = new class BOM205 extends BOM_ElementType_bomout_Group {
          constructor() { super(partSelf); }
          set(partSelf: IP_part_FlipliftPanelWoodFrame_PartVarsReadOnly) {
            const part = partSelf;
...
//====================================================================
  ...
  GlobalFunc.process_PanelWoodFrameBom(this, part, part.pa_BomId)
             // ################### END CUSTOM SCRIPTS ########################
            internal_leaveBomPartMasterDataElements();
          }
        }
        _bom._description = "Output Parts / Boards for panel wood frame";
        _bom.set(partSelf);
  ...
  override createBomTouchElements(touch: PartTouch, partNext: PartBase, posRel: CollisionDataRel) {
      try {
      // ncout_Group: 526: part_HandleDrill FromFront
    if (touch == PartTouch.FromFront && partNext instanceof P_part_HandleDrill) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          ...
          const _bom = new class BOMT526 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_FlipliftPanelWoodFrame_PartVarsReadOnly, touch: PartTouch, part2: IP_part_HandleDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
...
GlobalFunc.ncout_HandleDrill(this, partSelf, part2, posRel)
      ...
      try {
      // ncout_Group: 527: part_HingeDrill FromBack
    if (touch == PartTouch.FromBack && partNext instanceof P_part_HingeDrill) {
        let part2 = <P_part_HingeDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT527 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_FlipliftPanelWoodFrame_PartVarsReadOnly, touch: PartTouch, part2: IP_part_HingeDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//====================================================================
  ...
  //====================================================================
  // For each drilling (insert the drillings) Top side
  //====================================================================

  if (posRel.y > partSelf._dimy / 2) {
    ...
    drillings.forEach(x => {
      ...
      DrillVert.nc_XA= posRel.x + x.YA - insertPoint.GraphicLibrary.PartOffsetX;
      DrillVert.nc_YA = partSelf._dimy - (posRel.y - part2.pa_DrillDistance + insertPoint.InsertionPointY - x.XA + insertPoint.GraphicLibrary.PartOffsetY);
      ...
      // Add drawing
      let drilling01 = partSelf.add3DElement('Drilling01', DrillVert, posRel.x + x.YA - insertPoint.GraphicLibrary.PartOffsetX, posRel.y - part2.pa_DrillDistance + insertPoint.InsertionPointY - x.XA + insertPoint.GraphicLibrary.PartOffsetY, 0, x.DU, x.DU, x.TI );
      drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'z');
    });
  }

  //====================================================================
  // For each drilling (insert the drillings) Bottom side
  //====================================================================
    ...
    drillings.forEach(x => {
      ...
      let DrillVert = this.addncout_DrillVert();
      DrillVert.nc_TOOL = "102";
      DrillVert.nc_XA = posRel.x + x.YA + insertPoint.InsertionPointY + insertPoint.GraphicLibrary.PartOffsetY;
      DrillVert.nc_YA = partSelf._dimy - (part2.pa_DrillDistance + insertPoint.InsertionPointX + x.XA + insertPoint.GraphicLibrary.PartOffsetX);
      DrillVert.nc_TI = x.TI;
      DrillVert.nc_DU = x.DU;
      ...
      // Add drawing
      let drilling01 = partSelf.add3DElement('Drilling01', DrillVert, posRel.x + x.YA + insertPoint.InsertionPointY + insertPoint.GraphicLibrary.PartOffsetY, part2.pa_DrillDistance + insertPoint.InsertionPointX + x.XA + insertPoint.GraphicLibrary.PartOffsetX, 0, x.DU, x.DU, x.TI);
      drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU / 2 + '" /></svg>', 'z');
    });
  }
               // ################### END CUSTOM SCRIPTS ########################
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Drillings for Hinges";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 528: part_PushtoopenDrill FromBack
    if (touch == PartTouch.FromBack && partNext instanceof P_part_PushtoopenDrill) {
        let part2 = <P_part_PushtoopenDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT528 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_FlipliftPanelWoodFrame_PartVarsReadOnly, touch: PartTouch, part2: IP_part_PushtoopenDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
               // ####################### CUSTOM SCRIPTS ########################
GlobalFunc.ops_PushtoopenDrill('Front', this, partSelf, part2, posRel);
               // ################### END CUSTOM SCRIPTS ########################
              internal_leaveBomPartMasterDataTouches();
            }
          }
      ...
      try {
      // ncout_Group: 529: part_PushtoopenMountingPlateDrill FromBack
    if (touch == PartTouch.FromBack && partNext instanceof P_part_PushtoopenMountingPlateDrill) {
        let part2 = <P_part_PushtoopenMountingPlateDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT529 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_FlipliftPanelWoodFrame_PartVarsReadOnly, touch: PartTouch, part2: IP_part_PushtoopenMountingPlateDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
GlobalFunc.ops_PushtoopenDrill('Front', this, partSelf, part2, posRel);
      ...
      try {
      // ncout_Group: 531: part_FlipliftHardwareFrontpanelDrilling FromBack
    if (touch == PartTouch.FromBack && partNext instanceof P_part_FlipliftHardwareFrontpanelDrilling) {
        let part2 = <P_part_FlipliftHardwareFrontpanelDrilling>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT531 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_FlipliftPanelWoodFrame_PartVarsReadOnly, touch: PartTouch, part2: IP_part_FlipliftHardwareFrontpanelDrilling_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
processings.forEach((processing) => {
  if(processing.ProcessingLibrary == 'DrillVertical'){
    let foundDrillings = GlobalFunc.find_HardwareDrillVertLibrary(processing.ProcessingId!, 'Front');
...
{  
  ...
  // Add drawing
  let drilling01 = partSelf.add3DElement('Drilling01', DrillVert, PosX, PosY, PosZ, x.DU, x.DU, x.TI );
  drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'z');
})
               // ################### END CUSTOM SCRIPTS ########################
              internal_leaveBomPartMasterDataTouches();
      ...
      try {
      // ncout_Group: 533: part_HingeDrillFHF FromBack
    if (touch == PartTouch.FromBack && partNext instanceof P_part_HingeDrillFHF) {
        let part2 = <P_part_HingeDrillFHF>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT533 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_FlipliftPanelWoodFrame_PartVarsReadOnly, touch: PartTouch, part2: IP_part_HingeDrillFHF_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
               // ####################### CUSTOM SCRIPTS ########################
if (posRel.y > 0) { // If the posRel.y is bigger than 0 then it's the bottom door and we insert the 35 mm drill (front)
    //====================================================================
    // Get data for drillings and rotation
    //====================================================================
    ...
    drillings.forEach(x => {
      ...
      DrillVert.nc_TOOL = "102";
      DrillVert.nc_XA = posRel.x + x.YA + insertPoint.InsertionPointY + insertPoint.GraphicLibrary.PartOffsetY;
      DrillVert.nc_YA = partSelf._dimy - (partSelf._dimy - part2.pa_DrillDistance - insertPoint.InsertionPointX - x.XA - insertPoint.GraphicLibrary.PartOffsetX);
      DrillVert.nc_TI = x.TI;
      DrillVert.nc_DU = x.DU;
      ...
      // Add drawing
      let drilling01 = partSelf.add3DElement('Drilling01', DrillVert, posRel.x + x.YA + insertPoint.InsertionPointY + insertPoint.GraphicLibrary.PartOffsetY, partSelf._dimy - part2.pa_DrillDistance - insertPoint.InsertionPointX - x.XA - insertPoint.GraphicLibrary.PartOffsetX, 0, x.DU, x.DU, x.TI);
      drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU / 2 + '" /></svg>', 'z');
    });
  }
  else { // If the posRel.y is smaller than 0 then it's the top door and we insert the mounting plate drills (Carcase)
    //====================================================================
    // Get data for drillings and rotation
    //====================================================================
    ...
    {  
      ...
      DrillVert.nc_YA = partSelf._dimy - ( insertPoint.InsertionPointZ + x.XA);
      DrillVert.nc_TI=x.TI;
      DrillVert.nc_DU=x.DU;
      ...
      // Add drawing
      let drilling01 = partSelf.add3DElement('Drilling01', DrillVert, posRel.x + insertPoint.InsertionPointY + x.YA,  insertPoint.InsertionPointZ + x.XA, 0, x.DU, x.DU, x.TI );
      drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'z');
    });
  }
               // ################### END CUSTOM SCRIPTS ########################
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Drillings for central hinge in FHF";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
  ...
  override createBomTouchElementsEnd() : void { 
      try {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT537 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_FlipliftPanelWoodFrame_PartVarsReadOnly) {
              internal_enterBomPartMasterDataTouchesEnd(partSelf._id, partSelf._partId);
               // ####################### CUSTOM SCRIPTS ########################
// Call the function to show the drillings in the graphic
  GlobalFunc.process_FrameFrontGraphicDrilling(this, partSelf);
               // ################### END CUSTOM SCRIPTS ########################
              internal_leaveBomPartMasterDataTouches();
            }
          }
          _bom._parentId = partSelf._id;
          _bom._description = "Show the dowels in the graphics for the frames";
          _bom.set(partSelf);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
  ...
  get pa_FrontConstructionInfo(): cto_tab_FrontConstruction|undefined { return this.#pa_FrontConstructionInfo; }
  set pa_FrontConstructionInfo(val:cto_tab_FrontConstruction|undefined) { this.#pa_FrontConstructionInfo = val; }
  #pa_FrontConstructionInfo?: cto_tab_FrontConstruction;
  ...
  #pa_TopColor?: string;
  get pa_Weight(): number { return this.#pa_Weight!; }
  set pa_Weight(val:number) { this.#pa_Weight = val; }
  #pa_Weight?: number;
  get pa_FrameFillingMaterial(): string { return this.#pa_FrameFillingMaterial!; }
  set pa_FrameFillingMaterial(val:string) { this.#pa_FrameFillingMaterial = val; }
  #pa_FrameFillingMaterial?: string;
  get pa_FrameFillingThk(): number { return this.#pa_FrameFillingThk!; }
  set pa_FrameFillingThk(val:number) { this.#pa_FrameFillingThk = val; }
  #pa_FrameFillingThk?: number;
  get pa_FramePartsWidthHor(): number { return this.#pa_FramePartsWidthHor!; }
  set pa_FramePartsWidthHor(val:number) { this.#pa_FramePartsWidthHor = val; }
  #pa_FramePartsWidthHor?: number;
  get pa_FramePartsWidthVert(): number { return this.#pa_FramePartsWidthVert!; }
  set pa_FramePartsWidthVert(val:number) { this.#pa_FramePartsWidthVert = val; }
  #pa_FramePartsWidthVert?: number;
  get pa_PanelWoodFrameType(): string { return this.#pa_PanelWoodFrameType!; }
  set pa_PanelWoodFrameType(val:string) { this.#pa_PanelWoodFrameType = val; }
  #pa_PanelWoodFrameType?: string;
  get pa_FlipliftType(): string { return this.#pa_FlipliftType!; }
  set pa_FlipliftType(val:string) { this.#pa_FlipliftType = val; }
  #pa_FlipliftType?: string;
  ...
  get pa_FrameFillingWoodColor(): string { return this.#pa_FrameFillingWoodColor!; }
  set pa_FrameFillingWoodColor(val:string) { this.#pa_FrameFillingWoodColor = val; }
  #pa_FrameFillingWoodColor?: string;
  get pa_FrontGlassColor(): string { return this.#pa_FrontGlassColor!; }
  set pa_FrontGlassColor(val:string) { this.#pa_FrontGlassColor = val; }
  #pa_FrontGlassColor?: string;
}
