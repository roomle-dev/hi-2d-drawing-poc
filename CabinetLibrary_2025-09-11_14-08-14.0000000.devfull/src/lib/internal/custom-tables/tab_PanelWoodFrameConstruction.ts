...
export interface cti_tab_PanelWoodFrameConstruction {
  readonly in_PartGroup? : string;
  readonly in_FrontConstructionId? : string;
  readonly in_FrontColorGrainGroupId? : string;
  readonly in_FillingColorGrainGroupId? : string;
}

export interface ctm_tab_PanelWoodFrameConstruction {
}

export interface cto_tab_PanelWoodFrameConstruction extends ctm_tab_PanelWoodFrameConstruction {
  readonly _id : number;
  readonly InHouseProduction? : boolean;
  readonly FrameType? : string;
  readonly FramePartsWidthHor : number;
  readonly FramePartsWidthVert : number;
  readonly FramePartsThk : number;
  readonly FrameFillingType? : string;
  readonly FrameFillingThk : number;
  readonly Weight : number;
  readonly FrameHorGrainDirection? : string;
  readonly FrameVertGrainDirection? : string;
  readonly FillingGrainDirection? : string;
}

export interface ICT_tab_PanelWoodFrameConstruction
extends cti_tab_PanelWoodFrameConstruction, cto_tab_PanelWoodFrameConstruction {}

export class ct2_tab_PanelWoodFrameConstruction {

public findExactly(
     in_PartGroup: string|undefined,
     in_FrontConstructionId: string|undefined,
     in_FrontColorGrainGroupId: string|undefined,
     in_FillingColorGrainGroupId: string|undefined,
): cto_tab_PanelWoodFrameConstruction | undefined {
  const res = ct_tab_PanelWoodFrameConstruction.find((p) => 
p.in_PartGroup === in_PartGroup
 && p.in_FrontConstructionId === in_FrontConstructionId
 && p.in_FrontColorGrainGroupId === in_FrontColorGrainGroupId
 && p.in_FillingColorGrainGroupId === in_FillingColorGrainGroupId
);
return res;
}

public find(
predicate: (value: cti_tab_PanelWoodFrameConstruction) => boolean
): cto_tab_PanelWoodFrameConstruction | undefined {
  for (let index = 0; index < ct_tab_PanelWoodFrameConstruction.length; index++){
    const element = ct_tab_PanelWoodFrameConstruction[index];
...
export var ct_tab_PanelWoodFrameConstruction :ICT_tab_PanelWoodFrameConstruction[] = [
{
 _id: 1,
 in_PartGroup: "Door",
 in_FrontConstructionId: "ModernFrame01",
 in_FrontColorGrainGroupId: "Grain",
 in_FillingColorGrainGroupId: "Grain",
 InHouseProduction: true,
 FrameType: "Mitre",
 FramePartsWidthHor: 75,
 FramePartsWidthVert: 75,
 FramePartsThk: 19,
 FrameFillingType: "Glass",
 FrameFillingThk: 4,
 Weight: 25,
 FrameHorGrainDirection: "Lengthwise",
 FrameVertGrainDirection: "Crosswise",
 FillingGrainDirection: "Crosswise"
}
,{
 _id: 2,
 in_PartGroup: "Door",
 in_FrontConstructionId: "ModernFrame01",
 in_FrontColorGrainGroupId: "Grain",
 in_FillingColorGrainGroupId: "NoGrain",
 InHouseProduction: true,
 FrameType: "Mitre",
 FramePartsWidthHor: 75,
 FramePartsWidthVert: 75,
 ...
 FrameHorGrainDirection: "Lengthwise",
 FrameVertGrainDirection: "Crosswise",
 FillingGrainDirection: "None"
}
,{
 _id: 3,
 in_PartGroup: "Door",
 in_FrontConstructionId: "ModernFrame01",
 in_FrontColorGrainGroupId: "NoGrain",
 in_FillingColorGrainGroupId: "Grain",
 InHouseProduction: true,
 FrameType: "Mitre",
 FramePartsWidthHor: 75,
 ...
 FrameFillingThk: 4,
 Weight: 25,
 FrameHorGrainDirection: "None",
 FrameVertGrainDirection: "None",
 FillingGrainDirection: "Crosswise"
}
,{
 _id: 4,
...
,{
 ...
 FramePartsWidthVert: 75,
 FramePartsThk: 19,
 FrameFillingType: "Wood",
 FrameFillingThk: 8,
 Weight: 18.25,
 FrameHorGrainDirection: "Lengthwise",
 FrameVertGrainDirection: "Crosswise",
 FillingGrainDirection: "Lengthwise"
}
,{
 _id: 6,
 in_PartGroup: "Door",
