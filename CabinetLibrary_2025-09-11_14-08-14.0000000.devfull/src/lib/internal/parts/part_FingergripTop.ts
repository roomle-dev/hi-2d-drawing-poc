...
export interface IP_part_FingergripTop_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_Fingergrip01;
}

export interface IP_part_FingergripTop_PartVarsWritable extends IP_part_FingergripTop_PartVarsReadOnly {
}

export class P_part_FingergripTop extends PartBase implements IP_part_FingergripTop_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Fingergrip01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_FingergripTop', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
