...
//#region Imports
import { cbp_mc_CornerunitStraight01, dc_mc_CornerunitStraight01, adc_mc_CornerunitStraight01 } from '../internal/modules/mc_CornerunitStraight01'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_Panelblind01, OD_M_mc_Panelblind01 } from '../internal/modules/mc_Panelblind01'
...
export function mc_CornerunitStraight01_createBuildPlan(this: cbp_mc_CornerunitStraight01):void {
  internal_enterModuleCreateBuildPlan('mc_CornerunitStraight01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_CornerunitStraight01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_CornerunitStraight01_afterDataCompletion(this: adc_mc_CornerunitStraight01):void {
  internal_enterModuleAfterDataCompletion('mc_CornerunitStraight01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_CornerunitStraight01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_CornerunitStraight01_manufacturerDataCompletion(this: dc_mc_CornerunitStraight01):void {
  internal_enterModuleManufacturerDataCompletion('mc_CornerunitStraight01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_CornerunitStraight01_MANUFACTURERDATACOMPLETION
