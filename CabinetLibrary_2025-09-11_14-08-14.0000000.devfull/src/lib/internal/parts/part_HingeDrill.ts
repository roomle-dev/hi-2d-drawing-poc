...
export interface IP_part_HingeDrill_PartVarsReadOnly extends IPartBase {
...
export interface IP_part_HingeDrill_PartVarsWritable extends IP_part_HingeDrill_PartVarsReadOnly {
...
export class P_part_HingeDrill extends PartBase implements IP_part_HingeDrill_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Hinge01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_HingeDrill', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  ...
  checkAttributes() {
    ...
    if (this.#pa_Model3DGroupName === undefined) {
      logError('Attribute pa_Model3DGroupName not set in part part_HingeDrill (id: ' + this._id + ')');
    }
    if (this.#pa_FrontOverlay === undefined) {
      logError('Attribute pa_FrontOverlay not set in part part_HingeDrill (id: ' + this._id + ')');
    }
    if (this.#pa_DrillDistance === undefined) {
      logError('Attribute pa_DrillDistance not set in part part_HingeDrill (id: ' + this._id + ')');
    }
    if (this.#pa_Model3DGroupName2 === undefined) {
      logError('Attribute pa_Model3DGroupName2 not set in part part_HingeDrill (id: ' + this._id + ')');
    }
    if (this.#pa_ProcessingId === undefined) {
      logError('Attribute pa_ProcessingId not set in part part_HingeDrill (id: ' + this._id + ')');
    }
    if (this.#pa_ProcessingId2 === undefined) {
      logError('Attribute pa_ProcessingId2 not set in part part_HingeDrill (id: ' + this._id + ')');
    }
    if (this.#pa_FrontGapCarcase === undefined) {
      logError('Attribute pa_FrontGapCarcase not set in part part_HingeDrill (id: ' + this._id + ')');
    }
    if (this.#pa_HingeGapCarcase === undefined) {
      logError('Attribute pa_HingeGapCarcase not set in part part_HingeDrill (id: ' + this._id + ')');
    }
