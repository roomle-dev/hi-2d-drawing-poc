...
import { IPartParentsNonNull_mc_ShelffixedGroup01_mc_StorageunitShelffixed01 } from '../mod-interfaces'

export interface IP_part_Shelffixed_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_ShelffixedGroup01_mc_StorageunitShelffixed01;
  ...
  get pa_CarcasePartConnectionBackHor(): string;
...
export interface IP_part_Shelffixed_PartVarsWritable extends IP_part_Shelffixed_PartVarsReadOnly {
  set pa_HardwareColor(value: string);
  set pa_TypeElement(value: string);
  set pa_ParentName(value: string);
  set pa_CarcasePartConnectionBackHor(value: string);
...
export class P_part_Shelffixed extends PartBase implements IP_part_Shelffixed_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_ShelffixedGroup01_mc_StorageunitShelffixed01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_Shelffixed', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XZY';
  }
  parent: IPartParentsNonNull_mc_ShelffixedGroup01_mc_StorageunitShelffixed01; // module which created this part
  ...
  res.set('pa_CarcasePartConnectionBackHor', this.#pa_CarcasePartConnectionBackHor);
  ...
  setAttributes() {
    ...
    if (this.#pa_CarcasePartConnectionBackHor === undefined) {
      this.pa_CarcasePartConnectionBackHor = this.parent.mod_CarcasePartConnectionBackHor;
    }
    ...
    if (this.#pa_BtmColor === undefined) {
      this.pa_BtmColor = this.parent.mod_CarcaseColor;
    }
  ...
  checkAttributes() {
    ...
    if (this.#pa_HardwareQty1 === undefined) {
      logError('Attribute pa_HardwareQty1 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareQty2 === undefined) {
      logError('Attribute pa_HardwareQty2 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareQty3 === undefined) {
      logError('Attribute pa_HardwareQty3 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareQty4 === undefined) {
      logError('Attribute pa_HardwareQty4 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareQty5 === undefined) {
      logError('Attribute pa_HardwareQty5 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier1 === undefined) {
      logError('Attribute pa_HardwareSupplier1 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier2 === undefined) {
      logError('Attribute pa_HardwareSupplier2 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier3 === undefined) {
      logError('Attribute pa_HardwareSupplier3 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier4 === undefined) {
      logError('Attribute pa_HardwareSupplier4 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier5 === undefined) {
      logError('Attribute pa_HardwareSupplier5 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle1 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle1 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle2 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle2 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle3 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle3 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle4 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle4 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle5 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle5 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareColor === undefined) {
      logError('Attribute pa_HardwareColor not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_TypeElement === undefined) {
      logError('Attribute pa_TypeElement not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_ParentName === undefined) {
      logError('Attribute pa_ParentName not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_CarcasePartConnectionBackHor === undefined) {
      logError('Attribute pa_CarcasePartConnectionBackHor not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_CarcasePartConnectionRightHor === undefined) {
      logError('Attribute pa_CarcasePartConnectionRightHor not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_CarcasePartConnectionLeftHor === undefined) {
      logError('Attribute pa_CarcasePartConnectionLeftHor not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionRightHor === undefined) {
      logError('Attribute pa_FittingConnectionRightHor not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionLeftHor === undefined) {
      logError('Attribute pa_FittingConnectionLeftHor not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_TopColor === undefined) {
      logError('Attribute pa_TopColor not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_BtmColor === undefined) {
      logError('Attribute pa_BtmColor not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      logError('Attribute pa_EdgeFrontColor not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftColor === undefined) {
      logError('Attribute pa_EdgeLeftColor not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackColor === undefined) {
      logError('Attribute pa_EdgeBackColor not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightColor === undefined) {
      logError('Attribute pa_EdgeRightColor not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontType === undefined) {
      logError('Attribute pa_EdgeFrontType not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftType === undefined) {
      logError('Attribute pa_EdgeLeftType not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackType === undefined) {
      logError('Attribute pa_EdgeBackType not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightType === undefined) {
      logError('Attribute pa_EdgeRightType not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeJointType === undefined) {
      logError('Attribute pa_EdgeJointType not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_GrainDirection === undefined) {
      logError('Attribute pa_GrainDirection not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_Program === undefined) {
      logError('Attribute pa_Program not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_BomId === undefined) {
      logError('Attribute pa_BomId not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_CarcasePartConnectionBtmVert === undefined) {
      logError('Attribute pa_CarcasePartConnectionBtmVert not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_CarcasePartConnectionTopVert === undefined) {
      logError('Attribute pa_CarcasePartConnectionTopVert not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionTopVert === undefined) {
      logError('Attribute pa_FittingConnectionTopVert not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionBtmVert === undefined) {
      logError('Attribute pa_FittingConnectionBtmVert not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_AdditionalInfo1 === undefined) {
      logError('Attribute pa_AdditionalInfo1 not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_ColorGrainGroup === undefined) {
      logError('Attribute pa_ColorGrainGroup not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_ProgramGrainGroup === undefined) {
      logError('Attribute pa_ProgramGrainGroup not set in part part_Shelffixed (id: ' + this._id + ')');
    }
    if (this.#pa_GrainLogic === undefined) {
      logError('Attribute pa_GrainLogic not set in part part_Shelffixed (id: ' + this._id + ')');
    }
  ...
  createBomElements() {
    ...
    const partSelf = this;
      ...
      if (partSelf._g?.basic_CreateBom == 'Library') { // ####################### CUSTOM SCRIPTS ########################
        ...
        const _bom = new class BOM163 extends BOM_ElementType_bomout_Board {
          constructor() { super(partSelf); }
          set(partSelf: IP_part_Shelffixed_PartVarsReadOnly) {
            const part = partSelf;
...
GlobalFunc.process_BoardBom(this, part, elementType, elementCategory, parentBomId)
  ...
  override createBomTouchElements(touch: PartTouch, partNext: PartBase, posRel: CollisionDataRel) {
      try {
      // ncout_Group: 352: part_Sidepanelleft FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Sidepanelleft) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          ...
          const _bom = new class BOMT352 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelleft_PartVarsReadOnly, posRel:CollisionDataRel) {
...
//
// Description:
// Connection between Shelffixed and Sidepanelleft
// Touch FromLeft
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 353: part_Sidepanelright FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Sidepanelright) {
        let part2 = <P_part_Sidepanelright>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT353 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelright_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//
// Description:
// Connection between Shelffixed and Sidepanelright
// Touch FromRight
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 409: part_Sidepanelmiddle FromBottom
    if (touch == PartTouch.FromBottom && partNext instanceof P_part_Sidepanelmiddle) {
        let part2 = <P_part_Sidepanelmiddle>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT409 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelmiddle_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//
// Description:
// Connection between Shelffixed and Sidepanelmiddle
// Touch FromBottom
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 412: part_Sidepanelmiddle FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_Sidepanelmiddle) {
        let part2 = <P_part_Sidepanelmiddle>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT412 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelmiddle_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 424: part_CleatVert FromBottom
    if (touch == PartTouch.FromBottom && partNext instanceof P_part_CleatVert) {
        let part2 = <P_part_CleatVert>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT424 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_CleatVert_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//
// Description:
// Connection between Shelffixed and CleatVert
// Touch FromBottom
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with cleat vert from bottom";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 425: part_CleatVert FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_CleatVert) {
        let part2 = <P_part_CleatVert>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT425 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_CleatVert_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with cleat vert from top";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 448: part_PushtoopenDrill FromFront
    if (touch == PartTouch.FromFront && partNext instanceof P_part_PushtoopenDrill) {
        let part2 = <P_part_PushtoopenDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT448 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_PushtoopenDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
GlobalFunc.ops_PushtoopenDrill('Carcase', this, partSelf, part2, posRel);
      ...
      try {
      // ncout_Group: 454: part_PushtoopenMountingPlateDrill FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_PushtoopenMountingPlateDrill) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT454 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_PushtoopenMountingPlateDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
GlobalFunc.ops_PushtoopenDrill('Carcase', this, partSelf, part2, posRel);
      ...
      try {
      // ncout_Group: 460: part_PushtoopenMountingPlateDrill FromBottom
    if (touch == PartTouch.FromBottom && partNext instanceof P_part_PushtoopenMountingPlateDrill) {
        let part2 = <P_part_PushtoopenMountingPlateDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT460 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_PushtoopenMountingPlateDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
GlobalFunc.ops_PushtoopenDrill('Carcase', this, partSelf, part2, posRel);
      ...
      try {
      // ncout_Group: 482: part_Panelblind FromBottom
    if (touch == PartTouch.FromBottom && partNext instanceof P_part_Panelblind) {
        let part2 = <P_part_Panelblind>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT482 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Panelblind_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//
// Description:
// Connection between Shelffixed and Panel blind
// Touch FromBottom
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 483: part_Panelblind FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_Panelblind) {
        let part2 = <P_part_Panelblind>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT483 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Panelblind_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 505: part_HingeDrill FromBottom
    if (touch == PartTouch.FromBottom && partNext instanceof P_part_HingeDrill) {
        let part2 = <P_part_HingeDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT505 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_HingeDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//====================================================================
  ...
  {  
    ...
    drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'y');
      ...
      try {
      // ncout_Group: 506: part_HingeDrill FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_HingeDrill) {
        let part2 = <P_part_HingeDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT506 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_HingeDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
//====================================================================
  ...
  {  
    ...
    drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'y');
      ...
      try {
      // ncout_Group: 521: part_FlipliftHardwareSidepanelDrilling FromBottom
    if (touch == PartTouch.FromBottom && partNext instanceof P_part_FlipliftHardwareSidepanelDrilling) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT521 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_FlipliftHardwareSidepanelDrilling_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//====================================================================
  ...
  drillings.forEach(x => {
    ...
    drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU / 2 + '" /></svg>', 'y');
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with the filplift fittings";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 575: part_Backwall Collision
    if (touch == PartTouch.Collision && partNext instanceof P_part_Backwall) {
        let part2 = <P_part_Backwall>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT575 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Backwall_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
               // ####################### CUSTOM SCRIPTS ########################
GlobalFunc.ops_BackwallGroove(this, partSelf, part2, posRel, 'BackwallGrooveShelffixed', 'Horizontal');
               // ################### END CUSTOM SCRIPTS ########################
              internal_leaveBomPartMasterDataTouches();
            }
          }
      ...
      try {
      // ncout_Group: 597: part_Sidepanelmiddle FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Sidepanelmiddle) {
        let part2 = <P_part_Sidepanelmiddle>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT597 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelmiddle_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 598: part_Sidepanelmiddle FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Sidepanelmiddle) {
        let part2 = <P_part_Sidepanelmiddle>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT598 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Shelffixed_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Sidepanelmiddle_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  get pa_CarcasePartConnectionBackHor(): string { return this.#pa_CarcasePartConnectionBackHor!; }
  set pa_CarcasePartConnectionBackHor(val:string) { this.#pa_CarcasePartConnectionBackHor = val; }
  #pa_CarcasePartConnectionBackHor?: string;
