...
export interface adc_mf_Drawer extends IModBaseProp
, IModVarNonNull_mod_BackwallPos, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontSplit, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_HandleDrill, IModVarNonNull_mod_HandleLine, IModVarNonNull_mod_HandlePosLogic, IModVarNonNull_mod_FrontQtyElements, IModVarNonNull_mod_ShelffixedType, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_DrawerBoxColor, IModVarNonNull_mod_DrawerBoxDepthType, IModVarNonNull_mod_DrawerBoxHeightType, IModVarNonNull_mod_DrawerBoxOffsetDepth, IModVarNonNull_mod_DrawerBoxProgram, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontSplitHeight1, IModVarNonNull_mod_FrontSplitHeight2, IModVarNonNull_mod_FrontSplitHeight3, IModVarNonNull_mod_FrontSplitType1, IModVarNonNull_mod_FrontSplitType2, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_HandleLength, IModVarNonNull_mod_HandleOffsetX, IModVarNonNull_mod_HandleOffsetY, IModVarNonNull_mod_HandlePosMatrix, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HandlestripPos, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_ShelffixedBtm, IModVarNonNull_mod_ShelffixedPos, IModVarNonNull_mod_ShelffixedOffsetFront, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_ShelffixedOversizeFront, IModVarNonNull_mod_ShelffixedOversizeBack, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_CarcaseBackwallConstruction, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_DrawerBoxWeightType, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_DrawerBoxDesign, IModVarNonNull_mod_ShelffixedTop, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_DrawerType, IModVarNonNull_mod_SidepanelmiddleThk, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_PanelWoodFrameType, IModVarNonNull_mod_FramePartsWidthHor, IModVarNonNull_mod_FramePartsWidthVert, IModVarNonNull_mod_PanelWoodFrameFillingType, IModVarNonNull_mod_FrontHeightSelection, IModVarNonNull_mod_FrameFillingWoodColor, IModVarNonNull_mod_FrontGlassColor, IModVarNonNull_mod_DrawerOpeningDistance, IModVarNonNull_mod_FrameFillingColor {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  addOD_M_mc_Drawer01(index?: number): dc_mc_Drawer01;
...
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
      // CUSTOMSCRIPT_mf_Drawer_mod_FrontWidth_SETDEFAULT
      this.mod_FrontWidth = this.mod_DrawerType! == 'Single' ? this.parent.mod_Width! : this.parent.mod_Width! / 2;;
// ###############################################################
// ################### END CUSTOM SCRIPTS ########################
// ###############################################################
    }
    if (this.mod_DrawerBoxColor === undefined) {
      this.mod_DrawerBoxColor = this.g.basic_DrawerBoxColor;
    }
    if (this.mod_DrawerBoxDepthType === undefined) {
      this.mod_DrawerBoxDepthType = this.g.basic_DrawerBoxDepthType;
    }
    if (this.mod_DrawerBoxHeightType === undefined) {
      this.mod_DrawerBoxHeightType = this.g.basic_DrawerBoxHeightType;
    }
    if (this.mod_DrawerBoxOffsetDepth === undefined) {
      this.mod_DrawerBoxOffsetDepth = this.g.basic_DrawerBoxOffsetDepth;
    }
    if (this.mod_DrawerBoxProgram === undefined) {
      this.mod_DrawerBoxProgram = this.g.basic_DrawerBoxProgram;
    }
...
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
      // CUSTOMSCRIPT_mf_Drawer_mod_DrawerOpeningDistance_SETDEFAULT
      this.mod_DrawerOpeningDistance = this.parent.mod_Depth! - 50;
// ###############################################################
// ################### END CUSTOM SCRIPTS ########################
// ###############################################################
    }
  ...
  #manufacturerDataCompletionInternal = mf_Drawer_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mf_Drawer_NonNull(this);
  ...
  addOD_M_mc_Drawer01(index?: number): dc_mc_Drawer01 {
    var m = new OD_M_mc_Drawer01(this);
    m.dataCompletion();
  ...
  override createBuildPlan():void {
    var cbp = new OD_M_mf_Drawer_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mf_Drawer_NonNull implements cbp_mf_Drawer, adc_mf_Drawer ,IPartParentsNonNull_mf_Drawer {
  constructor(parent: OD_M_mf_Drawer) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mf_Drawer;
  ...
  #createBuildPlanInternal = mf_Drawer_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mf_Drawer_afterDataCompletion;
  ...
  addOD_M_mc_Drawer01(index?: number): dc_mc_Drawer01 {
    return this.#internalParent.addOD_M_mc_Drawer01(index);
  }
}
