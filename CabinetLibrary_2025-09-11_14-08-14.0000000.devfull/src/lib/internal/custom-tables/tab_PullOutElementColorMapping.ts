...
export interface cti_tab_PullOutElementColorMapping {
  readonly in_HardwareColor? : string;
  readonly in_PullOutType? : string;
  readonly in_PullOutDesign? : string;
}

export interface ctm_tab_PullOutElementColorMapping {
}

export interface cto_tab_PullOutElementColorMapping extends ctm_tab_PullOutElementColorMapping {
  readonly _id : number;
  readonly PullOutColor? : string;
}

export interface ICT_tab_PullOutElementColorMapping
extends cti_tab_PullOutElementColorMapping, cto_tab_PullOutElementColorMapping {}

export class ct2_tab_PullOutElementColorMapping {

public findExactly(
     in_HardwareColor: string|undefined,
     in_PullOutType: string|undefined,
     in_PullOutDesign: string|undefined,
): cto_tab_PullOutElementColorMapping | undefined {
  const res = ct_tab_PullOutElementColorMapping.find((p) => 
...
public find(
predicate: (value: cti_tab_PullOutElementColorMapping) => boolean
): cto_tab_PullOutElementColorMapping | undefined {
  for (let index = 0; index < ct_tab_PullOutElementColorMapping.length; index++){
    const element = ct_tab_PullOutElementColorMapping[index];
...
export var ct_tab_PullOutElementColorMapping :ICT_tab_PullOutElementColorMapping[] = [
{
 _id: 1,
