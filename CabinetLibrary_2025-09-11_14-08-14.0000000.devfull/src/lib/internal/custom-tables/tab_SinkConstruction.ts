...
export interface cti_tab_SinkConstruction {
  readonly in_ConstructionId? : string;
}

export interface ctm_tab_SinkConstruction {
}

export interface cto_tab_SinkConstruction extends ctm_tab_SinkConstruction {
  readonly _id : number;
  readonly CutWidth : number;
  readonly CutDepth : number;
  readonly CutRadius : number;
  readonly BlockWdt : number;
  readonly OffsetBlock : number;
  readonly PosTabWdt : number;
  readonly PosTabDpt : number;
  readonly PosTabHgt : number;
}

export interface ICT_tab_SinkConstruction
extends cti_tab_SinkConstruction, cto_tab_SinkConstruction {}

export class ct2_tab_SinkConstruction {

public findExactly(
     in_ConstructionId: string|undefined,
): cto_tab_SinkConstruction | undefined {
  const res = ct_tab_SinkConstruction.find((p) => 
...
public find(
predicate: (value: cti_tab_SinkConstruction) => boolean
): cto_tab_SinkConstruction | undefined {
  for (let index = 0; index < ct_tab_SinkConstruction.length; index++){
    const element = ct_tab_SinkConstruction[index];
...
export var ct_tab_SinkConstruction :ICT_tab_SinkConstruction[] = [
{
 _id: 262,
 in_ConstructionId: "Axis_R",
 CutWidth: 980,
 CutDepth: 490,
 CutRadius: 15,
 BlockWdt: 548.5,
...
,{
 _id: 264,
 in_ConstructionId: "Axia_White_R",
 CutWidth: 980,
 CutDepth: 490,
 CutRadius: 15,
 BlockWdt: 548.5,
...
,{
 _id: 265,
 in_ConstructionId: "Axia_White_L",
 CutWidth: 980,
 CutDepth: 490,
 CutRadius: 15,
 BlockWdt: 548.5,
...
,{
 _id: 268,
 in_ConstructionId: "Axia_Anthrazit_R",
 CutWidth: 980,
 CutDepth: 490,
 CutRadius: 15,
 BlockWdt: 548.5,
...
,{
 _id: 269,
 in_ConstructionId: "Axia_Anthrazit_L",
 CutWidth: 980,
 CutDepth: 490,
 CutRadius: 15,
 BlockWdt: 548.5,
