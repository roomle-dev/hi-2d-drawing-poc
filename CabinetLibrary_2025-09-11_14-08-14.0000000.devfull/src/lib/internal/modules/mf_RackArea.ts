...
import { IModParents_mr_CornerunitStraight_mr_StorageunitSingle } from '../mod-interfaces'
import { OD_M_mc_ShelfadjGroup01, dc_mc_ShelfadjGroup01 } from './mc_ShelfadjGroup01'
import { OD_M_mc_RackArea01, dc_mc_RackArea01 } from './mc_RackArea01'
import { OD_M_mc_ShelffixedGroup01, dc_mc_ShelffixedGroup01 } from './mc_ShelffixedGroup01'
import { IModuleNonNull_mf_RackArea,IModParents_mf_Door_mf_Fliplift_mf_RackArea,IModParents_mf_RackArea,IPartParentsNonNull_mf_Door_mf_Fliplift_mf_RackArea,IPartParentsNonNull_mf_RackArea} from '../mod-interfaces'
import {IModVar_mod_BackwallPos,IModVarNonNull_mod_BackwallPos,IModVar_mod_CarcaseBackwallConstruction,IModVarNonNull_mod_CarcaseBackwallConstruction,IModVar_mod_CarcaseDepth,IModVarNonNull_mod_CarcaseDepth,IModVar_mod_CarcaseHeight,IModVarNonNull_mod_CarcaseHeight,IModVar_mod_CarcaseWidth,IModVarNonNull_mod_CarcaseWidth,IModVar_mod_FrontColor,IModVarNonNull_mod_FrontColor,IModVar_mod_FrontGapCarcase,IModVarNonNull_mod_FrontGapCarcase,IModVar_mod_FrontGapHor,IModVarNonNull_mod_FrontGapHor,IModVar_mod_FrontGapHorTop,IModVarNonNull_mod_FrontGapHorTop,IModVar_mod_FrontGapVert,IModVarNonNull_mod_FrontGapVert,IModVar_mod_FrontProgram,IModVarNonNull_mod_FrontProgram,IModVar_mod_HeightPosInsertion,IModVarNonNull_mod_HeightPosInsertion,IModVar_mod_InteriorEquipmentLogic,IModVarNonNull_mod_InteriorEquipmentLogic,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_ParentName,IModVarNonNull_mod_ParentName,IModVar_mod_PlinthAreaHeight,IModVarNonNull_mod_PlinthAreaHeight,IModVar_mod_ShelffixedThk,IModVarNonNull_mod_ShelffixedThk,IModVar_mod_SidepanelleftThk,IModVarNonNull_mod_SidepanelleftThk,IModVar_mod_SidepanelrightThk,IModVarNonNull_mod_SidepanelrightThk,IModVar_mod_TypeElement,IModVarNonNull_mod_TypeElement,IModVar_mod_CarcaseId,IModVarNonNull_mod_CarcaseId,IModVar_mod_FrontId,IModVarNonNull_mod_FrontId,IModVar_mod_FrontOversizeBtm,IModVarNonNull_mod_FrontOversizeBtm,IModVar_mod_FrontOversizeLeft,IModVarNonNull_mod_FrontOversizeLeft,IModVar_mod_FrontOversizeRight,IModVarNonNull_mod_FrontOversizeRight,IModVar_mod_FrontOversizeTop,IModVarNonNull_mod_FrontOversizeTop,IModVar_mod_FrontPosStart,IModVarNonNull_mod_FrontPosStart,IModVar_mod_FrontThk,IModVarNonNull_mod_FrontThk,IModVar_mod_FrontWidth,IModVarNonNull_mod_FrontWidth,IModVar_mod_Originpos,IModVarNonNull_mod_Originpos,IModVar_mod_ShelfadjDesign,IModVarNonNull_mod_ShelfadjDesign,IModVar_mod_ShelfadjDrillDistance,IModVarNonNull_mod_ShelfadjDrillDistance,IModVar_mod_ShelfadjDrillinglineOffsetBtm,IModVarNonNull_mod_ShelfadjDrillinglineOffsetBtm,IModVar_mod_ShelfadjDrillinglineOffsetTop,IModVarNonNull_mod_ShelfadjDrillinglineOffsetTop,IModVar_mod_ShelfadjDrillType,IModVarNonNull_mod_ShelfadjDrillType,IModVar_mod_ShelfadjOffsetBack,IModVarNonNull_mod_ShelfadjOffsetBack,IModVar_mod_ShelfadjOffsetFront,IModVarNonNull_mod_ShelfadjOffsetFront,IModVar_mod_ShelfadjThk,IModVarNonNull_mod_ShelfadjThk,IModVar_mod_ShelffixedBtm,IModVarNonNull_mod_ShelffixedBtm,IModVar_mod_ShelffixedOffsetFront,IModVarNonNull_mod_ShelffixedOffsetFront,IModVar_mod_ShelffixedOversizeBack,IModVarNonNull_mod_ShelffixedOversizeBack,IModVar_mod_ShelffixedOversizeFront,IModVarNonNull_mod_ShelffixedOversizeFront,IModVar_mod_ShelffixedPos,IModVarNonNull_mod_ShelffixedPos,IModVar_mod_ShelffixedTop,IModVarNonNull_mod_ShelffixedTop,IModVar_mod_ShelffixedType,IModVarNonNull_mod_ShelffixedType,IModVar_mod_FrontHeight,IModVarNonNull_mod_FrontHeight,IModVar_mod_FingergripBtmType,IModVarNonNull_mod_FingergripBtmType,IModVar_mod_FingergripTop,IModVarNonNull_mod_FingergripTop,IModVar_mod_FingergripTopType,IModVarNonNull_mod_FingergripTopType,IModVar_mod_RackAreaType,IModVarNonNull_mod_RackAreaType,IModVar_mod_CarcasePartConnectionLeftHor,IModVarNonNull_mod_CarcasePartConnectionLeftHor,IModVar_mod_CarcasePartConnectionBackHor,IModVarNonNull_mod_CarcasePartConnectionBackHor,IModVar_mod_CarcasePartConnectionRightHor,IModVarNonNull_mod_CarcasePartConnectionRightHor,IModVar_mod_FittingConnectionLeftHor,IModVarNonNull_mod_FittingConnectionLeftHor,IModVar_mod_FittingConnectionRightHor,IModVarNonNull_mod_FittingConnectionRightHor,IModVar_mod_ShelvesBackwallFittingConnection,IModVarNonNull_mod_ShelvesBackwallFittingConnection,IModVar_mod_RackAreaShelftopConstruction,IModVarNonNull_mod_RackAreaShelftopConstruction,IModVar_mod_CarcaseSpaceDimension,IModVarNonNull_mod_CarcaseSpaceDimension,IModVar_mod_FrontHeightSelection,IModVarNonNull_mod_FrontHeightSelection,IModVar_mod_ShelfadjColor,IModVarNonNull_mod_ShelfadjColor,IModVar_mod_ShelfadjDescriptor,IModVarNonNull_mod_ShelfadjDescriptor,IModVar_mod_GrainLogic,IModVarNonNull_mod_GrainLogic} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_BackwallPos, IMatrix_mod_CarcaseBackwallConstruction, IMatrix_mod_CarcaseDepth, IMatrix_mod_CarcaseHeight, IMatrix_mod_CarcaseWidth, IMatrix_mod_FrontColor, IMatrix_mod_FrontGapCarcase, IMatrix_mod_FrontGapHor, IMatrix_mod_FrontGapHorTop, IMatrix_mod_FrontGapVert, IMatrix_mod_FrontProgram, IMatrix_mod_HeightPosInsertion, IMatrix_mod_InteriorEquipmentLogic, IMatrix_mod_ModuleName, IMatrix_mod_ParentName, IMatrix_mod_PlinthAreaHeight, IMatrix_mod_ShelffixedThk, IMatrix_mod_SidepanelleftThk, IMatrix_mod_SidepanelrightThk, IMatrix_mod_TypeElement, IMatrix_mod_CarcaseId, IMatrix_mod_FrontId, IMatrix_mod_FrontOversizeBtm, IMatrix_mod_FrontOversizeLeft, IMatrix_mod_FrontOversizeRight, IMatrix_mod_FrontOversizeTop, IMatrix_mod_FrontPosStart, IMatrix_mod_FrontThk, IMatrix_mod_FrontWidth, IMatrix_mod_ShelfadjDesign, IMatrix_mod_ShelfadjDrillDistance, IMatrix_mod_ShelfadjDrillinglineOffsetBtm, IMatrix_mod_ShelfadjDrillinglineOffsetTop, IMatrix_mod_ShelfadjDrillType, IMatrix_mod_ShelfadjOffsetBack, IMatrix_mod_ShelfadjOffsetFront, IMatrix_mod_ShelfadjThk, IMatrix_mod_ShelffixedBtm, IMatrix_mod_ShelffixedOffsetFront, IMatrix_mod_ShelffixedOversizeBack, IMatrix_mod_ShelffixedOversizeFront, IMatrix_mod_ShelffixedPos, IMatrix_mod_ShelffixedTop, IMatrix_mod_ShelffixedType, IMatrix_mod_FrontHeight, IMatrix_mod_FingergripBtmType, IMatrix_mod_FingergripTop, IMatrix_mod_FingergripTopType, IMatrix_mod_RackAreaType, IMatrix_mod_CarcasePartConnectionLeftHor, IMatrix_mod_CarcasePartConnectionBackHor, IMatrix_mod_CarcasePartConnectionRightHor, IMatrix_mod_FittingConnectionLeftHor, IMatrix_mod_FittingConnectionRightHor, IMatrix_mod_ShelvesBackwallFittingConnection, IMatrix_mod_RackAreaShelftopConstruction, IMatrix_mod_FrontHeightSelection, IMatrix_mod_ShelfadjColor, IMatrix_mod_ShelfadjDescriptor, IMatrix_mod_GrainLogic} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { mf_RackArea_createBuildPlan, mf_RackArea_afterDataCompletion, mf_RackArea_manufacturerDataCompletion } from '../../modules/mf_RackArea';

export interface cbp_mf_RackArea extends IModBaseProp
, IModVarNonNull_mod_BackwallPos, IModVarNonNull_mod_CarcaseBackwallConstruction, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_InteriorEquipmentLogic, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_ShelfadjDesign, IModVarNonNull_mod_ShelfadjDrillDistance, IModVarNonNull_mod_ShelfadjDrillinglineOffsetBtm, IModVarNonNull_mod_ShelfadjDrillinglineOffsetTop, IModVarNonNull_mod_ShelfadjDrillType, IModVarNonNull_mod_ShelfadjOffsetBack, IModVarNonNull_mod_ShelfadjOffsetFront, IModVarNonNull_mod_ShelfadjThk, IModVarNonNull_mod_ShelffixedBtm, IModVarNonNull_mod_ShelffixedOffsetFront, IModVarNonNull_mod_ShelffixedOversizeBack, IModVarNonNull_mod_ShelffixedOversizeFront, IModVarNonNull_mod_ShelffixedPos, IModVarNonNull_mod_ShelffixedTop, IModVarNonNull_mod_ShelffixedType, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_RackAreaType, IModVarNonNull_mod_CarcasePartConnectionLeftHor, IModVarNonNull_mod_CarcasePartConnectionBackHor, IModVarNonNull_mod_CarcasePartConnectionRightHor, IModVarNonNull_mod_FittingConnectionLeftHor, IModVarNonNull_mod_FittingConnectionRightHor, IModVarNonNull_mod_ShelvesBackwallFittingConnection, IModVarNonNull_mod_RackAreaShelftopConstruction, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_FrontHeightSelection, IModVarNonNull_mod_ShelfadjColor, IModVarNonNull_mod_ShelfadjDescriptor, IModVarNonNull_mod_GrainLogic {
  parent: IModParents_mr_CornerunitStraight_mr_StorageunitSingle;
...
export interface dc_mf_RackArea extends IModBaseProp
, IModVar_mod_BackwallPos, IModVar_mod_CarcaseBackwallConstruction, IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseHeight, IModVar_mod_CarcaseWidth, IModVar_mod_FrontColor, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapHorTop, IModVar_mod_FrontGapVert, IModVar_mod_FrontProgram, IModVar_mod_HeightPosInsertion, IModVar_mod_InteriorEquipmentLogic, IModVar_mod_ModuleName, IModVar_mod_ParentName, IModVar_mod_PlinthAreaHeight, IModVar_mod_ShelffixedThk, IModVar_mod_SidepanelleftThk, IModVar_mod_SidepanelrightThk, IModVar_mod_TypeElement, IModVar_mod_CarcaseId, IModVar_mod_FrontId, IModVar_mod_FrontOversizeBtm, IModVar_mod_FrontOversizeLeft, IModVar_mod_FrontOversizeRight, IModVar_mod_FrontOversizeTop, IModVar_mod_FrontPosStart, IModVar_mod_FrontThk, IModVar_mod_FrontWidth, IModVar_mod_Originpos, IModVar_mod_ShelfadjDesign, IModVar_mod_ShelfadjDrillDistance, IModVar_mod_ShelfadjDrillinglineOffsetBtm, IModVar_mod_ShelfadjDrillinglineOffsetTop, IModVar_mod_ShelfadjDrillType, IModVar_mod_ShelfadjOffsetBack, IModVar_mod_ShelfadjOffsetFront, IModVar_mod_ShelfadjThk, IModVar_mod_ShelffixedBtm, IModVar_mod_ShelffixedOffsetFront, IModVar_mod_ShelffixedOversizeBack, IModVar_mod_ShelffixedOversizeFront, IModVar_mod_ShelffixedPos, IModVar_mod_ShelffixedTop, IModVar_mod_ShelffixedType, IModVar_mod_FrontHeight, IModVar_mod_FingergripBtmType, IModVar_mod_FingergripTop, IModVar_mod_FingergripTopType, IModVar_mod_RackAreaType, IModVar_mod_CarcasePartConnectionLeftHor, IModVar_mod_CarcasePartConnectionBackHor, IModVar_mod_CarcasePartConnectionRightHor, IModVar_mod_FittingConnectionLeftHor, IModVar_mod_FittingConnectionRightHor, IModVar_mod_ShelvesBackwallFittingConnection, IModVar_mod_RackAreaShelftopConstruction, IModVar_mod_CarcaseSpaceDimension, IModVar_mod_FrontHeightSelection, IModVar_mod_ShelfadjColor, IModVar_mod_ShelfadjDescriptor, IModVar_mod_GrainLogic {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mf_RackArea;
  parent: IModParents_mr_CornerunitStraight_mr_StorageunitSingle;
  addOD_M_mc_ShelfadjGroup01(index?: number): dc_mc_ShelfadjGroup01;
  addOD_M_mc_RackArea01(index?: number): dc_mc_RackArea01;
  addOD_M_mc_ShelffixedGroup01(index?: number): dc_mc_ShelffixedGroup01;
}

export interface adc_mf_RackArea extends IModBaseProp
, IModVarNonNull_mod_BackwallPos, IModVarNonNull_mod_CarcaseBackwallConstruction, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_InteriorEquipmentLogic, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_ShelfadjDesign, IModVarNonNull_mod_ShelfadjDrillDistance, IModVarNonNull_mod_ShelfadjDrillinglineOffsetBtm, IModVarNonNull_mod_ShelfadjDrillinglineOffsetTop, IModVarNonNull_mod_ShelfadjDrillType, IModVarNonNull_mod_ShelfadjOffsetBack, IModVarNonNull_mod_ShelfadjOffsetFront, IModVarNonNull_mod_ShelfadjThk, IModVarNonNull_mod_ShelffixedBtm, IModVarNonNull_mod_ShelffixedOffsetFront, IModVarNonNull_mod_ShelffixedOversizeBack, IModVarNonNull_mod_ShelffixedOversizeFront, IModVarNonNull_mod_ShelffixedPos, IModVarNonNull_mod_ShelffixedTop, IModVarNonNull_mod_ShelffixedType, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_RackAreaType, IModVarNonNull_mod_CarcasePartConnectionLeftHor, IModVarNonNull_mod_CarcasePartConnectionBackHor, IModVarNonNull_mod_CarcasePartConnectionRightHor, IModVarNonNull_mod_FittingConnectionLeftHor, IModVarNonNull_mod_FittingConnectionRightHor, IModVarNonNull_mod_ShelvesBackwallFittingConnection, IModVarNonNull_mod_RackAreaShelftopConstruction, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_FrontHeightSelection, IModVarNonNull_mod_ShelfadjColor, IModVarNonNull_mod_ShelfadjDescriptor, IModVarNonNull_mod_GrainLogic {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  addOD_M_mc_ShelfadjGroup01(index?: number): dc_mc_ShelfadjGroup01;
...
export class OD_M_mf_RackArea extends OD_Base  implements dc_mf_RackArea
,IModParents_mf_Door_mf_Fliplift_mf_RackArea,IModParents_mf_RackArea
,IModVar_mod_BackwallPos,IModVar_mod_CarcaseBackwallConstruction,IModVar_mod_CarcaseDepth,IModVar_mod_CarcaseHeight,IModVar_mod_CarcaseWidth,IModVar_mod_FrontColor,IModVar_mod_FrontGapCarcase,IModVar_mod_FrontGapHor,IModVar_mod_FrontGapHorTop,IModVar_mod_FrontGapVert,IModVar_mod_FrontProgram,IModVar_mod_HeightPosInsertion,IModVar_mod_InteriorEquipmentLogic,IModVar_mod_ModuleName,IModVar_mod_ParentName,IModVar_mod_PlinthAreaHeight,IModVar_mod_ShelffixedThk,IModVar_mod_SidepanelleftThk,IModVar_mod_SidepanelrightThk,IModVar_mod_TypeElement,IModVar_mod_CarcaseId,IModVar_mod_FrontId,IModVar_mod_FrontOversizeBtm,IModVar_mod_FrontOversizeLeft,IModVar_mod_FrontOversizeRight,IModVar_mod_FrontOversizeTop,IModVar_mod_FrontPosStart,IModVar_mod_FrontThk,IModVar_mod_FrontWidth,IModVar_mod_Originpos,IModVar_mod_ShelfadjDesign,IModVar_mod_ShelfadjDrillDistance,IModVar_mod_ShelfadjDrillinglineOffsetBtm,IModVar_mod_ShelfadjDrillinglineOffsetTop,IModVar_mod_ShelfadjDrillType,IModVar_mod_ShelfadjOffsetBack,IModVar_mod_ShelfadjOffsetFront,IModVar_mod_ShelfadjThk,IModVar_mod_ShelffixedBtm,IModVar_mod_ShelffixedOffsetFront,IModVar_mod_ShelffixedOversizeBack,IModVar_mod_ShelffixedOversizeFront,IModVar_mod_ShelffixedPos,IModVar_mod_ShelffixedTop,IModVar_mod_ShelffixedType,IModVar_mod_FrontHeight,IModVar_mod_FingergripBtmType,IModVar_mod_FingergripTop,IModVar_mod_FingergripTopType,IModVar_mod_RackAreaType,IModVar_mod_CarcasePartConnectionLeftHor,IModVar_mod_CarcasePartConnectionBackHor,IModVar_mod_CarcasePartConnectionRightHor,IModVar_mod_FittingConnectionLeftHor,IModVar_mod_FittingConnectionRightHor,IModVar_mod_ShelvesBackwallFittingConnection,IModVar_mod_RackAreaShelftopConstruction,IModVar_mod_CarcaseSpaceDimension,IModVar_mod_FrontHeightSelection,IModVar_mod_ShelfadjColor,IModVar_mod_ShelfadjDescriptor,IModVar_mod_GrainLogic
 {
  constructor(parent: IModParents_mr_CornerunitStraight_mr_StorageunitSingle, manufacturerMode?:boolean) {
    super('mf_RackArea', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mf_RackArea_NonNull(this);
  }
  parent: IModParents_mr_CornerunitStraight_mr_StorageunitSingle;
  _selfNonNull: OD_M_mf_RackArea_NonNull;

  override variants:string[] = ['mod_BackwallPos','mod_CarcaseBackwallConstruction','mod_CarcaseDepth','mod_CarcaseHeight','mod_CarcaseWidth','mod_FrontColor','mod_FrontGapCarcase','mod_FrontGapHor','mod_FrontGapHorTop','mod_FrontGapVert','mod_FrontProgram','mod_HeightPosInsertion','mod_InteriorEquipmentLogic','mod_ModuleName','mod_ParentName','mod_PlinthAreaHeight','mod_ShelffixedThk','mod_SidepanelleftThk','mod_SidepanelrightThk','mod_TypeElement','mod_CarcaseId','mod_FrontId','mod_FrontOversizeBtm','mod_FrontOversizeLeft','mod_FrontOversizeRight','mod_FrontOversizeTop','mod_FrontPosStart','mod_FrontThk','mod_FrontWidth','mod_Originpos','mod_ShelfadjDesign','mod_ShelfadjDrillDistance','mod_ShelfadjDrillinglineOffsetBtm','mod_ShelfadjDrillinglineOffsetTop','mod_ShelfadjDrillType','mod_ShelfadjOffsetBack','mod_ShelfadjOffsetFront','mod_ShelfadjThk','mod_ShelffixedBtm','mod_ShelffixedOffsetFront','mod_ShelffixedOversizeBack','mod_ShelffixedOversizeFront','mod_ShelffixedPos','mod_ShelffixedTop','mod_ShelffixedType','mod_FrontHeight','mod_FingergripBtmType','mod_FingergripTop','mod_FingergripTopType','mod_RackAreaType','mod_CarcasePartConnectionLeftHor','mod_CarcasePartConnectionBackHor','mod_CarcasePartConnectionRightHor','mod_FittingConnectionLeftHor','mod_FittingConnectionRightHor','mod_ShelvesBackwallFittingConnection','mod_RackAreaShelftopConstruction','mod_CarcaseSpaceDimension','mod_FrontHeightSelection','mod_ShelfadjColor','mod_ShelfadjDescriptor','mod_GrainLogic',];
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mf_RackArea";
    }
    if (this.mod_CarcaseId === undefined) {
    ...
    if (this.mod_CarcasePartConnectionLeftHor === undefined) {
      this.mod_CarcasePartConnectionLeftHor = "SideCShelf";
    }
    if (this.mod_CarcasePartConnectionBackHor === undefined) {
      this.mod_CarcasePartConnectionBackHor = "BackwallCShelf";
    }
    if (this.mod_CarcasePartConnectionRightHor === undefined) {
      this.mod_CarcasePartConnectionRightHor = "SideCShelf";
    }
    if (this.mod_ShelvesBackwallFittingConnection === undefined) {
      this.mod_ShelvesBackwallFittingConnection = "Screws";
    }
  ...
  #dataCompletionSetDefaultScripts() {
    ...
    if (this.mod_RackAreaType === undefined) {
      this.mod_RackAreaType = this.g.basic_RackAreaType;
    }
    if (this.mod_RackAreaShelftopConstruction === undefined) {
      this.mod_RackAreaShelftopConstruction = this.g.basic_RackAreaShelftopConstruction;
    }
    } 
    catch (error) {
  ...
  #manufacturerDataCompletionInternal = mf_RackArea_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mf_RackArea_NonNull(this);
  ...
  seal(): IModuleNonNull_mf_RackArea{
    ...
    const adc = new OD_M_mf_RackArea_NonNull(this);
    return adc;
  }
  ...
  addOD_M_mc_RackArea01(index?: number): dc_mc_RackArea01 {
    var m = new OD_M_mc_RackArea01(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  addOD_M_mc_ShelffixedGroup01(index?: number): dc_mc_ShelffixedGroup01 {
    var m = new OD_M_mc_ShelffixedGroup01(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  override createBuildPlan():void {
    var cbp = new OD_M_mf_RackArea_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mf_RackArea_NonNull implements cbp_mf_RackArea, adc_mf_RackArea ,IPartParentsNonNull_mf_Door_mf_Fliplift_mf_RackArea,IPartParentsNonNull_mf_RackArea {
  constructor(parent: OD_M_mf_RackArea) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mf_RackArea;
  ...
  #createBuildPlanInternal = mf_RackArea_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mf_RackArea_afterDataCompletion;
  ...
  addOD_M_mc_RackArea01(index?: number): dc_mc_RackArea01 {
    return this.#internalParent.addOD_M_mc_RackArea01(index);
  }
  addOD_M_mc_ShelffixedGroup01(index?: number): dc_mc_ShelffixedGroup01 {
    return this.#internalParent.addOD_M_mc_ShelffixedGroup01(index);
  }
}
