...
//#region Imports
import { cbp_mr_Fingergrip, dc_mr_Fingergrip, adc_mr_Fingergrip } from '../internal/modules/mr_Fingergrip'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_Fingergrip01, OD_M_mc_Fingergrip01 } from '../internal/modules/mc_Fingergrip01'
...
export function mr_Fingergrip_createBuildPlan(this: cbp_mr_Fingergrip):void {
  internal_enterModuleCreateBuildPlan('mr_Fingergrip', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mr_Fingergrip_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mr_Fingergrip_afterDataCompletion(this: adc_mr_Fingergrip):void {
  internal_enterModuleAfterDataCompletion('mr_Fingergrip', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mr_Fingergrip_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mr_Fingergrip_manufacturerDataCompletion(this: dc_mr_Fingergrip):void {
  internal_enterModuleManufacturerDataCompletion('mr_Fingergrip', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mr_Fingergrip_MANUFACTURERDATACOMPLETION
