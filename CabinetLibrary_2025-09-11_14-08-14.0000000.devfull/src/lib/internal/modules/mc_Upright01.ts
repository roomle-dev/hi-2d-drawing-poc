...
import { IModParents_mr_Upright } from '../mod-interfaces'
import { IP_part_FinishPanel_PartVarsWritable, P_part_FinishPanel } from '../parts/part_FinishPanel'
import { IP_part_FinishPanelProfile_PartVarsWritable, P_part_FinishPanelProfile } from '../parts/part_FinishPanelProfile'
import { IP_part_UprightGroup_PartVarsWritable, P_part_UprightGroup } from '../parts/part_UprightGroup'
import { IModuleNonNull_mc_Upright01,IModParents_mc_Upright01,IPartParentsNonNull_mc_Upright01} from '../mod-interfaces'
import {IModVar_mod_UprightColor,IModVarNonNull_mod_UprightColor,IModVar_mod_UprightFloorProfileColor,IModVarNonNull_mod_UprightFloorProfileColor,IModVar_mod_PlinthAreaHeight,IModVarNonNull_mod_PlinthAreaHeight,IModVar_mod_UprightThk,IModVarNonNull_mod_UprightThk,IModVar_mod_UprightOverhang,IModVarNonNull_mod_UprightOverhang,IModVar_mod_UprightSide,IModVarNonNull_mod_UprightSide,IModVar_mod_Height,IModVarNonNull_mod_Height,IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_UprightConstruction,IModVarNonNull_mod_UprightConstruction} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_UprightColor, IMatrix_mod_UprightFloorProfileColor, IMatrix_mod_PlinthAreaHeight, IMatrix_mod_UprightThk, IMatrix_mod_UprightOverhang, IMatrix_mod_UprightSide, IMatrix_mod_Height, IMatrix_mod_Depth, IMatrix_mod_UprightConstruction} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_FinishPanel, IPartAdd_part_FinishPanelProfile, IPartAdd_part_UprightGroup } from '../part-add-interfaces';
import { mc_Upright01_createBuildPlan, mc_Upright01_afterDataCompletion, mc_Upright01_manufacturerDataCompletion } from '../../modules/mc_Upright01';

export interface cbp_mc_Upright01 extends IModBaseProp
, IPartAdd_part_FinishPanel, IPartAdd_part_FinishPanelProfile, IPartAdd_part_UprightGroup, IModVarNonNull_mod_UprightColor, IModVarNonNull_mod_UprightFloorProfileColor, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_UprightThk, IModVarNonNull_mod_UprightOverhang, IModVarNonNull_mod_UprightSide, IModVarNonNull_mod_Height, IModVarNonNull_mod_Depth, IModVarNonNull_mod_UprightConstruction {
  parent: IModParents_mr_Upright;
...
export interface dc_mc_Upright01 extends IModBaseProp
, IModVar_mod_UprightColor, IModVar_mod_UprightFloorProfileColor, IModVar_mod_PlinthAreaHeight, IModVar_mod_UprightThk, IModVar_mod_UprightOverhang, IModVar_mod_UprightSide, IModVar_mod_Height, IModVar_mod_Depth, IModVar_mod_UprightConstruction {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Upright01;
  parent: IModParents_mr_Upright;
}

export interface adc_mc_Upright01 extends IModBaseProp
...
export class OD_M_mc_Upright01 extends OD_Base  implements dc_mc_Upright01
,IModParents_mc_Upright01
,IModVar_mod_UprightColor,IModVar_mod_UprightFloorProfileColor,IModVar_mod_PlinthAreaHeight,IModVar_mod_UprightThk,IModVar_mod_UprightOverhang,IModVar_mod_UprightSide,IModVar_mod_Height,IModVar_mod_Depth,IModVar_mod_UprightConstruction
 {
  constructor(parent: IModParents_mr_Upright, manufacturerMode?:boolean) {
    super('mc_Upright01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Upright01_NonNull(this);
  }
  parent: IModParents_mr_Upright;
  _selfNonNull: OD_M_mc_Upright01_NonNull;

  override variants:string[] = ['mod_UprightColor','mod_UprightFloorProfileColor','mod_PlinthAreaHeight','mod_UprightThk','mod_UprightOverhang','mod_UprightSide','mod_Height','mod_Depth','mod_UprightConstruction',];
  ...
  get mod_UprightSide(): string | undefined { return this.#mod_UprightSide}
  set mod_UprightSide(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_UprightSide' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_UprightSide === value) return;
    this.#mod_UprightSide = value;
  }

  mod_UprightSide_matrix?: IMatrix_mod_UprightSide;
  #mod_Height?: number;
  ...
  res.set('mod_UprightSide', this.mod_UprightSide);
  ...
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_UprightSide');
    const val = _toString(json['attributes']['mod_UprightSide'], 'mod_UprightSide');
    internal_leaveValidateVariant();
    this.mod_UprightSide = val; }
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_UprightColor === undefined) {
      ...
      while (s !== undefined) {
        if (s.variants.includes('mod_UprightColor')) {
          let pv = <IModVar_mod_UprightColor>s;
          if (pv.mod_UprightColor !== undefined) {
            this.mod_UprightColor = (<IModVar_mod_UprightColor>s).mod_UprightColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_UprightFloorProfileColor === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_UprightFloorProfileColor')) {
          let pv = <IModVar_mod_UprightFloorProfileColor>s;
          if (pv.mod_UprightFloorProfileColor !== undefined) {
            this.mod_UprightFloorProfileColor = (<IModVar_mod_UprightFloorProfileColor>s).mod_UprightFloorProfileColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_UprightThk === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_UprightThk')) {
          let pv = <IModVar_mod_UprightThk>s;
          if (pv.mod_UprightThk !== undefined) {
            this.mod_UprightThk = (<IModVar_mod_UprightThk>s).mod_UprightThk;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_UprightOverhang === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_UprightOverhang')) {
          let pv = <IModVar_mod_UprightOverhang>s;
          if (pv.mod_UprightOverhang !== undefined) {
            this.mod_UprightOverhang = (<IModVar_mod_UprightOverhang>s).mod_UprightOverhang;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_UprightConstruction === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_UprightConstruction')) {
          let pv = <IModVar_mod_UprightConstruction>s;
          if (pv.mod_UprightConstruction !== undefined) {
            this.mod_UprightConstruction = (<IModVar_mod_UprightConstruction>s).mod_UprightConstruction;
            break;
          };
        }
        s = s.parentBase;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_UprightSide === undefined) {
      this.mod_UprightSide = "Left";
    }
  ...
  #manufacturerDataCompletionInternal = mc_Upright01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Upright01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Upright01{
    ...
    const adc = new OD_M_mc_Upright01_NonNull(this);
    return adc;
  }
  ...
  override validateSelections():void {
    ...
    this.mod_UprightSide_matrix = VariantValidation.mod_UprightSide(this, this);
  ...
  addpart_FinishPanel(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FinishPanel_PartVarsWritable {
    var c = new P_part_FinishPanel(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_FinishPanelProfile(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FinishPanelProfile_PartVarsWritable {
    var c = new P_part_FinishPanelProfile(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_UprightGroup(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_UprightGroup_PartVarsWritable {
    var c = new P_part_UprightGroup(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Upright01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Upright01_NonNull implements cbp_mc_Upright01, adc_mc_Upright01 ,IPartParentsNonNull_mc_Upright01 {
  constructor(parent: OD_M_mc_Upright01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Upright01;
  ...
  #createBuildPlanInternal = mc_Upright01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Upright01_afterDataCompletion;
  ...
  parent: IModParents_mr_Upright;
  addpart_FinishPanel(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FinishPanel_PartVarsWritable {
    return this.#internalParent.addpart_FinishPanel(x, y, z, dimx, dimy, dimz);
  }
  addpart_FinishPanelProfile(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FinishPanelProfile_PartVarsWritable {
    return this.#internalParent.addpart_FinishPanelProfile(x, y, z, dimx, dimy, dimz);
  }
  addpart_UprightGroup(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_UprightGroup_PartVarsWritable {
    return this.#internalParent.addpart_UprightGroup(x, y, z, dimx, dimy, dimz);
  }
  ...
  get mod_UprightSide(): string  {
    return this.#internalParent.mod_UprightSide!;
  }
