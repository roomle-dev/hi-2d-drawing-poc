...
import { OD_M_mf_Fliplift, dc_mf_Fliplift } from './mf_Fliplift'
import { OD_M_mf_Door, dc_mf_Door } from './mf_Door'
import { OD_M_mf_Oven, dc_mf_Oven } from './mf_Oven'
import { OD_M_mf_Fridge, dc_mf_Fridge } from './mf_Fridge'
import { OD_M_mf_RackArea, dc_mf_RackArea } from './mf_RackArea'
import { OD_M_mf_Fixedfront, dc_mf_Fixedfront } from './mf_Fixedfront'
import { OD_M_mf_Hob, dc_mf_Hob } from './mf_Hob'
import { OD_M_mf_Sink, dc_mf_Sink } from './mf_Sink'
import { IModuleNonNull_mr_StorageunitSingle,IModParents_mr_CornerunitStraight_mr_StorageunitSingle,IModParents_mr_CornerunitStraight_mr_Filler01_mr_StorageunitSingle,IModParents_mr_StorageunitSingle,IPartParentsNonNull_mr_CornerunitStraight_mr_StorageunitSingle,IPartParentsNonNull_mr_CornerunitStraight_mr_Filler01_mr_StorageunitSingle,IPartParentsNonNull_mr_StorageunitSingle} from '../mod-interfaces'
import {IModVar_mod_BackwallPos,IModVarNonNull_mod_BackwallPos,IModVar_mod_BackwallThk,IModVarNonNull_mod_BackwallThk,IModVar_mod_CarcaseBackwallConstruction,IModVarNonNull_mod_CarcaseBackwallConstruction,IModVar_mod_CarcaseConnectionLeftBtm,IModVarNonNull_mod_CarcaseConnectionLeftBtm,IModVar_mod_CarcaseConnectionLeftTop,IModVarNonNull_mod_CarcaseConnectionLeftTop,IModVar_mod_CarcaseConnectionRightBtm,IModVarNonNull_mod_CarcaseConnectionRightBtm,IModVar_mod_CarcaseConnectionRightTop,IModVarNonNull_mod_CarcaseConnectionRightTop,IModVar_mod_CarcaseShelfbtmConstruction,IModVarNonNull_mod_CarcaseShelfbtmConstruction,IModVar_mod_CarcaseShelftopConstruction,IModVarNonNull_mod_CarcaseShelftopConstruction,IModVar_mod_CarcaseVisBack,IModVarNonNull_mod_CarcaseVisBack,IModVar_mod_CarcaseVisBtm,IModVarNonNull_mod_CarcaseVisBtm,IModVar_mod_CarcaseVisLeft,IModVarNonNull_mod_CarcaseVisLeft,IModVar_mod_CarcaseVisRight,IModVarNonNull_mod_CarcaseVisRight,IModVar_mod_CarcaseVisTop,IModVarNonNull_mod_CarcaseVisTop,IModVar_mod_HandleLine,IModVarNonNull_mod_HandleLine,IModVar_mod_HandlePosLogic,IModVarNonNull_mod_HandlePosLogic,IModVar_mod_HangerPosX,IModVarNonNull_mod_HangerPosX,IModVar_mod_HangerPosY,IModVarNonNull_mod_HangerPosY,IModVar_mod_PlinthAreaVisLeft,IModVarNonNull_mod_PlinthAreaVisLeft,IModVar_mod_PlinthAreaVisRight,IModVarNonNull_mod_PlinthAreaVisRight,IModVar_mod_RailhortopbackThk,IModVarNonNull_mod_RailhortopbackThk,IModVar_mod_RailhortopfrontThk,IModVarNonNull_mod_RailhortopfrontThk,IModVar_mod_RailverttopbackThk,IModVarNonNull_mod_RailverttopbackThk,IModVar_mod_RailverttopfrontThk,IModVarNonNull_mod_RailverttopfrontThk,IModVar_mod_ShelfbtmThk,IModVarNonNull_mod_ShelfbtmThk,IModVar_mod_ShelffixedThk,IModVarNonNull_mod_ShelffixedThk,IModVar_mod_ShelftopThk,IModVarNonNull_mod_ShelftopThk,IModVar_mod_SidepanelleftThk,IModVarNonNull_mod_SidepanelleftThk,IModVar_mod_SidepanelrightThk,IModVarNonNull_mod_SidepanelrightThk,IModVar_mod_HardwareColor,IModVarNonNull_mod_HardwareColor,IModVar_mod_OpeningType,IModVarNonNull_mod_OpeningType,IModVar_mod_CarcaseBackwallColor,IModVarNonNull_mod_CarcaseBackwallColor,IModVar_mod_CarcaseBackwallProgram,IModVarNonNull_mod_CarcaseBackwallProgram,IModVar_mod_CarcaseColor,IModVarNonNull_mod_CarcaseColor,IModVar_mod_CarcaseOutsideColor,IModVarNonNull_mod_CarcaseOutsideColor,IModVar_mod_CarcaseEdgeBackColor,IModVarNonNull_mod_CarcaseEdgeBackColor,IModVar_mod_CarcaseEdgeColor,IModVarNonNull_mod_CarcaseEdgeColor,IModVar_mod_CarcaseEdgeFrontColor,IModVarNonNull_mod_CarcaseEdgeFrontColor,IModVar_mod_CarcaseProgram,IModVarNonNull_mod_CarcaseProgram,IModVar_mod_CarcaseOutsideProgram,IModVarNonNull_mod_CarcaseOutsideProgram,IModVar_mod_CarcaseShelfbtmOversizeInsideWall,IModVarNonNull_mod_CarcaseShelfbtmOversizeInsideWall,IModVar_mod_CarcaseShelfbtmOversizeLeft,IModVarNonNull_mod_CarcaseShelfbtmOversizeLeft,IModVar_mod_CarcaseShelfbtmOversizeRight,IModVarNonNull_mod_CarcaseShelfbtmOversizeRight,IModVar_mod_CarcaseShelftopOversizeInsideWall,IModVarNonNull_mod_CarcaseShelftopOversizeInsideWall,IModVar_mod_CarcaseShelftopOversizeLeft,IModVarNonNull_mod_CarcaseShelftopOversizeLeft,IModVar_mod_CarcaseShelftopOversizeRight,IModVarNonNull_mod_CarcaseShelftopOversizeRight,IModVar_mod_CarcaseSidepanelleftOversizeBtm,IModVarNonNull_mod_CarcaseSidepanelleftOversizeBtm,IModVar_mod_CarcaseSidepanelleftOversizeInsideWall,IModVarNonNull_mod_CarcaseSidepanelleftOversizeInsideWall,IModVar_mod_CarcaseSidepanelleftOversizeTop,IModVarNonNull_mod_CarcaseSidepanelleftOversizeTop,IModVar_mod_CarcaseSidepanelrightOversizeBtm,IModVarNonNull_mod_CarcaseSidepanelrightOversizeBtm,IModVar_mod_CarcaseSidepanelrightOversizeInsideWall,IModVarNonNull_mod_CarcaseSidepanelrightOversizeInsideWall,IModVar_mod_CarcaseSidepanelrightOversizeTop,IModVarNonNull_mod_CarcaseSidepanelrightOversizeTop,IModVar_mod_CarcaseDistanceWall,IModVarNonNull_mod_CarcaseDistanceWall,IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_FingergripType,IModVarNonNull_mod_FingergripType,IModVar_mod_FrontColor,IModVarNonNull_mod_FrontColor,IModVar_mod_FrontEdgeColor,IModVarNonNull_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVarNonNull_mod_FrontEdgeThk,IModVar_mod_FrontFrameColor,IModVarNonNull_mod_FrontFrameColor,IModVar_mod_FrontGapCarcase,IModVarNonNull_mod_FrontGapCarcase,IModVar_mod_FrontGapHor,IModVarNonNull_mod_FrontGapHor,IModVar_mod_FrontGapVert,IModVarNonNull_mod_FrontGapVert,IModVar_mod_FrontGlassColor,IModVarNonNull_mod_FrontGlassColor,IModVar_mod_FrontProgram,IModVarNonNull_mod_FrontProgram,IModVar_mod_FrontPosStart,IModVarNonNull_mod_FrontPosStart,IModVar_mod_HandleColor,IModVarNonNull_mod_HandleColor,IModVar_mod_HandleLength,IModVarNonNull_mod_HandleLength,IModVar_mod_HandlePosType,IModVarNonNull_mod_HandlePosType,IModVar_mod_HangerType,IModVarNonNull_mod_HangerType,IModVar_mod_Height,IModVarNonNull_mod_Height,IModVar_mod_HeightPosInsertion,IModVarNonNull_mod_HeightPosInsertion,IModVar_mod_LightPosX1,IModVarNonNull_mod_LightPosX1,IModVar_mod_LightPosX2,IModVarNonNull_mod_LightPosX2,IModVar_mod_LightPosX3,IModVarNonNull_mod_LightPosX3,IModVar_mod_LightPosX4,IModVarNonNull_mod_LightPosX4,IModVar_mod_LightPosX5,IModVarNonNull_mod_LightPosX5,IModVar_mod_LightPart,IModVarNonNull_mod_LightPart,IModVar_mod_LightPosX,IModVarNonNull_mod_LightPosX,IModVar_mod_LightPosY,IModVarNonNull_mod_LightPosY,IModVar_mod_LightSystem,IModVarNonNull_mod_LightSystem,IModVar_mod_Model,IModVarNonNull_mod_Model,IModVar_mod_PlinthAreaHeight,IModVarNonNull_mod_PlinthAreaHeight,IModVar_mod_ShelfadjThk,IModVarNonNull_mod_ShelfadjThk,IModVar_mod_TypeElement,IModVarNonNull_mod_TypeElement,IModVar_mod_Width,IModVarNonNull_mod_Width,IModVar_mod_BackwallFixedHeight,IModVarNonNull_mod_BackwallFixedHeight,IModVar_mod_HandleDesign,IModVarNonNull_mod_HandleDesign,IModVar_mod_FrontDesign,IModVarNonNull_mod_FrontDesign,IModVar_mod_PlinthAreaPosLeftMatrix,IModVarNonNull_mod_PlinthAreaPosLeftMatrix,IModVar_mod_PlinthAreaDesign,IModVarNonNull_mod_PlinthAreaDesign,IModVar_mod_PlinthAreaPosBackMatrix,IModVarNonNull_mod_PlinthAreaPosBackMatrix,IModVar_mod_PlinthAreaPosFrontMatrix,IModVarNonNull_mod_PlinthAreaPosFrontMatrix,IModVar_mod_PlinthAreaPosRightMatrix,IModVarNonNull_mod_PlinthAreaPosRightMatrix,IModVar_mod_PlinthAreaElementColor,IModVarNonNull_mod_PlinthAreaElementColor,IModVar_mod_InteriorEquipmentLogic,IModVarNonNull_mod_InteriorEquipmentLogic,IModVar_mod_ParentName,IModVarNonNull_mod_ParentName,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_PlinthAreaExtraItem,IModVarNonNull_mod_PlinthAreaExtraItem,IModVar_mod_FrontGapHorTop,IModVarNonNull_mod_FrontGapHorTop,IModVar_mod_ShelvesBackwallFittingConnection,IModVarNonNull_mod_ShelvesBackwallFittingConnection,IModVar_mod_FittingConnectionBtmVert,IModVarNonNull_mod_FittingConnectionBtmVert,IModVar_mod_FittingConnectionLeftBtm,IModVarNonNull_mod_FittingConnectionLeftBtm,IModVar_mod_FittingConnectionLeftHor,IModVarNonNull_mod_FittingConnectionLeftHor,IModVar_mod_FittingConnectionLeftTop,IModVarNonNull_mod_FittingConnectionLeftTop,IModVar_mod_FittingConnectionRightBtm,IModVarNonNull_mod_FittingConnectionRightBtm,IModVar_mod_FittingConnectionRightHor,IModVarNonNull_mod_FittingConnectionRightHor,IModVar_mod_FittingConnectionRightTop,IModVarNonNull_mod_FittingConnectionRightTop,IModVar_mod_FittingConnectionTopVert,IModVarNonNull_mod_FittingConnectionTopVert,IModVar_mod_CarcasePartConnectionBackHor,IModVarNonNull_mod_CarcasePartConnectionBackHor,IModVar_mod_CarcasePartConnectionBackVert,IModVarNonNull_mod_CarcasePartConnectionBackVert,IModVar_mod_CarcasePartConnectionBtmVert,IModVarNonNull_mod_CarcasePartConnectionBtmVert,IModVar_mod_CarcasePartConnectionLeftHor,IModVarNonNull_mod_CarcasePartConnectionLeftHor,IModVar_mod_CarcasePartConnectionRightHor,IModVarNonNull_mod_CarcasePartConnectionRightHor,IModVar_mod_CarcasePartConnectionTopVert,IModVarNonNull_mod_CarcasePartConnectionTopVert,IModVar_mod_HangerOffsetPosY,IModVarNonNull_mod_HangerOffsetPosY,IModVar_mod_HangerColor,IModVarNonNull_mod_HangerColor,IModVar_mod_RackAreaOversizeCarcaseType,IModVarNonNull_mod_RackAreaOversizeCarcaseType,IModVar_mod_RackAreaManualOffsetCarcase,IModVarNonNull_mod_RackAreaManualOffsetCarcase,IModVar_mod_CleatThk,IModVarNonNull_mod_CleatThk,IModVar_mod_CleatWidth,IModVarNonNull_mod_CleatWidth,IModVar_mod_VertDividerType,IModVarNonNull_mod_VertDividerType,IModVar_mod_SidepanelmiddleThk,IModVarNonNull_mod_SidepanelmiddleThk,IModVar_mod_CarcaseFrontConstruction,IModVarNonNull_mod_CarcaseFrontConstruction,IModVar_mod_CarcasePartInfo,IModVarNonNull_mod_CarcasePartInfo,IModVar_mod_PushtoopenLine,IModVarNonNull_mod_PushtoopenLine,IModVar_mod_PushtoopenType,IModVarNonNull_mod_PushtoopenType,IModVar_mod_PushtoopenColor,IModVarNonNull_mod_PushtoopenColor,IModVar_mod_FramePartsWidthHor,IModVarNonNull_mod_FramePartsWidthHor,IModVar_mod_FramePartsWidthVert,IModVarNonNull_mod_FramePartsWidthVert,IModVar_mod_PanelWoodFrameFillingType,IModVarNonNull_mod_PanelWoodFrameFillingType,IModVar_mod_PanelWoodFrameType,IModVarNonNull_mod_PanelWoodFrameType,IModVar_mod_CreateCountertop,IModVarNonNull_mod_CreateCountertop,IModVar_mod_CreateToekick,IModVarNonNull_mod_CreateToekick,IModVar_mod_CreateFingergrip,IModVarNonNull_mod_CreateFingergrip,IModVar_mod_CreatePaneltop,IModVarNonNull_mod_CreatePaneltop,IModVar_mod_PlinthAreaPositionInfo,IModVarNonNull_mod_PlinthAreaPositionInfo,IModVar_mod_DoorDirection,IModVarNonNull_mod_DoorDirection,IModVar_mod_SlopedCeilingDimensionLogic,IModVarNonNull_mod_SlopedCeilingDimensionLogic,IModVar_mod_SlopedCeilingConstruction,IModVarNonNull_mod_SlopedCeilingConstruction,IModVar_mod_SlopeAngle,IModVarNonNull_mod_SlopeAngle,IModVar_mod_BackHeight,IModVarNonNull_mod_BackHeight,IModVar_mod_TopDepth,IModVarNonNull_mod_TopDepth,IModVar_mod_FrameFillingWoodColor,IModVarNonNull_mod_FrameFillingWoodColor,IModVar_mod_CountertopThk,IModVarNonNull_mod_CountertopThk,IModVar_mod_CountertopInfo,IModVarNonNull_mod_CountertopInfo,IModVar_mod_SidepanelleftType,IModVarNonNull_mod_SidepanelleftType,IModVar_mod_SidepanelrightType,IModVarNonNull_mod_SidepanelrightType,IModVar_mod_GrainLogic,IModVarNonNull_mod_GrainLogic,IModVar_mod_ShelfadjColor,IModVarNonNull_mod_ShelfadjColor,IModVar_mod_FrameFillingColor,IModVarNonNull_mod_FrameFillingColor} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_BackwallPos, IMatrix_mod_BackwallThk, IMatrix_mod_CarcaseBackwallConstruction, IMatrix_mod_CarcaseConnectionLeftBtm, IMatrix_mod_CarcaseConnectionLeftTop, IMatrix_mod_CarcaseConnectionRightBtm, IMatrix_mod_CarcaseConnectionRightTop, IMatrix_mod_CarcaseShelfbtmConstruction, IMatrix_mod_CarcaseShelftopConstruction, IMatrix_mod_CarcaseVisBack, IMatrix_mod_CarcaseVisBtm, IMatrix_mod_CarcaseVisLeft, IMatrix_mod_CarcaseVisRight, IMatrix_mod_CarcaseVisTop, IMatrix_mod_HandleLine, IMatrix_mod_HandlePosLogic, IMatrix_mod_HangerPosX, IMatrix_mod_HangerPosY, IMatrix_mod_PlinthAreaVisLeft, IMatrix_mod_PlinthAreaVisRight, IMatrix_mod_RailhortopbackThk, IMatrix_mod_RailhortopfrontThk, IMatrix_mod_RailverttopbackThk, IMatrix_mod_RailverttopfrontThk, IMatrix_mod_ShelfbtmThk, IMatrix_mod_ShelffixedThk, IMatrix_mod_ShelftopThk, IMatrix_mod_SidepanelleftThk, IMatrix_mod_SidepanelrightThk, IMatrix_mod_HardwareColor, IMatrix_mod_OpeningType, IMatrix_mod_CarcaseBackwallColor, IMatrix_mod_CarcaseBackwallProgram, IMatrix_mod_CarcaseColor, IMatrix_mod_CarcaseOutsideColor, IMatrix_mod_CarcaseEdgeBackColor, IMatrix_mod_CarcaseEdgeColor, IMatrix_mod_CarcaseEdgeFrontColor, IMatrix_mod_CarcaseProgram, IMatrix_mod_CarcaseOutsideProgram, IMatrix_mod_CarcaseShelfbtmOversizeInsideWall, IMatrix_mod_CarcaseShelfbtmOversizeLeft, IMatrix_mod_CarcaseShelfbtmOversizeRight, IMatrix_mod_CarcaseShelftopOversizeInsideWall, IMatrix_mod_CarcaseShelftopOversizeLeft, IMatrix_mod_CarcaseShelftopOversizeRight, IMatrix_mod_CarcaseSidepanelleftOversizeBtm, IMatrix_mod_CarcaseSidepanelleftOversizeInsideWall, IMatrix_mod_CarcaseSidepanelleftOversizeTop, IMatrix_mod_CarcaseSidepanelrightOversizeBtm, IMatrix_mod_CarcaseSidepanelrightOversizeInsideWall, IMatrix_mod_CarcaseSidepanelrightOversizeTop, IMatrix_mod_CarcaseDistanceWall, IMatrix_mod_Depth, IMatrix_mod_FingergripType, IMatrix_mod_FrontColor, IMatrix_mod_FrontEdgeColor, IMatrix_mod_FrontEdgeThk, IMatrix_mod_FrontFrameColor, IMatrix_mod_FrontGapCarcase, IMatrix_mod_FrontGapHor, IMatrix_mod_FrontGapVert, IMatrix_mod_FrontGlassColor, IMatrix_mod_FrontProgram, IMatrix_mod_FrontPosStart, IMatrix_mod_HandleColor, IMatrix_mod_HandleLength, IMatrix_mod_HandlePosType, IMatrix_mod_HangerType, IMatrix_mod_Height, IMatrix_mod_HeightPosInsertion, IMatrix_mod_LightPosX1, IMatrix_mod_LightPosX2, IMatrix_mod_LightPosX3, IMatrix_mod_LightPosX4, IMatrix_mod_LightPosX5, IMatrix_mod_LightPart, IMatrix_mod_LightPosX, IMatrix_mod_LightPosY, IMatrix_mod_LightSystem, IMatrix_mod_Model, IMatrix_mod_PlinthAreaHeight, IMatrix_mod_ShelfadjThk, IMatrix_mod_TypeElement, IMatrix_mod_Width, IMatrix_mod_BackwallFixedHeight, IMatrix_mod_HandleDesign, IMatrix_mod_FrontDesign, IMatrix_mod_PlinthAreaPosLeftMatrix, IMatrix_mod_PlinthAreaDesign, IMatrix_mod_PlinthAreaPosBackMatrix, IMatrix_mod_PlinthAreaPosFrontMatrix, IMatrix_mod_PlinthAreaPosRightMatrix, IMatrix_mod_PlinthAreaElementColor, IMatrix_mod_InteriorEquipmentLogic, IMatrix_mod_ParentName, IMatrix_mod_ModuleName, IMatrix_mod_PlinthAreaExtraItem, IMatrix_mod_FrontGapHorTop, IMatrix_mod_ShelvesBackwallFittingConnection, IMatrix_mod_FittingConnectionBtmVert, IMatrix_mod_FittingConnectionLeftBtm, IMatrix_mod_FittingConnectionLeftHor, IMatrix_mod_FittingConnectionLeftTop, IMatrix_mod_FittingConnectionRightBtm, IMatrix_mod_FittingConnectionRightHor, IMatrix_mod_FittingConnectionRightTop, IMatrix_mod_FittingConnectionTopVert, IMatrix_mod_CarcasePartConnectionBackHor, IMatrix_mod_CarcasePartConnectionBackVert, IMatrix_mod_CarcasePartConnectionBtmVert, IMatrix_mod_CarcasePartConnectionLeftHor, IMatrix_mod_CarcasePartConnectionRightHor, IMatrix_mod_CarcasePartConnectionTopVert, IMatrix_mod_HangerOffsetPosY, IMatrix_mod_HangerColor, IMatrix_mod_RackAreaOversizeCarcaseType, IMatrix_mod_RackAreaManualOffsetCarcase, IMatrix_mod_CleatThk, IMatrix_mod_CleatWidth, IMatrix_mod_VertDividerType, IMatrix_mod_SidepanelmiddleThk, IMatrix_mod_CarcaseFrontConstruction, IMatrix_mod_PushtoopenLine, IMatrix_mod_PushtoopenType, IMatrix_mod_PushtoopenColor, IMatrix_mod_FramePartsWidthHor, IMatrix_mod_FramePartsWidthVert, IMatrix_mod_PanelWoodFrameFillingType, IMatrix_mod_PanelWoodFrameType, IMatrix_mod_CreateCountertop, IMatrix_mod_CreateToekick, IMatrix_mod_CreateFingergrip, IMatrix_mod_CreatePaneltop, IMatrix_mod_DoorDirection, IMatrix_mod_SlopedCeilingDimensionLogic, IMatrix_mod_SlopedCeilingConstruction, IMatrix_mod_SlopeAngle, IMatrix_mod_BackHeight, IMatrix_mod_TopDepth, IMatrix_mod_FrameFillingWoodColor, IMatrix_mod_CountertopThk, IMatrix_mod_SidepanelleftType, IMatrix_mod_SidepanelrightType, IMatrix_mod_GrainLogic, IMatrix_mod_ShelfadjColor, IMatrix_mod_FrameFillingColor} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'
import { IGlobalVarsParent } from '../global-vars-parent'

import { mr_StorageunitSingle_createBuildPlan, mr_StorageunitSingle_afterDataCompletion, mr_StorageunitSingle_manufacturerDataCompletion } from '../../modules/mr_StorageunitSingle';

export interface cbp_mr_StorageunitSingle extends IModBaseProp
...
export interface dc_mr_StorageunitSingle extends IModBaseProp
, IModVar_mod_BackwallPos, IModVar_mod_BackwallThk, IModVar_mod_CarcaseBackwallConstruction, IModVar_mod_CarcaseConnectionLeftBtm, IModVar_mod_CarcaseConnectionLeftTop, IModVar_mod_CarcaseConnectionRightBtm, IModVar_mod_CarcaseConnectionRightTop, IModVar_mod_CarcaseShelfbtmConstruction, IModVar_mod_CarcaseShelftopConstruction, IModVar_mod_CarcaseVisBack, IModVar_mod_CarcaseVisBtm, IModVar_mod_CarcaseVisLeft, IModVar_mod_CarcaseVisRight, IModVar_mod_CarcaseVisTop, IModVar_mod_HandleLine, IModVar_mod_HandlePosLogic, IModVar_mod_HangerPosX, IModVar_mod_HangerPosY, IModVar_mod_PlinthAreaVisLeft, IModVar_mod_PlinthAreaVisRight, IModVar_mod_RailhortopbackThk, IModVar_mod_RailhortopfrontThk, IModVar_mod_RailverttopbackThk, IModVar_mod_RailverttopfrontThk, IModVar_mod_ShelfbtmThk, IModVar_mod_ShelffixedThk, IModVar_mod_ShelftopThk, IModVar_mod_SidepanelleftThk, IModVar_mod_SidepanelrightThk, IModVar_mod_HardwareColor, IModVar_mod_OpeningType, IModVar_mod_CarcaseBackwallColor, IModVar_mod_CarcaseBackwallProgram, IModVar_mod_CarcaseColor, IModVar_mod_CarcaseOutsideColor, IModVar_mod_CarcaseEdgeBackColor, IModVar_mod_CarcaseEdgeColor, IModVar_mod_CarcaseEdgeFrontColor, IModVar_mod_CarcaseProgram, IModVar_mod_CarcaseOutsideProgram, IModVar_mod_CarcaseShelfbtmOversizeInsideWall, IModVar_mod_CarcaseShelfbtmOversizeLeft, IModVar_mod_CarcaseShelfbtmOversizeRight, IModVar_mod_CarcaseShelftopOversizeInsideWall, IModVar_mod_CarcaseShelftopOversizeLeft, IModVar_mod_CarcaseShelftopOversizeRight, IModVar_mod_CarcaseSidepanelleftOversizeBtm, IModVar_mod_CarcaseSidepanelleftOversizeInsideWall, IModVar_mod_CarcaseSidepanelleftOversizeTop, IModVar_mod_CarcaseSidepanelrightOversizeBtm, IModVar_mod_CarcaseSidepanelrightOversizeInsideWall, IModVar_mod_CarcaseSidepanelrightOversizeTop, IModVar_mod_CarcaseDistanceWall, IModVar_mod_Depth, IModVar_mod_FingergripType, IModVar_mod_FrontColor, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontFrameColor, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapVert, IModVar_mod_FrontGlassColor, IModVar_mod_FrontProgram, IModVar_mod_FrontPosStart, IModVar_mod_HandleColor, IModVar_mod_HandleLength, IModVar_mod_HandlePosType, IModVar_mod_HangerType, IModVar_mod_Height, IModVar_mod_HeightPosInsertion, IModVar_mod_LightPosX1, IModVar_mod_LightPosX2, IModVar_mod_LightPosX3, IModVar_mod_LightPosX4, IModVar_mod_LightPosX5, IModVar_mod_LightPart, IModVar_mod_LightPosX, IModVar_mod_LightPosY, IModVar_mod_LightSystem, IModVar_mod_Model, IModVar_mod_PlinthAreaHeight, IModVar_mod_ShelfadjThk, IModVar_mod_TypeElement, IModVar_mod_Width, IModVar_mod_BackwallFixedHeight, IModVar_mod_HandleDesign, IModVar_mod_FrontDesign, IModVar_mod_PlinthAreaPosLeftMatrix, IModVar_mod_PlinthAreaDesign, IModVar_mod_PlinthAreaPosBackMatrix, IModVar_mod_PlinthAreaPosFrontMatrix, IModVar_mod_PlinthAreaPosRightMatrix, IModVar_mod_PlinthAreaElementColor, IModVar_mod_InteriorEquipmentLogic, IModVar_mod_ParentName, IModVar_mod_ModuleName, IModVar_mod_PlinthAreaExtraItem, IModVar_mod_FrontGapHorTop, IModVar_mod_ShelvesBackwallFittingConnection, IModVar_mod_FittingConnectionBtmVert, IModVar_mod_FittingConnectionLeftBtm, IModVar_mod_FittingConnectionLeftHor, IModVar_mod_FittingConnectionLeftTop, IModVar_mod_FittingConnectionRightBtm, IModVar_mod_FittingConnectionRightHor, IModVar_mod_FittingConnectionRightTop, IModVar_mod_FittingConnectionTopVert, IModVar_mod_CarcasePartConnectionBackHor, IModVar_mod_CarcasePartConnectionBackVert, IModVar_mod_CarcasePartConnectionBtmVert, IModVar_mod_CarcasePartConnectionLeftHor, IModVar_mod_CarcasePartConnectionRightHor, IModVar_mod_CarcasePartConnectionTopVert, IModVar_mod_HangerOffsetPosY, IModVar_mod_HangerColor, IModVar_mod_RackAreaOversizeCarcaseType, IModVar_mod_RackAreaManualOffsetCarcase, IModVar_mod_CleatThk, IModVar_mod_CleatWidth, IModVar_mod_VertDividerType, IModVar_mod_SidepanelmiddleThk, IModVar_mod_CarcaseFrontConstruction, IModVar_mod_CarcasePartInfo, IModVar_mod_PushtoopenLine, IModVar_mod_PushtoopenType, IModVar_mod_PushtoopenColor, IModVar_mod_FramePartsWidthHor, IModVar_mod_FramePartsWidthVert, IModVar_mod_PanelWoodFrameFillingType, IModVar_mod_PanelWoodFrameType, IModVar_mod_CreateCountertop, IModVar_mod_CreateToekick, IModVar_mod_CreateFingergrip, IModVar_mod_CreatePaneltop, IModVar_mod_PlinthAreaPositionInfo, IModVar_mod_DoorDirection, IModVar_mod_SlopedCeilingDimensionLogic, IModVar_mod_SlopedCeilingConstruction, IModVar_mod_SlopeAngle, IModVar_mod_BackHeight, IModVar_mod_TopDepth, IModVar_mod_FrameFillingWoodColor, IModVar_mod_CountertopThk, IModVar_mod_CountertopInfo, IModVar_mod_SidepanelleftType, IModVar_mod_SidepanelrightType, IModVar_mod_GrainLogic, IModVar_mod_ShelfadjColor, IModVar_mod_FrameFillingColor {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mr_StorageunitSingle;
...
export interface adc_mr_StorageunitSingle extends IModBaseProp
, IModVarNonNull_mod_BackwallPos, IModVarNonNull_mod_BackwallThk, IModVarNonNull_mod_CarcaseBackwallConstruction, IModVarNonNull_mod_CarcaseConnectionLeftBtm, IModVarNonNull_mod_CarcaseConnectionLeftTop, IModVarNonNull_mod_CarcaseConnectionRightBtm, IModVarNonNull_mod_CarcaseConnectionRightTop, IModVarNonNull_mod_CarcaseShelfbtmConstruction, IModVarNonNull_mod_CarcaseShelftopConstruction, IModVarNonNull_mod_CarcaseVisBack, IModVarNonNull_mod_CarcaseVisBtm, IModVarNonNull_mod_CarcaseVisLeft, IModVarNonNull_mod_CarcaseVisRight, IModVarNonNull_mod_CarcaseVisTop, IModVarNonNull_mod_HandleLine, IModVarNonNull_mod_HandlePosLogic, IModVarNonNull_mod_HangerPosX, IModVarNonNull_mod_HangerPosY, IModVarNonNull_mod_PlinthAreaVisLeft, IModVarNonNull_mod_PlinthAreaVisRight, IModVarNonNull_mod_RailhortopbackThk, IModVarNonNull_mod_RailhortopfrontThk, IModVarNonNull_mod_RailverttopbackThk, IModVarNonNull_mod_RailverttopfrontThk, IModVarNonNull_mod_ShelfbtmThk, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_ShelftopThk, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_OpeningType, IModVarNonNull_mod_CarcaseBackwallColor, IModVarNonNull_mod_CarcaseBackwallProgram, IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseOutsideColor, IModVarNonNull_mod_CarcaseEdgeBackColor, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_CarcaseOutsideProgram, IModVarNonNull_mod_CarcaseShelfbtmOversizeInsideWall, IModVarNonNull_mod_CarcaseShelfbtmOversizeLeft, IModVarNonNull_mod_CarcaseShelfbtmOversizeRight, IModVarNonNull_mod_CarcaseShelftopOversizeInsideWall, IModVarNonNull_mod_CarcaseShelftopOversizeLeft, IModVarNonNull_mod_CarcaseShelftopOversizeRight, IModVarNonNull_mod_CarcaseSidepanelleftOversizeBtm, IModVarNonNull_mod_CarcaseSidepanelleftOversizeInsideWall, IModVarNonNull_mod_CarcaseSidepanelleftOversizeTop, IModVarNonNull_mod_CarcaseSidepanelrightOversizeBtm, IModVarNonNull_mod_CarcaseSidepanelrightOversizeInsideWall, IModVarNonNull_mod_CarcaseSidepanelrightOversizeTop, IModVarNonNull_mod_CarcaseDistanceWall, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FingergripType, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontFrameColor, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontGlassColor, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_HandleLength, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HangerType, IModVarNonNull_mod_Height, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_LightPosX1, IModVarNonNull_mod_LightPosX2, IModVarNonNull_mod_LightPosX3, IModVarNonNull_mod_LightPosX4, IModVarNonNull_mod_LightPosX5, IModVarNonNull_mod_LightPart, IModVarNonNull_mod_LightPosX, IModVarNonNull_mod_LightPosY, IModVarNonNull_mod_LightSystem, IModVarNonNull_mod_Model, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_ShelfadjThk, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_Width, IModVarNonNull_mod_BackwallFixedHeight, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_PlinthAreaPosLeftMatrix, IModVarNonNull_mod_PlinthAreaDesign, IModVarNonNull_mod_PlinthAreaPosBackMatrix, IModVarNonNull_mod_PlinthAreaPosFrontMatrix, IModVarNonNull_mod_PlinthAreaPosRightMatrix, IModVarNonNull_mod_PlinthAreaElementColor, IModVarNonNull_mod_InteriorEquipmentLogic, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_PlinthAreaExtraItem, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_ShelvesBackwallFittingConnection, IModVarNonNull_mod_FittingConnectionBtmVert, IModVarNonNull_mod_FittingConnectionLeftBtm, IModVarNonNull_mod_FittingConnectionLeftHor, IModVarNonNull_mod_FittingConnectionLeftTop, IModVarNonNull_mod_FittingConnectionRightBtm, IModVarNonNull_mod_FittingConnectionRightHor, IModVarNonNull_mod_FittingConnectionRightTop, IModVarNonNull_mod_FittingConnectionTopVert, IModVarNonNull_mod_CarcasePartConnectionBackHor, IModVarNonNull_mod_CarcasePartConnectionBackVert, IModVarNonNull_mod_CarcasePartConnectionBtmVert, IModVarNonNull_mod_CarcasePartConnectionLeftHor, IModVarNonNull_mod_CarcasePartConnectionRightHor, IModVarNonNull_mod_CarcasePartConnectionTopVert, IModVarNonNull_mod_HangerOffsetPosY, IModVarNonNull_mod_HangerColor, IModVarNonNull_mod_RackAreaOversizeCarcaseType, IModVarNonNull_mod_RackAreaManualOffsetCarcase, IModVarNonNull_mod_CleatThk, IModVarNonNull_mod_CleatWidth, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_SidepanelmiddleThk, IModVarNonNull_mod_CarcaseFrontConstruction, IModVarNonNull_mod_CarcasePartInfo, IModVarNonNull_mod_PushtoopenLine, IModVarNonNull_mod_PushtoopenType, IModVarNonNull_mod_PushtoopenColor, IModVarNonNull_mod_FramePartsWidthHor, IModVarNonNull_mod_FramePartsWidthVert, IModVarNonNull_mod_PanelWoodFrameFillingType, IModVarNonNull_mod_PanelWoodFrameType, IModVarNonNull_mod_CreateCountertop, IModVarNonNull_mod_CreateToekick, IModVarNonNull_mod_CreateFingergrip, IModVarNonNull_mod_CreatePaneltop, IModVarNonNull_mod_PlinthAreaPositionInfo, IModVarNonNull_mod_DoorDirection, IModVarNonNull_mod_SlopedCeilingDimensionLogic, IModVarNonNull_mod_SlopedCeilingConstruction, IModVarNonNull_mod_SlopeAngle, IModVarNonNull_mod_BackHeight, IModVarNonNull_mod_TopDepth, IModVarNonNull_mod_FrameFillingWoodColor, IModVarNonNull_mod_CountertopThk, IModVarNonNull_mod_CountertopInfo, IModVarNonNull_mod_SidepanelleftType, IModVarNonNull_mod_SidepanelrightType, IModVarNonNull_mod_GrainLogic, IModVarNonNull_mod_ShelfadjColor, IModVarNonNull_mod_FrameFillingColor {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  addOD_M_mc_Storageunit01(index?: number): dc_mc_Storageunit01;
...
export class OD_M_mr_StorageunitSingle extends OD_Base  implements dc_mr_StorageunitSingle
,IModParents_mr_CornerunitStraight_mr_StorageunitSingle,IModParents_mr_CornerunitStraight_mr_Filler01_mr_StorageunitSingle,IModParents_mr_StorageunitSingle
,IModVar_mod_BackwallPos,IModVar_mod_BackwallThk,IModVar_mod_CarcaseBackwallConstruction,IModVar_mod_CarcaseConnectionLeftBtm,IModVar_mod_CarcaseConnectionLeftTop,IModVar_mod_CarcaseConnectionRightBtm,IModVar_mod_CarcaseConnectionRightTop,IModVar_mod_CarcaseShelfbtmConstruction,IModVar_mod_CarcaseShelftopConstruction,IModVar_mod_CarcaseVisBack,IModVar_mod_CarcaseVisBtm,IModVar_mod_CarcaseVisLeft,IModVar_mod_CarcaseVisRight,IModVar_mod_CarcaseVisTop,IModVar_mod_HandleLine,IModVar_mod_HandlePosLogic,IModVar_mod_HangerPosX,IModVar_mod_HangerPosY,IModVar_mod_PlinthAreaVisLeft,IModVar_mod_PlinthAreaVisRight,IModVar_mod_RailhortopbackThk,IModVar_mod_RailhortopfrontThk,IModVar_mod_RailverttopbackThk,IModVar_mod_RailverttopfrontThk,IModVar_mod_ShelfbtmThk,IModVar_mod_ShelffixedThk,IModVar_mod_ShelftopThk,IModVar_mod_SidepanelleftThk,IModVar_mod_SidepanelrightThk,IModVar_mod_HardwareColor,IModVar_mod_OpeningType,IModVar_mod_CarcaseBackwallColor,IModVar_mod_CarcaseBackwallProgram,IModVar_mod_CarcaseColor,IModVar_mod_CarcaseOutsideColor,IModVar_mod_CarcaseEdgeBackColor,IModVar_mod_CarcaseEdgeColor,IModVar_mod_CarcaseEdgeFrontColor,IModVar_mod_CarcaseProgram,IModVar_mod_CarcaseOutsideProgram,IModVar_mod_CarcaseShelfbtmOversizeInsideWall,IModVar_mod_CarcaseShelfbtmOversizeLeft,IModVar_mod_CarcaseShelfbtmOversizeRight,IModVar_mod_CarcaseShelftopOversizeInsideWall,IModVar_mod_CarcaseShelftopOversizeLeft,IModVar_mod_CarcaseShelftopOversizeRight,IModVar_mod_CarcaseSidepanelleftOversizeBtm,IModVar_mod_CarcaseSidepanelleftOversizeInsideWall,IModVar_mod_CarcaseSidepanelleftOversizeTop,IModVar_mod_CarcaseSidepanelrightOversizeBtm,IModVar_mod_CarcaseSidepanelrightOversizeInsideWall,IModVar_mod_CarcaseSidepanelrightOversizeTop,IModVar_mod_CarcaseDistanceWall,IModVar_mod_Depth,IModVar_mod_FingergripType,IModVar_mod_FrontColor,IModVar_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVar_mod_FrontFrameColor,IModVar_mod_FrontGapCarcase,IModVar_mod_FrontGapHor,IModVar_mod_FrontGapVert,IModVar_mod_FrontGlassColor,IModVar_mod_FrontProgram,IModVar_mod_FrontPosStart,IModVar_mod_HandleColor,IModVar_mod_HandleLength,IModVar_mod_HandlePosType,IModVar_mod_HangerType,IModVar_mod_Height,IModVar_mod_HeightPosInsertion,IModVar_mod_LightPosX1,IModVar_mod_LightPosX2,IModVar_mod_LightPosX3,IModVar_mod_LightPosX4,IModVar_mod_LightPosX5,IModVar_mod_LightPart,IModVar_mod_LightPosX,IModVar_mod_LightPosY,IModVar_mod_LightSystem,IModVar_mod_Model,IModVar_mod_PlinthAreaHeight,IModVar_mod_ShelfadjThk,IModVar_mod_TypeElement,IModVar_mod_Width,IModVar_mod_BackwallFixedHeight,IModVar_mod_HandleDesign,IModVar_mod_FrontDesign,IModVar_mod_PlinthAreaPosLeftMatrix,IModVar_mod_PlinthAreaDesign,IModVar_mod_PlinthAreaPosBackMatrix,IModVar_mod_PlinthAreaPosFrontMatrix,IModVar_mod_PlinthAreaPosRightMatrix,IModVar_mod_PlinthAreaElementColor,IModVar_mod_InteriorEquipmentLogic,IModVar_mod_ParentName,IModVar_mod_ModuleName,IModVar_mod_PlinthAreaExtraItem,IModVar_mod_FrontGapHorTop,IModVar_mod_ShelvesBackwallFittingConnection,IModVar_mod_FittingConnectionBtmVert,IModVar_mod_FittingConnectionLeftBtm,IModVar_mod_FittingConnectionLeftHor,IModVar_mod_FittingConnectionLeftTop,IModVar_mod_FittingConnectionRightBtm,IModVar_mod_FittingConnectionRightHor,IModVar_mod_FittingConnectionRightTop,IModVar_mod_FittingConnectionTopVert,IModVar_mod_CarcasePartConnectionBackHor,IModVar_mod_CarcasePartConnectionBackVert,IModVar_mod_CarcasePartConnectionBtmVert,IModVar_mod_CarcasePartConnectionLeftHor,IModVar_mod_CarcasePartConnectionRightHor,IModVar_mod_CarcasePartConnectionTopVert,IModVar_mod_HangerOffsetPosY,IModVar_mod_HangerColor,IModVar_mod_RackAreaOversizeCarcaseType,IModVar_mod_RackAreaManualOffsetCarcase,IModVar_mod_CleatThk,IModVar_mod_CleatWidth,IModVar_mod_VertDividerType,IModVar_mod_SidepanelmiddleThk,IModVar_mod_CarcaseFrontConstruction,IModVar_mod_CarcasePartInfo,IModVar_mod_PushtoopenLine,IModVar_mod_PushtoopenType,IModVar_mod_PushtoopenColor,IModVar_mod_FramePartsWidthHor,IModVar_mod_FramePartsWidthVert,IModVar_mod_PanelWoodFrameFillingType,IModVar_mod_PanelWoodFrameType,IModVar_mod_CreateCountertop,IModVar_mod_CreateToekick,IModVar_mod_CreateFingergrip,IModVar_mod_CreatePaneltop,IModVar_mod_PlinthAreaPositionInfo,IModVar_mod_DoorDirection,IModVar_mod_SlopedCeilingDimensionLogic,IModVar_mod_SlopedCeilingConstruction,IModVar_mod_SlopeAngle,IModVar_mod_BackHeight,IModVar_mod_TopDepth,IModVar_mod_FrameFillingWoodColor,IModVar_mod_CountertopThk,IModVar_mod_CountertopInfo,IModVar_mod_SidepanelleftType,IModVar_mod_SidepanelrightType,IModVar_mod_GrainLogic,IModVar_mod_ShelfadjColor,IModVar_mod_FrameFillingColor
 {
  constructor(parent?: OD_Base, manufacturerMode?:boolean) {
    super('mr_StorageunitSingle', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this._g = new GlobalVars();
    this._openGroups = new Map<string, OpenGroup>();
    this._partGroups = new Map<string, PartGroup>();
    this._selfNonNull = new OD_M_mr_StorageunitSingle_NonNull(this);
  }
  _selfNonNull: OD_M_mr_StorageunitSingle_NonNull;
  ...
  override variants:string[] = ['mod_BackwallPos','mod_BackwallThk','mod_CarcaseBackwallConstruction','mod_CarcaseConnectionLeftBtm','mod_CarcaseConnectionLeftTop','mod_CarcaseConnectionRightBtm','mod_CarcaseConnectionRightTop','mod_CarcaseShelfbtmConstruction','mod_CarcaseShelftopConstruction','mod_CarcaseVisBack','mod_CarcaseVisBtm','mod_CarcaseVisLeft','mod_CarcaseVisRight','mod_CarcaseVisTop','mod_HandleLine','mod_HandlePosLogic','mod_HangerPosX','mod_HangerPosY','mod_PlinthAreaVisLeft','mod_PlinthAreaVisRight','mod_RailhortopbackThk','mod_RailhortopfrontThk','mod_RailverttopbackThk','mod_RailverttopfrontThk','mod_ShelfbtmThk','mod_ShelffixedThk','mod_ShelftopThk','mod_SidepanelleftThk','mod_SidepanelrightThk','mod_HardwareColor','mod_OpeningType','mod_CarcaseBackwallColor','mod_CarcaseBackwallProgram','mod_CarcaseColor','mod_CarcaseOutsideColor','mod_CarcaseEdgeBackColor','mod_CarcaseEdgeColor','mod_CarcaseEdgeFrontColor','mod_CarcaseProgram','mod_CarcaseOutsideProgram','mod_CarcaseShelfbtmOversizeInsideWall','mod_CarcaseShelfbtmOversizeLeft','mod_CarcaseShelfbtmOversizeRight','mod_CarcaseShelftopOversizeInsideWall','mod_CarcaseShelftopOversizeLeft','mod_CarcaseShelftopOversizeRight','mod_CarcaseSidepanelleftOversizeBtm','mod_CarcaseSidepanelleftOversizeInsideWall','mod_CarcaseSidepanelleftOversizeTop','mod_CarcaseSidepanelrightOversizeBtm','mod_CarcaseSidepanelrightOversizeInsideWall','mod_CarcaseSidepanelrightOversizeTop','mod_CarcaseDistanceWall','mod_Depth','mod_FingergripType','mod_FrontColor','mod_FrontEdgeColor','mod_FrontEdgeThk','mod_FrontFrameColor','mod_FrontGapCarcase','mod_FrontGapHor','mod_FrontGapVert','mod_FrontGlassColor','mod_FrontProgram','mod_FrontPosStart','mod_HandleColor','mod_HandleLength','mod_HandlePosType','mod_HangerType','mod_Height','mod_HeightPosInsertion','mod_LightPosX1','mod_LightPosX2','mod_LightPosX3','mod_LightPosX4','mod_LightPosX5','mod_LightPart','mod_LightPosX','mod_LightPosY','mod_LightSystem','mod_Model','mod_PlinthAreaHeight','mod_ShelfadjThk','mod_TypeElement','mod_Width','mod_BackwallFixedHeight','mod_HandleDesign','mod_FrontDesign','mod_PlinthAreaPosLeftMatrix','mod_PlinthAreaDesign','mod_PlinthAreaPosBackMatrix','mod_PlinthAreaPosFrontMatrix','mod_PlinthAreaPosRightMatrix','mod_PlinthAreaElementColor','mod_InteriorEquipmentLogic','mod_ParentName','mod_ModuleName','mod_PlinthAreaExtraItem','mod_FrontGapHorTop','mod_ShelvesBackwallFittingConnection','mod_FittingConnectionBtmVert','mod_FittingConnectionLeftBtm','mod_FittingConnectionLeftHor','mod_FittingConnectionLeftTop','mod_FittingConnectionRightBtm','mod_FittingConnectionRightHor','mod_FittingConnectionRightTop','mod_FittingConnectionTopVert','mod_CarcasePartConnectionBackHor','mod_CarcasePartConnectionBackVert','mod_CarcasePartConnectionBtmVert','mod_CarcasePartConnectionLeftHor','mod_CarcasePartConnectionRightHor','mod_CarcasePartConnectionTopVert','mod_HangerOffsetPosY','mod_HangerColor','mod_RackAreaOversizeCarcaseType','mod_RackAreaManualOffsetCarcase','mod_CleatThk','mod_CleatWidth','mod_VertDividerType','mod_SidepanelmiddleThk','mod_CarcaseFrontConstruction','mod_CarcasePartInfo','mod_PushtoopenLine','mod_PushtoopenType','mod_PushtoopenColor','mod_FramePartsWidthHor','mod_FramePartsWidthVert','mod_PanelWoodFrameFillingType','mod_PanelWoodFrameType','mod_CreateCountertop','mod_CreateToekick','mod_CreateFingergrip','mod_CreatePaneltop','mod_PlinthAreaPositionInfo','mod_DoorDirection','mod_SlopedCeilingDimensionLogic','mod_SlopedCeilingConstruction','mod_SlopeAngle','mod_BackHeight','mod_TopDepth','mod_FrameFillingWoodColor','mod_CountertopThk','mod_CountertopInfo','mod_SidepanelleftType','mod_SidepanelrightType','mod_GrainLogic','mod_ShelfadjColor','mod_FrameFillingColor',];
  ...
  get mod_RackAreaOversizeCarcaseType(): string | undefined { return this.#mod_RackAreaOversizeCarcaseType}
  set mod_RackAreaOversizeCarcaseType(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_RackAreaOversizeCarcaseType' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_RackAreaOversizeCarcaseType === value) return;
    this.#mod_RackAreaOversizeCarcaseType = value;
  }

  mod_RackAreaOversizeCarcaseType_matrix?: IMatrix_mod_RackAreaOversizeCarcaseType;
  #mod_RackAreaManualOffsetCarcase?: number;
  get mod_RackAreaManualOffsetCarcase(): number | undefined { return this.#mod_RackAreaManualOffsetCarcase}
  set mod_RackAreaManualOffsetCarcase(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_RackAreaManualOffsetCarcase' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_RackAreaManualOffsetCarcase === value) return;
    this.#mod_RackAreaManualOffsetCarcase = value;
  }

  mod_RackAreaManualOffsetCarcase_matrix?: IMatrix_mod_RackAreaManualOffsetCarcase;
  #mod_CleatThk?: number;
  ...
  res.set('mod_RackAreaOversizeCarcaseType', this.mod_RackAreaOversizeCarcaseType);
  res.set('mod_RackAreaManualOffsetCarcase', this.mod_RackAreaManualOffsetCarcase);
  ...
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_RackAreaOversizeCarcaseType');
    const val = _toString(json['attributes']['mod_RackAreaOversizeCarcaseType'], 'mod_RackAreaOversizeCarcaseType');
    internal_leaveValidateVariant();
    this.mod_RackAreaOversizeCarcaseType = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_RackAreaManualOffsetCarcase');
    const val = _toFloat(json['attributes']['mod_RackAreaManualOffsetCarcase'], 'mod_RackAreaManualOffsetCarcase');
    internal_leaveValidateVariant();
    this.mod_RackAreaManualOffsetCarcase = val; }
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ParentName === undefined) {
      this.mod_ParentName = "mr_StorageunitSingle";
    }
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mr_StorageunitSingle";
    }
    ...
    if (this.mod_SidepanelmiddleThk === undefined) {
      this.mod_SidepanelmiddleThk = 19;
    }
...
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
      // CUSTOMSCRIPT_mr_StorageunitSingle_mod_CarcaseBackwallColor_SETDEFAULT
...
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
      // CUSTOMSCRIPT_mr_StorageunitSingle_mod_CarcaseBackwallProgram_SETDEFAULT
...
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
      // CUSTOMSCRIPT_mr_StorageunitSingle_mod_CarcaseOutsideColor_SETDEFAULT
...
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
      // CUSTOMSCRIPT_mr_StorageunitSingle_mod_CarcaseEdgeBackColor_SETDEFAULT
...
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
      // CUSTOMSCRIPT_mr_StorageunitSingle_mod_CarcaseEdgeColor_SETDEFAULT
...
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
      // CUSTOMSCRIPT_mr_StorageunitSingle_mod_CarcaseEdgeFrontColor_SETDEFAULT
...
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
      // CUSTOMSCRIPT_mr_StorageunitSingle_mod_CarcaseOutsideProgram_SETDEFAULT
...
// ###############################################################
    ...
    if (this.mod_InteriorEquipmentLogic === undefined) {
      this.mod_InteriorEquipmentLogic = this.g.basic_InteriorEquipmentLogic;
    }
    ...
    if (this.mod_RackAreaOversizeCarcaseType === undefined) {
      this.mod_RackAreaOversizeCarcaseType = this.g.basic_RackAreaOversizeCarcaseType;
    }
    if (this.mod_RackAreaManualOffsetCarcase === undefined) {
      this.mod_RackAreaManualOffsetCarcase = this.g.basic_RackAreaManualOffsetCarcase;
    }
...
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
      // CUSTOMSCRIPT_mr_StorageunitSingle_mod_ShelfadjColor_SETDEFAULT
...
// ###############################################################
  ...
  #manufacturerDataCompletionInternal = mr_StorageunitSingle_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mr_StorageunitSingle_NonNull(this);
  ...
  seal(): IModuleNonNull_mr_StorageunitSingle{
    ...
    const adc = new OD_M_mr_StorageunitSingle_NonNull(this);
    return adc;
  }
  ...
  addOD_M_mf_Fliplift(index?: number): dc_mf_Fliplift {
    var m = new OD_M_mf_Fliplift(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  addOD_M_mf_Fixedfront(index?: number): dc_mf_Fixedfront {
    var m = new OD_M_mf_Fixedfront(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  override validateSelections():void {
    ...
    this.mod_RackAreaOversizeCarcaseType_matrix = VariantValidation.mod_RackAreaOversizeCarcaseType(this, this);
    this.mod_RackAreaManualOffsetCarcase_matrix = VariantValidation.mod_RackAreaManualOffsetCarcase(this, this);
  ...
  override createBuildPlan():void {
    var cbp = new OD_M_mr_StorageunitSingle_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mr_StorageunitSingle_NonNull implements cbp_mr_StorageunitSingle, adc_mr_StorageunitSingle ,IPartParentsNonNull_mr_CornerunitStraight_mr_StorageunitSingle,IPartParentsNonNull_mr_CornerunitStraight_mr_Filler01_mr_StorageunitSingle,IPartParentsNonNull_mr_StorageunitSingle {
  constructor(parent: OD_M_mr_StorageunitSingle) {
    this.#internalParent = parent;
  }
  #internalParent: OD_M_mr_StorageunitSingle;
  ...
  #createBuildPlanInternal = mr_StorageunitSingle_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mr_StorageunitSingle_afterDataCompletion;
...
addInsertLevelHeight(height:number, isDefault: boolean|undefined = undefined) : IInsertLevelInfo  { return this.#internalParent.addInsertLevelHeight(height, isDefault); }
  ...
  get mod_RackAreaOversizeCarcaseType(): string  {
    return this.#internalParent.mod_RackAreaOversizeCarcaseType!;
  }
  get mod_RackAreaManualOffsetCarcase(): number  {
    return this.#internalParent.mod_RackAreaManualOffsetCarcase!;
  }
  ...
  addOD_M_mf_Fliplift(index?: number): dc_mf_Fliplift {
    return this.#internalParent.addOD_M_mf_Fliplift(index);
  }
  addOD_M_mf_Door(index?: number): dc_mf_Door {
    return this.#internalParent.addOD_M_mf_Door(index);
  }
  addOD_M_mf_Oven(index?: number): dc_mf_Oven {
    return this.#internalParent.addOD_M_mf_Oven(index);
  }
  addOD_M_mf_Fridge(index?: number): dc_mf_Fridge {
    return this.#internalParent.addOD_M_mf_Fridge(index);
  }
  addOD_M_mf_RackArea(index?: number): dc_mf_RackArea {
    return this.#internalParent.addOD_M_mf_RackArea(index);
  }
  addOD_M_mf_Fixedfront(index?: number): dc_mf_Fixedfront {
    return this.#internalParent.addOD_M_mf_Fixedfront(index);
  }
  addOD_M_mf_Hob(index?: number): dc_mf_Hob {
    return this.#internalParent.addOD_M_mf_Hob(index);
  }
  addOD_M_mf_Sink(index?: number): dc_mf_Sink {
    return this.#internalParent.addOD_M_mf_Sink(index);
  }
}
