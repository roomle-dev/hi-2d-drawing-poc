...
//#region Imports
import { cbp_mc_ShelffixedGroup01, dc_mc_ShelffixedGroup01, adc_mc_ShelffixedGroup01 } from '../internal/modules/mc_ShelffixedGroup01'
...
export function mc_ShelffixedGroup01_createBuildPlan(this: cbp_mc_ShelffixedGroup01):void {
  internal_enterModuleCreateBuildPlan('mc_ShelffixedGroup01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_ShelffixedGroup01_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: July 2024
...
// ---------------------------------------------------------------
export function mc_ShelffixedGroup01_afterDataCompletion(this: adc_mc_ShelffixedGroup01):void {
  internal_enterModuleAfterDataCompletion('mc_ShelffixedGroup01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_ShelffixedGroup01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_ShelffixedGroup01_manufacturerDataCompletion(this: dc_mc_ShelffixedGroup01):void {
  internal_enterModuleManufacturerDataCompletion('mc_ShelffixedGroup01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_ShelffixedGroup01_MANUFACTURERDATACOMPLETION
