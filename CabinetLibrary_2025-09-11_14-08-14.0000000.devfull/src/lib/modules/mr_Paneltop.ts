...
//#region Imports
import { cbp_mr_Paneltop, dc_mr_Paneltop, adc_mr_Paneltop } from '../internal/modules/mr_Paneltop'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_Paneltop01, OD_M_mc_Paneltop01 } from '../internal/modules/mc_Paneltop01'
...
export function mr_Paneltop_createBuildPlan(this: cbp_mr_Paneltop):void {
  internal_enterModuleCreateBuildPlan('mr_Paneltop', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mr_Paneltop_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mr_Paneltop_afterDataCompletion(this: adc_mr_Paneltop):void {
  internal_enterModuleAfterDataCompletion('mr_Paneltop', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mr_Paneltop_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mr_Paneltop_manufacturerDataCompletion(this: dc_mr_Paneltop):void {
  internal_enterModuleManufacturerDataCompletion('mr_Paneltop', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mr_Paneltop_MANUFACTURERDATACOMPLETION
