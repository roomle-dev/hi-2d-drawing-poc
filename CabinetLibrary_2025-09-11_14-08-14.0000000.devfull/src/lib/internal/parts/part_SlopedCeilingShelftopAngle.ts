...
export interface IP_part_SlopedCeilingShelftopAngle_PartVarsReadOnly extends IPartBase {
...
export interface IP_part_SlopedCeilingShelftopAngle_PartVarsWritable extends IP_part_SlopedCeilingShelftopAngle_PartVarsReadOnly {
...
export class P_part_SlopedCeilingShelftopAngle extends PartBase implements IP_part_SlopedCeilingShelftopAngle_PartVarsWritable {
...
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_SlopedCeilingShelftopAngle', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XZY';
  }
  ...
  setAttributes() {
    ...
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // part_SlopedCeilingShelftopAngle_ValueScript
  ...
  checkAttributes() {
    ...
    if (this.#pa_AdditionalInfo1 === undefined) {
      logError('Attribute pa_AdditionalInfo1 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_BomId === undefined) {
      logError('Attribute pa_BomId not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_BtmColor === undefined) {
      logError('Attribute pa_BtmColor not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_CarcaseConnectionLeftTop === undefined) {
      logError('Attribute pa_CarcaseConnectionLeftTop not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_CarcaseConnectionRightTop === undefined) {
      logError('Attribute pa_CarcaseConnectionRightTop not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_CarcasePartConnectionTopVert === undefined) {
      logError('Attribute pa_CarcasePartConnectionTopVert not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackColor === undefined) {
      logError('Attribute pa_EdgeBackColor not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackType === undefined) {
      logError('Attribute pa_EdgeBackType not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      logError('Attribute pa_EdgeFrontColor not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontType === undefined) {
      logError('Attribute pa_EdgeFrontType not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeJointType === undefined) {
      logError('Attribute pa_EdgeJointType not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftColor === undefined) {
      logError('Attribute pa_EdgeLeftColor not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftType === undefined) {
      logError('Attribute pa_EdgeLeftType not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightColor === undefined) {
      logError('Attribute pa_EdgeRightColor not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightType === undefined) {
      logError('Attribute pa_EdgeRightType not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionLeftTop === undefined) {
      logError('Attribute pa_FittingConnectionLeftTop not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionRightTop === undefined) {
      logError('Attribute pa_FittingConnectionRightTop not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionTopVert === undefined) {
      logError('Attribute pa_FittingConnectionTopVert not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_GrainDirection === undefined) {
      logError('Attribute pa_GrainDirection not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareColor === undefined) {
      logError('Attribute pa_HardwareColor not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareQty1 === undefined) {
      logError('Attribute pa_HardwareQty1 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareQty3 === undefined) {
      logError('Attribute pa_HardwareQty3 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareQty5 === undefined) {
      logError('Attribute pa_HardwareQty5 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareQty2 === undefined) {
      logError('Attribute pa_HardwareQty2 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareQty4 === undefined) {
      logError('Attribute pa_HardwareQty4 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier1 === undefined) {
      logError('Attribute pa_HardwareSupplier1 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier2 === undefined) {
      logError('Attribute pa_HardwareSupplier2 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier3 === undefined) {
      logError('Attribute pa_HardwareSupplier3 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier4 === undefined) {
      logError('Attribute pa_HardwareSupplier4 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplier5 === undefined) {
      logError('Attribute pa_HardwareSupplier5 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle1 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle1 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle2 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle2 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle4 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle4 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle3 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle3 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_HardwareSupplierArticle5 === undefined) {
      logError('Attribute pa_HardwareSupplierArticle5 not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_ParentName === undefined) {
      logError('Attribute pa_ParentName not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_Program === undefined) {
      logError('Attribute pa_Program not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_TopColor === undefined) {
      logError('Attribute pa_TopColor not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_TypeElement === undefined) {
      logError('Attribute pa_TypeElement not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_AngleBack === undefined) {
      logError('Attribute pa_AngleBack not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_AngleFront === undefined) {
      logError('Attribute pa_AngleFront not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_AngleLeft === undefined) {
      logError('Attribute pa_AngleLeft not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
    if (this.#pa_AngleRight === undefined) {
      logError('Attribute pa_AngleRight not set in part part_SlopedCeilingShelftopAngle (id: ' + this._id + ')');
    }
  ...
  createBomElements() {
    ...
    const partSelf = this;
      ...
      if (partSelf._g?.basic_CreateBom == 'Library') { // ####################### CUSTOM SCRIPTS ########################
        ...
        const _bom = new class BOM214 extends BOM_ElementType_bomout_Board {
          constructor() { super(partSelf); }
          set(partSelf: IP_part_SlopedCeilingShelftopAngle_PartVarsReadOnly) {
            const part = partSelf;
  ...
  override createBomTouchElementsEnd() : void { 
      try {
        ...
        if (partSelf.pa_AngleBack != 0) { // ####################### CUSTOM SCRIPTS ########################
          ...
          const _bom = new class BOMT565 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_SlopedCeilingShelftopAngle_PartVarsReadOnly) {
              internal_enterBomPartMasterDataTouchesEnd(partSelf._id, partSelf._partId);
               // ####################### CUSTOM SCRIPTS ########################
GlobalFunc.ops_SawingAngle(this, 'AngledCutInLengthPositiveAngle', 0, partSelf._dimz, partSelf._dimx, partSelf._dimz, partSelf.pa_AngleBack);
               // ################### END CUSTOM SCRIPTS ########################
      ...
      try {
        const partSelf = this;
        if (partSelf.pa_AngleFront != 0) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT566 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_SlopedCeilingShelftopAngle_PartVarsReadOnly) {
              internal_enterBomPartMasterDataTouchesEnd(partSelf._id, partSelf._partId);
               // ####################### CUSTOM SCRIPTS ########################
GlobalFunc.ops_SawingAngle(this, 'AngledCutInLengthNegativeAngle', 0, 0, partSelf._dimx, 0, partSelf.pa_AngleFront);
               // ################### END CUSTOM SCRIPTS ########################
              internal_leaveBomPartMasterDataTouches();
            }
          }
          _bom._parentId = partSelf._id;
          _bom._description = "Sawing Angle in the Front";
          _bom.set(partSelf);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
