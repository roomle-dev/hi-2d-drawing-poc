...
//#region Imports
import { cbp_mc_Sink01, dc_mc_Sink01, adc_mc_Sink01 } from '../internal/modules/mc_Sink01'
...
export function mc_Sink01_createBuildPlan(this: cbp_mc_Sink01):void {
  internal_enterModuleCreateBuildPlan('mc_Sink01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Sink01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_Sink01_afterDataCompletion(this: adc_mc_Sink01):void {
  internal_enterModuleAfterDataCompletion('mc_Sink01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Sink01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Sink01_manufacturerDataCompletion(this: dc_mc_Sink01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Sink01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Sink01_MANUFACTURERDATACOMPLETION
