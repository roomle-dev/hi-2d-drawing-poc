...
export interface IP_part_DoorPanelWoodFrame_PartVarsReadOnly extends IPartBase {
...
export interface IP_part_DoorPanelWoodFrame_PartVarsWritable extends IP_part_DoorPanelWoodFrame_PartVarsReadOnly {
  ...
  set pa_DoorDirection(value: string);
...
export class P_part_DoorPanelWoodFrame extends PartBase implements IP_part_DoorPanelWoodFrame_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_PanelWoodFrame01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_DoorPanelWoodFrame', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  ...
  res.set('pa_DoorDirection', this.#pa_DoorDirection);
  ...
  setAttributes() {
    ...
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // part_DoorPanelWoodFrame_ValueScript
    ...
    if (this.#pa_DoorDirection === undefined) {
      this.pa_DoorDirection = this.parent.mod_DoorDirection;
    }
  ...
  checkAttributes() {
    ...
    if (this.#pa_BomId === undefined) {
      logError('Attribute pa_BomId not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_BtmColor === undefined) {
      logError('Attribute pa_BtmColor not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackColor === undefined) {
      logError('Attribute pa_EdgeBackColor not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackType === undefined) {
      logError('Attribute pa_EdgeBackType not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      logError('Attribute pa_EdgeFrontColor not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontType === undefined) {
      logError('Attribute pa_EdgeFrontType not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeJointType === undefined) {
      logError('Attribute pa_EdgeJointType not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftColor === undefined) {
      logError('Attribute pa_EdgeLeftColor not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftType === undefined) {
      logError('Attribute pa_EdgeLeftType not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightColor === undefined) {
      logError('Attribute pa_EdgeRightColor not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightType === undefined) {
      logError('Attribute pa_EdgeRightType not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrameFillingMaterial === undefined) {
      logError('Attribute pa_FrameFillingMaterial not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_DoorDirection === undefined) {
      logError('Attribute pa_DoorDirection not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrameFillingThk === undefined) {
      logError('Attribute pa_FrameFillingThk not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FramePartsWidthHor === undefined) {
      logError('Attribute pa_FramePartsWidthHor not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FramePartsWidthVert === undefined) {
      logError('Attribute pa_FramePartsWidthVert not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_GrainDirection === undefined) {
      logError('Attribute pa_GrainDirection not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_PanelWoodFrameType === undefined) {
      logError('Attribute pa_PanelWoodFrameType not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_Program === undefined) {
      logError('Attribute pa_Program not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_TopColor === undefined) {
      logError('Attribute pa_TopColor not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_TypeElement === undefined) {
      logError('Attribute pa_TypeElement not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_Weight === undefined) {
      logError('Attribute pa_Weight not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_AdditionalInfo1 === undefined) {
      logError('Attribute pa_AdditionalInfo1 not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrameFillingWoodColor === undefined) {
      logError('Attribute pa_FrameFillingWoodColor not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrontGlassColor === undefined) {
      logError('Attribute pa_FrontGlassColor not set in part part_DoorPanelWoodFrame (id: ' + this._id + ')');
    }
  ...
  createBomElements() {
    ...
    const partSelf = this;
      ...
      if (partSelf._g?.basic_CreateBom == 'Library') { // ####################### CUSTOM SCRIPTS ########################
        ...
        const _bom = new class BOM204 extends BOM_ElementType_bomout_Group {
          constructor() { super(partSelf); }
          set(partSelf: IP_part_DoorPanelWoodFrame_PartVarsReadOnly) {
            const part = partSelf;
...
//====================================================================
  ...
  override createBomTouchElements(touch: PartTouch, partNext: PartBase, posRel: CollisionDataRel) {
      try {
      // ncout_Group: 522: part_HandleDrill FromFront
    if (touch == PartTouch.FromFront && partNext instanceof P_part_HandleDrill) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          ...
          const _bom = new class BOMT522 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_DoorPanelWoodFrame_PartVarsReadOnly, touch: PartTouch, part2: IP_part_HandleDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
...
GlobalFunc.ncout_HandleDrill(this, partSelf, part2, posRel)
      ...
      try {
      // ncout_Group: 523: part_HingeDrill FromBack
    if (touch == PartTouch.FromBack && partNext instanceof P_part_HingeDrill) {
        let part2 = <P_part_HingeDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT523 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_DoorPanelWoodFrame_PartVarsReadOnly, touch: PartTouch, part2: IP_part_HingeDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//====================================================================
  ...
  drillings.forEach(x => {
    ...
    if (posRel.x < partSelf._dimx / 2) {
      ...
      try {
      // ncout_Group: 524: part_PushtoopenDrill FromBack
    if (touch == PartTouch.FromBack && partNext instanceof P_part_PushtoopenDrill) {
        let part2 = <P_part_PushtoopenDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT524 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_DoorPanelWoodFrame_PartVarsReadOnly, touch: PartTouch, part2: IP_part_PushtoopenDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
GlobalFunc.ops_PushtoopenDrill('Front', this, partSelf, part2, posRel);
      ...
      try {
      // ncout_Group: 525: part_PushtoopenMountingPlateDrill FromBack
    if (touch == PartTouch.FromBack && partNext instanceof P_part_PushtoopenMountingPlateDrill) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT525 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_DoorPanelWoodFrame_PartVarsReadOnly, touch: PartTouch, part2: IP_part_PushtoopenMountingPlateDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
GlobalFunc.ops_PushtoopenDrill('Front', this, partSelf, part2, posRel);
  ...
  override createBomTouchElementsEnd() : void { 
      try {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT534 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_DoorPanelWoodFrame_PartVarsReadOnly) {
...
// Call the function to show the drillings in the graphic
  ...
  get pa_DoorDirection(): string { return this.#pa_DoorDirection!; }
  set pa_DoorDirection(val:string) { this.#pa_DoorDirection = val; }
  #pa_DoorDirection?: string;
