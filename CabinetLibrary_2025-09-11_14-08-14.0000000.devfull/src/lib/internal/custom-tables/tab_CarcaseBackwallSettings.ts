...
export interface cti_tab_CarcaseBackwallSettings {
  readonly in_BackwallConstruction? : string;
}

export interface ctm_tab_CarcaseBackwallSettings {
}

export interface cto_tab_CarcaseBackwallSettings extends ctm_tab_CarcaseBackwallSettings {
  readonly _id : number;
  readonly ConstructionBackwallRight? : string;
  readonly ConstructionBackwallBottom? : string;
  readonly ConstructionBackwallLeft? : string;
  readonly ConstructionBackwallTop? : string;
  readonly RailVertBackInFrontBackwall? : string;
  readonly RailVertBackBehindBackwall? : string;
}

export interface ICT_tab_CarcaseBackwallSettings
extends cti_tab_CarcaseBackwallSettings, cto_tab_CarcaseBackwallSettings {}

export class ct2_tab_CarcaseBackwallSettings {

public findExactly(
     in_BackwallConstruction: string|undefined,
): cto_tab_CarcaseBackwallSettings | undefined {
  const res = ct_tab_CarcaseBackwallSettings.find((p) => 
...
public find(
predicate: (value: cti_tab_CarcaseBackwallSettings) => boolean
): cto_tab_CarcaseBackwallSettings | undefined {
  for (let index = 0; index < ct_tab_CarcaseBackwallSettings.length; index++){
    const element = ct_tab_CarcaseBackwallSettings[index];
...
export var ct_tab_CarcaseBackwallSettings :ICT_tab_CarcaseBackwallSettings[] = [
{
 _id: 44,
 in_BackwallConstruction: "Grooved_LBRT",
 ConstructionBackwallRight: "Inlayed",
 ConstructionBackwallBottom: "Inlayed",
 ConstructionBackwallLeft: "Inlayed",
 ConstructionBackwallTop: "Inlayed",
 RailVertBackInFrontBackwall: "Inlayed",
 RailVertBackBehindBackwall: "Inlayed"
}
,{
 _id: 45,
 in_BackwallConstruction: "Grooved_LRT",
 ConstructionBackwallRight: "Inlayed",
 ConstructionBackwallBottom: "Overlayed",
 ConstructionBackwallLeft: "Inlayed",
 ConstructionBackwallTop: "Inlayed",
 RailVertBackInFrontBackwall: "Inlayed",
 RailVertBackBehindBackwall: "Inlayed"
...
,{
 ...
 ConstructionBackwallBottom: "Inlayed",
 ConstructionBackwallLeft: "Inlayed",
 ConstructionBackwallTop: "Overlayed",
 RailVertBackInFrontBackwall: "Overlayed",
 RailVertBackBehindBackwall: "Backside"
}
,{
 _id: 47,
...
,{
 _id: 48,
 in_BackwallConstruction: "Rebated_LBRT",
 ConstructionBackwallRight: "Inlayed",
 ConstructionBackwallBottom: "Inlayed",
 ConstructionBackwallLeft: "Inlayed",
 ConstructionBackwallTop: "Inlayed",
...
,{
 _id: 49,
 in_BackwallConstruction: "Rebated_LRT",
 ConstructionBackwallRight: "Inlayed",
 ConstructionBackwallBottom: "Overlayed",
 ConstructionBackwallLeft: "Inlayed",
 ConstructionBackwallTop: "Inlayed",
...
,{
 _id: 50,
 in_BackwallConstruction: "Rebated_LBR",
 ConstructionBackwallRight: "Inlayed",
 ConstructionBackwallBottom: "Inlayed",
 ConstructionBackwallLeft: "Inlayed",
 ConstructionBackwallTop: "Overlayed",
...
,{
 _id: 51,
 in_BackwallConstruction: "Rebated_LR",
 ConstructionBackwallRight: "Inlayed",
 ConstructionBackwallBottom: "Overlayed",
 ConstructionBackwallLeft: "Inlayed",
 ConstructionBackwallTop: "Overlayed",
...
,{
 ...
 ConstructionBackwallRight: "Overlayed",
 ConstructionBackwallBottom: "Overlayed",
 ConstructionBackwallLeft: "Overlayed",
 ConstructionBackwallTop: "Overlayed",
 RailVertBackInFrontBackwall: "Overlayed",
 RailVertBackBehindBackwall: "Backside"
}
...
,{
 ...
 ConstructionBackwallLeft: "Inlayed",
 ConstructionBackwallTop: "Inlayed",
 RailVertBackInFrontBackwall: "n.a.",
 RailVertBackBehindBackwall: "n.a."
}
,{
 _id: 56,
