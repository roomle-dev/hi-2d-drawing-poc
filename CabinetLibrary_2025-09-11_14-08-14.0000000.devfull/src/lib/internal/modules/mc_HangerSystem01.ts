...
import { IP_part_HangerSystem_PartVarsWritable, P_part_HangerSystem } from '../parts/part_HangerSystem'
import { IP_part_HangerSystemBom_PartVarsWritable, P_part_HangerSystemBom } from '../parts/part_HangerSystemBom'
import { IP_part_HangerDrill_PartVarsWritable, P_part_HangerDrill } from '../parts/part_HangerDrill'
import { IModuleNonNull_mc_HangerSystem01,IModParents_mc_HangerSystem01,IPartParentsNonNull_mc_HangerSystem01} from '../mod-interfaces'
import {IModVar_mod_HangerPosX,IModVarNonNull_mod_HangerPosX,IModVar_mod_HangerPosY,IModVarNonNull_mod_HangerPosY,IModVar_mod_HangerType,IModVarNonNull_mod_HangerType,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_HangerInfo,IModVarNonNull_mod_HangerInfo,IModVar_mod_BackwallThk,IModVarNonNull_mod_BackwallThk,IModVar_mod_Originpos,IModVarNonNull_mod_Originpos} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_HangerPosX, IMatrix_mod_HangerPosY, IMatrix_mod_HangerType, IMatrix_mod_ModuleName, IMatrix_mod_BackwallThk} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_HangerSystem, IPartAdd_part_HangerSystemBom, IPartAdd_part_HangerDrill } from '../part-add-interfaces';
import { mc_HangerSystem01_createBuildPlan, mc_HangerSystem01_afterDataCompletion, mc_HangerSystem01_manufacturerDataCompletion } from '../../modules/mc_HangerSystem01';

export interface cbp_mc_HangerSystem01 extends IModBaseProp
, IPartAdd_part_HangerSystem, IPartAdd_part_HangerSystemBom, IPartAdd_part_HangerDrill, IModVarNonNull_mod_HangerPosX, IModVarNonNull_mod_HangerPosY, IModVarNonNull_mod_HangerType, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_HangerInfo, IModVarNonNull_mod_BackwallThk, IModVarNonNull_mod_Originpos {
...
export interface dc_mc_HangerSystem01 extends IModBaseProp
, IModVar_mod_HangerPosX, IModVar_mod_HangerPosY, IModVar_mod_HangerType, IModVar_mod_ModuleName, IModVar_mod_HangerInfo, IModVar_mod_BackwallThk, IModVar_mod_Originpos {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_HangerSystem01;
  parent: IModParents_mc_Storageunit01;
}

export interface adc_mc_HangerSystem01 extends IModBaseProp
...
export class OD_M_mc_HangerSystem01 extends OD_Base  implements dc_mc_HangerSystem01
,IModParents_mc_HangerSystem01
,IModVar_mod_HangerPosX,IModVar_mod_HangerPosY,IModVar_mod_HangerType,IModVar_mod_ModuleName,IModVar_mod_HangerInfo,IModVar_mod_BackwallThk,IModVar_mod_Originpos
 {
  constructor(parent: IModParents_mc_Storageunit01, manufacturerMode?:boolean) {
    super('mc_HangerSystem01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_HangerSystem01_NonNull(this);
  }
  parent: IModParents_mc_Storageunit01;
  _selfNonNull: OD_M_mc_HangerSystem01_NonNull;

  override variants:string[] = ['mod_HangerPosX','mod_HangerPosY','mod_HangerType','mod_ModuleName','mod_HangerInfo','mod_BackwallThk','mod_Originpos',];
  ...
  get mod_HangerInfo(): string[] { return this.#mod_HangerInfo;}
  ...
  res.set('mod_HangerInfo', JSON.stringify(this.mod_HangerInfo));
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_HangerPosX === undefined) {
      ...
      while (s !== undefined) {
        if (s.variants.includes('mod_HangerPosX')) {
          let pv = <IModVar_mod_HangerPosX>s;
          if (pv.mod_HangerPosX !== undefined) {
            this.mod_HangerPosX = (<IModVar_mod_HangerPosX>s).mod_HangerPosX;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_HangerPosY === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_HangerPosY')) {
          let pv = <IModVar_mod_HangerPosY>s;
          if (pv.mod_HangerPosY !== undefined) {
            this.mod_HangerPosY = (<IModVar_mod_HangerPosY>s).mod_HangerPosY;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_HangerType === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_HangerType')) {
          let pv = <IModVar_mod_HangerType>s;
          if (pv.mod_HangerType !== undefined) {
            this.mod_HangerType = (<IModVar_mod_HangerType>s).mod_HangerType;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_BackwallThk === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_BackwallThk')) {
          let pv = <IModVar_mod_BackwallThk>s;
          if (pv.mod_BackwallThk !== undefined) {
            this.mod_BackwallThk = (<IModVar_mod_BackwallThk>s).mod_BackwallThk;
            break;
          };
        }
        s = s.parentBase;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_HangerSystem01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_HangerSystem01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_HangerSystem01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_HangerSystem01{
    ...
    const adc = new OD_M_mc_HangerSystem01_NonNull(this);
    return adc;
  }
  ...
  addpart_HangerSystem(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HangerSystem_PartVarsWritable {
    var c = new P_part_HangerSystem(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_HangerSystemBom(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HangerSystemBom_PartVarsWritable {
    var c = new P_part_HangerSystemBom(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_HangerDrill(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HangerDrill_PartVarsWritable {
    var c = new P_part_HangerDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_HangerSystem01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_HangerSystem01_NonNull implements cbp_mc_HangerSystem01, adc_mc_HangerSystem01 ,IPartParentsNonNull_mc_HangerSystem01 {
  constructor(parent: OD_M_mc_HangerSystem01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_HangerSystem01;
  ...
  #createBuildPlanInternal = mc_HangerSystem01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_HangerSystem01_afterDataCompletion;
  ...
  parent: IModParents_mc_Storageunit01;
  addpart_HangerSystem(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HangerSystem_PartVarsWritable {
    return this.#internalParent.addpart_HangerSystem(x, y, z, dimx, dimy, dimz);
  }
  addpart_HangerSystemBom(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HangerSystemBom_PartVarsWritable {
    return this.#internalParent.addpart_HangerSystemBom(x, y, z, dimx, dimy, dimz);
  }
  addpart_HangerDrill(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HangerDrill_PartVarsWritable {
    return this.#internalParent.addpart_HangerDrill(x, y, z, dimx, dimy, dimz);
  }
  ...
  get mod_HangerInfo(): string [] {
    return this.#internalParent.mod_HangerInfo!;
  }
