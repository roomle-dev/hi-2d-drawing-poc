...
//#region Imports
import { cbp_mc_Oven01, dc_mc_Oven01, adc_mc_Oven01 } from '../internal/modules/mc_Oven01'
...
export function mc_Oven01_createBuildPlan(this: cbp_mc_Oven01):void {
  internal_enterModuleCreateBuildPlan('mc_Oven01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Oven01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_Oven01_afterDataCompletion(this: adc_mc_Oven01):void {
  internal_enterModuleAfterDataCompletion('mc_Oven01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Oven01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Oven01_manufacturerDataCompletion(this: dc_mc_Oven01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Oven01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Oven01_MANUFACTURERDATACOMPLETION
