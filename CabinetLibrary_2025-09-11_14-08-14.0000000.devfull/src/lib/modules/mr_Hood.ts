...
//#region Imports
import { cbp_mr_Hood, dc_mr_Hood, adc_mr_Hood } from '../internal/modules/mr_Hood'
...
export function mr_Hood_createBuildPlan(this: cbp_mr_Hood):void {
  internal_enterModuleCreateBuildPlan('mr_Hood', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mr_Hood_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mr_Hood_afterDataCompletion(this: adc_mr_Hood):void {
  internal_enterModuleAfterDataCompletion('mr_Hood', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mr_Hood_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mr_Hood_manufacturerDataCompletion(this: dc_mr_Hood):void {
  internal_enterModuleManufacturerDataCompletion('mr_Hood', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mr_Hood_MANUFACTURERDATACOMPLETION
