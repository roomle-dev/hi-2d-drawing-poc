...
export interface cti_tab_DrawerBoxWeightTypeSettings {
  ...
  readonly in_DrawerBoxDepthType? : string;
  readonly in_DrawerBoxHeightType? : string;
  readonly in_FrontpanelWeightMin : number;
  readonly in_FrontpanelWeightMax : number;
}

export interface ctm_tab_DrawerBoxWeightTypeSettings {
}

export interface cto_tab_DrawerBoxWeightTypeSettings extends ctm_tab_DrawerBoxWeightTypeSettings {
  readonly _id : number;
  readonly DrawerBoxWeightType? : string;
}

export interface ICT_tab_DrawerBoxWeightTypeSettings
extends cti_tab_DrawerBoxWeightTypeSettings, cto_tab_DrawerBoxWeightTypeSettings {}

export class ct2_tab_DrawerBoxWeightTypeSettings {

public findExactly(
     in_TypeElement: string|undefined,
     in_FrontWidthMin: number,
     in_FrontWidthMax: number,
     in_FrontHeightMin: number,
     in_FrontHeightMax: number,
     in_DrawerBoxDepthType: string|undefined,
     in_DrawerBoxHeightType: string|undefined,
     in_FrontpanelWeightMin: number,
     in_FrontpanelWeightMax: number,
): cto_tab_DrawerBoxWeightTypeSettings | undefined {
  const res = ct_tab_DrawerBoxWeightTypeSettings.find((p) => 
p.in_TypeElement === in_TypeElement
 ...
 && p.in_DrawerBoxDepthType === in_DrawerBoxDepthType
 && p.in_DrawerBoxHeightType === in_DrawerBoxHeightType
 && p.in_FrontpanelWeightMin === in_FrontpanelWeightMin
 && p.in_FrontpanelWeightMax === in_FrontpanelWeightMax
);
return res;
}

public find(
predicate: (value: cti_tab_DrawerBoxWeightTypeSettings) => boolean
): cto_tab_DrawerBoxWeightTypeSettings | undefined {
  for (let index = 0; index < ct_tab_DrawerBoxWeightTypeSettings.length; index++){
    const element = ct_tab_DrawerBoxWeightTypeSettings[index];
...
export var ct_tab_DrawerBoxWeightTypeSettings :ICT_tab_DrawerBoxWeightTypeSettings[] = [
{
 _id: 6,
 in_TypeElement: "All",
 in_FrontWidthMin: 595,
 in_FrontWidthMax: 9999,
 in_FrontHeightMin: 545,
 in_FrontHeightMax: 9999,
 in_DrawerBoxDepthType: "All",
 in_DrawerBoxHeightType: "C",
 in_FrontpanelWeightMin: 0,
 in_FrontpanelWeightMax: 40,
 DrawerBoxWeightType: "Heavy"
}
,{
 _id: 7,
 in_TypeElement: "All",
...
,{
 ...
 in_DrawerBoxDepthType: "All",
 in_DrawerBoxHeightType: "C",
 in_FrontpanelWeightMin: 40.1,
 in_FrontpanelWeightMax: 70,
 DrawerBoxWeightType: "Heavy"
}
,{
 _id: 9,
...
,{
 ...
 in_FrontHeightMax: 9999,
 in_DrawerBoxDepthType: "All",
 in_DrawerBoxHeightType: "All",
 in_FrontpanelWeightMin: 0,
 in_FrontpanelWeightMax: 2,
 DrawerBoxWeightType: "Standard"
}
,{
 _id: 11,
 in_TypeElement: "All",
 ...
 in_DrawerBoxDepthType: "All",
 in_DrawerBoxHeightType: "All",
 in_FrontpanelWeightMin: 2.01,
 in_FrontpanelWeightMax: 9999,
 DrawerBoxWeightType: "Heavy"
}
];
