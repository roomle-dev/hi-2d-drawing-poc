...
import { IPartParentsNonNull_mc_LightSystem01 } from '../mod-interfaces'

export interface IP_part_LightSystem_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_LightSystem01;
}

export interface IP_part_LightSystem_PartVarsWritable extends IP_part_LightSystem_PartVarsReadOnly {
}

export class P_part_LightSystem extends PartBase implements IP_part_LightSystem_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_LightSystem01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_LightSystem', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
  parent: IPartParentsNonNull_mc_LightSystem01; // module which created this part
