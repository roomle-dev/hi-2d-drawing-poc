...
export interface cti_tab_FillerSettings {
  readonly in_FillerType? : string;
  readonly in_Direction? : string;
  readonly in_AdditionalInfo01? : string;
}

export interface ctm_tab_FillerSettings {
}

export interface cto_tab_FillerSettings extends ctm_tab_FillerSettings {
  readonly _id : number;
  readonly SidepanelleftType? : string;
  readonly SidepanelrightType? : string;
  readonly ShelftopConstruction? : string;
  readonly ShelfbtmConstruction? : string;
  readonly BackwallConstruction? : string;
  readonly UseCarcaseDepth? : boolean;
}

export interface ICT_tab_FillerSettings
extends cti_tab_FillerSettings, cto_tab_FillerSettings {}

export class ct2_tab_FillerSettings {

public findExactly(
     in_FillerType: string|undefined,
     in_Direction: string|undefined,
     in_AdditionalInfo01: string|undefined,
): cto_tab_FillerSettings | undefined {
  const res = ct_tab_FillerSettings.find((p) => 
...
public find(
predicate: (value: cti_tab_FillerSettings) => boolean
): cto_tab_FillerSettings | undefined {
  for (let index = 0; index < ct_tab_FillerSettings.length; index++){
    const element = ct_tab_FillerSettings[index];
...
export var ct_tab_FillerSettings :ICT_tab_FillerSettings[] = [
{
 _id: 10,
 in_FillerType: "LShape",
 in_Direction: "Left",
 in_AdditionalInfo01: "All",
 SidepanelleftType: "OutSp",
 SidepanelrightType: "NoSp",
 ShelftopConstruction: "NoShelfTop",
 ShelfbtmConstruction: "NoShelfBtm",
 BackwallConstruction: "NoBackwall",
 UseCarcaseDepth: false
}
,{
 _id: 11,
 in_FillerType: "LShape",
 in_Direction: "Right",
 in_AdditionalInfo01: "All",
 SidepanelleftType: "NoSp",
 SidepanelrightType: "OutSp",
 ShelftopConstruction: "NoShelfTop",
 ShelfbtmConstruction: "NoShelfBtm",
 BackwallConstruction: "NoBackwall",
 UseCarcaseDepth: false
...
,{
 ...
 SidepanelleftType: "OutSp",
 SidepanelrightType: "NoSp",
 ShelftopConstruction: "ShelfTop",
 ShelfbtmConstruction: "ShelfBtm",
 BackwallConstruction: "NoBackwall",
 UseCarcaseDepth: true
}
,{
 _id: 13,
 in_FillerType: "CoverCarcase",
