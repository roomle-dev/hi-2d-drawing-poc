...
//#region Imports
import { cbp_mf_Dishwasher, dc_mf_Dishwasher, adc_mf_Dishwasher } from '../internal/modules/mf_Dishwasher'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_Dishwasher, OD_M_mc_Dishwasher } from '../internal/modules/mc_Dishwasher'
...
export function mf_Dishwasher_createBuildPlan(this: cbp_mf_Dishwasher):void {
  internal_enterModuleCreateBuildPlan('mf_Dishwasher', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mf_Dishwasher_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mf_Dishwasher_afterDataCompletion(this: adc_mf_Dishwasher):void {
  internal_enterModuleAfterDataCompletion('mf_Dishwasher', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_Dishwasher_AFTERDATACOMPLETION
  ...
  // Push the object back to the root for the docking
	...
	// Add the module
	let dW = this.addOD_M_mc_Dishwasher();
...
// ---------------------------------------------------------------
export function mf_Dishwasher_manufacturerDataCompletion(this: dc_mf_Dishwasher):void {
  internal_enterModuleManufacturerDataCompletion('mf_Dishwasher', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_Dishwasher_MANUFACTURERDATACOMPLETION
