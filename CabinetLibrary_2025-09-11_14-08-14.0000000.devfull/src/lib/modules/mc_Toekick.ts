...
//#region Imports
import { cbp_mc_Toekick, dc_mc_Toekick, adc_mc_Toekick } from '../internal/modules/mc_Toekick'
...
export function mc_Toekick_createBuildPlan(this: cbp_mc_Toekick):void {
  internal_enterModuleCreateBuildPlan('mc_Toekick', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Toekick_CREATEBUILDPLAN
// Schuler Consulting
// Create: October 2024
// By Stefano Cortese
// CabinetLibrary
...
// ---------------------------------------------------------------
export function mc_Toekick_afterDataCompletion(this: adc_mc_Toekick):void {
  internal_enterModuleAfterDataCompletion('mc_Toekick', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Toekick_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Toekick_manufacturerDataCompletion(this: dc_mc_Toekick):void {
  internal_enterModuleManufacturerDataCompletion('mc_Toekick', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Toekick_MANUFACTURERDATACOMPLETION
