...
//#region Imports
import { cbp_mf_Sink, dc_mf_Sink, adc_mf_Sink } from '../internal/modules/mf_Sink'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_Sink01, OD_M_mc_Sink01 } from '../internal/modules/mc_Sink01'
...
export function mf_Sink_createBuildPlan(this: cbp_mf_Sink):void {
  internal_enterModuleCreateBuildPlan('mf_Sink', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mf_Sink_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mf_Sink_afterDataCompletion(this: adc_mf_Sink):void {
  internal_enterModuleAfterDataCompletion('mf_Sink', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_Sink_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mf_Sink_manufacturerDataCompletion(this: dc_mf_Sink):void {
  internal_enterModuleManufacturerDataCompletion('mf_Sink', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_Sink_MANUFACTURERDATACOMPLETION
