...
import { IPartParentsNonNull_mc_RackArea01 } from '../mod-interfaces'

export interface IP_part_RackAreaUnit_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_RackArea01;
}

export interface IP_part_RackAreaUnit_PartVarsWritable extends IP_part_RackAreaUnit_PartVarsReadOnly {
}

export class P_part_RackAreaUnit extends PartBase implements IP_part_RackAreaUnit_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_RackArea01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_RackAreaUnit', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  parent: IPartParentsNonNull_mc_RackArea01; // module which created this part
