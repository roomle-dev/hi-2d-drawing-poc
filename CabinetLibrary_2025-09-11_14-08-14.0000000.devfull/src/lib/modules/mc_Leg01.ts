...
//#region Imports
import { cbp_mc_Leg01, dc_mc_Leg01, adc_mc_Leg01 } from '../internal/modules/mc_Leg01'
...
export function mc_Leg01_createBuildPlan(this: cbp_mc_Leg01):void {
  internal_enterModuleCreateBuildPlan('mc_Leg01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Leg01_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: May 2024
  // By Ludwig Weber
  ...
  try {
    ...
    const Height = plinthHeight + (RetLegPos.OversizeY ?? 0);
    ...
    this.addpart_LegDrill(0, 0, 0, 1, plinthHeight, 1);
  }
...
// ---------------------------------------------------------------
export function mc_Leg01_afterDataCompletion(this: adc_mc_Leg01):void {
  internal_enterModuleAfterDataCompletion('mc_Leg01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Leg01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Leg01_manufacturerDataCompletion(this: dc_mc_Leg01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Leg01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Leg01_MANUFACTURERDATACOMPLETION
