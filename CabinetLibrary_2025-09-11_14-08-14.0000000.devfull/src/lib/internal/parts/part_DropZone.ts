...
import { IPartParentsNonNull_mr_Appliance } from '../mod-interfaces'

export interface IP_part_DropZone_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mr_Appliance;
}

export interface IP_part_DropZone_PartVarsWritable extends IP_part_DropZone_PartVarsReadOnly {
}

export class P_part_DropZone extends PartBase implements IP_part_DropZone_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mr_Appliance, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_DropZone', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
  parent: IPartParentsNonNull_mr_Appliance; // module which created this part
