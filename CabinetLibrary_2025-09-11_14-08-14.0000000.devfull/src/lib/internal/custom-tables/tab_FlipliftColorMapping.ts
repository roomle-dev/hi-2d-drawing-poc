...
export interface cti_tab_FlipliftColorMapping {
  readonly in_HardwareColor? : string;
  readonly in_HardwareType? : string;
}

export interface ctm_tab_FlipliftColorMapping {
}

export interface cto_tab_FlipliftColorMapping extends ctm_tab_FlipliftColorMapping {
  readonly _id : number;
  readonly FlipliftColor? : string;
}

export interface ICT_tab_FlipliftColorMapping
extends cti_tab_FlipliftColorMapping, cto_tab_FlipliftColorMapping {}

export class ct2_tab_FlipliftColorMapping {

public findExactly(
     in_HardwareColor: string|undefined,
     in_HardwareType: string|undefined,
): cto_tab_FlipliftColorMapping | undefined {
  const res = ct_tab_FlipliftColorMapping.find((p) => 
...
public find(
predicate: (value: cti_tab_FlipliftColorMapping) => boolean
): cto_tab_FlipliftColorMapping | undefined {
  for (let index = 0; index < ct_tab_FlipliftColorMapping.length; index++){
    const element = ct_tab_FlipliftColorMapping[index];
...
export var ct_tab_FlipliftColorMapping :ICT_tab_FlipliftColorMapping[] = [
{
 _id: 1,
