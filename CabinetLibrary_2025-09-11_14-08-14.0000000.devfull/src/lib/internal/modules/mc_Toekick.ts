...
import { IModParents_mr_Toekick } from '../mod-interfaces'
import { IP_part_Toekick_PartVarsWritable, P_part_Toekick } from '../parts/part_Toekick'
import { IP_part_ToekickGroup_PartVarsWritable, P_part_ToekickGroup } from '../parts/part_ToekickGroup'
import { IModuleNonNull_mc_Toekick,IModParents_mc_Toekick,IPartParentsNonNull_mc_Toekick} from '../mod-interfaces'
import {IModVar_mod_ToekickColor,IModVarNonNull_mod_ToekickColor,IModVar_mod_ToekickHeight,IModVarNonNull_mod_ToekickHeight,IModVar_mod_ToekickThk,IModVarNonNull_mod_ToekickThk,IModVar_mod_ToekickLength,IModVarNonNull_mod_ToekickLength,IModVar_mod_ToekickId,IModVarNonNull_mod_ToekickId,IModVar_mod_GrainLogic,IModVarNonNull_mod_GrainLogic,IModVar_mod_ToekickProgram,IModVarNonNull_mod_ToekickProgram} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_ToekickColor, IMatrix_mod_ToekickHeight, IMatrix_mod_ToekickThk, IMatrix_mod_ToekickLength, IMatrix_mod_ToekickId, IMatrix_mod_GrainLogic, IMatrix_mod_ToekickProgram} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_Toekick, IPartAdd_part_ToekickGroup } from '../part-add-interfaces';
import { mc_Toekick_createBuildPlan, mc_Toekick_afterDataCompletion, mc_Toekick_manufacturerDataCompletion } from '../../modules/mc_Toekick';

export interface cbp_mc_Toekick extends IModBaseProp
, IPartAdd_part_Toekick, IPartAdd_part_ToekickGroup, IModVarNonNull_mod_ToekickColor, IModVarNonNull_mod_ToekickHeight, IModVarNonNull_mod_ToekickThk, IModVarNonNull_mod_ToekickLength, IModVarNonNull_mod_ToekickId, IModVarNonNull_mod_GrainLogic, IModVarNonNull_mod_ToekickProgram {
  parent: IModParents_mr_Toekick;
...
export interface dc_mc_Toekick extends IModBaseProp
, IModVar_mod_ToekickColor, IModVar_mod_ToekickHeight, IModVar_mod_ToekickThk, IModVar_mod_ToekickLength, IModVar_mod_ToekickId, IModVar_mod_GrainLogic, IModVar_mod_ToekickProgram {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Toekick;
  parent: IModParents_mr_Toekick;
}

export interface adc_mc_Toekick extends IModBaseProp
...
export class OD_M_mc_Toekick extends OD_Base  implements dc_mc_Toekick
,IModParents_mc_Toekick
,IModVar_mod_ToekickColor,IModVar_mod_ToekickHeight,IModVar_mod_ToekickThk,IModVar_mod_ToekickLength,IModVar_mod_ToekickId,IModVar_mod_GrainLogic,IModVar_mod_ToekickProgram
 {
  constructor(parent: IModParents_mr_Toekick, manufacturerMode?:boolean) {
    super('mc_Toekick', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Toekick_NonNull(this);
  }
  parent: IModParents_mr_Toekick;
  _selfNonNull: OD_M_mc_Toekick_NonNull;

  override variants:string[] = ['mod_ToekickColor','mod_ToekickHeight','mod_ToekickThk','mod_ToekickLength','mod_ToekickId','mod_GrainLogic','mod_ToekickProgram',];
  ...
  get mod_ToekickHeight(): number | undefined { return this.#mod_ToekickHeight}
  set mod_ToekickHeight(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_ToekickHeight' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_ToekickHeight === value) return;
    this.#mod_ToekickHeight = value;
  }

  mod_ToekickHeight_matrix?: IMatrix_mod_ToekickHeight;
  ...
  get mod_ToekickLength(): number | undefined { return this.#mod_ToekickLength}
  set mod_ToekickLength(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_ToekickLength' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_ToekickLength === value) return;
    this.#mod_ToekickLength = value;
  }

  mod_ToekickLength_matrix?: IMatrix_mod_ToekickLength;
  ...
  res.set('mod_ToekickHeight', this.mod_ToekickHeight);
  res.set('mod_ToekickThk', this.mod_ToekickThk);
  res.set('mod_ToekickLength', this.mod_ToekickLength);
  ...
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_ToekickHeight');
    const val = _toFloat(json['attributes']['mod_ToekickHeight'], 'mod_ToekickHeight');
    internal_leaveValidateVariant();
    this.mod_ToekickHeight = val; }
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_ToekickLength');
    const val = _toFloat(json['attributes']['mod_ToekickLength'], 'mod_ToekickLength');
    internal_leaveValidateVariant();
    this.mod_ToekickLength = val; }
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_ToekickColor === undefined) {
      ...
      while (s !== undefined) {
        if (s.variants.includes('mod_ToekickColor')) {
          let pv = <IModVar_mod_ToekickColor>s;
          if (pv.mod_ToekickColor !== undefined) {
            this.mod_ToekickColor = (<IModVar_mod_ToekickColor>s).mod_ToekickColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_ToekickThk === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_ToekickThk')) {
          let pv = <IModVar_mod_ToekickThk>s;
          if (pv.mod_ToekickThk !== undefined) {
            this.mod_ToekickThk = (<IModVar_mod_ToekickThk>s).mod_ToekickThk;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_ToekickId === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_ToekickId')) {
          let pv = <IModVar_mod_ToekickId>s;
          if (pv.mod_ToekickId !== undefined) {
            this.mod_ToekickId = (<IModVar_mod_ToekickId>s).mod_ToekickId;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_ToekickProgram === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_ToekickProgram')) {
          let pv = <IModVar_mod_ToekickProgram>s;
          if (pv.mod_ToekickProgram !== undefined) {
            this.mod_ToekickProgram = (<IModVar_mod_ToekickProgram>s).mod_ToekickProgram;
            break;
          };
        }
        s = s.parentBase;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ToekickHeight === undefined) {
      this.mod_ToekickHeight = 110;
    }
    if (this.mod_ToekickLength === undefined) {
      this.mod_ToekickLength = 1500;
    }
    if (this.mod_ToekickId === undefined) {
      this.mod_ToekickId = "";
    }
  ...
  #manufacturerDataCompletionInternal = mc_Toekick_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Toekick_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Toekick{
    ...
    const adc = new OD_M_mc_Toekick_NonNull(this);
    return adc;
  }

  override validateSelections():void {
    this.mod_ToekickColor_matrix = VariantValidation.mod_ToekickColor(this, this);
    this.mod_ToekickHeight_matrix = VariantValidation.mod_ToekickHeight(this, this);
    this.mod_ToekickThk_matrix = VariantValidation.mod_ToekickThk(this, this);
    this.mod_ToekickLength_matrix = VariantValidation.mod_ToekickLength(this, this);
    this.mod_ToekickId_matrix = VariantValidation.mod_ToekickId(this, this);
    this.mod_GrainLogic_matrix = VariantValidation.mod_GrainLogic(this, this);
    this.mod_ToekickProgram_matrix = VariantValidation.mod_ToekickProgram(this, this);
  }
  addpart_Toekick(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Toekick_PartVarsWritable {
    var c = new P_part_Toekick(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_ToekickGroup(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_ToekickGroup_PartVarsWritable {
    var c = new P_part_ToekickGroup(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Toekick_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Toekick_NonNull implements cbp_mc_Toekick, adc_mc_Toekick ,IPartParentsNonNull_mc_Toekick {
  constructor(parent: OD_M_mc_Toekick) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Toekick;
  ...
  #createBuildPlanInternal = mc_Toekick_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Toekick_afterDataCompletion;
  ...
  parent: IModParents_mr_Toekick;
  addpart_Toekick(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Toekick_PartVarsWritable {
    return this.#internalParent.addpart_Toekick(x, y, z, dimx, dimy, dimz);
  }
  addpart_ToekickGroup(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_ToekickGroup_PartVarsWritable {
    return this.#internalParent.addpart_ToekickGroup(x, y, z, dimx, dimy, dimz);
  }
  ...
  get mod_ToekickHeight(): number  {
    return this.#internalParent.mod_ToekickHeight!;
  }
  get mod_ToekickThk(): number  {
    return this.#internalParent.mod_ToekickThk!;
  }
  get mod_ToekickLength(): number  {
    return this.#internalParent.mod_ToekickLength!;
  }
