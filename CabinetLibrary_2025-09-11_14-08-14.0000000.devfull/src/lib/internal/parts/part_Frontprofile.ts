...
import { IPartParentsNonNull_mc_FrontPanelGlass01 } from '../mod-interfaces'

export interface IP_part_Frontprofile_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_FrontPanelGlass01;
}

export interface IP_part_Frontprofile_PartVarsWritable extends IP_part_Frontprofile_PartVarsReadOnly {
}

export class P_part_Frontprofile extends PartBase implements IP_part_Frontprofile_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_FrontPanelGlass01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_Frontprofile', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
  parent: IPartParentsNonNull_mc_FrontPanelGlass01; // module which created this part
