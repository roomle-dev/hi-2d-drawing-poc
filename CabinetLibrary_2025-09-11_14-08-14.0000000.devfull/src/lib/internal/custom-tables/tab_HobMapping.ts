...
export interface cti_tab_HobMapping {
  readonly in_Supplier? : string;
  readonly in_HobId? : string;
}

export interface ctm_tab_HobMapping {
}

export interface cto_tab_HobMapping extends ctm_tab_HobMapping {
  readonly _id : number;
  readonly ConstructionId? : string;
  readonly GraphicId? : string;
}

export interface ICT_tab_HobMapping
extends cti_tab_HobMapping, cto_tab_HobMapping {}

export class ct2_tab_HobMapping {

public findExactly(
     in_Supplier: string|undefined,
     in_HobId: string|undefined,
): cto_tab_HobMapping | undefined {
  const res = ct_tab_HobMapping.find((p) => 
...
public find(
predicate: (value: cti_tab_HobMapping) => boolean
): cto_tab_HobMapping | undefined {
  for (let index = 0; index < ct_tab_HobMapping.length; index++){
    const element = ct_tab_HobMapping[index];
...
export var ct_tab_HobMapping :ICT_tab_HobMapping[] = [
{
 _id: 1,
 in_Supplier: "Bora",
 in_HobId: "PUXU",
...
,{
 ...
 in_Supplier: "Siemens",
 in_HobId: "ER6A6PB70D",
 ConstructionId: "ER6A6PB70D",
 GraphicId: "ER6A6PB70D"
}
,{
 _id: 3,
 in_Supplier: "Siemens",
 in_HobId: "ET601FNP1E",
 ConstructionId: "ET601FNP1E",
 GraphicId: "ET601FNP1E"
}
,{
 _id: 4,
 in_Supplier: "Siemens",
 in_HobId: "EX975LXC1E",
 ConstructionId: "EX975LXC1E",
 GraphicId: "EX975LXC1E"
}
,{
 _id: 5,
 in_Supplier: "None",
 in_HobId: "None",
 ConstructionId: "DefaultHob",
 GraphicId: "DefaultHob"
}
];
