...
, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontSplit, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_HandleDrill, IModVarNonNull_mod_HandleLine, IModVarNonNull_mod_HandlePosLogic, IModVarNonNull_mod_FrontQtyElements, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontSplitHeight1, IModVarNonNull_mod_FrontSplitHeight2, IModVarNonNull_mod_FrontSplitHeight3, IModVarNonNull_mod_FrontSplitType1, IModVarNonNull_mod_FrontSplitType2, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_HandleLength, IModVarNonNull_mod_HandleOffsetX, IModVarNonNull_mod_HandleOffsetY, IModVarNonNull_mod_HandlePosMatrix, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HandlestripPos, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_HingeLogic, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_FrontDescriptor, IModVarNonNull_mod_FramePartsWidthHor, IModVarNonNull_mod_FramePartsWidthVert, IModVarNonNull_mod_PanelWoodFrameFillingType, IModVarNonNull_mod_PanelWoodFrameType, IModVarNonNull_mod_FrontHeightSelection, IModVarNonNull_mod_FrameFillingWoodColor, IModVarNonNull_mod_FrontGlassColor, IModVarNonNull_mod_DishwasherId, IModVarNonNull_mod_DishwasherSupplier, IModVarNonNull_mod_Height, IModVarNonNull_mod_Depth, IModVarNonNull_mod_DishwasherInfo {
  parent: IModParents_mr_Appliance;
...
export interface dc_mf_Dishwasher extends IModBaseProp
, IModVar_mod_FingergripTop, IModVar_mod_FrontHeight, IModVar_mod_FrontId, IModVar_mod_FrontSplit, IModVar_mod_FrontThk, IModVar_mod_FrontWidth, IModVar_mod_HandleDrill, IModVar_mod_HandleLine, IModVar_mod_HandlePosLogic, IModVar_mod_FrontQtyElements, IModVar_mod_FrontPosStart, IModVar_mod_FrontColor, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapVert, IModVar_mod_FrontOversizeBtm, IModVar_mod_FrontOversizeLeft, IModVar_mod_FrontOversizeRight, IModVar_mod_FrontOversizeTop, IModVar_mod_FrontProgram, IModVar_mod_FrontSplitHeight1, IModVar_mod_FrontSplitHeight2, IModVar_mod_FrontSplitHeight3, IModVar_mod_FrontSplitType1, IModVar_mod_FrontSplitType2, IModVar_mod_HandleColor, IModVar_mod_HandleLength, IModVar_mod_HandleOffsetX, IModVar_mod_HandleOffsetY, IModVar_mod_HandlePosMatrix, IModVar_mod_HandlePosType, IModVar_mod_HandlestripPos, IModVar_mod_HeightPosInsertion, IModVar_mod_HandleDesign, IModVar_mod_FrontDesign, IModVar_mod_Originpos, IModVar_mod_PlinthAreaHeight, IModVar_mod_ParentName, IModVar_mod_ModuleName, IModVar_mod_FrontGapHorTop, IModVar_mod_HingeLogic, IModVar_mod_FingergripTopType, IModVar_mod_FingergripBtmType, IModVar_mod_TypeElement, IModVar_mod_FrontDescriptor, IModVar_mod_FramePartsWidthHor, IModVar_mod_FramePartsWidthVert, IModVar_mod_PanelWoodFrameFillingType, IModVar_mod_PanelWoodFrameType, IModVar_mod_FrontHeightSelection, IModVar_mod_FrameFillingWoodColor, IModVar_mod_FrontGlassColor, IModVar_mod_DishwasherId, IModVar_mod_DishwasherSupplier, IModVar_mod_Height, IModVar_mod_Depth, IModVar_mod_DishwasherInfo {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mf_Dishwasher;
  parent: IModParents_mr_Appliance;
  addOD_M_mc_Dishwasher(index?: number): dc_mc_Dishwasher;
}

export interface adc_mf_Dishwasher extends IModBaseProp
, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontSplit, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_HandleDrill, IModVarNonNull_mod_HandleLine, IModVarNonNull_mod_HandlePosLogic, IModVarNonNull_mod_FrontQtyElements, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontSplitHeight1, IModVarNonNull_mod_FrontSplitHeight2, IModVarNonNull_mod_FrontSplitHeight3, IModVarNonNull_mod_FrontSplitType1, IModVarNonNull_mod_FrontSplitType2, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_HandleLength, IModVarNonNull_mod_HandleOffsetX, IModVarNonNull_mod_HandleOffsetY, IModVarNonNull_mod_HandlePosMatrix, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HandlestripPos, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_HingeLogic, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_FrontDescriptor, IModVarNonNull_mod_FramePartsWidthHor, IModVarNonNull_mod_FramePartsWidthVert, IModVarNonNull_mod_PanelWoodFrameFillingType, IModVarNonNull_mod_PanelWoodFrameType, IModVarNonNull_mod_FrontHeightSelection, IModVarNonNull_mod_FrameFillingWoodColor, IModVarNonNull_mod_FrontGlassColor, IModVarNonNull_mod_DishwasherId, IModVarNonNull_mod_DishwasherSupplier, IModVarNonNull_mod_Height, IModVarNonNull_mod_Depth, IModVarNonNull_mod_DishwasherInfo {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  addOD_M_mc_Dishwasher(index?: number): dc_mc_Dishwasher;
...
export class OD_M_mf_Dishwasher extends OD_Base  implements dc_mf_Dishwasher
,IModParents_mf_Dishwasher
,IModVar_mod_FingergripTop,IModVar_mod_FrontHeight,IModVar_mod_FrontId,IModVar_mod_FrontSplit,IModVar_mod_FrontThk,IModVar_mod_FrontWidth,IModVar_mod_HandleDrill,IModVar_mod_HandleLine,IModVar_mod_HandlePosLogic,IModVar_mod_FrontQtyElements,IModVar_mod_FrontPosStart,IModVar_mod_FrontColor,IModVar_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVar_mod_FrontGapCarcase,IModVar_mod_FrontGapHor,IModVar_mod_FrontGapVert,IModVar_mod_FrontOversizeBtm,IModVar_mod_FrontOversizeLeft,IModVar_mod_FrontOversizeRight,IModVar_mod_FrontOversizeTop,IModVar_mod_FrontProgram,IModVar_mod_FrontSplitHeight1,IModVar_mod_FrontSplitHeight2,IModVar_mod_FrontSplitHeight3,IModVar_mod_FrontSplitType1,IModVar_mod_FrontSplitType2,IModVar_mod_HandleColor,IModVar_mod_HandleLength,IModVar_mod_HandleOffsetX,IModVar_mod_HandleOffsetY,IModVar_mod_HandlePosMatrix,IModVar_mod_HandlePosType,IModVar_mod_HandlestripPos,IModVar_mod_HeightPosInsertion,IModVar_mod_HandleDesign,IModVar_mod_FrontDesign,IModVar_mod_Originpos,IModVar_mod_PlinthAreaHeight,IModVar_mod_ParentName,IModVar_mod_ModuleName,IModVar_mod_FrontGapHorTop,IModVar_mod_HingeLogic,IModVar_mod_FingergripTopType,IModVar_mod_FingergripBtmType,IModVar_mod_TypeElement,IModVar_mod_FrontDescriptor,IModVar_mod_FramePartsWidthHor,IModVar_mod_FramePartsWidthVert,IModVar_mod_PanelWoodFrameFillingType,IModVar_mod_PanelWoodFrameType,IModVar_mod_FrontHeightSelection,IModVar_mod_FrameFillingWoodColor,IModVar_mod_FrontGlassColor,IModVar_mod_DishwasherId,IModVar_mod_DishwasherSupplier,IModVar_mod_Height,IModVar_mod_Depth,IModVar_mod_DishwasherInfo
 {
  constructor(parent: IModParents_mr_Appliance, manufacturerMode?:boolean) {
    super('mf_Dishwasher', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mf_Dishwasher_NonNull(this);
  }
  parent: IModParents_mr_Appliance;
  _selfNonNull: OD_M_mf_Dishwasher_NonNull;

  override variants:string[] = ['mod_FingergripTop','mod_FrontHeight','mod_FrontId','mod_FrontSplit','mod_FrontThk','mod_FrontWidth','mod_HandleDrill','mod_HandleLine','mod_HandlePosLogic','mod_FrontQtyElements','mod_FrontPosStart','mod_FrontColor','mod_FrontEdgeColor','mod_FrontEdgeThk','mod_FrontGapCarcase','mod_FrontGapHor','mod_FrontGapVert','mod_FrontOversizeBtm','mod_FrontOversizeLeft','mod_FrontOversizeRight','mod_FrontOversizeTop','mod_FrontProgram','mod_FrontSplitHeight1','mod_FrontSplitHeight2','mod_FrontSplitHeight3','mod_FrontSplitType1','mod_FrontSplitType2','mod_HandleColor','mod_HandleLength','mod_HandleOffsetX','mod_HandleOffsetY','mod_HandlePosMatrix','mod_HandlePosType','mod_HandlestripPos','mod_HeightPosInsertion','mod_HandleDesign','mod_FrontDesign','mod_Originpos','mod_PlinthAreaHeight','mod_ParentName','mod_ModuleName','mod_FrontGapHorTop','mod_HingeLogic','mod_FingergripTopType','mod_FingergripBtmType','mod_TypeElement','mod_FrontDescriptor','mod_FramePartsWidthHor','mod_FramePartsWidthVert','mod_PanelWoodFrameFillingType','mod_PanelWoodFrameType','mod_FrontHeightSelection','mod_FrameFillingWoodColor','mod_FrontGlassColor','mod_DishwasherId','mod_DishwasherSupplier','mod_Height','mod_Depth','mod_DishwasherInfo',];
  ...
  override checkPosRelevantRequiredAttributes():void {
    ...
    if (this.#mod_FrontSplit !== undefined) {
      this.#mod_FrontSplit = undefined;
      logWarning('The attribute "mod_FrontSplit" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_DishwasherId === undefined) {
      this.mod_DishwasherId = "SN87TX02CE";
    }
    if (this.mod_DishwasherSupplier === undefined) {
      this.mod_DishwasherSupplier = "Siemens";
    }
  ...
  #manufacturerDataCompletionInternal = mf_Dishwasher_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mf_Dishwasher_NonNull(this);
  ...
  seal(): IModuleNonNull_mf_Dishwasher{
    ...
    const adc = new OD_M_mf_Dishwasher_NonNull(this);
    return adc;
  }

  addOD_M_mc_Dishwasher(index?: number): dc_mc_Dishwasher {
    var m = new OD_M_mc_Dishwasher(this);
    m.dataCompletion();
  ...
  override createBuildPlan():void {
    var cbp = new OD_M_mf_Dishwasher_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mf_Dishwasher_NonNull implements cbp_mf_Dishwasher, adc_mf_Dishwasher ,IPartParentsNonNull_mf_Dishwasher {
  constructor(parent: OD_M_mf_Dishwasher) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mf_Dishwasher;
  ...
  #createBuildPlanInternal = mf_Dishwasher_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mf_Dishwasher_afterDataCompletion;
  ...
  addOD_M_mc_Dishwasher(index?: number): dc_mc_Dishwasher {
    return this.#internalParent.addOD_M_mc_Dishwasher(index);
  }
}
