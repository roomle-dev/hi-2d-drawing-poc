...
//#region Imports
import { cbp_mc_MetalFrame01, dc_mc_MetalFrame01, adc_mc_MetalFrame01 } from '../internal/modules/mc_MetalFrame01'
...
export function mc_MetalFrame01_createBuildPlan(this: cbp_mc_MetalFrame01):void {
  internal_enterModuleCreateBuildPlan('mc_MetalFrame01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_MetalFrame01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_MetalFrame01_afterDataCompletion(this: adc_mc_MetalFrame01):void {
  internal_enterModuleAfterDataCompletion('mc_MetalFrame01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_MetalFrame01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_MetalFrame01_manufacturerDataCompletion(this: dc_mc_MetalFrame01):void {
  internal_enterModuleManufacturerDataCompletion('mc_MetalFrame01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_MetalFrame01_MANUFACTURERDATACOMPLETION
