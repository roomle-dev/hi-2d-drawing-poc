...
import { IPartParentsNonNull_mc_Shelves01 } from '../mod-interfaces'

export interface IP_part_Shelves_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_Shelves01;
}

export interface IP_part_Shelves_PartVarsWritable extends IP_part_Shelves_PartVarsReadOnly {
}

export class P_part_Shelves extends PartBase implements IP_part_Shelves_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Shelves01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_Shelves', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XZY';
  }
  parent: IPartParentsNonNull_mc_Shelves01; // module which created this part
