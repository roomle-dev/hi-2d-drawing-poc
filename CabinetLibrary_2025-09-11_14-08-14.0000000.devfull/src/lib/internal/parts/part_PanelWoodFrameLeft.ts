...
export interface IP_part_PanelWoodFrameLeft_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_PanelWoodFrame01;
}

export interface IP_part_PanelWoodFrameLeft_PartVarsWritable extends IP_part_PanelWoodFrameLeft_PartVarsReadOnly {
}

export class P_part_PanelWoodFrameLeft extends PartBase implements IP_part_PanelWoodFrameLeft_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_PanelWoodFrame01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_PanelWoodFrameLeft', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
