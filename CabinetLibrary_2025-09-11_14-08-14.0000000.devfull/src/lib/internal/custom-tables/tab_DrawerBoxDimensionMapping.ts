...
export interface cti_tab_DrawerBoxDimensionMapping {
  readonly in_BoxDesign? : string;
  readonly in_BoxProgram? : string;
  readonly in_BoxColor? : string;
  readonly in_SpaceDepthMin : number;
  readonly in_SpaceDepthMax : number;
  readonly in_SpaceHeightMin : number;
  readonly in_SpaceHeightMax : number;
}

export interface ctm_tab_DrawerBoxDimensionMapping {
}

export interface cto_tab_DrawerBoxDimensionMapping extends ctm_tab_DrawerBoxDimensionMapping {
  readonly _id : number;
  readonly DepthType? : string;
  readonly HeightType? : string;
}

export interface ICT_tab_DrawerBoxDimensionMapping
extends cti_tab_DrawerBoxDimensionMapping, cto_tab_DrawerBoxDimensionMapping {}

export class ct2_tab_DrawerBoxDimensionMapping {

public findExactly(
     in_BoxDesign: string|undefined,
     in_BoxProgram: string|undefined,
     in_BoxColor: string|undefined,
     in_SpaceDepthMin: number,
     in_SpaceDepthMax: number,
     in_SpaceHeightMin: number,
     in_SpaceHeightMax: number,
): cto_tab_DrawerBoxDimensionMapping | undefined {
  const res = ct_tab_DrawerBoxDimensionMapping.find((p) => 
p.in_BoxDesign === in_BoxDesign
 && p.in_BoxProgram === in_BoxProgram
 && p.in_BoxColor === in_BoxColor
 && p.in_SpaceDepthMin === in_SpaceDepthMin
 && p.in_SpaceDepthMax === in_SpaceDepthMax
 && p.in_SpaceHeightMin === in_SpaceHeightMin
 && p.in_SpaceHeightMax === in_SpaceHeightMax
);
return res;
}

public find(
predicate: (value: cti_tab_DrawerBoxDimensionMapping) => boolean
): cto_tab_DrawerBoxDimensionMapping | undefined {
  for (let index = 0; index < ct_tab_DrawerBoxDimensionMapping.length; index++){
    const element = ct_tab_DrawerBoxDimensionMapping[index];
...
export var ct_tab_DrawerBoxDimensionMapping :ICT_tab_DrawerBoxDimensionMapping[] = [
{
 _id: 194,
 in_BoxDesign: "Legrabox",
 in_BoxProgram: "All",
 in_BoxColor: "All",
 in_SpaceDepthMin: 550,
 in_SpaceDepthMax: 599.9,
 in_SpaceHeightMin: 144,
 in_SpaceHeightMax: 189.9,
 DepthType: "550",
 HeightType: "K"
}
,{
 ...
 in_BoxProgram: "All",
 in_BoxColor: "All",
 in_SpaceDepthMin: 450,
 in_SpaceDepthMax: 499.9,
 in_SpaceHeightMin: 80,
 in_SpaceHeightMax: 104.9,
 DepthType: "450",
 HeightType: "N"
}
,{
 ...
 in_BoxProgram: "All",
 in_BoxColor: "Terra",
 in_SpaceDepthMin: 300,
 in_SpaceDepthMax: 349.9,
 in_SpaceHeightMin: 144,
 in_SpaceHeightMax: 189.9,
 DepthType: "300",
 HeightType: "K"
...
,{
 ...
 in_SpaceDepthMin: 550,
 in_SpaceDepthMax: 599.9,
 in_SpaceHeightMin: 105,
 in_SpaceHeightMax: 143.9,
 DepthType: "550",
 HeightType: "M"
}
,{
 ...
 in_BoxProgram: "All",
 in_BoxColor: "All",
 in_SpaceDepthMin: 500,
 in_SpaceDepthMax: 549.9,
 in_SpaceHeightMin: 80,
 in_SpaceHeightMax: 104.9,
 DepthType: "500",
 HeightType: "N"
...
,{
 ...
 in_BoxProgram: "All",
 in_BoxColor: "Terra",
 in_SpaceDepthMin: 600,
 in_SpaceDepthMax: 9999,
 in_SpaceHeightMin: 144,
 in_SpaceHeightMax: 189.9,
 DepthType: "600",
 HeightType: "K"
...
,{
 ...
 in_BoxProgram: "All",
 in_BoxColor: "Terra",
 in_SpaceDepthMin: 400,
 in_SpaceDepthMax: 449.9,
 in_SpaceHeightMin: 80,
 in_SpaceHeightMax: 104.9,
 DepthType: "400",
 HeightType: "N"
...
,{
 ...
 in_SpaceDepthMin: 300,
 in_SpaceDepthMax: 349.9,
 in_SpaceHeightMin: 190,
 in_SpaceHeightMax: 9999,
 DepthType: "300",
 HeightType: "C"
}
,{
...
,{
 ...
 in_BoxProgram: "All",
 in_BoxColor: "All",
 in_SpaceDepthMin: 270,
 in_SpaceDepthMax: 299.9,
 in_SpaceHeightMin: 105,
 in_SpaceHeightMax: 189.9,
 DepthType: "270",
 HeightType: "M"
...
,{
 ...
 in_BoxProgram: "All",
 in_BoxColor: "All",
 in_SpaceDepthMin: 350,
 in_SpaceDepthMax: 399.9,
 in_SpaceHeightMin: 190,
 in_SpaceHeightMax: 9999,
 DepthType: "350",
 HeightType: "C"
