...
import { IModParents_mr_Backsplash } from '../mod-interfaces'
import { IP_part_Backsplash_PartVarsWritable, P_part_Backsplash } from '../parts/part_Backsplash'
import { IP_part_BacksplashGroup_PartVarsWritable, P_part_BacksplashGroup } from '../parts/part_BacksplashGroup'
import { IModuleNonNull_mc_Backsplash,IModParents_mc_Backsplash,IPartParentsNonNull_mc_Backsplash} from '../mod-interfaces'
...
import { IPartAdd_part_Backsplash, IPartAdd_part_BacksplashGroup } from '../part-add-interfaces';
import { mc_Backsplash_createBuildPlan, mc_Backsplash_afterDataCompletion, mc_Backsplash_manufacturerDataCompletion } from '../../modules/mc_Backsplash';

export interface cbp_mc_Backsplash extends IModBaseProp
, IPartAdd_part_Backsplash, IPartAdd_part_BacksplashGroup, IModVarNonNull_mod_BacksplashColor, IModVarNonNull_mod_BacksplashHeight, IModVarNonNull_mod_BacksplashThk, IModVarNonNull_mod_BacksplashWidth {
  parent: IModParents_mr_Backsplash;
...
export interface dc_mc_Backsplash extends IModBaseProp
, IModVar_mod_BacksplashColor, IModVar_mod_BacksplashHeight, IModVar_mod_BacksplashThk, IModVar_mod_BacksplashWidth {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Backsplash;
  parent: IModParents_mr_Backsplash;
}

export interface adc_mc_Backsplash extends IModBaseProp
...
export class OD_M_mc_Backsplash extends OD_Base  implements dc_mc_Backsplash
,IModParents_mc_Backsplash
,IModVar_mod_BacksplashColor,IModVar_mod_BacksplashHeight,IModVar_mod_BacksplashThk,IModVar_mod_BacksplashWidth
 {
  constructor(parent: IModParents_mr_Backsplash, manufacturerMode?:boolean) {
    super('mc_Backsplash', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Backsplash_NonNull(this);
  }
  parent: IModParents_mr_Backsplash;
  _selfNonNull: OD_M_mc_Backsplash_NonNull;
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_BacksplashColor === undefined) {
      ...
      while (s !== undefined) {
        if (s.variants.includes('mod_BacksplashColor')) {
          let pv = <IModVar_mod_BacksplashColor>s;
          if (pv.mod_BacksplashColor !== undefined) {
            this.mod_BacksplashColor = (<IModVar_mod_BacksplashColor>s).mod_BacksplashColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_BacksplashHeight === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_BacksplashHeight')) {
          let pv = <IModVar_mod_BacksplashHeight>s;
          if (pv.mod_BacksplashHeight !== undefined) {
            this.mod_BacksplashHeight = (<IModVar_mod_BacksplashHeight>s).mod_BacksplashHeight;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_BacksplashThk === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_BacksplashThk')) {
          let pv = <IModVar_mod_BacksplashThk>s;
          if (pv.mod_BacksplashThk !== undefined) {
            this.mod_BacksplashThk = (<IModVar_mod_BacksplashThk>s).mod_BacksplashThk;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_BacksplashWidth === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_BacksplashWidth')) {
          let pv = <IModVar_mod_BacksplashWidth>s;
          if (pv.mod_BacksplashWidth !== undefined) {
            this.mod_BacksplashWidth = (<IModVar_mod_BacksplashWidth>s).mod_BacksplashWidth;
            break;
          };
        }
        s = s.parentBase;
  ...
  #manufacturerDataCompletionInternal = mc_Backsplash_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Backsplash_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Backsplash{
    ...
    const adc = new OD_M_mc_Backsplash_NonNull(this);
    return adc;
  }
  ...
  addpart_Backsplash(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Backsplash_PartVarsWritable {
    var c = new P_part_Backsplash(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_BacksplashGroup(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_BacksplashGroup_PartVarsWritable {
    var c = new P_part_BacksplashGroup(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Backsplash_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Backsplash_NonNull implements cbp_mc_Backsplash, adc_mc_Backsplash ,IPartParentsNonNull_mc_Backsplash {
  constructor(parent: OD_M_mc_Backsplash) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Backsplash;
  ...
  #createBuildPlanInternal = mc_Backsplash_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Backsplash_afterDataCompletion;
  ...
  parent: IModParents_mr_Backsplash;
  addpart_Backsplash(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Backsplash_PartVarsWritable {
    return this.#internalParent.addpart_Backsplash(x, y, z, dimx, dimy, dimz);
  }
  addpart_BacksplashGroup(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_BacksplashGroup_PartVarsWritable {
    return this.#internalParent.addpart_BacksplashGroup(x, y, z, dimx, dimy, dimz);
  }
