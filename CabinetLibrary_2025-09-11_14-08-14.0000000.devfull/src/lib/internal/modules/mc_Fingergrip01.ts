...
import { IModParents_mr_Fingergrip } from '../mod-interfaces'
import { IP_part_FingergripTop_PartVarsWritable, P_part_FingergripTop } from '../parts/part_FingergripTop'
import { IP_part_FingergripMiddle_PartVarsWritable, P_part_FingergripMiddle } from '../parts/part_FingergripMiddle'
import { IModuleNonNull_mc_Fingergrip01,IModParents_mc_Fingergrip01,IPartParentsNonNull_mc_Fingergrip01} from '../mod-interfaces'
import {IModVar_mod_FingergripColor,IModVarNonNull_mod_FingergripColor,IModVar_mod_FingergripType,IModVarNonNull_mod_FingergripType,IModVar_mod_FingergripLength,IModVarNonNull_mod_FingergripLength,IModVar_mod_FingergripPostype,IModVarNonNull_mod_FingergripPostype} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_FingergripColor, IMatrix_mod_FingergripType, IMatrix_mod_FingergripLength, IMatrix_mod_FingergripPostype} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_FingergripTop, IPartAdd_part_FingergripMiddle } from '../part-add-interfaces';
import { mc_Fingergrip01_createBuildPlan, mc_Fingergrip01_afterDataCompletion, mc_Fingergrip01_manufacturerDataCompletion } from '../../modules/mc_Fingergrip01';

export interface cbp_mc_Fingergrip01 extends IModBaseProp
, IPartAdd_part_FingergripTop, IPartAdd_part_FingergripMiddle, IModVarNonNull_mod_FingergripColor, IModVarNonNull_mod_FingergripType, IModVarNonNull_mod_FingergripLength, IModVarNonNull_mod_FingergripPostype {
  parent: IModParents_mr_Fingergrip;
...
export interface dc_mc_Fingergrip01 extends IModBaseProp
, IModVar_mod_FingergripColor, IModVar_mod_FingergripType, IModVar_mod_FingergripLength, IModVar_mod_FingergripPostype {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Fingergrip01;
  parent: IModParents_mr_Fingergrip;
}

export interface adc_mc_Fingergrip01 extends IModBaseProp
...
export class OD_M_mc_Fingergrip01 extends OD_Base  implements dc_mc_Fingergrip01
,IModParents_mc_Fingergrip01
,IModVar_mod_FingergripColor,IModVar_mod_FingergripType,IModVar_mod_FingergripLength,IModVar_mod_FingergripPostype
 {
  constructor(parent: IModParents_mr_Fingergrip, manufacturerMode?:boolean) {
    super('mc_Fingergrip01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Fingergrip01_NonNull(this);
  }
  parent: IModParents_mr_Fingergrip;
  _selfNonNull: OD_M_mc_Fingergrip01_NonNull;

  override variants:string[] = ['mod_FingergripColor','mod_FingergripType','mod_FingergripLength','mod_FingergripPostype',];
  #mod_FingergripColor?: string;
  get mod_FingergripColor(): string | undefined { return this.#mod_FingergripColor}
  set mod_FingergripColor(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_FingergripColor' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_FingergripColor === value) return;
    this.#mod_FingergripColor = value;
  }

  mod_FingergripColor_matrix?: IMatrix_mod_FingergripColor;
  ...
  get mod_FingergripLength(): number | undefined { return this.#mod_FingergripLength}
  set mod_FingergripLength(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_FingergripLength' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_FingergripLength === value) return;
    this.#mod_FingergripLength = value;
  }

  mod_FingergripLength_matrix?: IMatrix_mod_FingergripLength;
  #mod_FingergripPostype?: string;
  get mod_FingergripPostype(): string | undefined { return this.#mod_FingergripPostype}
  set mod_FingergripPostype(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_FingergripPostype' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_FingergripPostype === value) return;
    this.#mod_FingergripPostype = value;
  }

  mod_FingergripPostype_matrix?: IMatrix_mod_FingergripPostype;
  override getAttributes() : Map<string,any> { 
    let res = new Map<string,any>();
  res.set('mod_FingergripColor', this.mod_FingergripColor);
  res.set('mod_FingergripType', this.mod_FingergripType);
  res.set('mod_FingergripLength', this.mod_FingergripLength);
  res.set('mod_FingergripPostype', this.mod_FingergripPostype);
    return res;
  }
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_FingergripColor');
    const val = _toString(json['attributes']['mod_FingergripColor'], 'mod_FingergripColor');
    internal_leaveValidateVariant();
    this.mod_FingergripColor = val; }
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_FingergripLength');
    const val = _toFloat(json['attributes']['mod_FingergripLength'], 'mod_FingergripLength');
    internal_leaveValidateVariant();
    this.mod_FingergripLength = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_FingergripPostype');
    const val = _toString(json['attributes']['mod_FingergripPostype'], 'mod_FingergripPostype');
    internal_leaveValidateVariant();
    this.mod_FingergripPostype = val; }
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_FingergripColor === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_FingergripColor')) {
          let pv = <IModVar_mod_FingergripColor>s;
          if (pv.mod_FingergripColor !== undefined) {
            this.mod_FingergripColor = (<IModVar_mod_FingergripColor>s).mod_FingergripColor;
            break;
          };
        }
        s = s.parentBase;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_FingergripPostype === undefined) {
      this.mod_FingergripPostype = "";
    }
  ...
  #manufacturerDataCompletionInternal = mc_Fingergrip01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Fingergrip01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Fingergrip01{
    ...
    const adc = new OD_M_mc_Fingergrip01_NonNull(this);
    return adc;
  }

  override validateSelections():void {
    this.mod_FingergripColor_matrix = VariantValidation.mod_FingergripColor(this, this);
    this.mod_FingergripType_matrix = VariantValidation.mod_FingergripType(this, this);
    this.mod_FingergripLength_matrix = VariantValidation.mod_FingergripLength(this, this);
    this.mod_FingergripPostype_matrix = VariantValidation.mod_FingergripPostype(this, this);
  }
  addpart_FingergripTop(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FingergripTop_PartVarsWritable {
    var c = new P_part_FingergripTop(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_FingergripMiddle(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FingergripMiddle_PartVarsWritable {
    var c = new P_part_FingergripMiddle(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Fingergrip01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Fingergrip01_NonNull implements cbp_mc_Fingergrip01, adc_mc_Fingergrip01 ,IPartParentsNonNull_mc_Fingergrip01 {
  constructor(parent: OD_M_mc_Fingergrip01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Fingergrip01;
  ...
  #createBuildPlanInternal = mc_Fingergrip01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Fingergrip01_afterDataCompletion;
  ...
  parent: IModParents_mr_Fingergrip;
  addpart_FingergripTop(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FingergripTop_PartVarsWritable {
    return this.#internalParent.addpart_FingergripTop(x, y, z, dimx, dimy, dimz);
  }
  addpart_FingergripMiddle(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FingergripMiddle_PartVarsWritable {
    return this.#internalParent.addpart_FingergripMiddle(x, y, z, dimx, dimy, dimz);
  }
  get mod_FingergripColor(): string  {
    return this.#internalParent.mod_FingergripColor!;
  }
  ...
  get mod_FingergripLength(): number  {
    return this.#internalParent.mod_FingergripLength!;
  }
  get mod_FingergripPostype(): string  {
    return this.#internalParent.mod_FingergripPostype!;
  }
}
