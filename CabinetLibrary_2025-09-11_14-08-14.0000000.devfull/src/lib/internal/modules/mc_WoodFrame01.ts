...
import { IModuleNonNull_mc_WoodFrame01} from '../mod-interfaces'
import {IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_FrontColor,IModVarNonNull_mod_FrontColor,IModVar_mod_FrontDesign,IModVarNonNull_mod_FrontDesign,IModVar_mod_FrontEdgeColor,IModVarNonNull_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVarNonNull_mod_FrontEdgeThk,IModVar_mod_FrontId,IModVarNonNull_mod_FrontId,IModVar_mod_FrontProgram,IModVarNonNull_mod_FrontProgram,IModVar_mod_FrontType,IModVarNonNull_mod_FrontType,IModVar_mod_Height,IModVarNonNull_mod_Height,IModVar_mod_PartInfo,IModVarNonNull_mod_PartInfo,IModVar_mod_Width,IModVarNonNull_mod_Width,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_HandleDesign,IModVarNonNull_mod_HandleDesign,IModVar_mod_HandlePosType,IModVarNonNull_mod_HandlePosType,IModVar_mod_FrontpanelWeightCalculations,IModVarNonNull_mod_FrontpanelWeightCalculations,IModVar_mod_FramePartsWidthHor,IModVarNonNull_mod_FramePartsWidthHor,IModVar_mod_FramePartsWidthVert,IModVarNonNull_mod_FramePartsWidthVert} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_Depth, IMatrix_mod_FrontColor, IMatrix_mod_FrontDesign, IMatrix_mod_FrontEdgeColor, IMatrix_mod_FrontEdgeThk, IMatrix_mod_FrontId, IMatrix_mod_FrontProgram, IMatrix_mod_FrontType, IMatrix_mod_Height, IMatrix_mod_PartInfo, IMatrix_mod_Width, IMatrix_mod_ModuleName, IMatrix_mod_HandleDesign, IMatrix_mod_HandlePosType, IMatrix_mod_FramePartsWidthHor, IMatrix_mod_FramePartsWidthVert} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { mc_WoodFrame01_createBuildPlan, mc_WoodFrame01_afterDataCompletion, mc_WoodFrame01_manufacturerDataCompletion } from '../../modules/mc_WoodFrame01';

export interface cbp_mc_WoodFrame01 extends IModBaseProp
...
export interface dc_mc_WoodFrame01 extends IModBaseProp
, IModVar_mod_Depth, IModVar_mod_FrontColor, IModVar_mod_FrontDesign, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontId, IModVar_mod_FrontProgram, IModVar_mod_FrontType, IModVar_mod_Height, IModVar_mod_PartInfo, IModVar_mod_Width, IModVar_mod_ModuleName, IModVar_mod_HandleDesign, IModVar_mod_HandlePosType, IModVar_mod_FrontpanelWeightCalculations, IModVar_mod_FramePartsWidthHor, IModVar_mod_FramePartsWidthVert {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_WoodFrame01;
  parent: OD_Base;
}

export interface adc_mc_WoodFrame01 extends IModBaseProp
, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_Height, IModVarNonNull_mod_PartInfo, IModVarNonNull_mod_Width, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_FrontpanelWeightCalculations, IModVarNonNull_mod_FramePartsWidthHor, IModVarNonNull_mod_FramePartsWidthVert {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
}

export class OD_M_mc_WoodFrame01 extends OD_Base  implements dc_mc_WoodFrame01

,IModVar_mod_Depth,IModVar_mod_FrontColor,IModVar_mod_FrontDesign,IModVar_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVar_mod_FrontId,IModVar_mod_FrontProgram,IModVar_mod_FrontType,IModVar_mod_Height,IModVar_mod_PartInfo,IModVar_mod_Width,IModVar_mod_ModuleName,IModVar_mod_HandleDesign,IModVar_mod_HandlePosType,IModVar_mod_FrontpanelWeightCalculations,IModVar_mod_FramePartsWidthHor,IModVar_mod_FramePartsWidthVert
 {
  constructor(parent: OD_Base, manufacturerMode?:boolean) {
    super('mc_WoodFrame01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_WoodFrame01_NonNull(this);
  }
  parent: OD_Base;
  _selfNonNull: OD_M_mc_WoodFrame01_NonNull;

  override variants:string[] = ['mod_Depth','mod_FrontColor','mod_FrontDesign','mod_FrontEdgeColor','mod_FrontEdgeThk','mod_FrontId','mod_FrontProgram','mod_FrontType','mod_Height','mod_PartInfo','mod_Width','mod_ModuleName','mod_HandleDesign','mod_HandlePosType','mod_FrontpanelWeightCalculations','mod_FramePartsWidthHor','mod_FramePartsWidthVert',];
  #mod_Depth?: number;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = " mc_WoodFrame01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_WoodFrame01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_WoodFrame01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_WoodFrame01{
    ...
    const adc = new OD_M_mc_WoodFrame01_NonNull(this);
    return adc;
  }
  ...
  override createBuildPlan():void {
    var cbp = new OD_M_mc_WoodFrame01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_WoodFrame01_NonNull implements cbp_mc_WoodFrame01, adc_mc_WoodFrame01  {
  constructor(parent: OD_M_mc_WoodFrame01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_WoodFrame01;
  ...
  #createBuildPlanInternal = mc_WoodFrame01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_WoodFrame01_afterDataCompletion;
