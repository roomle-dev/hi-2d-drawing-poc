...
//#region Imports
import { cbp_mc_FillerFront01, dc_mc_FillerFront01, adc_mc_FillerFront01 } from '../internal/modules/mc_FillerFront01'
...
export function mc_FillerFront01_createBuildPlan(this: cbp_mc_FillerFront01):void {
  internal_enterModuleCreateBuildPlan('mc_FillerFront01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_FillerFront01_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: April 2025
  // By Joao Lisboa
...
// ---------------------------------------------------------------
export function mc_FillerFront01_afterDataCompletion(this: adc_mc_FillerFront01):void {
  internal_enterModuleAfterDataCompletion('mc_FillerFront01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_FillerFront01_AFTERDATACOMPLETION
  ...
  let retDoorInfo = GlobalFunc.find_FrontConstruction(this.mod_FrontProgram, this.mod_FrontDesign, 'Filler', this.mod_FrontWidth, this.mod_FrontHeight, 'All', 'All');
  ...
  //Define values for atributes not in use
  Door.mod_HandleDesign = '10';
  Door.mod_HandlePosType = '01';
  ...
  //===================================================
  let fillerHardwareInfo = GlobalFunc.process_FillerHardware(this, retDoorInfo.Width(this), retDoorInfo.Height(this), retDoorInfo.WidthPos(this) + this.mod_Originpos[0], this.mod_FrontPosStart + retDoorInfo.HeightPos(this), 'FromFront');
...
// ---------------------------------------------------------------
export function mc_FillerFront01_manufacturerDataCompletion(this: dc_mc_FillerFront01):void {
  internal_enterModuleManufacturerDataCompletion('mc_FillerFront01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_FillerFront01_MANUFACTURERDATACOMPLETION
