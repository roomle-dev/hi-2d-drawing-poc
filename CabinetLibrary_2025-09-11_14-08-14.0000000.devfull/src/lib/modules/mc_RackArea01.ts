...
//#region Imports
import { cbp_mc_RackArea01, dc_mc_RackArea01, adc_mc_RackArea01 } from '../internal/modules/mc_RackArea01'
...
export function mc_RackArea01_createBuildPlan(this: cbp_mc_RackArea01):void {
  internal_enterModuleCreateBuildPlan('mc_RackArea01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_RackArea01_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: July 2024
...
// ---------------------------------------------------------------
export function mc_RackArea01_afterDataCompletion(this: adc_mc_RackArea01):void {
  internal_enterModuleAfterDataCompletion('mc_RackArea01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_RackArea01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_RackArea01_manufacturerDataCompletion(this: dc_mc_RackArea01):void {
  internal_enterModuleManufacturerDataCompletion('mc_RackArea01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_RackArea01_MANUFACTURERDATACOMPLETION
