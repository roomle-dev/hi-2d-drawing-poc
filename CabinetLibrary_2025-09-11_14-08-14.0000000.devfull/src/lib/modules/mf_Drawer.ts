...
//#region Imports
import { cbp_mf_Drawer, dc_mf_Drawer, adc_mf_Drawer } from '../internal/modules/mf_Drawer'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_Drawer01, OD_M_mc_Drawer01 } from '../internal/modules/mc_Drawer01'
...
export function mf_Drawer_createBuildPlan(this: cbp_mf_Drawer):void {
  internal_enterModuleCreateBuildPlan('mf_Drawer', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mf_Drawer_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mf_Drawer_afterDataCompletion(this: adc_mf_Drawer):void {
  internal_enterModuleAfterDataCompletion('mf_Drawer', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_Drawer_AFTERDATACOMPLETION
// Schuler Consulting
// Create: Nov 2022
// By Ludwig Weber
...
// ---------------------------------------------------------------
export function mf_Drawer_manufacturerDataCompletion(this: dc_mf_Drawer):void {
  internal_enterModuleManufacturerDataCompletion('mf_Drawer', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_Drawer_MANUFACTURERDATACOMPLETION
