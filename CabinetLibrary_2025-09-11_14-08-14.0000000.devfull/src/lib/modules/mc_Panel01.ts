...
//#region Imports
import { cbp_mc_Panel01, dc_mc_Panel01, adc_mc_Panel01 } from '../internal/modules/mc_Panel01'
...
export function mc_Panel01_createBuildPlan(this: cbp_mc_Panel01):void {
  internal_enterModuleCreateBuildPlan('mc_Panel01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Panel01_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: Nov 2022
  // By Ludwig Weber
...
// ---------------------------------------------------------------
export function mc_Panel01_afterDataCompletion(this: adc_mc_Panel01):void {
  internal_enterModuleAfterDataCompletion('mc_Panel01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Panel01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Panel01_manufacturerDataCompletion(this: dc_mc_Panel01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Panel01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Panel01_MANUFACTURERDATACOMPLETION
