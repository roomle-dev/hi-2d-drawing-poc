...
import { IPartParentsNonNull_mc_ApplianceGraphic } from '../mod-interfaces'

export interface IP_part_ApplianceGraphic_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_ApplianceGraphic;
}

export interface IP_part_ApplianceGraphic_PartVarsWritable extends IP_part_ApplianceGraphic_PartVarsReadOnly {
}

export class P_part_ApplianceGraphic extends PartBase implements IP_part_ApplianceGraphic_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_ApplianceGraphic, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_ApplianceGraphic', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
  parent: IPartParentsNonNull_mc_ApplianceGraphic; // module which created this part
