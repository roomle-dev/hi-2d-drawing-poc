...
//#region Imports
import { cbp_mc_StorageunitShelffixed01, dc_mc_StorageunitShelffixed01, adc_mc_StorageunitShelffixed01 } from '../internal/modules/mc_StorageunitShelffixed01'
...
export function mc_StorageunitShelffixed01_createBuildPlan(this: cbp_mc_StorageunitShelffixed01):void {
  internal_enterModuleCreateBuildPlan('mc_StorageunitShelffixed01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_StorageunitShelffixed01_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: Nov 2022
  // By Ludwig Weber
...
// ---------------------------------------------------------------
export function mc_StorageunitShelffixed01_afterDataCompletion(this: adc_mc_StorageunitShelffixed01):void {
  internal_enterModuleAfterDataCompletion('mc_StorageunitShelffixed01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitShelffixed01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_StorageunitShelffixed01_manufacturerDataCompletion(this: dc_mc_StorageunitShelffixed01):void {
  internal_enterModuleManufacturerDataCompletion('mc_StorageunitShelffixed01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitShelffixed01_MANUFACTURERDATACOMPLETION
