...
export interface cti_tab_FlipliftSettings {
...
export interface ctm_tab_FlipliftSettings {
}

export interface cto_tab_FlipliftSettings extends ctm_tab_FlipliftSettings {
  readonly _id : number;
  readonly Priority : number;
  readonly FlipliftHardwareType? : string;
  readonly Hinges? : boolean;
  readonly PushToOpen? : boolean;
  readonly Sequence? : string;
}

export interface ICT_tab_FlipliftSettings
extends cti_tab_FlipliftSettings, cto_tab_FlipliftSettings {}

export class ct2_tab_FlipliftSettings {
...
): cto_tab_FlipliftSettings | undefined {
  const res = ct_tab_FlipliftSettings.find((p) => 
...
public find(
predicate: (value: cti_tab_FlipliftSettings) => boolean
): cto_tab_FlipliftSettings | undefined {
  for (let index = 0; index < ct_tab_FlipliftSettings.length; index++){
    const element = ct_tab_FlipliftSettings[index];
...
export var ct_tab_FlipliftSettings :ICT_tab_FlipliftSettings[] = [
{
 _id: 7,
 in_FlipliftType: "FHF",
 in_HeightMin: 480,
 ...
 Priority: 1,
 FlipliftHardwareType: "Powerstorage",
 Hinges: true,
 PushToOpen: false,
 Sequence: "L_R"
}
...
,{
 ...
 in_OpeningType: "Handle",
 Priority: 2,
 FlipliftHardwareType: "Gasspring",
 Hinges: true,
 PushToOpen: false,
 Sequence: "L_R"
}
...
,{
 ...
 in_OpeningType: "Handle",
 Priority: 1,
 FlipliftHardwareType: "DropDownHinge",
 Hinges: true,
 PushToOpen: false,
 Sequence: "L_R"
}
