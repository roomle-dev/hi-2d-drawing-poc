...
import { OD_M_mc_Sink01, dc_mc_Sink01 } from './mc_Sink01'
import { OD_M_mc_ApplianceGraphic, dc_mc_ApplianceGraphic } from './mc_ApplianceGraphic'
import { IModuleNonNull_mf_Sink,IModParents_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood,IModParents_mf_Sink,IPartParentsNonNull_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood,IPartParentsNonNull_mf_Sink} from '../mod-interfaces'
import {IModVar_mod_SinkId,IModVarNonNull_mod_SinkId,IModVar_mod_SinkMoveDepth,IModVarNonNull_mod_SinkMoveDepth,IModVar_mod_SinkMoveWidth,IModVarNonNull_mod_SinkMoveWidth,IModVar_mod_SinkSupplier,IModVarNonNull_mod_SinkSupplier,IModVar_mod_MixerId,IModVarNonNull_mod_MixerId,IModVar_mod_MixerSupplier,IModVarNonNull_mod_MixerSupplier,IModVar_mod_CountertopInfo,IModVarNonNull_mod_CountertopInfo} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_SinkId, IMatrix_mod_SinkMoveDepth, IMatrix_mod_SinkMoveWidth, IMatrix_mod_SinkSupplier, IMatrix_mod_MixerId, IMatrix_mod_MixerSupplier} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { mf_Sink_createBuildPlan, mf_Sink_afterDataCompletion, mf_Sink_manufacturerDataCompletion } from '../../modules/mf_Sink';

export interface cbp_mf_Sink extends IModBaseProp
...
export interface dc_mf_Sink extends IModBaseProp
, IModVar_mod_SinkId, IModVar_mod_SinkMoveDepth, IModVar_mod_SinkMoveWidth, IModVar_mod_SinkSupplier, IModVar_mod_MixerId, IModVar_mod_MixerSupplier, IModVar_mod_CountertopInfo {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mf_Sink;
  parent: IModParents_mr_StorageunitSingle;
  addOD_M_mc_Sink01(index?: number): dc_mc_Sink01;
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
}

export interface adc_mf_Sink extends IModBaseProp
, IModVarNonNull_mod_SinkId, IModVarNonNull_mod_SinkMoveDepth, IModVarNonNull_mod_SinkMoveWidth, IModVarNonNull_mod_SinkSupplier, IModVarNonNull_mod_MixerId, IModVarNonNull_mod_MixerSupplier, IModVarNonNull_mod_CountertopInfo {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  addOD_M_mc_Sink01(index?: number): dc_mc_Sink01;
...
export class OD_M_mf_Sink extends OD_Base  implements dc_mf_Sink
,IModParents_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood,IModParents_mf_Sink
,IModVar_mod_SinkId,IModVar_mod_SinkMoveDepth,IModVar_mod_SinkMoveWidth,IModVar_mod_SinkSupplier,IModVar_mod_MixerId,IModVar_mod_MixerSupplier,IModVar_mod_CountertopInfo
 {
  constructor(parent: IModParents_mr_StorageunitSingle, manufacturerMode?:boolean) {
    super('mf_Sink', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mf_Sink_NonNull(this);
  }
  parent: IModParents_mr_StorageunitSingle;
  _selfNonNull: OD_M_mf_Sink_NonNull;

  override variants:string[] = ['mod_SinkId','mod_SinkMoveDepth','mod_SinkMoveWidth','mod_SinkSupplier','mod_MixerId','mod_MixerSupplier','mod_CountertopInfo',];
  #mod_SinkId?: string;
  get mod_SinkId(): string | undefined { return this.#mod_SinkId}
  set mod_SinkId(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_SinkId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_SinkId === value) return;
    this.#mod_SinkId = value;
  }

  mod_SinkId_matrix?: IMatrix_mod_SinkId;
  #mod_SinkMoveDepth?: number;
  get mod_SinkMoveDepth(): number | undefined { return this.#mod_SinkMoveDepth}
  set mod_SinkMoveDepth(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_SinkMoveDepth' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_SinkMoveDepth === value) return;
    this.#mod_SinkMoveDepth = value;
  }

  mod_SinkMoveDepth_matrix?: IMatrix_mod_SinkMoveDepth;
  #mod_SinkMoveWidth?: number;
  get mod_SinkMoveWidth(): number | undefined { return this.#mod_SinkMoveWidth}
  set mod_SinkMoveWidth(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_SinkMoveWidth' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_SinkMoveWidth === value) return;
    this.#mod_SinkMoveWidth = value;
  }

  mod_SinkMoveWidth_matrix?: IMatrix_mod_SinkMoveWidth;
  #mod_SinkSupplier?: string;
  get mod_SinkSupplier(): string | undefined { return this.#mod_SinkSupplier}
  set mod_SinkSupplier(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_SinkSupplier' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_SinkSupplier === value) return;
    this.#mod_SinkSupplier = value;
  }

  mod_SinkSupplier_matrix?: IMatrix_mod_SinkSupplier;
  #mod_MixerId?: string;
  get mod_MixerId(): string | undefined { return this.#mod_MixerId}
  set mod_MixerId(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_MixerId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_MixerId === value) return;
    this.#mod_MixerId = value;
  }

  mod_MixerId_matrix?: IMatrix_mod_MixerId;
  #mod_MixerSupplier?: string;
  get mod_MixerSupplier(): string | undefined { return this.#mod_MixerSupplier}
  set mod_MixerSupplier(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_MixerSupplier' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_MixerSupplier === value) return;
    this.#mod_MixerSupplier = value;
  }

  mod_MixerSupplier_matrix?: IMatrix_mod_MixerSupplier;
  #mod_CountertopInfo: string[] = [];
  get mod_CountertopInfo(): string[] { return this.#mod_CountertopInfo;}
  override getAttributes() : Map<string,any> { 
    let res = new Map<string,any>();
  res.set('mod_SinkId', this.mod_SinkId);
  res.set('mod_SinkMoveDepth', this.mod_SinkMoveDepth);
  res.set('mod_SinkMoveWidth', this.mod_SinkMoveWidth);
  res.set('mod_SinkSupplier', this.mod_SinkSupplier);
  res.set('mod_MixerId', this.mod_MixerId);
  res.set('mod_MixerSupplier', this.mod_MixerSupplier);
  ...
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_SinkId');
    const val = _toString(json['attributes']['mod_SinkId'], 'mod_SinkId');
    internal_leaveValidateVariant();
    this.mod_SinkId = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_SinkMoveDepth');
    const val = _toFloat(json['attributes']['mod_SinkMoveDepth'], 'mod_SinkMoveDepth');
    internal_leaveValidateVariant();
    this.mod_SinkMoveDepth = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_SinkMoveWidth');
    const val = _toFloat(json['attributes']['mod_SinkMoveWidth'], 'mod_SinkMoveWidth');
    internal_leaveValidateVariant();
    this.mod_SinkMoveWidth = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_SinkSupplier');
    const val = _toString(json['attributes']['mod_SinkSupplier'], 'mod_SinkSupplier');
    internal_leaveValidateVariant();
    this.mod_SinkSupplier = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_MixerId');
    const val = _toString(json['attributes']['mod_MixerId'], 'mod_MixerId');
    internal_leaveValidateVariant();
    this.mod_MixerId = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_MixerSupplier');
    const val = _toString(json['attributes']['mod_MixerSupplier'], 'mod_MixerSupplier');
    internal_leaveValidateVariant();
    this.mod_MixerSupplier = val; }
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_SinkId === undefined) {
      this.mod_SinkId = "None";
    }
    if (this.mod_SinkMoveDepth === undefined) {
      this.mod_SinkMoveDepth = 50;
    }
    if (this.mod_SinkMoveWidth === undefined) {
      this.mod_SinkMoveWidth = 0;
    }
    if (this.mod_SinkSupplier === undefined) {
      this.mod_SinkSupplier = "None";
    }
    if (this.mod_MixerId === undefined) {
      this.mod_MixerId = "None";
    }
    if (this.mod_MixerSupplier === undefined) {
      this.mod_MixerSupplier = "None";
    }
  ...
  #manufacturerDataCompletionInternal = mf_Sink_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mf_Sink_NonNull(this);
  ...
  seal(): IModuleNonNull_mf_Sink{
    ...
    const adc = new OD_M_mf_Sink_NonNull(this);
    return adc;
  }

  addOD_M_mc_Sink01(index?: number): dc_mc_Sink01 {
    var m = new OD_M_mc_Sink01(this);
    m.dataCompletion();
  ...
  override validateSelections():void {
    this.mod_SinkId_matrix = VariantValidation.mod_SinkId(this, this);
    this.mod_SinkMoveDepth_matrix = VariantValidation.mod_SinkMoveDepth(this, this);
    this.mod_SinkMoveWidth_matrix = VariantValidation.mod_SinkMoveWidth(this, this);
    this.mod_SinkSupplier_matrix = VariantValidation.mod_SinkSupplier(this, this);
    this.mod_MixerId_matrix = VariantValidation.mod_MixerId(this, this);
    this.mod_MixerSupplier_matrix = VariantValidation.mod_MixerSupplier(this, this);
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mf_Sink_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mf_Sink_NonNull implements cbp_mf_Sink, adc_mf_Sink ,IPartParentsNonNull_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood,IPartParentsNonNull_mf_Sink {
  constructor(parent: OD_M_mf_Sink) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mf_Sink;
  ...
  #createBuildPlanInternal = mf_Sink_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mf_Sink_afterDataCompletion;
  ...
  parent: IModParents_mr_StorageunitSingle;
  get mod_SinkId(): string  {
    return this.#internalParent.mod_SinkId!;
  }
  get mod_SinkMoveDepth(): number  {
    return this.#internalParent.mod_SinkMoveDepth!;
  }
  get mod_SinkMoveWidth(): number  {
    return this.#internalParent.mod_SinkMoveWidth!;
  }
  get mod_SinkSupplier(): string  {
    return this.#internalParent.mod_SinkSupplier!;
  }
  get mod_MixerId(): string  {
    return this.#internalParent.mod_MixerId!;
  }
  get mod_MixerSupplier(): string  {
    return this.#internalParent.mod_MixerSupplier!;
  }
  get mod_CountertopInfo(): string [] {
    return this.#internalParent.mod_CountertopInfo!;
  }
  addOD_M_mc_Sink01(index?: number): dc_mc_Sink01 {
    return this.#internalParent.addOD_M_mc_Sink01(index);
  }
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic {
