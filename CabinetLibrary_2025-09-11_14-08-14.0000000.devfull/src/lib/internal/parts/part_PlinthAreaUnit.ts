...
import { IPartParentsNonNull_mr_Appliance_mr_Filler01 } from '../mod-interfaces'

export interface IP_part_PlinthAreaUnit_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mr_Appliance_mr_Filler01;
}

export interface IP_part_PlinthAreaUnit_PartVarsWritable extends IP_part_PlinthAreaUnit_PartVarsReadOnly {
}

export class P_part_PlinthAreaUnit extends PartBase implements IP_part_PlinthAreaUnit_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mr_Appliance_mr_Filler01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_PlinthAreaUnit', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
  parent: IPartParentsNonNull_mr_Appliance_mr_Filler01; // module which created this part
