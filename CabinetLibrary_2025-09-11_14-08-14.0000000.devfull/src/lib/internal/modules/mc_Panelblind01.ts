...
import { IModParents_mc_CornerunitStraight01 } from '../mod-interfaces'
import { IP_part_Panelblind_PartVarsWritable, P_part_Panelblind } from '../parts/part_Panelblind'
import { IModuleNonNull_mc_Panelblind01,IModParents_mc_Panelblind01,IPartParentsNonNull_mc_Panelblind01} from '../mod-interfaces'
import {IModVar_mod_CarcaseColor,IModVarNonNull_mod_CarcaseColor,IModVar_mod_CarcaseEdgeBackColor,IModVarNonNull_mod_CarcaseEdgeBackColor,IModVar_mod_CarcaseEdgeColor,IModVarNonNull_mod_CarcaseEdgeColor,IModVar_mod_CarcaseEdgeFrontColor,IModVarNonNull_mod_CarcaseEdgeFrontColor,IModVar_mod_CarcaseId,IModVarNonNull_mod_CarcaseId,IModVar_mod_CarcaseOutsideColor,IModVarNonNull_mod_CarcaseOutsideColor,IModVar_mod_CarcaseOutsideProgram,IModVarNonNull_mod_CarcaseOutsideProgram,IModVar_mod_CarcaseProgram,IModVarNonNull_mod_CarcaseProgram,IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_EdgeBackType,IModVarNonNull_mod_EdgeBackType,IModVar_mod_EdgeFrontType,IModVarNonNull_mod_EdgeFrontType,IModVar_mod_EdgeJointType,IModVarNonNull_mod_EdgeJointType,IModVar_mod_EdgeLeftType,IModVarNonNull_mod_EdgeLeftType,IModVar_mod_EdgeRightType,IModVarNonNull_mod_EdgeRightType,IModVar_mod_Height,IModVarNonNull_mod_Height,IModVar_mod_Width,IModVarNonNull_mod_Width,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_CarcasePartConnectionLeftHor,IModVarNonNull_mod_CarcasePartConnectionLeftHor,IModVar_mod_CarcasePartConnectionRightHor,IModVarNonNull_mod_CarcasePartConnectionRightHor,IModVar_mod_CarcasePartConnectionBtmVert,IModVarNonNull_mod_CarcasePartConnectionBtmVert,IModVar_mod_CarcasePartConnectionTopVert,IModVarNonNull_mod_CarcasePartConnectionTopVert,IModVar_mod_FittingConnectionTopVert,IModVarNonNull_mod_FittingConnectionTopVert,IModVar_mod_FittingConnectionBtmVert,IModVarNonNull_mod_FittingConnectionBtmVert,IModVar_mod_FittingConnectionLeftHor,IModVarNonNull_mod_FittingConnectionLeftHor,IModVar_mod_FittingConnectionRightHor,IModVarNonNull_mod_FittingConnectionRightHor,IModVar_mod_TypeElement,IModVarNonNull_mod_TypeElement,IModVar_mod_ParentName,IModVarNonNull_mod_ParentName,IModVar_mod_GrainLogic,IModVarNonNull_mod_GrainLogic} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_CarcaseColor, IMatrix_mod_CarcaseEdgeBackColor, IMatrix_mod_CarcaseEdgeColor, IMatrix_mod_CarcaseEdgeFrontColor, IMatrix_mod_CarcaseId, IMatrix_mod_CarcaseOutsideColor, IMatrix_mod_CarcaseOutsideProgram, IMatrix_mod_CarcaseProgram, IMatrix_mod_Depth, IMatrix_mod_EdgeBackType, IMatrix_mod_EdgeFrontType, IMatrix_mod_EdgeJointType, IMatrix_mod_EdgeLeftType, IMatrix_mod_EdgeRightType, IMatrix_mod_Height, IMatrix_mod_Width, IMatrix_mod_ModuleName, IMatrix_mod_CarcasePartConnectionLeftHor, IMatrix_mod_CarcasePartConnectionRightHor, IMatrix_mod_CarcasePartConnectionBtmVert, IMatrix_mod_CarcasePartConnectionTopVert, IMatrix_mod_FittingConnectionTopVert, IMatrix_mod_FittingConnectionBtmVert, IMatrix_mod_FittingConnectionLeftHor, IMatrix_mod_FittingConnectionRightHor, IMatrix_mod_TypeElement, IMatrix_mod_ParentName, IMatrix_mod_GrainLogic} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_Panelblind } from '../part-add-interfaces';
import { mc_Panelblind01_createBuildPlan, mc_Panelblind01_afterDataCompletion, mc_Panelblind01_manufacturerDataCompletion } from '../../modules/mc_Panelblind01';

export interface cbp_mc_Panelblind01 extends IModBaseProp
, IPartAdd_part_Panelblind, IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseEdgeBackColor, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseOutsideColor, IModVarNonNull_mod_CarcaseOutsideProgram, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_Depth, IModVarNonNull_mod_EdgeBackType, IModVarNonNull_mod_EdgeFrontType, IModVarNonNull_mod_EdgeJointType, IModVarNonNull_mod_EdgeLeftType, IModVarNonNull_mod_EdgeRightType, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_CarcasePartConnectionLeftHor, IModVarNonNull_mod_CarcasePartConnectionRightHor, IModVarNonNull_mod_CarcasePartConnectionBtmVert, IModVarNonNull_mod_CarcasePartConnectionTopVert, IModVarNonNull_mod_FittingConnectionTopVert, IModVarNonNull_mod_FittingConnectionBtmVert, IModVarNonNull_mod_FittingConnectionLeftHor, IModVarNonNull_mod_FittingConnectionRightHor, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_GrainLogic {
  parent: IModParents_mc_CornerunitStraight01;
...
export interface dc_mc_Panelblind01 extends IModBaseProp
, IModVar_mod_CarcaseColor, IModVar_mod_CarcaseEdgeBackColor, IModVar_mod_CarcaseEdgeColor, IModVar_mod_CarcaseEdgeFrontColor, IModVar_mod_CarcaseId, IModVar_mod_CarcaseOutsideColor, IModVar_mod_CarcaseOutsideProgram, IModVar_mod_CarcaseProgram, IModVar_mod_Depth, IModVar_mod_EdgeBackType, IModVar_mod_EdgeFrontType, IModVar_mod_EdgeJointType, IModVar_mod_EdgeLeftType, IModVar_mod_EdgeRightType, IModVar_mod_Height, IModVar_mod_Width, IModVar_mod_ModuleName, IModVar_mod_CarcasePartConnectionLeftHor, IModVar_mod_CarcasePartConnectionRightHor, IModVar_mod_CarcasePartConnectionBtmVert, IModVar_mod_CarcasePartConnectionTopVert, IModVar_mod_FittingConnectionTopVert, IModVar_mod_FittingConnectionBtmVert, IModVar_mod_FittingConnectionLeftHor, IModVar_mod_FittingConnectionRightHor, IModVar_mod_TypeElement, IModVar_mod_ParentName, IModVar_mod_GrainLogic {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Panelblind01;
  parent: IModParents_mc_CornerunitStraight01;
}

export interface adc_mc_Panelblind01 extends IModBaseProp
...
export class OD_M_mc_Panelblind01 extends OD_Base  implements dc_mc_Panelblind01
,IModParents_mc_Panelblind01
,IModVar_mod_CarcaseColor,IModVar_mod_CarcaseEdgeBackColor,IModVar_mod_CarcaseEdgeColor,IModVar_mod_CarcaseEdgeFrontColor,IModVar_mod_CarcaseId,IModVar_mod_CarcaseOutsideColor,IModVar_mod_CarcaseOutsideProgram,IModVar_mod_CarcaseProgram,IModVar_mod_Depth,IModVar_mod_EdgeBackType,IModVar_mod_EdgeFrontType,IModVar_mod_EdgeJointType,IModVar_mod_EdgeLeftType,IModVar_mod_EdgeRightType,IModVar_mod_Height,IModVar_mod_Width,IModVar_mod_ModuleName,IModVar_mod_CarcasePartConnectionLeftHor,IModVar_mod_CarcasePartConnectionRightHor,IModVar_mod_CarcasePartConnectionBtmVert,IModVar_mod_CarcasePartConnectionTopVert,IModVar_mod_FittingConnectionTopVert,IModVar_mod_FittingConnectionBtmVert,IModVar_mod_FittingConnectionLeftHor,IModVar_mod_FittingConnectionRightHor,IModVar_mod_TypeElement,IModVar_mod_ParentName,IModVar_mod_GrainLogic
 {
  constructor(parent: IModParents_mc_CornerunitStraight01, manufacturerMode?:boolean) {
    super('mc_Panelblind01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Panelblind01_NonNull(this);
  }
  parent: IModParents_mc_CornerunitStraight01;
  _selfNonNull: OD_M_mc_Panelblind01_NonNull;

  override variants:string[] = ['mod_CarcaseColor','mod_CarcaseEdgeBackColor','mod_CarcaseEdgeColor','mod_CarcaseEdgeFrontColor','mod_CarcaseId','mod_CarcaseOutsideColor','mod_CarcaseOutsideProgram','mod_CarcaseProgram','mod_Depth','mod_EdgeBackType','mod_EdgeFrontType','mod_EdgeJointType','mod_EdgeLeftType','mod_EdgeRightType','mod_Height','mod_Width','mod_ModuleName','mod_CarcasePartConnectionLeftHor','mod_CarcasePartConnectionRightHor','mod_CarcasePartConnectionBtmVert','mod_CarcasePartConnectionTopVert','mod_FittingConnectionTopVert','mod_FittingConnectionBtmVert','mod_FittingConnectionLeftHor','mod_FittingConnectionRightHor','mod_TypeElement','mod_ParentName','mod_GrainLogic',];
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_Panelblind01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_Panelblind01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Panelblind01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Panelblind01{
    ...
    const adc = new OD_M_mc_Panelblind01_NonNull(this);
    return adc;
  }
  ...
  addpart_Panelblind(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Panelblind_PartVarsWritable {
    var c = new P_part_Panelblind(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Panelblind01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Panelblind01_NonNull implements cbp_mc_Panelblind01, adc_mc_Panelblind01 ,IPartParentsNonNull_mc_Panelblind01 {
  constructor(parent: OD_M_mc_Panelblind01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Panelblind01;
  ...
  #createBuildPlanInternal = mc_Panelblind01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Panelblind01_afterDataCompletion;
  ...
  parent: IModParents_mc_CornerunitStraight01;
  addpart_Panelblind(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Panelblind_PartVarsWritable {
    return this.#internalParent.addpart_Panelblind(x, y, z, dimx, dimy, dimz);
  }
