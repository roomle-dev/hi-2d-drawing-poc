...
import { IModParents_mf_Oven } from '../mod-interfaces'
import { OD_M_mc_ApplianceGraphic, dc_mc_ApplianceGraphic } from './mc_ApplianceGraphic'
import { IModuleNonNull_mc_Oven01,IModParents_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood,IPartParentsNonNull_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood} from '../mod-interfaces'
import {IModVar_mod_CarcaseHeight,IModVarNonNull_mod_CarcaseHeight,IModVar_mod_CarcaseDepth,IModVarNonNull_mod_CarcaseDepth,IModVar_mod_CarcaseWidth,IModVarNonNull_mod_CarcaseWidth,IModVar_mod_Originpos,IModVarNonNull_mod_Originpos,IModVar_mod_OvenId,IModVarNonNull_mod_OvenId} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_CarcaseHeight, IMatrix_mod_CarcaseDepth, IMatrix_mod_CarcaseWidth, IMatrix_mod_OvenId} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { mc_Oven01_createBuildPlan, mc_Oven01_afterDataCompletion, mc_Oven01_manufacturerDataCompletion } from '../../modules/mc_Oven01';

export interface cbp_mc_Oven01 extends IModBaseProp
...
export interface dc_mc_Oven01 extends IModBaseProp
, IModVar_mod_CarcaseHeight, IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseWidth, IModVar_mod_Originpos, IModVar_mod_OvenId {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Oven01;
  parent: IModParents_mf_Oven;
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
}

export interface adc_mc_Oven01 extends IModBaseProp
, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_OvenId {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
...
export class OD_M_mc_Oven01 extends OD_Base  implements dc_mc_Oven01
,IModParents_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood
,IModVar_mod_CarcaseHeight,IModVar_mod_CarcaseDepth,IModVar_mod_CarcaseWidth,IModVar_mod_Originpos,IModVar_mod_OvenId
 {
  constructor(parent: IModParents_mf_Oven, manufacturerMode?:boolean) {
    super('mc_Oven01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Oven01_NonNull(this);
  }
  parent: IModParents_mf_Oven;
  _selfNonNull: OD_M_mc_Oven01_NonNull;

  override variants:string[] = ['mod_CarcaseHeight','mod_CarcaseDepth','mod_CarcaseWidth','mod_Originpos','mod_OvenId',];
  ...
  #mod_OvenId?: string;
  get mod_OvenId(): string | undefined { return this.#mod_OvenId}
  set mod_OvenId(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_OvenId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_OvenId === value) return;
    this.#mod_OvenId = value;
  }

  mod_OvenId_matrix?: IMatrix_mod_OvenId;
  ...
  res.set('mod_OvenId', this.mod_OvenId);
    return res;
  }
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_OvenId');
    const val = _toString(json['attributes']['mod_OvenId'], 'mod_OvenId');
    internal_leaveValidateVariant();
    this.mod_OvenId = val; }
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_OvenId === undefined) {
      this.mod_OvenId = "None";
    }
  ...
  #manufacturerDataCompletionInternal = mc_Oven01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Oven01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Oven01{
    ...
    const adc = new OD_M_mc_Oven01_NonNull(this);
    return adc;
  }
  ...
  override validateSelections():void {
    ...
    this.mod_OvenId_matrix = VariantValidation.mod_OvenId(this, this);
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Oven01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Oven01_NonNull implements cbp_mc_Oven01, adc_mc_Oven01 ,IPartParentsNonNull_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood {
  constructor(parent: OD_M_mc_Oven01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Oven01;
  ...
  #createBuildPlanInternal = mc_Oven01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Oven01_afterDataCompletion;
  ...
  get mod_OvenId(): string  {
    return this.#internalParent.mod_OvenId!;
  }
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic {
