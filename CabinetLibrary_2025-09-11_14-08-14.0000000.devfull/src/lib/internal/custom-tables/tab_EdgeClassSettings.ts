...
export interface cti_tab_EdgeClassSettings {
  readonly in_EdgeType? : string;
}

export interface ctm_tab_EdgeClassSettings {
}

export interface cto_tab_EdgeClassSettings extends ctm_tab_EdgeClassSettings {
  readonly _id : number;
  readonly Description? : string;
  readonly EdgeClass? : string;
}

export interface ICT_tab_EdgeClassSettings
extends cti_tab_EdgeClassSettings, cto_tab_EdgeClassSettings {}

export class ct2_tab_EdgeClassSettings {

public findExactly(
     in_EdgeType: string|undefined,
): cto_tab_EdgeClassSettings | undefined {
  const res = ct_tab_EdgeClassSettings.find((p) => 
p.in_EdgeType === in_EdgeType
);
return res;
}

public find(
predicate: (value: cti_tab_EdgeClassSettings) => boolean
): cto_tab_EdgeClassSettings | undefined {
  for (let index = 0; index < ct_tab_EdgeClassSettings.length; index++){
    const element = ct_tab_EdgeClassSettings[index];
...
export var ct_tab_EdgeClassSettings :ICT_tab_EdgeClassSettings[] = [
{
 _id: 1,
 in_EdgeType: "CBE",
 Description: "Carcase Back Edge",
 EdgeClass: "CarcaseClass2"
}
,{
 _id: 2,
 in_EdgeType: "CFE",
 Description: "Carcase Front Edge",
 EdgeClass: "CarcaseClass1"
}
,{
 _id: 3,
 in_EdgeType: "CLR",
 Description: "Carcase Edges (not Front or Back)",
 EdgeClass: "CarcaseClass2"
}
,{
 _id: 4,
 in_EdgeType: "DOW",
 Description: "Cutting in EdgeBander (for doweling)",
 EdgeClass: "CarcaseClass3"
}
,{
 _id: 5,
 in_EdgeType: "FHS",
 Description: "Front handle strip ",
 EdgeClass: "FrontClass2"
}
,{
 _id: 6,
 in_EdgeType: "FRE",
 Description: "Front Edge",
 EdgeClass: "FrontClass1"
}
,{
 _id: 7,
 in_EdgeType: "ICN",
 Description: "Carcase Interior Not Visible Edge",
 EdgeClass: "CarcaseClass2"
}
,{
 _id: 8,
 in_EdgeType: "ICV",
 Description: "Carcase Interior Visible Edge",
 EdgeClass: "CarcaseClass2"
}
,{
 _id: 9,
 in_EdgeType: "MIT",
 Description: "Mitre Cut Edge",
 EdgeClass: "CarcaseClass1"
}
,{
 _id: 10,
 in_EdgeType: "NOE",
 Description: "No Edge",
 EdgeClass: "NoEdgeClass"
}
,{
 _id: 11,
 in_EdgeType: "SPB",
 Description: "SidePanel Bottom",
 EdgeClass: "CarcaseClass2"
}
,{
 _id: 12,
 in_EdgeType: "SPT",
 Description: "SidePanel Top",
 EdgeClass: "CarcaseClass2"
}
,{
 _id: 13,
 in_EdgeType: "VBE",
 Description: "Visible Edge in a Back Panel",
 EdgeClass: "CarcaseClass2"
}
];
