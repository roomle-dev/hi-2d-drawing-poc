...
export interface cti_tab_CarcasePartGrainDirectionSettings {
  readonly in_CarcaseProgram? : string;
...
export interface ctm_tab_CarcasePartGrainDirectionSettings {
}

export interface cto_tab_CarcasePartGrainDirectionSettings extends ctm_tab_CarcasePartGrainDirectionSettings {
  readonly _id : number;
  readonly CarcaseGrainDirection? : string;
}

export interface ICT_tab_CarcasePartGrainDirectionSettings
extends cti_tab_CarcasePartGrainDirectionSettings, cto_tab_CarcasePartGrainDirectionSettings {}

export class ct2_tab_CarcasePartGrainDirectionSettings {

public findExactly(
     in_CarcaseProgram: string|undefined,
     in_GrainAvailable: boolean|undefined,
     in_LengthMin: number,
     in_LengthMax: number,
     in_WidthMin: number,
     in_WidthMax: number,
): cto_tab_CarcasePartGrainDirectionSettings | undefined {
  const res = ct_tab_CarcasePartGrainDirectionSettings.find((p) => 
p.in_CarcaseProgram === in_CarcaseProgram
...
public find(
predicate: (value: cti_tab_CarcasePartGrainDirectionSettings) => boolean
): cto_tab_CarcasePartGrainDirectionSettings | undefined {
  for (let index = 0; index < ct_tab_CarcasePartGrainDirectionSettings.length; index++){
    const element = ct_tab_CarcasePartGrainDirectionSettings[index];
...
export var ct_tab_CarcasePartGrainDirectionSettings :ICT_tab_CarcasePartGrainDirectionSettings[] = [
];
