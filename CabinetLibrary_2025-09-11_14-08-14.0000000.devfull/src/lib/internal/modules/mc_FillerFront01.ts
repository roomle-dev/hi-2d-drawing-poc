...
import { IModuleNonNull_mc_FillerFront01,IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01,IModParents_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01,IModParents_mc_CornerFillerFront01_mc_FillerFront01_mf_CornerFillerFront,IModParents_mc_CornerFillerFront01_mc_FillerFront01,IPartParentsNonNull_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01,IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01,IPartParentsNonNull_mc_CornerFillerFront01_mc_FillerFront01_mf_CornerFillerFront,IPartParentsNonNull_mc_CornerFillerFront01_mc_FillerFront01} from '../mod-interfaces'
import {IModVar_mod_CarcaseId,IModVarNonNull_mod_CarcaseId,IModVar_mod_CarcasePartInfo,IModVarNonNull_mod_CarcasePartInfo,IModVar_mod_Direction,IModVarNonNull_mod_Direction,IModVar_mod_FingergripBtmType,IModVarNonNull_mod_FingergripBtmType,IModVar_mod_FingergripTop,IModVarNonNull_mod_FingergripTop,IModVar_mod_FingergripTopType,IModVarNonNull_mod_FingergripTopType,IModVar_mod_FrontColor,IModVarNonNull_mod_FrontColor,IModVar_mod_FrontDesign,IModVarNonNull_mod_FrontDesign,IModVar_mod_FrontEdgeColor,IModVarNonNull_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVarNonNull_mod_FrontEdgeThk,IModVar_mod_FrontGapCarcase,IModVarNonNull_mod_FrontGapCarcase,IModVar_mod_FrontGapHor,IModVarNonNull_mod_FrontGapHor,IModVar_mod_FrontGapVert,IModVarNonNull_mod_FrontGapVert,IModVar_mod_FrontHeight,IModVarNonNull_mod_FrontHeight,IModVar_mod_FrontId,IModVarNonNull_mod_FrontId,IModVar_mod_FrontOversizeBtm,IModVarNonNull_mod_FrontOversizeBtm,IModVar_mod_FrontOversizeRight,IModVarNonNull_mod_FrontOversizeRight,IModVar_mod_FrontOversizeLeft,IModVarNonNull_mod_FrontOversizeLeft,IModVar_mod_FrontOversizeTop,IModVarNonNull_mod_FrontOversizeTop,IModVar_mod_FrontPosStart,IModVarNonNull_mod_FrontPosStart,IModVar_mod_FrontThk,IModVarNonNull_mod_FrontThk,IModVar_mod_FrontWidth,IModVarNonNull_mod_FrontWidth,IModVar_mod_HeightPosInsertion,IModVarNonNull_mod_HeightPosInsertion,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_Originpos,IModVarNonNull_mod_Originpos,IModVar_mod_PlinthAreaHeight,IModVarNonNull_mod_PlinthAreaHeight,IModVar_mod_SidepanelleftThk,IModVarNonNull_mod_SidepanelleftThk,IModVar_mod_SidepanelrightThk,IModVarNonNull_mod_SidepanelrightThk,IModVar_mod_TypeElement,IModVarNonNull_mod_TypeElement,IModVar_mod_FrontProgram,IModVarNonNull_mod_FrontProgram,IModVar_mod_DoorDirection,IModVarNonNull_mod_DoorDirection,IModVar_mod_ParentName,IModVarNonNull_mod_ParentName,IModVar_mod_FillerType,IModVarNonNull_mod_FillerType,IModVar_mod_FillerHardware,IModVarNonNull_mod_FillerHardware,IModVar_mod_FillerHardwareInfo,IModVarNonNull_mod_FillerHardwareInfo} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_CarcaseId, IMatrix_mod_Direction, IMatrix_mod_FingergripBtmType, IMatrix_mod_FingergripTop, IMatrix_mod_FingergripTopType, IMatrix_mod_FrontColor, IMatrix_mod_FrontDesign, IMatrix_mod_FrontEdgeColor, IMatrix_mod_FrontEdgeThk, IMatrix_mod_FrontGapCarcase, IMatrix_mod_FrontGapHor, IMatrix_mod_FrontGapVert, IMatrix_mod_FrontHeight, IMatrix_mod_FrontId, IMatrix_mod_FrontOversizeBtm, IMatrix_mod_FrontOversizeRight, IMatrix_mod_FrontOversizeLeft, IMatrix_mod_FrontOversizeTop, IMatrix_mod_FrontPosStart, IMatrix_mod_FrontThk, IMatrix_mod_FrontWidth, IMatrix_mod_HeightPosInsertion, IMatrix_mod_ModuleName, IMatrix_mod_PlinthAreaHeight, IMatrix_mod_SidepanelleftThk, IMatrix_mod_SidepanelrightThk, IMatrix_mod_TypeElement, IMatrix_mod_FrontProgram, IMatrix_mod_DoorDirection, IMatrix_mod_ParentName, IMatrix_mod_FillerType, IMatrix_mod_FillerHardware} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_FillerUnit, IPartAdd_part_FillerHardware, IPartAdd_part_FillerHardwareProcessing } from '../part-add-interfaces';
import { mc_FillerFront01_createBuildPlan, mc_FillerFront01_afterDataCompletion, mc_FillerFront01_manufacturerDataCompletion } from '../../modules/mc_FillerFront01';
...
export interface adc_mc_FillerFront01 extends IModBaseProp
, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcasePartInfo, IModVarNonNull_mod_Direction, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_DoorDirection, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_FillerType, IModVarNonNull_mod_FillerHardware, IModVarNonNull_mod_FillerHardwareInfo {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  addOD_M_mc_FrontPanel01(index?: number): dc_mc_FrontPanel01;
...
,IModVar_mod_CarcaseId,IModVar_mod_CarcasePartInfo,IModVar_mod_Direction,IModVar_mod_FingergripBtmType,IModVar_mod_FingergripTop,IModVar_mod_FingergripTopType,IModVar_mod_FrontColor,IModVar_mod_FrontDesign,IModVar_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVar_mod_FrontGapCarcase,IModVar_mod_FrontGapHor,IModVar_mod_FrontGapVert,IModVar_mod_FrontHeight,IModVar_mod_FrontId,IModVar_mod_FrontOversizeBtm,IModVar_mod_FrontOversizeRight,IModVar_mod_FrontOversizeLeft,IModVar_mod_FrontOversizeTop,IModVar_mod_FrontPosStart,IModVar_mod_FrontThk,IModVar_mod_FrontWidth,IModVar_mod_HeightPosInsertion,IModVar_mod_ModuleName,IModVar_mod_Originpos,IModVar_mod_PlinthAreaHeight,IModVar_mod_SidepanelleftThk,IModVar_mod_SidepanelrightThk,IModVar_mod_TypeElement,IModVar_mod_FrontProgram,IModVar_mod_DoorDirection,IModVar_mod_ParentName,IModVar_mod_FillerType,IModVar_mod_FillerHardware,IModVar_mod_FillerHardwareInfo
 {
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_FrontWidth === undefined) {
      this.mod_FrontWidth = 150;
    }
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_FillerFront01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_FillerFront01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_FillerFront01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_FillerFront01{
    ...
    const adc = new OD_M_mc_FillerFront01_NonNull(this);
    return adc;
  }
  ...
  override createBuildPlan():void {
    var cbp = new OD_M_mc_FillerFront01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_FillerFront01_NonNull implements cbp_mc_FillerFront01, adc_mc_FillerFront01 ,IPartParentsNonNull_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01,IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01,IPartParentsNonNull_mc_CornerFillerFront01_mc_FillerFront01_mf_CornerFillerFront,IPartParentsNonNull_mc_CornerFillerFront01_mc_FillerFront01 {
  constructor(parent: OD_M_mc_FillerFront01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_FillerFront01;
  ...
  #createBuildPlanInternal = mc_FillerFront01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_FillerFront01_afterDataCompletion;
