...
export interface cti_tab_FridgeConstruction {
  readonly in_ConstructionId? : string;
}

export interface ctm_tab_FridgeConstruction {
}

export interface cto_tab_FridgeConstruction extends ctm_tab_FridgeConstruction {
  readonly _id : number;
  readonly DefaultHeight : number;
  readonly MinHeight? : string;
  readonly MaxHeight? : string;
  readonly SplitDoor? : boolean;
  readonly Hinges? : boolean;
  readonly BottomFrontDrawer? : boolean;
  readonly MinHeightDoorBtm : number;
  readonly MaxHeightDoorBtm : number;
}

export interface ICT_tab_FridgeConstruction
extends cti_tab_FridgeConstruction, cto_tab_FridgeConstruction {}

export class ct2_tab_FridgeConstruction {

public findExactly(
     in_ConstructionId: string|undefined,
): cto_tab_FridgeConstruction | undefined {
  const res = ct_tab_FridgeConstruction.find((p) => 
...
public find(
predicate: (value: cti_tab_FridgeConstruction) => boolean
): cto_tab_FridgeConstruction | undefined {
  for (let index = 0; index < ct_tab_FridgeConstruction.length; index++){
    const element = ct_tab_FridgeConstruction[index];
...
export var ct_tab_FridgeConstruction :ICT_tab_FridgeConstruction[] = [
{
 _id: 17,
 in_ConstructionId: "KI86SHDD0",
 DefaultHeight: 1775,
 MinHeight: "1772",
 MaxHeight: "1780",
 SplitDoor: true,
 Hinges: false,
 BottomFrontDrawer: false,
 MinHeightDoorBtm: 630,
 MaxHeightDoorBtm: 690
}
,{
 _id: 18,
 in_ConstructionId: "KI82LADD0",
 DefaultHeight: 1776,
 MinHeight: "1776",
 MaxHeight: "1780",
 SplitDoor: false,
...
,{
 _id: 20,
 in_ConstructionId: "FridgeDefault",
 DefaultHeight: 1225,
 MinHeight: "1221",
 MaxHeight: "1228",
 SplitDoor: false,
