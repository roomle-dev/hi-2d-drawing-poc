...
export interface cti_tab_SinkMapping {
  readonly in_Supplier? : string;
  readonly in_SinkId? : string;
}

export interface ctm_tab_SinkMapping {
}

export interface cto_tab_SinkMapping extends ctm_tab_SinkMapping {
  readonly _id : number;
  readonly ConstructionId? : string;
  readonly GraphicId? : string;
}

export interface ICT_tab_SinkMapping
extends cti_tab_SinkMapping, cto_tab_SinkMapping {}

export class ct2_tab_SinkMapping {

public findExactly(
     in_Supplier: string|undefined,
     in_SinkId: string|undefined,
): cto_tab_SinkMapping | undefined {
  const res = ct_tab_SinkMapping.find((p) => 
p.in_Supplier === in_Supplier
 && p.in_SinkId === in_SinkId
);
return res;
}

public find(
predicate: (value: cti_tab_SinkMapping) => boolean
): cto_tab_SinkMapping | undefined {
  for (let index = 0; index < ct_tab_SinkMapping.length; index++){
    const element = ct_tab_SinkMapping[index];
...
export var ct_tab_SinkMapping :ICT_tab_SinkMapping[] = [
{
 _id: 1,
 in_Supplier: "Blanco",
 in_SinkId: "Axis_R",
 ConstructionId: "Axis_R",
 GraphicId: "Axis_R"
}
,{
 _id: 2,
 in_Supplier: "Blanco",
 in_SinkId: "Axis_L",
 ConstructionId: "Axis_L",
 GraphicId: "Axis_L"
}
,{
 _id: 3,
 in_Supplier: "Blanco",
 in_SinkId: "Axia_White_R",
 ConstructionId: "Axia_White_R",
 GraphicId: "Axia_White_R"
}
,{
 _id: 4,
 in_Supplier: "Blanco",
 in_SinkId: "Axia_White_L",
 ConstructionId: "Axia_White_L",
 GraphicId: "Axia_White_L"
}
,{
 _id: 5,
 in_Supplier: "Blanco",
 in_SinkId: "Axia_Grey_R",
 ConstructionId: "Axia_Grey_R",
 GraphicId: "Axia_Grey_R"
}
,{
 _id: 6,
 in_Supplier: "Blanco",
 in_SinkId: "Axia_Grey_L",
 ConstructionId: "Axia_Grey_L",
 GraphicId: "Axia_Grey_L"
}
,{
 _id: 7,
 in_Supplier: "Blanco",
 in_SinkId: "Axia_Anthrazit_R",
 ConstructionId: "Axia_Anthrazit_R",
 GraphicId: "Axia_Anthrazit_R"
}
,{
 _id: 8,
 in_Supplier: "Blanco",
 in_SinkId: "Axia_Anthrazit_L",
 ConstructionId: "Axia_Anthrazit_L",
 GraphicId: "Axia_Anthrazit_L"
}
,{
 _id: 9,
 in_Supplier: "Blanco",
 in_SinkId: "Dinas_R",
 ConstructionId: "Dinas_R",
 GraphicId: "Dinas_R"
}
,{
 _id: 10,
...
,{
 ...
 in_Supplier: "None",
 in_SinkId: "None",
 ConstructionId: "SinkDefault",
 GraphicId: "SinkDefault"
}
,{
 _id: 12,
 in_Supplier: "Blanco",
 in_SinkId: "Metra_L",
 ConstructionId: "Metra_L",
 GraphicId: "Metra_L"
}
,{
 _id: 13,
