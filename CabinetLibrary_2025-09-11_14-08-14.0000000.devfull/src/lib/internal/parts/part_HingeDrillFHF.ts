...
import { IPartParentsNonNull_mc_Hinge01 } from '../mod-interfaces'

export interface IP_part_HingeDrillFHF_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_Hinge01;
  get pa_DrillDistance(): number;
  get pa_FrontGapCarcase(): number;
  get pa_FrontOverlay(): number;
  get pa_HingeGapCarcase(): number;
  get pa_Model3DGroupName(): string;
  get pa_Model3DGroupName2(): string;
  get pa_ProcessingId(): string;
  get pa_ProcessingId2(): string;
}

export interface IP_part_HingeDrillFHF_PartVarsWritable extends IP_part_HingeDrillFHF_PartVarsReadOnly {
  set pa_DrillDistance(value: number);
  set pa_FrontGapCarcase(value: number);
  set pa_FrontOverlay(value: number);
  set pa_HingeGapCarcase(value: number);
  set pa_Model3DGroupName(value: string);
  set pa_Model3DGroupName2(value: string);
  set pa_ProcessingId(value: string);
  set pa_ProcessingId2(value: string);
}

export class P_part_HingeDrillFHF extends PartBase implements IP_part_HingeDrillFHF_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Hinge01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_HingeDrillFHF', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  parent: IPartParentsNonNull_mc_Hinge01; // module which created this part
  override getAttributes() : Map<string,any> { 
    let res = new Map<string,any>();
  res.set('pa_DrillDistance', this.#pa_DrillDistance);
  res.set('pa_FrontGapCarcase', this.#pa_FrontGapCarcase);
  res.set('pa_FrontOverlay', this.#pa_FrontOverlay);
  res.set('pa_HingeGapCarcase', this.#pa_HingeGapCarcase);
  res.set('pa_Model3DGroupName', this.#pa_Model3DGroupName);
  res.set('pa_Model3DGroupName2', this.#pa_Model3DGroupName2);
  res.set('pa_ProcessingId', this.#pa_ProcessingId);
  res.set('pa_ProcessingId2', this.#pa_ProcessingId2);
    return res;
  }
  setAttributes() {
    try {
    ...
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // part_HingeDrillFHF_ValueScript
    if (this.#pa_DrillDistance === undefined) {
      this.pa_DrillDistance = 0;
    }
    if (this.#pa_FrontGapCarcase === undefined) {
      this.pa_FrontGapCarcase = 0;
    }
    if (this.#pa_FrontOverlay === undefined) {
      this.pa_FrontOverlay = 0;
    }
    if (this.#pa_HingeGapCarcase === undefined) {
      this.pa_HingeGapCarcase = 0;
    }
    if (this.#pa_Model3DGroupName === undefined) {
      this.pa_Model3DGroupName = '';
    }
    if (this.#pa_Model3DGroupName2 === undefined) {
      this.pa_Model3DGroupName2 = '';
    }
    if (this.#pa_ProcessingId === undefined) {
      this.pa_ProcessingId = '';
    }
    if (this.#pa_ProcessingId2 === undefined) {
      this.pa_ProcessingId2 = '';
    }
    // ###############################################################
    // ################### END CUSTOM SCRIPTS ########################
    // ###############################################################
  ...
  checkAttributes() {
    ...
    if (this.#pa_DrillDistance === undefined) {
      logError('Attribute pa_DrillDistance not set in part part_HingeDrillFHF (id: ' + this._id + ')');
    }
    if (this.#pa_FrontGapCarcase === undefined) {
      logError('Attribute pa_FrontGapCarcase not set in part part_HingeDrillFHF (id: ' + this._id + ')');
    }
    if (this.#pa_FrontOverlay === undefined) {
      logError('Attribute pa_FrontOverlay not set in part part_HingeDrillFHF (id: ' + this._id + ')');
    }
    if (this.#pa_HingeGapCarcase === undefined) {
      logError('Attribute pa_HingeGapCarcase not set in part part_HingeDrillFHF (id: ' + this._id + ')');
    }
    if (this.#pa_Model3DGroupName === undefined) {
      logError('Attribute pa_Model3DGroupName not set in part part_HingeDrillFHF (id: ' + this._id + ')');
    }
    if (this.#pa_Model3DGroupName2 === undefined) {
      logError('Attribute pa_Model3DGroupName2 not set in part part_HingeDrillFHF (id: ' + this._id + ')');
    }
    if (this.#pa_ProcessingId === undefined) {
      logError('Attribute pa_ProcessingId not set in part part_HingeDrillFHF (id: ' + this._id + ')');
    }
    if (this.#pa_ProcessingId2 === undefined) {
      logError('Attribute pa_ProcessingId2 not set in part part_HingeDrillFHF (id: ' + this._id + ')');
    }
  ...
  get pa_DrillDistance(): number { return this.#pa_DrillDistance!; }
  set pa_DrillDistance(val:number) { this.#pa_DrillDistance = val; }
  #pa_DrillDistance?: number;
  get pa_FrontGapCarcase(): number { return this.#pa_FrontGapCarcase!; }
  set pa_FrontGapCarcase(val:number) { this.#pa_FrontGapCarcase = val; }
  #pa_FrontGapCarcase?: number;
  get pa_FrontOverlay(): number { return this.#pa_FrontOverlay!; }
  set pa_FrontOverlay(val:number) { this.#pa_FrontOverlay = val; }
  #pa_FrontOverlay?: number;
  get pa_HingeGapCarcase(): number { return this.#pa_HingeGapCarcase!; }
  set pa_HingeGapCarcase(val:number) { this.#pa_HingeGapCarcase = val; }
  #pa_HingeGapCarcase?: number;
  get pa_Model3DGroupName(): string { return this.#pa_Model3DGroupName!; }
  set pa_Model3DGroupName(val:string) { this.#pa_Model3DGroupName = val; }
  #pa_Model3DGroupName?: string;
  get pa_Model3DGroupName2(): string { return this.#pa_Model3DGroupName2!; }
  set pa_Model3DGroupName2(val:string) { this.#pa_Model3DGroupName2 = val; }
  #pa_Model3DGroupName2?: string;
  ...
  get pa_ProcessingId2(): string { return this.#pa_ProcessingId2!; }
  set pa_ProcessingId2(val:string) { this.#pa_ProcessingId2 = val; }
  #pa_ProcessingId2?: string;
}
