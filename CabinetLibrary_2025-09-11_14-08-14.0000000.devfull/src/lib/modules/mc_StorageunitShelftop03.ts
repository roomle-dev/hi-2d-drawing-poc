...
//#region Imports
import { cbp_mc_StorageunitShelftop03, dc_mc_StorageunitShelftop03, adc_mc_StorageunitShelftop03 } from '../internal/modules/mc_StorageunitShelftop03'
...
export function mc_StorageunitShelftop03_createBuildPlan(this: cbp_mc_StorageunitShelftop03):void {
  internal_enterModuleCreateBuildPlan('mc_StorageunitShelftop03', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_StorageunitShelftop03_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_StorageunitShelftop03_afterDataCompletion(this: adc_mc_StorageunitShelftop03):void {
  internal_enterModuleAfterDataCompletion('mc_StorageunitShelftop03', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitShelftop03_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_StorageunitShelftop03_manufacturerDataCompletion(this: dc_mc_StorageunitShelftop03):void {
  internal_enterModuleManufacturerDataCompletion('mc_StorageunitShelftop03', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitShelftop03_MANUFACTURERDATACOMPLETION
