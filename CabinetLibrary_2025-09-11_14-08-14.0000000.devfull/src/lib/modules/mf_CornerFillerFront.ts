...
//#region Imports
import { cbp_mf_CornerFillerFront, dc_mf_CornerFillerFront, adc_mf_CornerFillerFront } from '../internal/modules/mf_CornerFillerFront'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_CornerFillerFront01, OD_M_mc_CornerFillerFront01 } from '../internal/modules/mc_CornerFillerFront01'
...
export function mf_CornerFillerFront_createBuildPlan(this: cbp_mf_CornerFillerFront):void {
  internal_enterModuleCreateBuildPlan('mf_CornerFillerFront', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mf_CornerFillerFront_CREATEBUILDPLAN
//Schuler Consulting
// Create: March 2024
// By Joao Lisboa
...
//
// Description:
// CreateBuildPlan of mf_CornerunitStraightFiller
...
let tempDepth:number = 0;

if(this.mod_CarcaseDirection == 'Left')
{
  if(this.mod_CornerunitStraightFillerConstruction_matrix.PartInCornerCabinet == 'Mitre')
  {
    tempWidth = this.mod_WidthRight;
    tempDepth = this.mod_WidthLeft;
  }
  else if(this.mod_CornerunitStraightFillerConstruction_matrix.PartInCornerCabinet == 'Short')
  {
    tempWidth = this.mod_WidthRight + this.mod_ThkLeft;
    tempDepth = this.mod_WidthLeft;
  }
  else if(this.mod_CornerunitStraightFillerConstruction_matrix.PartInCornerCabinet == 'Long')
  {
    tempWidth = this.mod_WidthRight;
    tempDepth = this.mod_WidthLeft + this.mod_ThkRight;
  }
  else
  {
    logError('Error 21002: The selected value for the attribute CornerunitStraightFillerConstruction is not valid.')
  }
}
else if(this.mod_CarcaseDirection == 'Right')
{
  if(this.mod_CornerunitStraightFillerConstruction_matrix.PartInCornerCabinet == 'Mitre')
  {
    tempWidth = this.mod_WidthLeft;
    tempDepth = this.mod_WidthRight;
  }
  else if(this.mod_CornerunitStraightFillerConstruction_matrix.PartInCornerCabinet == 'Short')
  {
    tempWidth = this.mod_WidthLeft + this.mod_ThkRight;
    tempDepth = this.mod_WidthRight;
  }
  else if(this.mod_CornerunitStraightFillerConstruction_matrix.PartInCornerCabinet == 'Long')
  {
    tempWidth = this.mod_WidthLeft;
    tempDepth = this.mod_WidthRight + this.mod_ThkLeft;
  }
  else
  {
    logError('Error 21002: The selected value for the attribute CornerunitStraightFillerConstruction is not valid.')
...
{
  logError('Error 21001: The selected value for the attribute Carcase Direction is not valid.')
}

tempHeight = Math.max(this.mod_HeightLeft, this.mod_HeightRight);


let FillerUnit=this.addpart_FillerUnit(0,0,0,tempWidth,Math.max(this.mod_HeightLeft, this.mod_HeightRight),tempDepth);
...
// ---------------------------------------------------------------
export function mf_CornerFillerFront_afterDataCompletion(this: adc_mf_CornerFillerFront):void {
  internal_enterModuleAfterDataCompletion('mf_CornerFillerFront', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_CornerFillerFront_AFTERDATACOMPLETION
// Schuler Consulting
// Create: March 2024
// By Joao Lisboa
// Purpose: CabinetLibrary
//
// Description:
// AfterDataCompletion of mf_CornerunitStraightFiller
...
// Add the module Left
let fillerL = this.addOD_M_mc_CornerFillerFront01();
// Add the module Right
let fillerR = this.addOD_M_mc_CornerFillerFront01();

fillerL.mod_FrontWidth = this.mod_WidthLeft;
fillerR.mod_FrontWidth = this.mod_WidthRight;
fillerL.mod_FrontHeight= this.mod_HeightLeft;
fillerR.mod_FrontHeight= this.mod_HeightRight;
fillerL.mod_FrontThk = this.mod_ThkLeft;
fillerR.mod_FrontThk = this.mod_ThkRight;

fillerL.mod_DoorDirection = 'Left';
fillerR.mod_DoorDirection = 'Right';

fillerL.mod_Direction = 'Left';
fillerR.mod_Direction = 'Right';

fillerL.mod_FrontId = this.mod_FrontId //+ "L"
fillerR.mod_FrontId = this.mod_FrontId //+ "R"

// Get the Information of the Carcase Parts Info
  fillerL.mod_CarcasePartInfo.push(this.mod_CarcasePartInfo[0]);
  fillerR.mod_CarcasePartInfo.push(this.mod_CarcasePartInfo[0]);

// SetOrigin for Left and Right Filler
if(this.mod_CornerunitStraightFillerConstruction_matrix.PartInCornerCabinet == 'Mitre')
{
  if (this.mod_CarcaseDirection == 'Right')
  {
    fillerL.setOrigin(this.mod_CornerunitFrontWidth + this.mod_FrontGapVert / 2, 0, this.mod_FrontGapCarcase);
    //Save OriginPos
    fillerL.mod_Originpos.push(this.mod_Originpos[0] + this.mod_CornerunitFrontWidth + this.mod_FrontGapVert / 2);
    fillerL.mod_Originpos.push(this.mod_Originpos[1] + 0);
    fillerL.mod_Originpos.push(this.mod_Originpos[2] + this.mod_FrontGapCarcase);

    let modMatrix = ModuleHelper.posAndRotateY(this.mod_CornerunitFrontWidth + this.mod_FrontGapVert / 2 + this.mod_WidthLeft - this.mod_FrontGapVert, 0, this.mod_FrontGapCarcase, -90, new Vector3(this.mod_CornerunitFrontWidth + this.mod_FrontGapVert / 2 + this.mod_WidthLeft - this.mod_FrontGapVert, 0, this.mod_FrontGapCarcase));
    fillerR.setOrigin(modMatrix);
    //Save OriginPos AFTER rotation
    fillerR.mod_Originpos.push(this.mod_Originpos[0] + this.mod_CornerunitFrontWidth + this.mod_FrontGapVert / 2 + this.mod_WidthLeft - this.mod_FrontGapVert);
    fillerR.mod_Originpos.push(this.mod_Originpos[1] + 0);
    fillerR.mod_Originpos.push(this.mod_Originpos[2] + this.mod_FrontGapCarcase);
  }
  else
  {
    let modMatrix = ModuleHelper.posAndRotateY(this.mod_CarcaseWidth - this.mod_CornerunitFrontWidth - this.mod_WidthRight + this.mod_FrontGapVert / 2 - this.mod_WidthLeft + this.mod_FrontGapVert, 0, this.mod_FrontGapCarcase, 90, new Vector3(this.mod_CarcaseWidth - this.mod_CornerunitFrontWidth - this.mod_WidthRight + this.mod_FrontGapVert / 2 - this.mod_WidthLeft + this.mod_FrontGapVert + (this.mod_WidthLeft - this.mod_FrontGapVert), 0, this.mod_FrontGapCarcase));
    fillerL.setOrigin(modMatrix);
    //Save OriginPos AFTER rotation
    fillerL.mod_Originpos.push(this.mod_Originpos[0] + this.mod_CarcaseWidth - this.mod_CornerunitFrontWidth - this.mod_WidthRight + this.mod_FrontGapVert / 2);
    fillerL.mod_Originpos.push(this.mod_Originpos[1] + 0);
    fillerL.mod_Originpos.push(this.mod_Originpos[2] + this.mod_FrontGapCarcase);

    fillerR.setOrigin(this.mod_CarcaseWidth - this.mod_CornerunitFrontWidth - this.mod_WidthRight + this.mod_FrontGapVert / 2, 0, this.mod_FrontGapCarcase);
    //Save OriginPos
    fillerR.mod_Originpos.push(this.mod_Originpos[0] + this.mod_CarcaseWidth - this.mod_CornerunitFrontWidth - this.mod_WidthRight + this.mod_FrontGapVert / 2);
    fillerR.mod_Originpos.push(this.mod_Originpos[1] + 0);
    fillerR.mod_Originpos.push(this.mod_Originpos[2] + this.mod_FrontGapCarcase);
  }
}
else if(this.mod_CornerunitStraightFillerConstruction_matrix.PartInCornerCabinet == 'Short')
{
  if (this.mod_CarcaseDirection == 'Right')
  {
    ...
    let modMatrix = ModuleHelper.posAndRotateY(this.mod_CornerunitFrontWidth + this.mod_FrontGapVert/2 + this.mod_WidthLeft - this.mod_FrontGapVert + this.mod_ThkRight, 0, this.mod_FrontGapCarcase, -90, new Vector3(this.mod_CornerunitFrontWidth + this.mod_FrontGapVert/2 + this.mod_WidthLeft - this.mod_FrontGapVert + this.mod_ThkRight, 0, this.mod_FrontGapCarcase));
    fillerR.setOrigin(modMatrix);
    //Save OriginPos AFTER rotation
    fillerR.mod_Originpos.push(this.mod_Originpos[0] + this.mod_CornerunitFrontWidth + this.mod_FrontGapVert / 2 + this.mod_WidthLeft - this.mod_FrontGapVert);
    fillerR.mod_Originpos.push(this.mod_Originpos[1] + 0);
  ...
  {
    let modMatrix = ModuleHelper.posAndRotateY(this.mod_CarcaseWidth - this.mod_CornerunitFrontWidth - this.mod_WidthRight + this.mod_FrontGapVert / 2 - this.mod_WidthLeft + this.mod_FrontGapVert - this.mod_ThkLeft, 0, this.mod_FrontGapCarcase, 90, new Vector3(this.mod_CarcaseWidth - this.mod_CornerunitFrontWidth - this.mod_WidthRight + this.mod_FrontGapVert / 2 - this.mod_WidthLeft + this.mod_FrontGapVert - this.mod_ThkLeft + (this.mod_WidthLeft - this.mod_FrontGapVert), 0, this.mod_FrontGapCarcase));
    fillerL.setOrigin(modMatrix);
    //Save OriginPos AFTER rotation
    fillerL.mod_Originpos.push(this.mod_Originpos[0] + this.mod_CarcaseWidth - this.mod_CornerunitFrontWidth - this.mod_WidthRight + this.mod_FrontGapVert / 2 - this.mod_ThkLeft);
    fillerL.mod_Originpos.push(this.mod_Originpos[1] + 0);
    fillerL.mod_Originpos.push(this.mod_Originpos[2] + this.mod_FrontGapCarcase);
...
else if(this.mod_CornerunitStraightFillerConstruction_matrix.PartInCornerCabinet == 'Long')
{
  if (this.mod_CarcaseDirection == 'Right')
  {
    ...
    let modMatrix = ModuleHelper.posAndRotateY(this.mod_CornerunitFrontWidth + this.mod_FrontGapVert/2 + this.mod_WidthLeft - this.mod_FrontGapVert, 0, this.mod_FrontGapCarcase + this.mod_ThkLeft, -90, new Vector3(this.mod_CornerunitFrontWidth + this.mod_FrontGapVert/2 + this.mod_WidthLeft - this.mod_FrontGapVert, 0, this.mod_FrontGapCarcase + this.mod_ThkLeft));
    fillerR.setOrigin(modMatrix);
    //Save OriginPos AFTER rotation
    fillerR.mod_Originpos.push(this.mod_Originpos[0] + this.mod_CornerunitFrontWidth + this.mod_FrontGapVert / 2 + this.mod_WidthLeft - this.mod_FrontGapVert - this.mod_ThkRight);
    fillerR.mod_Originpos.push(this.mod_Originpos[1] + 0);
    fillerR.mod_Originpos.push(this.mod_Originpos[2] + this.mod_FrontGapCarcase + this.mod_ThkLeft);
  }
  else
  {
    let modMatrix = ModuleHelper.posAndRotateY(this.mod_CarcaseWidth - this.mod_CornerunitFrontWidth - this.mod_WidthRight + this.mod_FrontGapVert / 2 - this.mod_WidthLeft + this.mod_FrontGapVert, 0, this.mod_FrontGapCarcase + this.mod_ThkRight, 90, new Vector3(this.mod_CarcaseWidth - this.mod_CornerunitFrontWidth - this.mod_WidthRight + this.mod_FrontGapVert / 2 - this.mod_WidthLeft + this.mod_FrontGapVert + (this.mod_WidthLeft - this.mod_FrontGapVert), 0, this.mod_FrontGapCarcase + this.mod_ThkRight));
    fillerL.setOrigin(modMatrix);
    //Save OriginPos AFTER rotation
    fillerL.mod_Originpos.push(this.mod_Originpos[0] + this.mod_CarcaseWidth - this.mod_CornerunitFrontWidth - this.mod_WidthRight + this.mod_FrontGapVert / 2);
    fillerL.mod_Originpos.push(this.mod_Originpos[1] + 0);
    fillerL.mod_Originpos.push(this.mod_Originpos[2] + this.mod_FrontGapCarcase + this.mod_ThkRight)
...
{
  let ErrorMessage = GlobalFunc.find_ErrorList('Error 22024',1);
  logError(ErrorMessage.Message(''));

}

fillerL.mod_HandlePosMatrix = this.mod_HandlePosLeftMatrix;
fillerR.mod_HandlePosMatrix = this.mod_HandlePosRightMatrix;
...
// ---------------------------------------------------------------
export function mf_CornerFillerFront_manufacturerDataCompletion(this: dc_mf_CornerFillerFront):void {
  internal_enterModuleManufacturerDataCompletion('mf_CornerFillerFront', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_CornerFillerFront_MANUFACTURERDATACOMPLETION
