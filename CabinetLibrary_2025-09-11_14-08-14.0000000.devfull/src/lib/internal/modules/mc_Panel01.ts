...
import { IModParents_mr_IslandBackwall } from '../mod-interfaces'
import { IP_part_PanelHor_PartVarsWritable, P_part_PanelHor } from '../parts/part_PanelHor'
import { IP_part_PanelVert_PartVarsWritable, P_part_PanelVert } from '../parts/part_PanelVert'
import { IP_part_PanelUnit_PartVarsWritable, P_part_PanelUnit } from '../parts/part_PanelUnit'
import { IModuleNonNull_mc_Panel01,IModParents_mc_Panel01,IPartParentsNonNull_mc_Panel01} from '../mod-interfaces'
import {IModVar_mod_PanelId,IModVarNonNull_mod_PanelId,IModVar_mod_Color,IModVarNonNull_mod_Color,IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_Program,IModVarNonNull_mod_Program,IModVar_mod_Thk,IModVarNonNull_mod_Thk,IModVar_mod_Width,IModVarNonNull_mod_Width,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_Height,IModVarNonNull_mod_Height,IModVar_mod_PaneltopColor,IModVarNonNull_mod_PaneltopColor,IModVar_mod_PaneltopThk,IModVarNonNull_mod_PaneltopThk,IModVar_mod_IslandBackwallOverhangFront,IModVarNonNull_mod_IslandBackwallOverhangFront} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_PanelId, IMatrix_mod_Color, IMatrix_mod_Depth, IMatrix_mod_Program, IMatrix_mod_Thk, IMatrix_mod_Width, IMatrix_mod_ModuleName, IMatrix_mod_Height, IMatrix_mod_PaneltopColor, IMatrix_mod_PaneltopThk, IMatrix_mod_IslandBackwallOverhangFront} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_PanelHor, IPartAdd_part_PanelVert, IPartAdd_part_PanelUnit } from '../part-add-interfaces';
import { mc_Panel01_createBuildPlan, mc_Panel01_afterDataCompletion, mc_Panel01_manufacturerDataCompletion } from '../../modules/mc_Panel01';

export interface cbp_mc_Panel01 extends IModBaseProp
, IPartAdd_part_PanelHor, IPartAdd_part_PanelVert, IPartAdd_part_PanelUnit, IModVarNonNull_mod_PanelId, IModVarNonNull_mod_Color, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Program, IModVarNonNull_mod_Thk, IModVarNonNull_mod_Width, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_Height, IModVarNonNull_mod_PaneltopColor, IModVarNonNull_mod_PaneltopThk, IModVarNonNull_mod_IslandBackwallOverhangFront {
  parent: IModParents_mr_IslandBackwall;
...
export interface dc_mc_Panel01 extends IModBaseProp
, IModVar_mod_PanelId, IModVar_mod_Color, IModVar_mod_Depth, IModVar_mod_Program, IModVar_mod_Thk, IModVar_mod_Width, IModVar_mod_ModuleName, IModVar_mod_Height, IModVar_mod_PaneltopColor, IModVar_mod_PaneltopThk, IModVar_mod_IslandBackwallOverhangFront {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Panel01;
  parent: IModParents_mr_IslandBackwall;
}

export interface adc_mc_Panel01 extends IModBaseProp
, IModVarNonNull_mod_PanelId, IModVarNonNull_mod_Color, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Program, IModVarNonNull_mod_Thk, IModVarNonNull_mod_Width, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_Height, IModVarNonNull_mod_PaneltopColor, IModVarNonNull_mod_PaneltopThk, IModVarNonNull_mod_IslandBackwallOverhangFront {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
}

export class OD_M_mc_Panel01 extends OD_Base  implements dc_mc_Panel01
,IModParents_mc_Panel01
,IModVar_mod_PanelId,IModVar_mod_Color,IModVar_mod_Depth,IModVar_mod_Program,IModVar_mod_Thk,IModVar_mod_Width,IModVar_mod_ModuleName,IModVar_mod_Height,IModVar_mod_PaneltopColor,IModVar_mod_PaneltopThk,IModVar_mod_IslandBackwallOverhangFront
 {
  constructor(parent: IModParents_mr_IslandBackwall, manufacturerMode?:boolean) {
    super('mc_Panel01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Panel01_NonNull(this);
  }
  parent: IModParents_mr_IslandBackwall;
  _selfNonNull: OD_M_mc_Panel01_NonNull;

  override variants:string[] = ['mod_PanelId','mod_Color','mod_Depth','mod_Program','mod_Thk','mod_Width','mod_ModuleName','mod_Height','mod_PaneltopColor','mod_PaneltopThk','mod_IslandBackwallOverhangFront',];
  #mod_PanelId?: string;
  get mod_PanelId(): string | undefined { return this.#mod_PanelId}
  set mod_PanelId(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_PanelId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_PanelId === value) return;
    this.#mod_PanelId = value;
  }

  mod_PanelId_matrix?: IMatrix_mod_PanelId;
  #mod_Color?: string;
  ...
  res.set('mod_PanelId', this.mod_PanelId);
  ...
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_PanelId');
    const val = _toString(json['attributes']['mod_PanelId'], 'mod_PanelId');
    internal_leaveValidateVariant();
    this.mod_PanelId = val; }
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_Color === undefined) {
      ...
      while (s !== undefined) {
        if (s.variants.includes('mod_Color')) {
          let pv = <IModVar_mod_Color>s;
          if (pv.mod_Color !== undefined) {
            this.mod_Color = (<IModVar_mod_Color>s).mod_Color;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_Program === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_Program')) {
          let pv = <IModVar_mod_Program>s;
          if (pv.mod_Program !== undefined) {
            this.mod_Program = (<IModVar_mod_Program>s).mod_Program;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_IslandBackwallOverhangFront === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_IslandBackwallOverhangFront')) {
          let pv = <IModVar_mod_IslandBackwallOverhangFront>s;
          if (pv.mod_IslandBackwallOverhangFront !== undefined) {
            this.mod_IslandBackwallOverhangFront = (<IModVar_mod_IslandBackwallOverhangFront>s).mod_IslandBackwallOverhangFront;
            break;
          };
        }
        s = s.parentBase;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_PanelId === undefined) {
      this.mod_PanelId = "None";
    }
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_Panel01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_Panel01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Panel01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Panel01{
    ...
    const adc = new OD_M_mc_Panel01_NonNull(this);
    return adc;
  }

  override validateSelections():void {
    this.mod_PanelId_matrix = VariantValidation.mod_PanelId(this, this);
...
class OD_M_mc_Panel01_NonNull implements cbp_mc_Panel01, adc_mc_Panel01 ,IPartParentsNonNull_mc_Panel01 {
  constructor(parent: OD_M_mc_Panel01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Panel01;
  ...
  #createBuildPlanInternal = mc_Panel01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Panel01_afterDataCompletion;
  ...
  parent: IModParents_mr_IslandBackwall;
  addpart_PanelHor(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PanelHor_PartVarsWritable {
    return this.#internalParent.addpart_PanelHor(x, y, z, dimx, dimy, dimz);
  }
  addpart_PanelVert(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PanelVert_PartVarsWritable {
    return this.#internalParent.addpart_PanelVert(x, y, z, dimx, dimy, dimz);
  }
  addpart_PanelUnit(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PanelUnit_PartVarsWritable {
    return this.#internalParent.addpart_PanelUnit(x, y, z, dimx, dimy, dimz);
  }
  get mod_PanelId(): string  {
    return this.#internalParent.mod_PanelId!;
  }
