...
export interface cti_tab_HardwareSettings {
  readonly in_Supplier? : string;
  readonly in_SupplierArticleNumber? : string;
}

export interface ctm_tab_HardwareSettings {
}

export interface cto_tab_HardwareSettings extends ctm_tab_HardwareSettings {
  readonly _id : number;
  readonly BomHardwareDescription? : string;
  readonly BomHardwareType? : string;
}

export interface ICT_tab_HardwareSettings
extends cti_tab_HardwareSettings, cto_tab_HardwareSettings {}

export class ct2_tab_HardwareSettings {

public findExactly(
     in_Supplier: string|undefined,
     in_SupplierArticleNumber: string|undefined,
): cto_tab_HardwareSettings | undefined {
  const res = ct_tab_HardwareSettings.find((p) => 
...
public find(
predicate: (value: cti_tab_HardwareSettings) => boolean
): cto_tab_HardwareSettings | undefined {
  for (let index = 0; index < ct_tab_HardwareSettings.length; index++){
    const element = ct_tab_HardwareSettings[index];
...
export var ct_tab_HardwareSettings :ICT_tab_HardwareSettings[] = [
{
 _id: 1,
 in_Supplier: "Haefele",
 in_SupplierArticleNumber: "155.01.250",
 BomHardwareDescription: "Handle: 155.01.250",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 2,
 in_Supplier: "Haefele",
 in_SupplierArticleNumber: "155.01.251",
 BomHardwareDescription: "Handle: 155.01.251",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 3,
 ...
 BomHardwareDescription: "Handle: 155.01.252",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 4,
 ...
 BomHardwareDescription: "Handle: 155.01.253",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 5,
 ...
 BomHardwareDescription: "Handle: 155.01.254",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 6,
 ...
 BomHardwareDescription: "Handle: 155.01.255",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 7,
 ...
 BomHardwareDescription: "Handle: 155.01.256",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 8,
 ...
 BomHardwareDescription: "Handle: 155.01.257",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 9,
 ...
 BomHardwareDescription: "Handle: 155.01.258",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 10,
 ...
 BomHardwareDescription: "Handle: 155.01.259",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 11,
 ...
 BomHardwareDescription: "Handle: 155.01.260",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 12,
 ...
 BomHardwareDescription: "Handle: 155.01.261",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 13,
 ...
 BomHardwareDescription: "Handle: 155.01.262",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 14,
 ...
 BomHardwareDescription: "Handle: 155.01.380",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 15,
 ...
 BomHardwareDescription: "Handle: 155.01.381",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 16,
 ...
 BomHardwareDescription: "Handle: 155.01.382",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 17,
 ...
 BomHardwareDescription: "Handle: 155.01.383",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 18,
 ...
 BomHardwareDescription: "Handle: 155.01.384",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 19,
 ...
 BomHardwareDescription: "Handle: 155.01.385",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 20,
 ...
 BomHardwareDescription: "Handle: 155.01.386",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 21,
 ...
 BomHardwareDescription: "Handle: 155.01.387",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 22,
 ...
 BomHardwareDescription: "Handle: 155.01.388",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 23,
 ...
 BomHardwareDescription: "Handle: 155.01.389",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 24,
 ...
 BomHardwareDescription: "Handle: 155.01.390",
 BomHardwareType: "Handle Bom Type"
}
,{
 _id: 25,
 ...
 BomHardwareDescription: "Handle: 155.01.391",
 BomHardwareType: "Handle Bom Type"
}
];
