...
import { IModParents_mf_Fixedfront } from '../mod-interfaces'
import { IP_part_FixedfrontUnit_PartVarsWritable, P_part_FixedfrontUnit } from '../parts/part_FixedfrontUnit'
...
import { IModuleNonNull_mc_Fixedfront01,IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01,IModParents_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01,IModParents_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_Fixedfront01_mc_Fliplift01,IModParents_mc_Fixedfront01,IPartParentsNonNull_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01,IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01,IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_Fixedfront01_mc_Fliplift01,IPartParentsNonNull_mc_Fixedfront01} from '../mod-interfaces'
import {IModVar_mod_BackwallPos,IModVarNonNull_mod_BackwallPos,IModVar_mod_CarcaseDepth,IModVarNonNull_mod_CarcaseDepth,IModVar_mod_CarcaseHeight,IModVarNonNull_mod_CarcaseHeight,IModVar_mod_CarcaseId,IModVarNonNull_mod_CarcaseId,IModVar_mod_CarcaseSpaceDimension,IModVarNonNull_mod_CarcaseSpaceDimension,IModVar_mod_CarcaseWidth,IModVarNonNull_mod_CarcaseWidth,IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_FingergripTop,IModVarNonNull_mod_FingergripTop,IModVar_mod_FramePartsWidthHor,IModVarNonNull_mod_FramePartsWidthHor,IModVar_mod_FramePartsWidthVert,IModVarNonNull_mod_FramePartsWidthVert,IModVar_mod_FrontColor,IModVarNonNull_mod_FrontColor,IModVar_mod_FrontDesign,IModVarNonNull_mod_FrontDesign,IModVar_mod_FrontEdgeColor,IModVarNonNull_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVarNonNull_mod_FrontEdgeThk,IModVar_mod_FrontGapCarcase,IModVarNonNull_mod_FrontGapCarcase,IModVar_mod_FrontGapHor,IModVarNonNull_mod_FrontGapHor,IModVar_mod_FrontGapHorTop,IModVarNonNull_mod_FrontGapHorTop,IModVar_mod_FrontGapVert,IModVarNonNull_mod_FrontGapVert,IModVar_mod_FrontHeight,IModVarNonNull_mod_FrontHeight,IModVar_mod_FrontId,IModVarNonNull_mod_FrontId,IModVar_mod_FrontOversizeBtm,IModVarNonNull_mod_FrontOversizeBtm,IModVar_mod_FrontOversizeLeft,IModVarNonNull_mod_FrontOversizeLeft,IModVar_mod_FrontOversizeRight,IModVarNonNull_mod_FrontOversizeRight,IModVar_mod_FrontOversizeTop,IModVarNonNull_mod_FrontOversizeTop,IModVar_mod_FrontPosStart,IModVarNonNull_mod_FrontPosStart,IModVar_mod_FrontProgram,IModVarNonNull_mod_FrontProgram,IModVar_mod_FrontThk,IModVarNonNull_mod_FrontThk,IModVar_mod_FrontWidth,IModVarNonNull_mod_FrontWidth,IModVar_mod_HandlestripPos,IModVarNonNull_mod_HandlestripPos,IModVar_mod_HeightPosInsertion,IModVarNonNull_mod_HeightPosInsertion,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_Originpos,IModVarNonNull_mod_Originpos,IModVar_mod_PanelWoodFrameFillingType,IModVarNonNull_mod_PanelWoodFrameFillingType,IModVar_mod_PanelWoodFrameType,IModVarNonNull_mod_PanelWoodFrameType,IModVar_mod_PlinthAreaHeight,IModVarNonNull_mod_PlinthAreaHeight,IModVar_mod_ShelfbtmThk,IModVarNonNull_mod_ShelfbtmThk,IModVar_mod_ShelffixedBtm,IModVarNonNull_mod_ShelffixedBtm,IModVar_mod_ShelffixedPos,IModVarNonNull_mod_ShelffixedPos,IModVar_mod_ShelffixedThk,IModVarNonNull_mod_ShelffixedThk,IModVar_mod_ShelffixedType,IModVarNonNull_mod_ShelffixedType,IModVar_mod_TypeElement,IModVarNonNull_mod_TypeElement,IModVar_mod_VertDividerType,IModVarNonNull_mod_VertDividerType,IModVar_mod_HandlePosType,IModVarNonNull_mod_HandlePosType,IModVar_mod_HandleDesign,IModVarNonNull_mod_HandleDesign,IModVar_mod_FrameFillingWoodColor,IModVarNonNull_mod_FrameFillingWoodColor,IModVar_mod_FrontGlassColor,IModVarNonNull_mod_FrontGlassColor,IModVar_mod_FrameFillingColor,IModVarNonNull_mod_FrameFillingColor} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_BackwallPos, IMatrix_mod_CarcaseDepth, IMatrix_mod_CarcaseHeight, IMatrix_mod_CarcaseId, IMatrix_mod_CarcaseWidth, IMatrix_mod_Depth, IMatrix_mod_FingergripTop, IMatrix_mod_FramePartsWidthHor, IMatrix_mod_FramePartsWidthVert, IMatrix_mod_FrontColor, IMatrix_mod_FrontDesign, IMatrix_mod_FrontEdgeColor, IMatrix_mod_FrontEdgeThk, IMatrix_mod_FrontGapCarcase, IMatrix_mod_FrontGapHor, IMatrix_mod_FrontGapHorTop, IMatrix_mod_FrontGapVert, IMatrix_mod_FrontHeight, IMatrix_mod_FrontId, IMatrix_mod_FrontOversizeBtm, IMatrix_mod_FrontOversizeLeft, IMatrix_mod_FrontOversizeRight, IMatrix_mod_FrontOversizeTop, IMatrix_mod_FrontPosStart, IMatrix_mod_FrontProgram, IMatrix_mod_FrontThk, IMatrix_mod_FrontWidth, IMatrix_mod_HandlestripPos, IMatrix_mod_HeightPosInsertion, IMatrix_mod_ModuleName, IMatrix_mod_PanelWoodFrameFillingType, IMatrix_mod_PanelWoodFrameType, IMatrix_mod_PlinthAreaHeight, IMatrix_mod_ShelfbtmThk, IMatrix_mod_ShelffixedBtm, IMatrix_mod_ShelffixedPos, IMatrix_mod_ShelffixedThk, IMatrix_mod_ShelffixedType, IMatrix_mod_TypeElement, IMatrix_mod_VertDividerType, IMatrix_mod_HandlePosType, IMatrix_mod_HandleDesign, IMatrix_mod_FrameFillingWoodColor, IMatrix_mod_FrontGlassColor, IMatrix_mod_FrameFillingColor} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_FixedfrontUnit } from '../part-add-interfaces';
import { mc_Fixedfront01_createBuildPlan, mc_Fixedfront01_afterDataCompletion, mc_Fixedfront01_manufacturerDataCompletion } from '../../modules/mc_Fixedfront01';

export interface cbp_mc_Fixedfront01 extends IModBaseProp
, IPartAdd_part_FixedfrontUnit, IModVarNonNull_mod_BackwallPos, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FramePartsWidthHor, IModVarNonNull_mod_FramePartsWidthVert, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_HandlestripPos, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_PanelWoodFrameFillingType, IModVarNonNull_mod_PanelWoodFrameType, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_ShelfbtmThk, IModVarNonNull_mod_ShelffixedBtm, IModVarNonNull_mod_ShelffixedPos, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_ShelffixedType, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_FrameFillingWoodColor, IModVarNonNull_mod_FrontGlassColor, IModVarNonNull_mod_FrameFillingColor {
  parent: IModParents_mf_Fixedfront;
...
export interface dc_mc_Fixedfront01 extends IModBaseProp
, IModVar_mod_BackwallPos, IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseHeight, IModVar_mod_CarcaseId, IModVar_mod_CarcaseSpaceDimension, IModVar_mod_CarcaseWidth, IModVar_mod_Depth, IModVar_mod_FingergripTop, IModVar_mod_FramePartsWidthHor, IModVar_mod_FramePartsWidthVert, IModVar_mod_FrontColor, IModVar_mod_FrontDesign, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapHorTop, IModVar_mod_FrontGapVert, IModVar_mod_FrontHeight, IModVar_mod_FrontId, IModVar_mod_FrontOversizeBtm, IModVar_mod_FrontOversizeLeft, IModVar_mod_FrontOversizeRight, IModVar_mod_FrontOversizeTop, IModVar_mod_FrontPosStart, IModVar_mod_FrontProgram, IModVar_mod_FrontThk, IModVar_mod_FrontWidth, IModVar_mod_HandlestripPos, IModVar_mod_HeightPosInsertion, IModVar_mod_ModuleName, IModVar_mod_Originpos, IModVar_mod_PanelWoodFrameFillingType, IModVar_mod_PanelWoodFrameType, IModVar_mod_PlinthAreaHeight, IModVar_mod_ShelfbtmThk, IModVar_mod_ShelffixedBtm, IModVar_mod_ShelffixedPos, IModVar_mod_ShelffixedThk, IModVar_mod_ShelffixedType, IModVar_mod_TypeElement, IModVar_mod_VertDividerType, IModVar_mod_HandlePosType, IModVar_mod_HandleDesign, IModVar_mod_FrameFillingWoodColor, IModVar_mod_FrontGlassColor, IModVar_mod_FrameFillingColor {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Fixedfront01;
  parent: IModParents_mf_Fixedfront;
...
export interface adc_mc_Fixedfront01 extends IModBaseProp
...
export class OD_M_mc_Fixedfront01 extends OD_Base  implements dc_mc_Fixedfront01
...
,IModVar_mod_BackwallPos,IModVar_mod_CarcaseDepth,IModVar_mod_CarcaseHeight,IModVar_mod_CarcaseId,IModVar_mod_CarcaseSpaceDimension,IModVar_mod_CarcaseWidth,IModVar_mod_Depth,IModVar_mod_FingergripTop,IModVar_mod_FramePartsWidthHor,IModVar_mod_FramePartsWidthVert,IModVar_mod_FrontColor,IModVar_mod_FrontDesign,IModVar_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVar_mod_FrontGapCarcase,IModVar_mod_FrontGapHor,IModVar_mod_FrontGapHorTop,IModVar_mod_FrontGapVert,IModVar_mod_FrontHeight,IModVar_mod_FrontId,IModVar_mod_FrontOversizeBtm,IModVar_mod_FrontOversizeLeft,IModVar_mod_FrontOversizeRight,IModVar_mod_FrontOversizeTop,IModVar_mod_FrontPosStart,IModVar_mod_FrontProgram,IModVar_mod_FrontThk,IModVar_mod_FrontWidth,IModVar_mod_HandlestripPos,IModVar_mod_HeightPosInsertion,IModVar_mod_ModuleName,IModVar_mod_Originpos,IModVar_mod_PanelWoodFrameFillingType,IModVar_mod_PanelWoodFrameType,IModVar_mod_PlinthAreaHeight,IModVar_mod_ShelfbtmThk,IModVar_mod_ShelffixedBtm,IModVar_mod_ShelffixedPos,IModVar_mod_ShelffixedThk,IModVar_mod_ShelffixedType,IModVar_mod_TypeElement,IModVar_mod_VertDividerType,IModVar_mod_HandlePosType,IModVar_mod_HandleDesign,IModVar_mod_FrameFillingWoodColor,IModVar_mod_FrontGlassColor,IModVar_mod_FrameFillingColor
 {
  constructor(parent: IModParents_mf_Fixedfront, manufacturerMode?:boolean) {
    super('mc_Fixedfront01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Fixedfront01_NonNull(this);
  }
  parent: IModParents_mf_Fixedfront;
  _selfNonNull: OD_M_mc_Fixedfront01_NonNull;

  override variants:string[] = ['mod_BackwallPos','mod_CarcaseDepth','mod_CarcaseHeight','mod_CarcaseId','mod_CarcaseSpaceDimension','mod_CarcaseWidth','mod_Depth','mod_FingergripTop','mod_FramePartsWidthHor','mod_FramePartsWidthVert','mod_FrontColor','mod_FrontDesign','mod_FrontEdgeColor','mod_FrontEdgeThk','mod_FrontGapCarcase','mod_FrontGapHor','mod_FrontGapHorTop','mod_FrontGapVert','mod_FrontHeight','mod_FrontId','mod_FrontOversizeBtm','mod_FrontOversizeLeft','mod_FrontOversizeRight','mod_FrontOversizeTop','mod_FrontPosStart','mod_FrontProgram','mod_FrontThk','mod_FrontWidth','mod_HandlestripPos','mod_HeightPosInsertion','mod_ModuleName','mod_Originpos','mod_PanelWoodFrameFillingType','mod_PanelWoodFrameType','mod_PlinthAreaHeight','mod_ShelfbtmThk','mod_ShelffixedBtm','mod_ShelffixedPos','mod_ShelffixedThk','mod_ShelffixedType','mod_TypeElement','mod_VertDividerType','mod_HandlePosType','mod_HandleDesign','mod_FrameFillingWoodColor','mod_FrontGlassColor','mod_FrameFillingColor',];
  ...
  #manufacturerDataCompletionInternal = mc_Fixedfront01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Fixedfront01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Fixedfront01{
    ...
    const adc = new OD_M_mc_Fixedfront01_NonNull(this);
    return adc;
  }
  ...
  addpart_FixedfrontUnit(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FixedfrontUnit_PartVarsWritable {
    var c = new P_part_FixedfrontUnit(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Fixedfront01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Fixedfront01_NonNull implements cbp_mc_Fixedfront01, adc_mc_Fixedfront01 ,IPartParentsNonNull_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01,IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01,IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_Fixedfront01_mc_Fliplift01,IPartParentsNonNull_mc_Fixedfront01 {
  constructor(parent: OD_M_mc_Fixedfront01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Fixedfront01;
  ...
  #createBuildPlanInternal = mc_Fixedfront01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Fixedfront01_afterDataCompletion;
  ...
  parent: IModParents_mf_Fixedfront;
  addpart_FixedfrontUnit(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FixedfrontUnit_PartVarsWritable {
    return this.#internalParent.addpart_FixedfrontUnit(x, y, z, dimx, dimy, dimz);
  }
