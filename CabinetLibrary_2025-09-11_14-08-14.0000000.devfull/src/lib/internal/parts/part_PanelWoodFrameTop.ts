...
export interface IP_part_PanelWoodFrameTop_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_PanelWoodFrame01;
}

export interface IP_part_PanelWoodFrameTop_PartVarsWritable extends IP_part_PanelWoodFrameTop_PartVarsReadOnly {
}

export class P_part_PanelWoodFrameTop extends PartBase implements IP_part_PanelWoodFrameTop_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_PanelWoodFrame01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_PanelWoodFrameTop', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
