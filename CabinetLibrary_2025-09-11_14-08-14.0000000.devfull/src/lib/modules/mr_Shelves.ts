...
//#region Imports
import { cbp_mr_Shelves, dc_mr_Shelves, adc_mr_Shelves } from '../internal/modules/mr_Shelves'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_Shelves01, OD_M_mc_Shelves01 } from '../internal/modules/mc_Shelves01'
import { dc_mc_Bracket01, OD_M_mc_Bracket01 } from '../internal/modules/mc_Bracket01'
...
export function mr_Shelves_createBuildPlan(this: cbp_mr_Shelves):void {
  internal_enterModuleCreateBuildPlan('mr_Shelves', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mr_Shelves_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mr_Shelves_afterDataCompletion(this: adc_mr_Shelves):void {
  internal_enterModuleAfterDataCompletion('mr_Shelves', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mr_Shelves_AFTERDATACOMPLETION
  // Schuler Consulting
  // Create: May 2025
  // By Stefano Cortese
...
// ---------------------------------------------------------------
export function mr_Shelves_manufacturerDataCompletion(this: dc_mr_Shelves):void {
  internal_enterModuleManufacturerDataCompletion('mr_Shelves', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mr_Shelves_MANUFACTURERDATACOMPLETION
