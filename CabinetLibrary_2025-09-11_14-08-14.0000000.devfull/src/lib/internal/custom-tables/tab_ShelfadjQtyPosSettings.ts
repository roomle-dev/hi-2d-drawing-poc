...
export interface cti_tab_ShelfadjQtyPosSettings {
  readonly in_TypeElement? : string;
  readonly in_FrontModule? : string;
  readonly in_FrontModuleType? : string;
  readonly in_CarcaseSpaceHeightMin? : number;
  readonly in_CarcaseSpaceHeightMax? : number;
}

export interface ctm_tab_ShelfadjQtyPosSettings {
}

export interface cto_tab_ShelfadjQtyPosSettings extends ctm_tab_ShelfadjQtyPosSettings {
  readonly _id : number;
  readonly DescriptorPosY? : string;
}

export interface ICT_tab_ShelfadjQtyPosSettings
extends cti_tab_ShelfadjQtyPosSettings, cto_tab_ShelfadjQtyPosSettings {}

export class ct2_tab_ShelfadjQtyPosSettings {

public findExactly(
     in_TypeElement: string|undefined,
     in_FrontModule: string|undefined,
     in_FrontModuleType: string|undefined,
     in_CarcaseSpaceHeightMin: number|undefined,
     in_CarcaseSpaceHeightMax: number|undefined,
): cto_tab_ShelfadjQtyPosSettings | undefined {
  const res = ct_tab_ShelfadjQtyPosSettings.find((p) => 
p.in_TypeElement === in_TypeElement
 && p.in_FrontModule === in_FrontModule
 && p.in_FrontModuleType === in_FrontModuleType
 && p.in_CarcaseSpaceHeightMin === in_CarcaseSpaceHeightMin
 && p.in_CarcaseSpaceHeightMax === in_CarcaseSpaceHeightMax
);
return res;
}

public find(
predicate: (value: cti_tab_ShelfadjQtyPosSettings) => boolean
): cto_tab_ShelfadjQtyPosSettings | undefined {
  for (let index = 0; index < ct_tab_ShelfadjQtyPosSettings.length; index++){
    const element = ct_tab_ShelfadjQtyPosSettings[index];
...
export var ct_tab_ShelfadjQtyPosSettings :ICT_tab_ShelfadjQtyPosSettings[] = [
{
 _id: 162,
 in_TypeElement: "BaseUnit",
 in_FrontModule: "Door",
 in_FrontModuleType: "All",
 in_CarcaseSpaceHeightMin: 0,
 in_CarcaseSpaceHeightMax: 400,
 DescriptorPosY: "N/A"
}
,{
 _id: 163,
 ...
 in_FrontModule: "Door",
 in_FrontModuleType: "All",
 in_CarcaseSpaceHeightMin: 400.01,
 in_CarcaseSpaceHeightMax: 600,
 DescriptorPosY: "1_1"
}
,{
 _id: 164,
 ...
 in_FrontModule: "Door",
 in_FrontModuleType: "All",
 in_CarcaseSpaceHeightMin: 600.01,
 in_CarcaseSpaceHeightMax: 800,
 DescriptorPosY: "1_1_1"
}
,{
 _id: 165,
 in_TypeElement: "BaseUnit",
 in_FrontModule: "Door",
 in_FrontModuleType: "All",
 in_CarcaseSpaceHeightMin: 800.01,
 in_CarcaseSpaceHeightMax: 900,
 DescriptorPosY: "1_1_1_1"
}
,{
 _id: 166,
 in_TypeElement: "BaseUnit",
 in_FrontModule: "Door",
 in_FrontModuleType: "All",
 in_CarcaseSpaceHeightMin: 900.01,
 in_CarcaseSpaceHeightMax: 9999,
 DescriptorPosY: "1_1_1_1_1"
}
,{
 _id: 167,
...
,{
 ...
 in_FrontModule: "Fliplift",
 in_FrontModuleType: "All",
 in_CarcaseSpaceHeightMin: 1200.01,
 in_CarcaseSpaceHeightMax: 9999,
 DescriptorPosY: "1_1_1_1"
}
,{
 _id: 187,
 in_TypeElement: "EasyMode",
 in_FrontModule: "RackArea",
 in_FrontModuleType: "All",
 in_CarcaseSpaceHeightMin: 0,
 in_CarcaseSpaceHeightMax: 9999,
