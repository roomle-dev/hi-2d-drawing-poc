...
import { OD_M_mc_Hob01, dc_mc_Hob01 } from './mc_Hob01'
import { IModuleNonNull_mf_Hob,IModParents_mf_Hob,IPartParentsNonNull_mf_Hob} from '../mod-interfaces'
import {IModVar_mod_HobSupplier,IModVarNonNull_mod_HobSupplier,IModVar_mod_HobId,IModVarNonNull_mod_HobId,IModVar_mod_HobMoveDepth,IModVarNonNull_mod_HobMoveDepth,IModVar_mod_HobMoveWidth,IModVarNonNull_mod_HobMoveWidth,IModVar_mod_HobInfo,IModVarNonNull_mod_HobInfo,IModVar_mod_CountertopInfo,IModVarNonNull_mod_CountertopInfo} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_HobSupplier, IMatrix_mod_HobId, IMatrix_mod_HobMoveDepth, IMatrix_mod_HobMoveWidth} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { mf_Hob_createBuildPlan, mf_Hob_afterDataCompletion, mf_Hob_manufacturerDataCompletion } from '../../modules/mf_Hob';

export interface cbp_mf_Hob extends IModBaseProp
...
export interface dc_mf_Hob extends IModBaseProp
, IModVar_mod_HobSupplier, IModVar_mod_HobId, IModVar_mod_HobMoveDepth, IModVar_mod_HobMoveWidth, IModVar_mod_HobInfo, IModVar_mod_CountertopInfo {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mf_Hob;
  parent: IModParents_mr_StorageunitSingle;
  addOD_M_mc_Hob01(index?: number): dc_mc_Hob01;
}

export interface adc_mf_Hob extends IModBaseProp
, IModVarNonNull_mod_HobSupplier, IModVarNonNull_mod_HobId, IModVarNonNull_mod_HobMoveDepth, IModVarNonNull_mod_HobMoveWidth, IModVarNonNull_mod_HobInfo, IModVarNonNull_mod_CountertopInfo {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  addOD_M_mc_Hob01(index?: number): dc_mc_Hob01;
...
export class OD_M_mf_Hob extends OD_Base  implements dc_mf_Hob
,IModParents_mf_Hob
,IModVar_mod_HobSupplier,IModVar_mod_HobId,IModVar_mod_HobMoveDepth,IModVar_mod_HobMoveWidth,IModVar_mod_HobInfo,IModVar_mod_CountertopInfo
 {
  constructor(parent: IModParents_mr_StorageunitSingle, manufacturerMode?:boolean) {
    super('mf_Hob', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mf_Hob_NonNull(this);
  }
  parent: IModParents_mr_StorageunitSingle;
  _selfNonNull: OD_M_mf_Hob_NonNull;

  override variants:string[] = ['mod_HobSupplier','mod_HobId','mod_HobMoveDepth','mod_HobMoveWidth','mod_HobInfo','mod_CountertopInfo',];
  #mod_HobSupplier?: string;
  get mod_HobSupplier(): string | undefined { return this.#mod_HobSupplier}
  set mod_HobSupplier(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_HobSupplier' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_HobSupplier === value) return;
    this.#mod_HobSupplier = value;
  }

  mod_HobSupplier_matrix?: IMatrix_mod_HobSupplier;
  #mod_HobId?: string;
  get mod_HobId(): string | undefined { return this.#mod_HobId}
  set mod_HobId(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_HobId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_HobId === value) return;
    this.#mod_HobId = value;
  }

  mod_HobId_matrix?: IMatrix_mod_HobId;
  #mod_HobMoveDepth?: number;
  get mod_HobMoveDepth(): number | undefined { return this.#mod_HobMoveDepth}
  set mod_HobMoveDepth(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_HobMoveDepth' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_HobMoveDepth === value) return;
    this.#mod_HobMoveDepth = value;
  }

  mod_HobMoveDepth_matrix?: IMatrix_mod_HobMoveDepth;
  #mod_HobMoveWidth?: number;
  get mod_HobMoveWidth(): number | undefined { return this.#mod_HobMoveWidth}
  set mod_HobMoveWidth(value: number | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_HobMoveWidth' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_HobMoveWidth === value) return;
    this.#mod_HobMoveWidth = value;
  }

  mod_HobMoveWidth_matrix?: IMatrix_mod_HobMoveWidth;
  #mod_HobInfo: number[] = [];
  get mod_HobInfo(): number[] { return this.#mod_HobInfo;}
  #mod_CountertopInfo: string[] = [];
  get mod_CountertopInfo(): string[] { return this.#mod_CountertopInfo;}
  override getAttributes() : Map<string,any> { 
    let res = new Map<string,any>();
  res.set('mod_HobSupplier', this.mod_HobSupplier);
  res.set('mod_HobId', this.mod_HobId);
  res.set('mod_HobMoveDepth', this.mod_HobMoveDepth);
  res.set('mod_HobMoveWidth', this.mod_HobMoveWidth);
  res.set('mod_HobInfo', JSON.stringify(this.mod_HobInfo));
  ...
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_HobSupplier');
    const val = _toString(json['attributes']['mod_HobSupplier'], 'mod_HobSupplier');
    internal_leaveValidateVariant();
    this.mod_HobSupplier = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_HobId');
    const val = _toString(json['attributes']['mod_HobId'], 'mod_HobId');
    internal_leaveValidateVariant();
    this.mod_HobId = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_HobMoveDepth');
    const val = _toFloat(json['attributes']['mod_HobMoveDepth'], 'mod_HobMoveDepth');
    internal_leaveValidateVariant();
    this.mod_HobMoveDepth = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_HobMoveWidth');
    const val = _toFloat(json['attributes']['mod_HobMoveWidth'], 'mod_HobMoveWidth');
    internal_leaveValidateVariant();
    this.mod_HobMoveWidth = val; }
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_HobSupplier === undefined) {
      this.mod_HobSupplier = "None";
    }
    if (this.mod_HobId === undefined) {
      this.mod_HobId = "None";
    }
    if (this.mod_HobMoveDepth === undefined) {
      this.mod_HobMoveDepth = 60;
    }
    if (this.mod_HobMoveWidth === undefined) {
      this.mod_HobMoveWidth = 0;
    }
  ...
  #manufacturerDataCompletionInternal = mf_Hob_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mf_Hob_NonNull(this);
  ...
  seal(): IModuleNonNull_mf_Hob{
    ...
    const adc = new OD_M_mf_Hob_NonNull(this);
    return adc;
  }

  addOD_M_mc_Hob01(index?: number): dc_mc_Hob01 {
    var m = new OD_M_mc_Hob01(this);
    m.dataCompletion();
  ...
  override validateSelections():void {
    this.mod_HobSupplier_matrix = VariantValidation.mod_HobSupplier(this, this);
    this.mod_HobId_matrix = VariantValidation.mod_HobId(this, this);
    this.mod_HobMoveDepth_matrix = VariantValidation.mod_HobMoveDepth(this, this);
    this.mod_HobMoveWidth_matrix = VariantValidation.mod_HobMoveWidth(this, this);
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mf_Hob_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mf_Hob_NonNull implements cbp_mf_Hob, adc_mf_Hob ,IPartParentsNonNull_mf_Hob {
  constructor(parent: OD_M_mf_Hob) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mf_Hob;
  ...
  #createBuildPlanInternal = mf_Hob_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mf_Hob_afterDataCompletion;
  ...
  parent: IModParents_mr_StorageunitSingle;
  get mod_HobSupplier(): string  {
    return this.#internalParent.mod_HobSupplier!;
  }
  get mod_HobId(): string  {
    return this.#internalParent.mod_HobId!;
  }
  get mod_HobMoveDepth(): number  {
    return this.#internalParent.mod_HobMoveDepth!;
  }
  get mod_HobMoveWidth(): number  {
    return this.#internalParent.mod_HobMoveWidth!;
  }
  get mod_HobInfo(): number [] {
    return this.#internalParent.mod_HobInfo!;
  }
  get mod_CountertopInfo(): string [] {
    return this.#internalParent.mod_CountertopInfo!;
  }
  addOD_M_mc_Hob01(index?: number): dc_mc_Hob01 {
    return this.#internalParent.addOD_M_mc_Hob01(index);
  }
}
