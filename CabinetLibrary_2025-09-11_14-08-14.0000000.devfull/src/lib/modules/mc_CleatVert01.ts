...
//#region Imports
import { cbp_mc_CleatVert01, dc_mc_CleatVert01, adc_mc_CleatVert01 } from '../internal/modules/mc_CleatVert01'
...
export function mc_CleatVert01_createBuildPlan(this: cbp_mc_CleatVert01):void {
  internal_enterModuleCreateBuildPlan('mc_CleatVert01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_CleatVert01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_CleatVert01_afterDataCompletion(this: adc_mc_CleatVert01):void {
  internal_enterModuleAfterDataCompletion('mc_CleatVert01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_CleatVert01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_CleatVert01_manufacturerDataCompletion(this: dc_mc_CleatVert01):void {
  internal_enterModuleManufacturerDataCompletion('mc_CleatVert01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_CleatVert01_MANUFACTURERDATACOMPLETION
