...
export interface IP_part_FlipliftHardwareGraphic_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_FlipliftHardware01;
}

export interface IP_part_FlipliftHardwareGraphic_PartVarsWritable extends IP_part_FlipliftHardwareGraphic_PartVarsReadOnly {
}

export class P_part_FlipliftHardwareGraphic extends PartBase implements IP_part_FlipliftHardwareGraphic_PartVarsWritable {
...
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_FlipliftHardwareGraphic', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
