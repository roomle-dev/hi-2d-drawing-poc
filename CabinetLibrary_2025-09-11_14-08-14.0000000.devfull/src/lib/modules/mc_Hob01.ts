...
//#region Imports
import { cbp_mc_Hob01, dc_mc_Hob01, adc_mc_Hob01 } from '../internal/modules/mc_Hob01'
...
export function mc_Hob01_createBuildPlan(this: cbp_mc_Hob01):void {
  internal_enterModuleCreateBuildPlan('mc_Hob01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Hob01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_Hob01_afterDataCompletion(this: adc_mc_Hob01):void {
  internal_enterModuleAfterDataCompletion('mc_Hob01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Hob01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Hob01_manufacturerDataCompletion(this: dc_mc_Hob01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Hob01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Hob01_MANUFACTURERDATACOMPLETION
