...
//#region Imports
import { cbp_mc_StorageunitBackwall01, dc_mc_StorageunitBackwall01, adc_mc_StorageunitBackwall01 } from '../internal/modules/mc_StorageunitBackwall01'
...
export function mc_StorageunitBackwall01_createBuildPlan(this: cbp_mc_StorageunitBackwall01):void {
  internal_enterModuleCreateBuildPlan('mc_StorageunitBackwall01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_StorageunitBackwall01_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: Nov 2022
  // By Ludwig Weber
...
// ---------------------------------------------------------------
export function mc_StorageunitBackwall01_afterDataCompletion(this: adc_mc_StorageunitBackwall01):void {
  internal_enterModuleAfterDataCompletion('mc_StorageunitBackwall01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitBackwall01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_StorageunitBackwall01_manufacturerDataCompletion(this: dc_mc_StorageunitBackwall01):void {
  internal_enterModuleManufacturerDataCompletion('mc_StorageunitBackwall01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitBackwall01_MANUFACTURERDATACOMPLETION
