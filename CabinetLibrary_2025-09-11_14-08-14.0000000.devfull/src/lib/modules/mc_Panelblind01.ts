...
//#region Imports
import { cbp_mc_Panelblind01, dc_mc_Panelblind01, adc_mc_Panelblind01 } from '../internal/modules/mc_Panelblind01'
...
export function mc_Panelblind01_createBuildPlan(this: cbp_mc_Panelblind01):void {
  internal_enterModuleCreateBuildPlan('mc_Panelblind01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Panelblind01_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: Feb 2024
  // By Joao Lisboa
  ...
  GlobalFunc.process_AddMaterial(Elem, 'side', this.mod_CarcaseColor, this.mod_CarcaseColor, this.mod_CarcaseEdgeColor, this.mod_CarcaseEdgeColor, 'back', false, false);
...
// ---------------------------------------------------------------
export function mc_Panelblind01_afterDataCompletion(this: adc_mc_Panelblind01):void {
  internal_enterModuleAfterDataCompletion('mc_Panelblind01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Panelblind01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Panelblind01_manufacturerDataCompletion(this: dc_mc_Panelblind01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Panelblind01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Panelblind01_MANUFACTURERDATACOMPLETION
