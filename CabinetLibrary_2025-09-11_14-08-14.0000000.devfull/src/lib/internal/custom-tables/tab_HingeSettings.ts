...
export interface cti_tab_HingeSettings {
  ...
  readonly in_DoorThicknessMin? : number;
  readonly in_DoorThicknessMax? : number;
  readonly in_Angle? : number;
  readonly in_InteriorCabinet? : string;
}

export interface ctm_tab_HingeSettings {
}

export interface cto_tab_HingeSettings extends ctm_tab_HingeSettings {
  readonly _id : number;
  readonly HingeType? : string;
  readonly MountingPlateType? : string;
  readonly HingeDrillingsType? : string;
}

export interface ICT_tab_HingeSettings
extends cti_tab_HingeSettings, cto_tab_HingeSettings {}

export class ct2_tab_HingeSettings {
...
public findExactly(
     ...
     in_DoorThicknessMin: number|undefined,
     in_DoorThicknessMax: number|undefined,
     in_Angle: number|undefined,
     in_InteriorCabinet: string|undefined,
): cto_tab_HingeSettings | undefined {
  const res = ct_tab_HingeSettings.find((p) => 
p.in_TypeElement === in_TypeElement
 ...
 && p.in_DoorThicknessMin === in_DoorThicknessMin
 && p.in_DoorThicknessMax === in_DoorThicknessMax
 && p.in_Angle === in_Angle
 && p.in_InteriorCabinet === in_InteriorCabinet
);
return res;
}

public find(
predicate: (value: cti_tab_HingeSettings) => boolean
): cto_tab_HingeSettings | undefined {
  for (let index = 0; index < ct_tab_HingeSettings.length; index++){
    const element = ct_tab_HingeSettings[index];
...
export var ct_tab_HingeSettings :ICT_tab_HingeSettings[] = [
{
 _id: 206,
 in_TypeElement: "All",
 in_FrontType: "Doors",
 ...
 in_FrontDesign: "All",
 in_DoorThicknessMin: 15,
 in_DoorThicknessMax: 15,
 in_Angle: 90,
 in_InteriorCabinet: "All",
 HingeType: "110º",
 MountingPlateType: "CruciformA",
 HingeDrillingsType: "Fixed"
}
,{
 _id: 207,
 in_TypeElement: "All",
 ...
 in_DoorThicknessMax: 15,
 in_Angle: 90,
 in_InteriorCabinet: "InteriorDrawers",
 HingeType: "165º",
 MountingPlateType: "CruciformA",
 HingeDrillingsType: "Fixed"
}
,{
 ...
 in_AdditionalInfo2: "All",
 in_FrontDesign: "All",
 in_DoorThicknessMin: 16,
 in_DoorThicknessMax: 19,
 in_Angle: 90,
 in_InteriorCabinet: "All",
 HingeType: "110ºSoftClose",
 MountingPlateType: "Horizontal",
 HingeDrillingsType: "CalculationBasedMin"
}
,{
 _id: 209,
 in_TypeElement: "All",
 ...
 in_Angle: 90,
 in_InteriorCabinet: "InteriorDrawers",
 HingeType: "155ºSoftClose",
 MountingPlateType: "CruciformSM",
 HingeDrillingsType: "CalculationBasedMax"
}
,{
 _id: 210,
 in_TypeElement: "All",
 ...
 in_Angle: 180,
 in_InteriorCabinet: "All",
 HingeType: "BlindCornerInset110ºSoftClose",
 MountingPlateType: "CruciformSM",
 HingeDrillingsType: "Fixed"
}
,{
...
,{
 ...
 in_Angle: 90,
 in_InteriorCabinet: "All",
 HingeType: "120ºForFHF",
 MountingPlateType: "HorizontalForFHF",
 HingeDrillingsType: "CalculationBasedMin"
}
,{
 _id: 214,
