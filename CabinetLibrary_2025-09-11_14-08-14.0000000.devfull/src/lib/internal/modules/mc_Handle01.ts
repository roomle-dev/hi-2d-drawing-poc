...
import { IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_Fliplift01 } from '../mod-interfaces'
import { IP_part_Handle_PartVarsWritable, P_part_Handle } from '../parts/part_Handle'
import { IP_part_HandleDrill_PartVarsWritable, P_part_HandleDrill } from '../parts/part_HandleDrill'
import { IModuleNonNull_mc_Handle01,IModParents_mc_Handle01,IPartParentsNonNull_mc_Handle01} from '../mod-interfaces'
import {IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_FrontHeight,IModVarNonNull_mod_FrontHeight,IModVar_mod_FrontId,IModVarNonNull_mod_FrontId,IModVar_mod_HandleDrill,IModVarNonNull_mod_HandleDrill,IModVar_mod_HandleLine,IModVarNonNull_mod_HandleLine,IModVar_mod_HandlePosLogic,IModVarNonNull_mod_HandlePosLogic,IModVar_mod_Height,IModVarNonNull_mod_Height,IModVar_mod_FrontPosStart,IModVarNonNull_mod_FrontPosStart,IModVar_mod_Width,IModVarNonNull_mod_Width,IModVar_mod_FrontProgram,IModVarNonNull_mod_FrontProgram,IModVar_mod_HandleColor,IModVarNonNull_mod_HandleColor,IModVar_mod_HandleLength,IModVarNonNull_mod_HandleLength,IModVar_mod_HandleOffsetX,IModVarNonNull_mod_HandleOffsetX,IModVar_mod_HandleOffsetY,IModVarNonNull_mod_HandleOffsetY,IModVar_mod_HandlePosMatrix,IModVarNonNull_mod_HandlePosMatrix,IModVar_mod_HandlePosType,IModVarNonNull_mod_HandlePosType,IModVar_mod_HeightPosInsertion,IModVarNonNull_mod_HeightPosInsertion,IModVar_mod_PlinthAreaHeight,IModVarNonNull_mod_PlinthAreaHeight,IModVar_mod_HandleDesign,IModVarNonNull_mod_HandleDesign,IModVar_mod_PartInfo,IModVarNonNull_mod_PartInfo,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_ProcessingId,IModVarNonNull_mod_ProcessingId,IModVar_mod_ProcessingLibrary,IModVarNonNull_mod_ProcessingLibrary,IModVar_mod_HardwareId,IModVarNonNull_mod_HardwareId,IModVar_mod_Model3DGroupName,IModVarNonNull_mod_Model3DGroupName,IModVar_mod_Rotation,IModVarNonNull_mod_Rotation,IModVar_mod_FrontThk,IModVarNonNull_mod_FrontThk,IModVar_mod_FrontWidth,IModVarNonNull_mod_FrontWidth,IModVar_mod_HandleWeightCalculations,IModVarNonNull_mod_HandleWeightCalculations,IModVar_mod_FrontType,IModVarNonNull_mod_FrontType,IModVar_mod_HardwareTypeList,IModVarNonNull_mod_HardwareTypeList} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_Depth, IMatrix_mod_FrontHeight, IMatrix_mod_FrontId, IMatrix_mod_HandleDrill, IMatrix_mod_HandleLine, IMatrix_mod_HandlePosLogic, IMatrix_mod_Height, IMatrix_mod_FrontPosStart, IMatrix_mod_Width, IMatrix_mod_FrontProgram, IMatrix_mod_HandleColor, IMatrix_mod_HandleLength, IMatrix_mod_HandleOffsetX, IMatrix_mod_HandleOffsetY, IMatrix_mod_HandlePosMatrix, IMatrix_mod_HandlePosType, IMatrix_mod_HeightPosInsertion, IMatrix_mod_PlinthAreaHeight, IMatrix_mod_HandleDesign, IMatrix_mod_PartInfo, IMatrix_mod_ModuleName, IMatrix_mod_ProcessingId, IMatrix_mod_ProcessingLibrary, IMatrix_mod_HardwareId, IMatrix_mod_Model3DGroupName, IMatrix_mod_Rotation, IMatrix_mod_FrontThk, IMatrix_mod_FrontWidth, IMatrix_mod_FrontType} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_Handle, IPartAdd_part_HandleDrill } from '../part-add-interfaces';
import { mc_Handle01_createBuildPlan, mc_Handle01_afterDataCompletion, mc_Handle01_manufacturerDataCompletion } from '../../modules/mc_Handle01';

export interface cbp_mc_Handle01 extends IModBaseProp
, IPartAdd_part_Handle, IPartAdd_part_HandleDrill, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_HandleDrill, IModVarNonNull_mod_HandleLine, IModVarNonNull_mod_HandlePosLogic, IModVarNonNull_mod_Height, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_Width, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_HandleLength, IModVarNonNull_mod_HandleOffsetX, IModVarNonNull_mod_HandleOffsetY, IModVarNonNull_mod_HandlePosMatrix, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_PartInfo, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_ProcessingId, IModVarNonNull_mod_ProcessingLibrary, IModVarNonNull_mod_HardwareId, IModVarNonNull_mod_Model3DGroupName, IModVarNonNull_mod_Rotation, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_HandleWeightCalculations, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_HardwareTypeList {
  parent: IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_Fliplift01;
...
export interface dc_mc_Handle01 extends IModBaseProp
, IModVar_mod_Depth, IModVar_mod_FrontHeight, IModVar_mod_FrontId, IModVar_mod_HandleDrill, IModVar_mod_HandleLine, IModVar_mod_HandlePosLogic, IModVar_mod_Height, IModVar_mod_FrontPosStart, IModVar_mod_Width, IModVar_mod_FrontProgram, IModVar_mod_HandleColor, IModVar_mod_HandleLength, IModVar_mod_HandleOffsetX, IModVar_mod_HandleOffsetY, IModVar_mod_HandlePosMatrix, IModVar_mod_HandlePosType, IModVar_mod_HeightPosInsertion, IModVar_mod_PlinthAreaHeight, IModVar_mod_HandleDesign, IModVar_mod_PartInfo, IModVar_mod_ModuleName, IModVar_mod_ProcessingId, IModVar_mod_ProcessingLibrary, IModVar_mod_HardwareId, IModVar_mod_Model3DGroupName, IModVar_mod_Rotation, IModVar_mod_FrontThk, IModVar_mod_FrontWidth, IModVar_mod_HandleWeightCalculations, IModVar_mod_FrontType, IModVar_mod_HardwareTypeList {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Handle01;
  parent: IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_Fliplift01;
}

export interface adc_mc_Handle01 extends IModBaseProp
...
export class OD_M_mc_Handle01 extends OD_Base  implements dc_mc_Handle01
,IModParents_mc_Handle01
,IModVar_mod_Depth,IModVar_mod_FrontHeight,IModVar_mod_FrontId,IModVar_mod_HandleDrill,IModVar_mod_HandleLine,IModVar_mod_HandlePosLogic,IModVar_mod_Height,IModVar_mod_FrontPosStart,IModVar_mod_Width,IModVar_mod_FrontProgram,IModVar_mod_HandleColor,IModVar_mod_HandleLength,IModVar_mod_HandleOffsetX,IModVar_mod_HandleOffsetY,IModVar_mod_HandlePosMatrix,IModVar_mod_HandlePosType,IModVar_mod_HeightPosInsertion,IModVar_mod_PlinthAreaHeight,IModVar_mod_HandleDesign,IModVar_mod_PartInfo,IModVar_mod_ModuleName,IModVar_mod_ProcessingId,IModVar_mod_ProcessingLibrary,IModVar_mod_HardwareId,IModVar_mod_Model3DGroupName,IModVar_mod_Rotation,IModVar_mod_FrontThk,IModVar_mod_FrontWidth,IModVar_mod_HandleWeightCalculations,IModVar_mod_FrontType,IModVar_mod_HardwareTypeList
 {
  constructor(parent: IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_Fliplift01, manufacturerMode?:boolean) {
    super('mc_Handle01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Handle01_NonNull(this);
  }
  parent: IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_Fliplift01;
  _selfNonNull: OD_M_mc_Handle01_NonNull;

  override variants:string[] = ['mod_Depth','mod_FrontHeight','mod_FrontId','mod_HandleDrill','mod_HandleLine','mod_HandlePosLogic','mod_Height','mod_FrontPosStart','mod_Width','mod_FrontProgram','mod_HandleColor','mod_HandleLength','mod_HandleOffsetX','mod_HandleOffsetY','mod_HandlePosMatrix','mod_HandlePosType','mod_HeightPosInsertion','mod_PlinthAreaHeight','mod_HandleDesign','mod_PartInfo','mod_ModuleName','mod_ProcessingId','mod_ProcessingLibrary','mod_HardwareId','mod_Model3DGroupName','mod_Rotation','mod_FrontThk','mod_FrontWidth','mod_HandleWeightCalculations','mod_FrontType','mod_HardwareTypeList',];
  #mod_Depth?: number;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_Handle01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_Handle01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Handle01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Handle01{
    ...
    const adc = new OD_M_mc_Handle01_NonNull(this);
    return adc;
  }
  ...
  addpart_Handle(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Handle_PartVarsWritable {
    var c = new P_part_Handle(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_HandleDrill(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HandleDrill_PartVarsWritable {
    var c = new P_part_HandleDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Handle01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Handle01_NonNull implements cbp_mc_Handle01, adc_mc_Handle01 ,IPartParentsNonNull_mc_Handle01 {
  constructor(parent: OD_M_mc_Handle01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Handle01;
  ...
  #createBuildPlanInternal = mc_Handle01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Handle01_afterDataCompletion;
  ...
  parent: IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_Fliplift01;
  addpart_Handle(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Handle_PartVarsWritable {
    return this.#internalParent.addpart_Handle(x, y, z, dimx, dimy, dimz);
  }
  addpart_HandleDrill(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_HandleDrill_PartVarsWritable {
    return this.#internalParent.addpart_HandleDrill(x, y, z, dimx, dimy, dimz);
  }
