...
export interface cti_tab_FrontPartGrainDirectionSettings {
  readonly in_PartID? : string;
  readonly in_FrontProgram? : string;
  readonly in_GrainAvailable? : boolean;
...
export interface ctm_tab_FrontPartGrainDirectionSettings {
}

export interface cto_tab_FrontPartGrainDirectionSettings extends ctm_tab_FrontPartGrainDirectionSettings {
  readonly _id : number;
  readonly FrontGrainDirection? : string;
}

export interface ICT_tab_FrontPartGrainDirectionSettings
extends cti_tab_FrontPartGrainDirectionSettings, cto_tab_FrontPartGrainDirectionSettings {}

export class ct2_tab_FrontPartGrainDirectionSettings {

public findExactly(
     in_PartID: string|undefined,
     in_FrontProgram: string|undefined,
     in_GrainAvailable: boolean|undefined,
     in_LengthMin: number,
     in_LengthMax: number,
     in_WidthMin: number,
     in_WidthMax: number,
): cto_tab_FrontPartGrainDirectionSettings | undefined {
  const res = ct_tab_FrontPartGrainDirectionSettings.find((p) => 
p.in_PartID === in_PartID
 && p.in_FrontProgram === in_FrontProgram
 && p.in_GrainAvailable === in_GrainAvailable
...
public find(
predicate: (value: cti_tab_FrontPartGrainDirectionSettings) => boolean
): cto_tab_FrontPartGrainDirectionSettings | undefined {
  for (let index = 0; index < ct_tab_FrontPartGrainDirectionSettings.length; index++){
    const element = ct_tab_FrontPartGrainDirectionSettings[index];
...
export var ct_tab_FrontPartGrainDirectionSettings :ICT_tab_FrontPartGrainDirectionSettings[] = [
{
 _id: 45,
 in_PartID: "part_Backwall",
 in_FrontProgram: "All",
 in_GrainAvailable: false,
 in_LengthMin: 0,
 in_LengthMax: 9999,
 in_WidthMin: 0,
 in_WidthMax: 9999,
 FrontGrainDirection: "Neutral"
}
,{
 _id: 46,
 in_PartID: "part_Backwall",
 in_FrontProgram: "All",
 in_GrainAvailable: true,
 in_LengthMin: 0,
 in_LengthMax: 9999,
 in_WidthMin: 0,
 in_WidthMax: 9999,
 FrontGrainDirection: "Vertical"
}
,{
 _id: 47,
...
,{
 ...
 in_WidthMin: 0,
 in_WidthMax: 9999,
 FrontGrainDirection: "Horizontal"
}
,{
 _id: 55,
 in_PartID: "part_FillerLeft",
 in_FrontProgram: "All",
 in_GrainAvailable: false,
 in_LengthMin: 0,
 in_LengthMax: 9999,
