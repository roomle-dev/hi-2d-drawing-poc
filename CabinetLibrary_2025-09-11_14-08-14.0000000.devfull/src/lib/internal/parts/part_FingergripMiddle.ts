...
import { IPartParentsNonNull_mc_Fingergrip01 } from '../mod-interfaces'

export interface IP_part_FingergripMiddle_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_Fingergrip01;
}

export interface IP_part_FingergripMiddle_PartVarsWritable extends IP_part_FingergripMiddle_PartVarsReadOnly {
}

export class P_part_FingergripMiddle extends PartBase implements IP_part_FingergripMiddle_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Fingergrip01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_FingergripMiddle', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
  parent: IPartParentsNonNull_mc_Fingergrip01; // module which created this part
