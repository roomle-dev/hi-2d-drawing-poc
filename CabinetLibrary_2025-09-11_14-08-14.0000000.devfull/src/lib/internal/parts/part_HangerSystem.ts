...
export interface IP_part_HangerSystem_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_HangerSystem01;
}

export interface IP_part_HangerSystem_PartVarsWritable extends IP_part_HangerSystem_PartVarsReadOnly {
}

export class P_part_HangerSystem extends PartBase implements IP_part_HangerSystem_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_HangerSystem01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_HangerSystem', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
