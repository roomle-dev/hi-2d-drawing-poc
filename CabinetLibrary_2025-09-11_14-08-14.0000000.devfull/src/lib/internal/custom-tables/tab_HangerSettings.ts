...
export interface cti_tab_HangerSettings {
  readonly in_TypeElement? : string;
  readonly in_CarcaseHeightMin? : number;
  readonly in_CarcaseHeightMax? : number;
  ...
  readonly in_DistanceBehindBackwallMin? : number;
  readonly in_BackwallPositionMin? : number;
  readonly in_BackwallPositionMax? : number;
}

export interface ctm_tab_HangerSettings {
}

export interface cto_tab_HangerSettings extends ctm_tab_HangerSettings {
  readonly _id : number;
  readonly HangerType? : string;
}

export interface ICT_tab_HangerSettings
extends cti_tab_HangerSettings, cto_tab_HangerSettings {}

export class ct2_tab_HangerSettings {

public findExactly(
     in_TypeElement: string|undefined,
     in_CarcaseHeightMin: number|undefined,
     in_CarcaseHeightMax: number|undefined,
     in_CarcaseWidthMin: number|undefined,
     in_CarcaseWidthMax: number|undefined,
     in_WeightMin: number|undefined,
     in_WeightMax: number|undefined,
     in_DistanceBehindBackwallMin: number|undefined,
     in_BackwallPositionMin: number|undefined,
     in_BackwallPositionMax: number|undefined,
): cto_tab_HangerSettings | undefined {
  const res = ct_tab_HangerSettings.find((p) => 
p.in_TypeElement === in_TypeElement
 && p.in_CarcaseHeightMin === in_CarcaseHeightMin
 && p.in_CarcaseHeightMax === in_CarcaseHeightMax
 ...
 && p.in_DistanceBehindBackwallMin === in_DistanceBehindBackwallMin
 && p.in_BackwallPositionMin === in_BackwallPositionMin
 && p.in_BackwallPositionMax === in_BackwallPositionMax
);
return res;
}

public find(
predicate: (value: cti_tab_HangerSettings) => boolean
): cto_tab_HangerSettings | undefined {
  for (let index = 0; index < ct_tab_HangerSettings.length; index++){
    const element = ct_tab_HangerSettings[index];
...
export var ct_tab_HangerSettings :ICT_tab_HangerSettings[] = [
{
 ...
 in_WeightMin: 0,
 in_WeightMax: 75,
 in_DistanceBehindBackwallMin: 9,
 in_BackwallPositionMin: 15,
 in_BackwallPositionMax: 28,
...
,{
 ...
 in_WeightMin: 0,
 in_WeightMax: 52,
 in_DistanceBehindBackwallMin: 5.5,
 in_BackwallPositionMin: 13.5,
 in_BackwallPositionMax: 24,
...
,{
 ...
 in_WeightMin: 0,
 in_WeightMax: 120,
 in_DistanceBehindBackwallMin: 10,
 in_BackwallPositionMin: 18,
 in_BackwallPositionMax: 37,
...
,{
 ...
 in_WeightMin: 0,
 in_WeightMax: 92,
 in_DistanceBehindBackwallMin: 16,
 in_BackwallPositionMin: 16,
 in_BackwallPositionMax: 32,
...
,{
 ...
 in_WeightMin: 0,
 in_WeightMax: 45,
 in_DistanceBehindBackwallMin: 15,
 in_BackwallPositionMin: 23,
 in_BackwallPositionMax: 30,
 HangerType: "WallUnitVisibleHanger45kg"
}
];
