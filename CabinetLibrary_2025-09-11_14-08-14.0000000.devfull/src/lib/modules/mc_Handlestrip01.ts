...
//#region Imports
import { cbp_mc_Handlestrip01, dc_mc_Handlestrip01, adc_mc_Handlestrip01 } from '../internal/modules/mc_Handlestrip01'
...
export function mc_Handlestrip01_createBuildPlan(this: cbp_mc_Handlestrip01):void {
  internal_enterModuleCreateBuildPlan('mc_Handlestrip01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Handlestrip01_CREATEBUILDPLAN
// Schuler Consulting
// Create: Feb 2024
// By Stefano Cortese
// CabinetLibrary
...
// ---------------------------------------------------------------
export function mc_Handlestrip01_afterDataCompletion(this: adc_mc_Handlestrip01):void {
  internal_enterModuleAfterDataCompletion('mc_Handlestrip01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Handlestrip01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Handlestrip01_manufacturerDataCompletion(this: dc_mc_Handlestrip01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Handlestrip01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Handlestrip01_MANUFACTURERDATACOMPLETION
