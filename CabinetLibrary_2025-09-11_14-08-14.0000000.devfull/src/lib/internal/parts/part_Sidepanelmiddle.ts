...
export interface IP_part_Sidepanelmiddle_PartVarsReadOnly extends IPartBase {
  ...
  get pa_CarcaseConnectionRightBtm(): string;
  get pa_CarcaseConnectionRightTop(): string;
  get pa_FittingConnectionRightBtm(): string;
...
export interface IP_part_Sidepanelmiddle_PartVarsWritable extends IP_part_Sidepanelmiddle_PartVarsReadOnly {
  ...
  set pa_CarcaseConnectionRightBtm(value: string);
  set pa_CarcaseConnectionRightTop(value: string);
  set pa_FittingConnectionRightBtm(value: string);
...
export class P_part_Sidepanelmiddle extends PartBase implements IP_part_Sidepanelmiddle_PartVarsWritable {
...
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_Sidepanelmiddle', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'YZX';
  }
  ...
  res.set('pa_CarcaseConnectionRightBtm', this.#pa_CarcaseConnectionRightBtm);
  res.set('pa_CarcaseConnectionRightTop', this.#pa_CarcaseConnectionRightTop);
  res.set('pa_FittingConnectionRightBtm', this.#pa_FittingConnectionRightBtm);
  ...
  setAttributes() {
    ...
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // part_Sidepanelmiddle_ValueScript
    ...
    if (this.#pa_CarcaseConnectionRightBtm === undefined) {
      this.pa_CarcaseConnectionRightBtm = this.parent.mod_CarcaseConnectionRightBtm;
    }
    ...
    if (this.#pa_FittingConnectionRightBtm === undefined) {
      this.pa_FittingConnectionRightBtm = this.parent.mod_FittingConnectionRightBtm;
    }
  ...
  checkAttributes() {
    ...
    if (this.#pa_TopColor === undefined) {
      logError('Attribute pa_TopColor not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_BtmColor === undefined) {
      logError('Attribute pa_BtmColor not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      logError('Attribute pa_EdgeFrontColor not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftColor === undefined) {
      logError('Attribute pa_EdgeLeftColor not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackColor === undefined) {
      logError('Attribute pa_EdgeBackColor not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightColor === undefined) {
      logError('Attribute pa_EdgeRightColor not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontType === undefined) {
      logError('Attribute pa_EdgeFrontType not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftType === undefined) {
      logError('Attribute pa_EdgeLeftType not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackType === undefined) {
      logError('Attribute pa_EdgeBackType not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightType === undefined) {
      logError('Attribute pa_EdgeRightType not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeJointType === undefined) {
      logError('Attribute pa_EdgeJointType not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_BomId === undefined) {
      logError('Attribute pa_BomId not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_CarcasePartConnectionTopVert === undefined) {
      logError('Attribute pa_CarcasePartConnectionTopVert not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_CarcasePartConnectionBtmVert === undefined) {
      logError('Attribute pa_CarcasePartConnectionBtmVert not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionTopVert === undefined) {
      logError('Attribute pa_FittingConnectionTopVert not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionBtmVert === undefined) {
      logError('Attribute pa_FittingConnectionBtmVert not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_ParentName === undefined) {
      logError('Attribute pa_ParentName not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_TypeElement === undefined) {
      logError('Attribute pa_TypeElement not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_GrainDirection === undefined) {
      logError('Attribute pa_GrainDirection not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_CarcasePartConnectionLeftHor === undefined) {
      logError('Attribute pa_CarcasePartConnectionLeftHor not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_CarcasePartConnectionRightHor === undefined) {
      logError('Attribute pa_CarcasePartConnectionRightHor not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionLeftHor === undefined) {
      logError('Attribute pa_FittingConnectionLeftHor not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionRightHor === undefined) {
      logError('Attribute pa_FittingConnectionRightHor not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_AdditionalInfo1 === undefined) {
      logError('Attribute pa_AdditionalInfo1 not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_FingergripInfo === undefined) {
      logError('Attribute pa_FingergripInfo not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_CarcaseConnectionLeftBtm === undefined) {
      logError('Attribute pa_CarcaseConnectionLeftBtm not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_CarcaseConnectionLeftTop === undefined) {
      logError('Attribute pa_CarcaseConnectionLeftTop not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionLeftTop === undefined) {
      logError('Attribute pa_FittingConnectionLeftTop not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionLeftBtm === undefined) {
      logError('Attribute pa_FittingConnectionLeftBtm not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_CarcaseConnectionRightBtm === undefined) {
      logError('Attribute pa_CarcaseConnectionRightBtm not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_CarcaseConnectionRightTop === undefined) {
      logError('Attribute pa_CarcaseConnectionRightTop not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionRightBtm === undefined) {
      logError('Attribute pa_FittingConnectionRightBtm not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_FittingConnectionRightTop === undefined) {
      logError('Attribute pa_FittingConnectionRightTop not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_BackHeight === undefined) {
      logError('Attribute pa_BackHeight not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_TopDepth === undefined) {
      logError('Attribute pa_TopDepth not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_ColorGrainGroup === undefined) {
      logError('Attribute pa_ColorGrainGroup not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_ProgramGrainGroup === undefined) {
      logError('Attribute pa_ProgramGrainGroup not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
    if (this.#pa_GrainLogic === undefined) {
      logError('Attribute pa_GrainLogic not set in part part_Sidepanelmiddle (id: ' + this._id + ')');
    }
  ...
  createBomElements() {
    ...
    const partSelf = this;
      ...
      if (partSelf._g?.basic_CreateBom == 'Library') { // ####################### CUSTOM SCRIPTS ########################
        ...
        const _bom = new class BOM161 extends BOM_ElementType_bomout_Board {
          constructor() { super(partSelf); }
          set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly) {
            const part = partSelf;
...
let parentId=part.pa_BomId;

// Call the function to process the Bom-Element
GlobalFunc.process_BoardBom(this, part, elementType, elementCategory, parentId)
             // ################### END CUSTOM SCRIPTS ########################
  ...
  override createBomTouchElements(touch: PartTouch, partNext: PartBase, posRel: CollisionDataRel) {
      try {
      // ncout_Group: 397: part_Shelftop FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_Shelftop) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          ...
          const _bom = new class BOMT397 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Shelftop_PartVarsReadOnly, posRel:CollisionDataRel) {
...
//
// Description:
// Connection between Sidepanelmiddle and Shelftop
// Touch FromTop
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 398: part_Shelfbtm FromBottom
    if (touch == PartTouch.FromBottom && partNext instanceof P_part_Shelfbtm) {
        let part2 = <P_part_Shelfbtm>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT398 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Shelfbtm_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//
// Description:
// Connection between Sidepanelmiddle and Shelfbottom
// Touch FromBottom
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 407: part_HingeDrill FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_HingeDrill) {
        let part2 = <P_part_HingeDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT407 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_HingeDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
{  
  ...
  drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'x');
      ...
      try {
      // ncout_Group: 408: part_HingeDrill FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_HingeDrill) {
        let part2 = <P_part_HingeDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT408 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_HingeDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
{  
  ...
  drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'x');
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Drilling of MountingPlate";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 410: part_Shelffixed FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_Shelffixed) {
        let part2 = <P_part_Shelffixed>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT410 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Shelffixed_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//
// Description:
// Connection between Sidepanelmiddle and Shelffixed
// Touch FromTop
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with fixed shelf from top";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 411: part_Shelffixed FromBottom
    if (touch == PartTouch.FromBottom && partNext instanceof P_part_Shelffixed) {
        let part2 = <P_part_Shelffixed>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT411 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Shelffixed_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with fixed shelf from bottom";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 413: part_ShelfadjDrill FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_ShelfadjDrill) {
        let part2 = <P_part_ShelfadjDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT413 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_ShelfadjDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
for(let i = 1; i <= QtyDrills; i++){
  ...
  StartPos += part2.pa_ShelfadjDrillDistance;
      ...
      try {
      // ncout_Group: 414: part_ShelfadjDrill FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_ShelfadjDrill) {
        let part2 = <P_part_ShelfadjDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT414 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_ShelfadjDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
for(let i = 1; i <= QtyDrills; i++){
  ...
  DrillingLines.forEach(DrillingLine => {
    ...
    // Add drawing
    let drilling01 = partSelf.add3DElement('Drilling01', DrillVert, posRel.x + part2._dimx, posY, posZ, DrillInfo.TI, DrillInfo.DU, DrillInfo.DU);
    drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + DrillInfo.DU / 2 + '" /></svg>', 'x');
  ...
  StartPos += part2.pa_ShelfadjDrillDistance;
      ...
      try {
      // ncout_Group: 415: part_DrawerBoxDrilling FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_DrawerBoxDrilling) {
        let part2 = <P_part_DrawerBoxDrilling>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT415 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_DrawerBoxDrilling_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
{  
  ...
  drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'x');
      ...
      try {
      // ncout_Group: 416: part_DrawerBoxDrilling FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_DrawerBoxDrilling) {
        let part2 = <P_part_DrawerBoxDrilling>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT416 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_DrawerBoxDrilling_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
{  
  ...
  // Add drawing
  let drilling01 = partSelf.add3DElement('Drilling01', DrillVert, 0, PosX, PosY, x.TI, x.DU, x.DU );
  drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'x');
})
               // ################### END CUSTOM SCRIPTS ########################
              internal_leaveBomPartMasterDataTouches();
      ...
      try {
      // ncout_Group: 420: part_ShelfadjDrill FromBack
    if (touch == PartTouch.FromBack && partNext instanceof P_part_ShelfadjDrill) {
        let part2 = <P_part_ShelfadjDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT420 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_ShelfadjDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Variables
let StartPos = posRel.y;
//let DrillingLines = GlobalFunc.process_Descriptor(part2.pa_ShelfadjVertdividerDrillDescriptor, part2._dimx);
...
for(let i = 1; i <= QtyDrills; i++){
  ...
  DrillingLines.forEach(DrillingLine => {
    ...
    let posX = DrillInfo.XA + DrillingLine;

    let DrillHor = this.addncout_DrillHor();
    DrillHor.nc_TOOL = "103";
    DrillHor.nc_XA = partSelf._dimy - posY;
    DrillHor.nc_YA = partSelf._dimz;
    DrillHor.nc_ZA = partSelf._dimx - posX;
    DrillHor.nc_BM = DrillInfo.matrix_BM || "YM";
    DrillHor.nc_TI = DrillInfo.TI;
    DrillHor.nc_DU = DrillInfo.DU;
    DrillHor.nc_KO = DrillInfo.matrix_KO || "00";

    // Add drawing
    let drilling01 = partSelf.add3DElement('Drilling01', DrillHor, posX, posY, 0, DrillInfo.DU, DrillInfo.DU, DrillInfo.TI);
  ...
  StartPos += part2.pa_ShelfadjDrillDistance;
      ...
      try {
      // ncout_Group: 423: part_Railhortopfront FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_Railhortopfront) {
        let part2 = <P_part_Railhortopfront>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT423 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Railhortopfront_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//
// Description:
// Connection between Sidepanelmiddle and Rail horizontal front top
// Touch FromTop
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 440: part_Railhortopback FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_Railhortopback) {
        let part2 = <P_part_Railhortopback>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT440 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Railhortopback_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with rail horizontal top back";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 450: part_PushtoopenDrill FromFront
    if (touch == PartTouch.FromFront && partNext instanceof P_part_PushtoopenDrill) {
        let part2 = <P_part_PushtoopenDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT450 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_PushtoopenDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
GlobalFunc.ops_PushtoopenDrill('Carcase', this, partSelf, part2, posRel);
      ...
      try {
      // ncout_Group: 458: part_PushtoopenMountingPlateDrill FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_PushtoopenMountingPlateDrill) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT458 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_PushtoopenMountingPlateDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
GlobalFunc.ops_PushtoopenDrill('Carcase', this, partSelf, part2, posRel);
      ...
      try {
      // ncout_Group: 461: part_PushtoopenMountingPlateDrill FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_PushtoopenMountingPlateDrill) {
        let part2 = <P_part_PushtoopenMountingPlateDrill>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT461 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_PushtoopenMountingPlateDrill_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
GlobalFunc.ops_PushtoopenDrill('Carcase', this, partSelf, part2, posRel);
      ...
      try {
      // ncout_Group: 477: part_Panelblind FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Panelblind) {
        let part2 = <P_part_Panelblind>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT477 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Panelblind_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//
// Description:
// Connection between Sidepanelmiddle and Panel blind
// Touch FromLeft
//
// Revisions:
// 
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 478: part_Panelblind FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Panelblind) {
        let part2 = <P_part_Panelblind>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT478 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Panelblind_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 549: part_SlopedCeilingShelftopHor FromTop
    if (touch == PartTouch.FromTop && partNext instanceof P_part_SlopedCeilingShelftopHor) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT549 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_SlopedCeilingShelftopHor_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 571: part_Backwall Collision
    if (touch == PartTouch.Collision && partNext instanceof P_part_Backwall) {
        let part2 = <P_part_Backwall>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT571 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Backwall_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
               // ####################### CUSTOM SCRIPTS ########################
GlobalFunc.ops_BackwallGroove(this, partSelf, part2, posRel, 'BackwallGrooveSidepanelmiddle', 'Vertical');
               // ################### END CUSTOM SCRIPTS ########################
              internal_leaveBomPartMasterDataTouches();
            }
          }
      ...
      try {
      // ncout_Group: 582: part_Shelfbtm FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Shelfbtm) {
        let part2 = <P_part_Shelfbtm>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT582 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Shelfbtm_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with Shelf bottom from right";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 583: part_Shelftop FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Shelftop) {
        let part2 = <P_part_Shelftop>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT583 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Shelftop_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Call the process function
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with Shelf top from right";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 584: part_Shelfbtm FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Shelfbtm) {
        let part2 = <P_part_Shelfbtm>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT584 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Shelfbtm_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  //
  // Description:
  // Connection between Sidepanelright and Shelfbottom
  // Touch FromLeft
  //
  // Revisions:
  // 
  ...
  let FallingDirection = 'Right';
  let ConnectionOrientation = 'FrontBack';
  let ConnectionType = partSelf.pa_CarcaseConnectionRightBtm;
  let FittingType = partSelf.pa_FittingConnectionRightBtm;
  let InsideDirection = 'Left';
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with shelf bottom fromt left";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 585: part_Shelftop FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Shelftop) {
        let part2 = <P_part_Shelftop>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT585 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Shelftop_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  //
  // Description:
  // Connection between Sidepanelright and Shelftop
  // Touch FromLeft
  //
  // Revisions:
  // 
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Connection with shelf top from left";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 591: part_SlopedCeilingShelftopHor FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_SlopedCeilingShelftopHor) {
        let part2 = <P_part_SlopedCeilingShelftopHor>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT591 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_SlopedCeilingShelftopHor_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 592: part_FlipliftHardwareSidepanelDrilling FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_FlipliftHardwareSidepanelDrilling) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT592 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_FlipliftHardwareSidepanelDrilling_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
//====================================================================
  ...
  {  
    ...
    drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'x');
      ...
      try {
      // ncout_Group: 593: part_FlipliftHardwareSidepanelDrilling FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_FlipliftHardwareSidepanelDrilling) {
        let part2 = <P_part_FlipliftHardwareSidepanelDrilling>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT593 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_FlipliftHardwareSidepanelDrilling_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
//====================================================================
  ...
  {  
    ...
    drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU/2 + '" /></svg>', 'x');
      ...
      try {
      // ncout_Group: 594: part_SlopedCeilingShelftopHor FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_SlopedCeilingShelftopHor) {
        let part2 = <P_part_SlopedCeilingShelftopHor>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT594 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_SlopedCeilingShelftopHor_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 595: part_Shelffixed FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Shelffixed) {
        let part2 = <P_part_Shelffixed>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT595 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Shelffixed_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  //
  // Description:
  // Connection between Sidepanelright and Shelffixed
  // Touch FromLeft
  //
  // Revisions:
  // 
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 596: part_Shelffixed FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Shelffixed) {
        let part2 = <P_part_Shelffixed>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT596 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Shelffixed_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 603: part_Railhortopback FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Railhortopback) {
        let part2 = <P_part_Railhortopback>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT603 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Railhortopback_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 604: part_Railhortopfront FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Railhortopfront) {
        let part2 = <P_part_Railhortopfront>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT604 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Railhortopfront_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 605: part_Railverttopback FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Railverttopback) {
        let part2 = <P_part_Railverttopback>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT605 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Railverttopback_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
// Schuler Consulting
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 606: part_Railverttopfront FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_Railverttopfront) {
        let part2 = <P_part_Railverttopfront>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT606 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Railverttopfront_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
...
// Schuler Consulting
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 607: part_Railhortopback FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Railhortopback) {
        let part2 = <P_part_Railhortopback>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT607 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Railhortopback_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  //
  // Description:
  // Connection between Sidepanelright and Rail horizontal top front
  // Touch FromLeft
  //
  // Revisions:
  // 
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 608: part_Railhortopfront FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Railhortopfront) {
        let part2 = <P_part_Railhortopfront>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT608 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Railhortopfront_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  //
  // Description:
  // Connection between Sidepanelright and Rail horizontal top back
  // Touch FromLeft
  //
  // Revisions:
  // 
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 609: part_Railverttopback FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Railverttopback) {
        let part2 = <P_part_Railverttopback>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT609 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Railverttopback_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  //
  // Description:
  // Connection between Sidepanelright and Rail vertical top back
  // Touch FromLeft
  //
  // Revisions:
  // 
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 610: part_Railverttopfront FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_Railverttopfront) {
        let part2 = <P_part_Railverttopfront>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT610 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_Railverttopfront_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
// Schuler Consulting
  ...
  //
  // Description:
  // Connection between Sidepanelright and Rail vertical top front
  // Touch FromLeft
  //
  // Revisions:
  // 
  ...
  GlobalFunc.process_CarcasePartConnection(this, partSelf, part2, posRel, Area, PartType, DrillingPosition, TouchDirectionGraphic, FallingDirection, ConnectionOrientation, ConnectionType, FittingType, InsideDirection, DrillingPartType)
      ...
      try {
      // ncout_Group: 623: part_FillerHardwareProcessing FromRight
    if (touch == PartTouch.FromRight && partNext instanceof P_part_FillerHardwareProcessing) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT623 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_FillerHardwareProcessing_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
              this._touchPart2Name = part2._partId;
              internal_enterBomPartMasterDataTouches(partSelf._id, partSelf._partId, part2._id, part2._partId, touch);
  ...
  if (part2.pa_HardwareIdentifier == 'CarcaseConnector' || part2.pa_HardwareIdentifier == 'FrontAndCarcaseConnector') {
    ...
    drillings.forEach(x => {
      ...
      drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU / 2 + '" /></svg>', 'x');
          ...
          _bom._parentId = partSelf._id;
          _bom._description = "Drillings for the Filler Hardware";
          _bom.set(partSelf, touch, part2, posRel);
          partSelf._bom.push(_bom);
          if(_bom._subBom){
            _bom._subBom.forEach(p => partSelf._bom.push(p));
      ...
      try {
      // ncout_Group: 628: part_FillerHardwareProcessing FromLeft
    if (touch == PartTouch.FromLeft && partNext instanceof P_part_FillerHardwareProcessing) {
        let part2 = <P_part_FillerHardwareProcessing>partNext;
        const partSelf = this;
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT628 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly, touch: PartTouch, part2: IP_part_FillerHardwareProcessing_PartVarsReadOnly, posRel:CollisionDataRel) {
              this._touchOrigin = touch;
              this._touchPart2Id = part2._id;
...
//====================================================================
  ...
  if (part2.pa_HardwareIdentifier == 'CarcaseConnector' || part2.pa_HardwareIdentifier == 'FrontAndCarcaseConnector') {
    ...
    drillings.forEach(x => {
      ...
      // Add drawing
      let drilling01 = partSelf.add3DElement('Drilling01', DrillVert, partSelf._x!, posRel.y + insertPoint.InsertionPointY - x.YA, partSelf._dimz - insertPoint.InsertionPointX - x.XA + (part2.pa_FrontGapCarcase), x.TI, x.DU, x.DU);
      drilling01.extrude('<svg><circle cx="' + 0 + '" cy="' + 0 + '" r="' + x.DU / 2 + '" /></svg>', 'x');
    });
  }
               // ################### END CUSTOM SCRIPTS ########################
  ...
  override createBomTouchElementsEnd() : void { 
      try {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT581 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly) {
              internal_enterBomPartMasterDataTouchesEnd(partSelf._id, partSelf._partId);
               // ####################### CUSTOM SCRIPTS ########################
GlobalFunc.ops_FingergripPocketVert(this, partSelf, '', '', 'Fingergrip', 'Sidepanelmiddle');
               // ################### END CUSTOM SCRIPTS ########################
              internal_leaveBomPartMasterDataTouches();
            }
          }
      ...
      try {
        ...
        if ((partSelf.pa_TopDepth != 0 && partSelf.pa_BackHeight != 0)) { // ####################### CUSTOM SCRIPTS ########################
          let parentId = partSelf._id;
          const _bom = new class BOMT601 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Sidepanelmiddle_PartVarsReadOnly) {
              internal_enterBomPartMasterDataTouchesEnd(partSelf._id, partSelf._partId);
               // ####################### CUSTOM SCRIPTS ########################
GlobalFunc.ops_SawingVert(this, partSelf, '', '', 'SlopedCeilingShapeSidepanelmiddle', 'All');
               // ################### END CUSTOM SCRIPTS ########################
              internal_leaveBomPartMasterDataTouches();
            }
          }
  ...
  get pa_CarcaseConnectionRightBtm(): string { return this.#pa_CarcaseConnectionRightBtm!; }
  set pa_CarcaseConnectionRightBtm(val:string) { this.#pa_CarcaseConnectionRightBtm = val; }
  #pa_CarcaseConnectionRightBtm?: string;
  ...
  get pa_FittingConnectionRightBtm(): string { return this.#pa_FittingConnectionRightBtm!; }
  set pa_FittingConnectionRightBtm(val:string) { this.#pa_FittingConnectionRightBtm = val; }
  #pa_FittingConnectionRightBtm?: string;
