...
import { IModParents_mc_Door01_mc_Drawer01_mc_Fliplift01 } from '../mod-interfaces'
import { IP_part_FrontGlass_PartVarsWritable, P_part_FrontGlass } from '../parts/part_FrontGlass'
import { IP_part_Frontprofile_PartVarsWritable, P_part_Frontprofile } from '../parts/part_Frontprofile'
import { IModuleNonNull_mc_FrontPanelGlass01,IModParents_mc_FrontPanelGlass01,IPartParentsNonNull_mc_FrontPanelGlass01} from '../mod-interfaces'
import {IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_FrontId,IModVarNonNull_mod_FrontId,IModVar_mod_FrontType,IModVarNonNull_mod_FrontType,IModVar_mod_Height,IModVarNonNull_mod_Height,IModVar_mod_Width,IModVarNonNull_mod_Width,IModVar_mod_FrontFrameColor,IModVarNonNull_mod_FrontFrameColor,IModVar_mod_FrontGlassColor,IModVarNonNull_mod_FrontGlassColor,IModVar_mod_FrontProgram,IModVarNonNull_mod_FrontProgram,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_Depth, IMatrix_mod_FrontId, IMatrix_mod_FrontType, IMatrix_mod_Height, IMatrix_mod_Width, IMatrix_mod_FrontFrameColor, IMatrix_mod_FrontGlassColor, IMatrix_mod_FrontProgram, IMatrix_mod_ModuleName} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_FrontGlass, IPartAdd_part_Frontprofile } from '../part-add-interfaces';
import { mc_FrontPanelGlass01_createBuildPlan, mc_FrontPanelGlass01_afterDataCompletion, mc_FrontPanelGlass01_manufacturerDataCompletion } from '../../modules/mc_FrontPanelGlass01';

export interface cbp_mc_FrontPanelGlass01 extends IModBaseProp
, IPartAdd_part_FrontGlass, IPartAdd_part_Frontprofile, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width, IModVarNonNull_mod_FrontFrameColor, IModVarNonNull_mod_FrontGlassColor, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_ModuleName {
  parent: IModParents_mc_Door01_mc_Drawer01_mc_Fliplift01;
...
export interface dc_mc_FrontPanelGlass01 extends IModBaseProp
, IModVar_mod_Depth, IModVar_mod_FrontId, IModVar_mod_FrontType, IModVar_mod_Height, IModVar_mod_Width, IModVar_mod_FrontFrameColor, IModVar_mod_FrontGlassColor, IModVar_mod_FrontProgram, IModVar_mod_ModuleName {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_FrontPanelGlass01;
  parent: IModParents_mc_Door01_mc_Drawer01_mc_Fliplift01;
}

export interface adc_mc_FrontPanelGlass01 extends IModBaseProp
...
export class OD_M_mc_FrontPanelGlass01 extends OD_Base  implements dc_mc_FrontPanelGlass01
,IModParents_mc_FrontPanelGlass01
,IModVar_mod_Depth,IModVar_mod_FrontId,IModVar_mod_FrontType,IModVar_mod_Height,IModVar_mod_Width,IModVar_mod_FrontFrameColor,IModVar_mod_FrontGlassColor,IModVar_mod_FrontProgram,IModVar_mod_ModuleName
 {
  constructor(parent: IModParents_mc_Door01_mc_Drawer01_mc_Fliplift01, manufacturerMode?:boolean) {
    super('mc_FrontPanelGlass01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_FrontPanelGlass01_NonNull(this);
  }
  parent: IModParents_mc_Door01_mc_Drawer01_mc_Fliplift01;
  _selfNonNull: OD_M_mc_FrontPanelGlass01_NonNull;

  override variants:string[] = ['mod_Depth','mod_FrontId','mod_FrontType','mod_Height','mod_Width','mod_FrontFrameColor','mod_FrontGlassColor','mod_FrontProgram','mod_ModuleName',];
  #mod_Depth?: number;
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_FrontFrameColor === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_FrontFrameColor')) {
          let pv = <IModVar_mod_FrontFrameColor>s;
          if (pv.mod_FrontFrameColor !== undefined) {
            this.mod_FrontFrameColor = (<IModVar_mod_FrontFrameColor>s).mod_FrontFrameColor;
            break;
          };
        }
        s = s.parentBase;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_FrontPanelGlass01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_FrontPanelGlass01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_FrontPanelGlass01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_FrontPanelGlass01{
    ...
    const adc = new OD_M_mc_FrontPanelGlass01_NonNull(this);
    return adc;
  }
  ...
  addpart_FrontGlass(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FrontGlass_PartVarsWritable {
    var c = new P_part_FrontGlass(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_Frontprofile(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Frontprofile_PartVarsWritable {
    var c = new P_part_Frontprofile(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_FrontPanelGlass01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_FrontPanelGlass01_NonNull implements cbp_mc_FrontPanelGlass01, adc_mc_FrontPanelGlass01 ,IPartParentsNonNull_mc_FrontPanelGlass01 {
  constructor(parent: OD_M_mc_FrontPanelGlass01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_FrontPanelGlass01;
  ...
  #createBuildPlanInternal = mc_FrontPanelGlass01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_FrontPanelGlass01_afterDataCompletion;
  ...
  parent: IModParents_mc_Door01_mc_Drawer01_mc_Fliplift01;
  addpart_FrontGlass(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_FrontGlass_PartVarsWritable {
    return this.#internalParent.addpart_FrontGlass(x, y, z, dimx, dimy, dimz);
  }
  addpart_Frontprofile(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Frontprofile_PartVarsWritable {
    return this.#internalParent.addpart_Frontprofile(x, y, z, dimx, dimy, dimz);
  }
