...
export interface cti_tab_DrawerBoxExtraItemSettings {
  readonly in_FrontProgram? : string;
  readonly in_OpeningType? : string;
  readonly in_WidthMin : number;
  readonly in_WidthMax : number;
  readonly in_DepthMin : number;
  readonly in_DepthMax : number;
}

export interface ctm_tab_DrawerBoxExtraItemSettings {
}

export interface cto_tab_DrawerBoxExtraItemSettings extends ctm_tab_DrawerBoxExtraItemSettings {
  readonly _id : number;
  readonly FrontToBottomConnectorId? : string;
  readonly FrontToBottomConnectorDescriptor? : string;
  readonly PushToOpenId? : string;
  readonly SyncronizationId? : string;
}

export interface ICT_tab_DrawerBoxExtraItemSettings
extends cti_tab_DrawerBoxExtraItemSettings, cto_tab_DrawerBoxExtraItemSettings {}

export class ct2_tab_DrawerBoxExtraItemSettings {
...
public findExactly(
     ...
     in_DepthMin: number,
     in_DepthMax: number,
): cto_tab_DrawerBoxExtraItemSettings | undefined {
  const res = ct_tab_DrawerBoxExtraItemSettings.find((p) => 
p.in_FrontProgram === in_FrontProgram
 && p.in_OpeningType === in_OpeningType
 && p.in_WidthMin === in_WidthMin
 && p.in_WidthMax === in_WidthMax
 && p.in_DepthMin === in_DepthMin
 && p.in_DepthMax === in_DepthMax
);
return res;
}

public find(
predicate: (value: cti_tab_DrawerBoxExtraItemSettings) => boolean
): cto_tab_DrawerBoxExtraItemSettings | undefined {
  for (let index = 0; index < ct_tab_DrawerBoxExtraItemSettings.length; index++){
    const element = ct_tab_DrawerBoxExtraItemSettings[index];
...
export var ct_tab_DrawerBoxExtraItemSettings :ICT_tab_DrawerBoxExtraItemSettings[] = [
{
 _id: 35,
 in_FrontProgram: "All",
 in_OpeningType: "All",
 ...
 in_DepthMin: 0,
 in_DepthMax: 9999,
 FrontToBottomConnectorId: "None",
 FrontToBottomConnectorDescriptor: "None",
 PushToOpenId: "None",
 SyncronizationId: "None"
}
,{
 _id: 36,
 in_FrontProgram: "All",
 ...
 in_DepthMin: 0,
 in_DepthMax: 9999,
 FrontToBottomConnectorId: "Legra_FrontBotCon",
 FrontToBottomConnectorDescriptor: "1_1",
 PushToOpenId: "None",
 SyncronizationId: "None"
}
,{
 ...
 in_DepthMax: 9999,
 FrontToBottomConnectorId: "Legra_FrontBotCon",
 FrontToBottomConnectorDescriptor: "200mm_1_200mm",
 PushToOpenId: "None",
 SyncronizationId: "None"
}
,{
 ...
 in_DepthMax: 9999,
 FrontToBottomConnectorId: "Legra_FrontBotCon",
 FrontToBottomConnectorDescriptor: "1_1_1_1",
 PushToOpenId: "None",
 SyncronizationId: "None"
}
,{
 ...
 in_DepthMax: 449,
 FrontToBottomConnectorId: "Legra_FrontBotCon",
 FrontToBottomConnectorDescriptor: "1_1_1",
 PushToOpenId: "None",
 SyncronizationId: "Legra_Syncro_Small"
}
,{
 _id: 40,
 in_FrontProgram: "All",
 ...
 FrontToBottomConnectorDescriptor: "1_1_1",
 PushToOpenId: "None",
 SyncronizationId: "Legra_Syncro_Large"
}
,{
 _id: 41,
 in_FrontProgram: "All",
 ...
 FrontToBottomConnectorDescriptor: "1_1_1",
 PushToOpenId: "None",
 SyncronizationId: "Legra_Syncro_TipOn_Large"
}
];
