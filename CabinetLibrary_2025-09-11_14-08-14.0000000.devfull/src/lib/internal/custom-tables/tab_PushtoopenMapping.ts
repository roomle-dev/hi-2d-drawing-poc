...
export interface cti_tab_PushtoopenMapping {
  readonly in_Position? : string;
  readonly in_Type? : string;
  readonly in_PartThkMin? : number;
  readonly in_PartThkMax? : number;
...
export interface ctm_tab_PushtoopenMapping {
}

export interface cto_tab_PushtoopenMapping extends ctm_tab_PushtoopenMapping {
  readonly _id : number;
  readonly ObjectCarcase? : string;
  readonly DrillAdjustablePosThk? : number;
  readonly MinFrontGapCarcase : number;
}

export interface ICT_tab_PushtoopenMapping
extends cti_tab_PushtoopenMapping, cto_tab_PushtoopenMapping {}

export class ct2_tab_PushtoopenMapping {

public findExactly(
     in_Position: string|undefined,
     in_Type: string|undefined,
     in_PartThkMin: number|undefined,
     in_PartThkMax: number|undefined,
...
): cto_tab_PushtoopenMapping | undefined {
  const res = ct_tab_PushtoopenMapping.find((p) => 
p.in_Position === in_Position
 && p.in_Type === in_Type
 && p.in_PartThkMin === in_PartThkMin
 && p.in_PartThkMax === in_PartThkMax
...
public find(
predicate: (value: cti_tab_PushtoopenMapping) => boolean
): cto_tab_PushtoopenMapping | undefined {
  for (let index = 0; index < ct_tab_PushtoopenMapping.length; index++){
    const element = ct_tab_PushtoopenMapping[index];
...
export var ct_tab_PushtoopenMapping :ICT_tab_PushtoopenMapping[] = [
{
 _id: 46,
 in_Position: "Bottom",
 in_Type: "DrilledCenter",
 in_PartThkMin: 15.1,
 in_PartThkMax: 16,
 in_FrontOverlayMin: 13,
 in_FrontOverlayMax: 999,
 in_WeightMin: 0,
 in_WeightMax: 999,
 in_Color: "All",
 ObjectCarcase: "PushToOpenShortGrey",
 DrillAdjustablePosThk: undefined,
 MinFrontGapCarcase: 3.1
}
,{
 _id: 47,
 in_Position: "Bottom",
...
,{
 ...
 in_Color: "All",
 ObjectCarcase: "PushToOpenShortGrey",
 DrillAdjustablePosThk: 5,
 MinFrontGapCarcase: 3.1
}
,{
 _id: 50,
 in_Position: "Bottom",
 in_Type: "WithAdapterHousing",
 in_PartThkMin: 0,
 in_PartThkMax: 999,
 in_FrontOverlayMin: -5,
 in_FrontOverlayMax: 12.99,
 in_WeightMin: 0,
 in_WeightMax: 999,
 in_Color: "All",
 ObjectCarcase: "AdapterHousingShortGrey",
 DrillAdjustablePosThk: undefined,
 MinFrontGapCarcase: 2
}
,{
 _id: 51,
 in_Position: "Side",
