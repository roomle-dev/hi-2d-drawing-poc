...
import { IModuleNonNull_mr_Toekick,IModParents_mr_Toekick,IPartParentsNonNull_mr_Toekick} from '../mod-interfaces'
import {IModVar_mod_ToekickColor,IModVarNonNull_mod_ToekickColor,IModVar_mod_ToekickThk,IModVarNonNull_mod_ToekickThk,IModVar_mod_ToekickReductionTop,IModVarNonNull_mod_ToekickReductionTop,IModVar_mod_ToekickConnectionOverhang,IModVarNonNull_mod_ToekickConnectionOverhang,IModVar_mod_ToekickConnectionSequence,IModVarNonNull_mod_ToekickConnectionSequence,IModVar_mod_ToekickSidepanelOverdimensionBtm,IModVarNonNull_mod_ToekickSidepanelOverdimensionBtm,IModVar_mod_ToekickSidepanelTransitionType,IModVarNonNull_mod_ToekickSidepanelTransitionType,IModVar_mod_ToekickId,IModVarNonNull_mod_ToekickId,IModVar_mod_LengthList,IModVarNonNull_mod_LengthList,IModVar_mod_GrainLogic,IModVarNonNull_mod_GrainLogic,IModVar_mod_ToekickProgram,IModVarNonNull_mod_ToekickProgram} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_ToekickColor, IMatrix_mod_ToekickThk, IMatrix_mod_ToekickReductionTop, IMatrix_mod_ToekickConnectionOverhang, IMatrix_mod_ToekickConnectionSequence, IMatrix_mod_ToekickSidepanelOverdimensionBtm, IMatrix_mod_ToekickSidepanelTransitionType, IMatrix_mod_ToekickId, IMatrix_mod_GrainLogic, IMatrix_mod_ToekickProgram} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { mr_Toekick_createBuildPlan, mr_Toekick_afterDataCompletion, mr_Toekick_manufacturerDataCompletion } from '../../modules/mr_Toekick';
...
export interface adc_mr_Toekick extends IModBaseProp
, IModVarNonNull_mod_ToekickColor, IModVarNonNull_mod_ToekickThk, IModVarNonNull_mod_ToekickReductionTop, IModVarNonNull_mod_ToekickConnectionOverhang, IModVarNonNull_mod_ToekickConnectionSequence, IModVarNonNull_mod_ToekickSidepanelOverdimensionBtm, IModVarNonNull_mod_ToekickSidepanelTransitionType, IModVarNonNull_mod_ToekickId, IModVarNonNull_mod_LengthList, IModVarNonNull_mod_GrainLogic, IModVarNonNull_mod_ToekickProgram {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  addOD_M_mc_Toekick(index?: number): dc_mc_Toekick;
...
,IModParents_mr_Toekick
,IModVar_mod_ToekickColor,IModVar_mod_ToekickThk,IModVar_mod_ToekickReductionTop,IModVar_mod_ToekickConnectionOverhang,IModVar_mod_ToekickConnectionSequence,IModVar_mod_ToekickSidepanelOverdimensionBtm,IModVar_mod_ToekickSidepanelTransitionType,IModVar_mod_ToekickId,IModVar_mod_LengthList,IModVar_mod_GrainLogic,IModVar_mod_ToekickProgram
 {
  constructor(parent?: OD_Base, manufacturerMode?:boolean) {
    super('mr_Toekick', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this._g = new GlobalVars();
    this._openGroups = new Map<string, OpenGroup>();
    this._partGroups = new Map<string, PartGroup>();
    this._selfNonNull = new OD_M_mr_Toekick_NonNull(this);
    this._isGenerated = true;
  }
  _selfNonNull: OD_M_mr_Toekick_NonNull;
  getGenerationContours(): GenerationContour[] { return this.generationContours; }

  override variants:string[] = ['mod_ToekickColor','mod_ToekickThk','mod_ToekickReductionTop','mod_ToekickConnectionOverhang','mod_ToekickConnectionSequence','mod_ToekickSidepanelOverdimensionBtm','mod_ToekickSidepanelTransitionType','mod_ToekickId','mod_LengthList','mod_GrainLogic','mod_ToekickProgram',];
  ...
  #dataCompletionSetDefaultScripts() {
    ...
    if (this.mod_ToekickReductionTop === undefined) {
      this.mod_ToekickReductionTop = this.g.basic_ToekickReductionTop;
    }
    if (this.mod_ToekickConnectionOverhang === undefined) {
      this.mod_ToekickConnectionOverhang = this.g.basic_ToekickConnectionOverhang;
    }
    if (this.mod_ToekickSidepanelOverdimensionBtm === undefined) {
      this.mod_ToekickSidepanelOverdimensionBtm = this.g.basic_ToekickSidepanelOverdimensionBtm;
    }
    if (this.mod_ToekickSidepanelTransitionType === undefined) {
      this.mod_ToekickSidepanelTransitionType = this.g.basic_ToekickSidepanelTransitionType;
    }
  ...
  #manufacturerDataCompletionInternal = mr_Toekick_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mr_Toekick_NonNull(this);
  ...
  override validateSelections():void {
    ...
    this.mod_ToekickReductionTop_matrix = VariantValidation.mod_ToekickReductionTop(this, this);
    this.mod_ToekickConnectionOverhang_matrix = VariantValidation.mod_ToekickConnectionOverhang(this, this);
    this.mod_ToekickConnectionSequence_matrix = VariantValidation.mod_ToekickConnectionSequence(this, this);
    this.mod_ToekickSidepanelOverdimensionBtm_matrix = VariantValidation.mod_ToekickSidepanelOverdimensionBtm(this, this);
    this.mod_ToekickSidepanelTransitionType_matrix = VariantValidation.mod_ToekickSidepanelTransitionType(this, this);
  ...
  override createBuildPlan():void {
    var cbp = new OD_M_mr_Toekick_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mr_Toekick_NonNull implements cbp_mr_Toekick, adc_mr_Toekick ,IPartParentsNonNull_mr_Toekick {
  constructor(parent: OD_M_mr_Toekick) {
  ...
  #createBuildPlanInternal = mr_Toekick_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mr_Toekick_afterDataCompletion;
