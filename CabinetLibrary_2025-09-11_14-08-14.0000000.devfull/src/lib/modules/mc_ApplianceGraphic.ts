...
//#region Imports
import { cbp_mc_ApplianceGraphic, dc_mc_ApplianceGraphic, adc_mc_ApplianceGraphic } from '../internal/modules/mc_ApplianceGraphic'
...
export function mc_ApplianceGraphic_createBuildPlan(this: cbp_mc_ApplianceGraphic):void {
  internal_enterModuleCreateBuildPlan('mc_ApplianceGraphic', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_ApplianceGraphic_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: March 2025
  // By Ludwig Weber
...
// ---------------------------------------------------------------
export function mc_ApplianceGraphic_afterDataCompletion(this: adc_mc_ApplianceGraphic):void {
  internal_enterModuleAfterDataCompletion('mc_ApplianceGraphic', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_ApplianceGraphic_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_ApplianceGraphic_manufacturerDataCompletion(this: dc_mc_ApplianceGraphic):void {
  internal_enterModuleManufacturerDataCompletion('mc_ApplianceGraphic', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_ApplianceGraphic_MANUFACTURERDATACOMPLETION
