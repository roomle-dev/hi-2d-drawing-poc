...
//#region Imports
import { cbp_mc_Fridge01, dc_mc_Fridge01, adc_mc_Fridge01 } from '../internal/modules/mc_Fridge01'
...
export function mc_Fridge01_createBuildPlan(this: cbp_mc_Fridge01):void {
  internal_enterModuleCreateBuildPlan('mc_Fridge01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Fridge01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_Fridge01_afterDataCompletion(this: adc_mc_Fridge01):void {
  internal_enterModuleAfterDataCompletion('mc_Fridge01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Fridge01_AFTERDATACOMPLETION
  ...
  //
  // Description:
  // AfterDataCompletion of mc_Fridge01
  ...
  // Set the attributes
  Graphic.mod_GraphicId = this.mod_FridgeGraphicId;
...
// ---------------------------------------------------------------
export function mc_Fridge01_manufacturerDataCompletion(this: dc_mc_Fridge01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Fridge01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Fridge01_MANUFACTURERDATACOMPLETION
