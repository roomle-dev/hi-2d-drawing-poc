...
//#region Imports
import { cbp_mc_StorageunitShelftop04, dc_mc_StorageunitShelftop04, adc_mc_StorageunitShelftop04 } from '../internal/modules/mc_StorageunitShelftop04'
...
export function mc_StorageunitShelftop04_createBuildPlan(this: cbp_mc_StorageunitShelftop04):void {
  internal_enterModuleCreateBuildPlan('mc_StorageunitShelftop04', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_StorageunitShelftop04_CREATEBUILDPLAN
  // Schuler Consulting
	// Create: Nov 2022
	// By Ludwig Weber
	...
	if (this.mod_PartInfo == 'part_SlopedCeilingShelftopHor') {
		...
		// Add the material
		GlobalFunc.process_AddMaterial(Elem, 'shelf', this.mod_CarcaseColor, this.mod_CarcaseOutsideColor, this.mod_CarcaseEdgeColor, this.mod_CarcaseEdgeFrontColor, 'bottom', this.mod_CarcaseVisTop, tmpShape);	
...
// ---------------------------------------------------------------
export function mc_StorageunitShelftop04_afterDataCompletion(this: adc_mc_StorageunitShelftop04):void {
  internal_enterModuleAfterDataCompletion('mc_StorageunitShelftop04', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitShelftop04_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_StorageunitShelftop04_manufacturerDataCompletion(this: dc_mc_StorageunitShelftop04):void {
  internal_enterModuleManufacturerDataCompletion('mc_StorageunitShelftop04', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitShelftop04_MANUFACTURERDATACOMPLETION
