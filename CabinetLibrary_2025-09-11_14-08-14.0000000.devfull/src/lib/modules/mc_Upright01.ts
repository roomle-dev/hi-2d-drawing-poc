...
//#region Imports
import { cbp_mc_Upright01, dc_mc_Upright01, adc_mc_Upright01 } from '../internal/modules/mc_Upright01'
...
export function mc_Upright01_createBuildPlan(this: cbp_mc_Upright01):void {
  internal_enterModuleCreateBuildPlan('mc_Upright01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Upright01_CREATEBUILDPLAN
  // Schuler Consulting
  ...
  let UprightgroupGroup = this.addpart_UprightGroup(0, 2, 0, this.mod_UprightThk, this.mod_Height, this.mod_Depth);
  this.createPartGroup('Upright', UprightgroupGroup);
  UprightgroupGroup.pa_BomId = BomIdname;
  ...
  // Insert the Upright
  let FinishPanel = this.addpart_FinishPanel(0, 2, 0, this.mod_UprightThk, this.mod_Height-2, this.mod_Depth);
  this.assignPartGroup('Upright', FinishPanel);
  ...
  FinishPanel.pa_FinishPanelHeight = this.mod_Height;
  ...
  if (this.mod_UprightConstruction === "ToFloor") {
    let Profile = this.addpart_FinishPanelProfile(-1, 0, -1, this.mod_UprightThk + 2, 20, this.mod_Depth + 2);
    this.assignPartGroup('Upright', Profile);
...
// ---------------------------------------------------------------
export function mc_Upright01_afterDataCompletion(this: adc_mc_Upright01):void {
  internal_enterModuleAfterDataCompletion('mc_Upright01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Upright01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Upright01_manufacturerDataCompletion(this: dc_mc_Upright01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Upright01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Upright01_MANUFACTURERDATACOMPLETION
