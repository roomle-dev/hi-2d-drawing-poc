...
import { IModParents_mf_Sink } from '../mod-interfaces'
import { OD_M_mc_ApplianceGraphic, dc_mc_ApplianceGraphic } from './mc_ApplianceGraphic'
import { IModuleNonNull_mc_Sink01,IModParents_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood,IPartParentsNonNull_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood} from '../mod-interfaces'
import {IModVar_mod_SinkConstructionId,IModVarNonNull_mod_SinkConstructionId,IModVar_mod_SinkGraphicId,IModVarNonNull_mod_SinkGraphicId} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_SinkConstructionId, IMatrix_mod_SinkGraphicId} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { mc_Sink01_createBuildPlan, mc_Sink01_afterDataCompletion, mc_Sink01_manufacturerDataCompletion } from '../../modules/mc_Sink01';

export interface cbp_mc_Sink01 extends IModBaseProp
, IModVarNonNull_mod_SinkConstructionId, IModVarNonNull_mod_SinkGraphicId {
  parent: IModParents_mf_Sink;
...
export interface dc_mc_Sink01 extends IModBaseProp
, IModVar_mod_SinkConstructionId, IModVar_mod_SinkGraphicId {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Sink01;
  parent: IModParents_mf_Sink;
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
}

export interface adc_mc_Sink01 extends IModBaseProp
, IModVarNonNull_mod_SinkConstructionId, IModVarNonNull_mod_SinkGraphicId {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
...
export class OD_M_mc_Sink01 extends OD_Base  implements dc_mc_Sink01
,IModParents_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood
,IModVar_mod_SinkConstructionId,IModVar_mod_SinkGraphicId
 {
  constructor(parent: IModParents_mf_Sink, manufacturerMode?:boolean) {
    super('mc_Sink01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Sink01_NonNull(this);
  }
  parent: IModParents_mf_Sink;
  _selfNonNull: OD_M_mc_Sink01_NonNull;

  override variants:string[] = ['mod_SinkConstructionId','mod_SinkGraphicId',];
  #mod_SinkConstructionId?: string;
  get mod_SinkConstructionId(): string | undefined { return this.#mod_SinkConstructionId}
  set mod_SinkConstructionId(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_SinkConstructionId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_SinkConstructionId === value) return;
    this.#mod_SinkConstructionId = value;
  }

  mod_SinkConstructionId_matrix?: IMatrix_mod_SinkConstructionId;
  #mod_SinkGraphicId?: string;
  get mod_SinkGraphicId(): string | undefined { return this.#mod_SinkGraphicId}
  set mod_SinkGraphicId(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_SinkGraphicId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_SinkGraphicId === value) return;
    this.#mod_SinkGraphicId = value;
  }

  mod_SinkGraphicId_matrix?: IMatrix_mod_SinkGraphicId;
  override getAttributes() : Map<string,any> { 
    let res = new Map<string,any>();
  res.set('mod_SinkConstructionId', this.mod_SinkConstructionId);
  res.set('mod_SinkGraphicId', this.mod_SinkGraphicId);
    return res;
  }
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_SinkConstructionId');
    const val = _toString(json['attributes']['mod_SinkConstructionId'], 'mod_SinkConstructionId');
    internal_leaveValidateVariant();
    this.mod_SinkConstructionId = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_SinkGraphicId');
    const val = _toString(json['attributes']['mod_SinkGraphicId'], 'mod_SinkGraphicId');
    internal_leaveValidateVariant();
    this.mod_SinkGraphicId = val; }
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_SinkConstructionId === undefined) {
      this.mod_SinkConstructionId = "None";
    }
    if (this.mod_SinkGraphicId === undefined) {
      this.mod_SinkGraphicId = "";
    }
  ...
  #manufacturerDataCompletionInternal = mc_Sink01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Sink01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Sink01{
    ...
    const adc = new OD_M_mc_Sink01_NonNull(this);
    return adc;
  }
  ...
  override validateSelections():void {
    this.mod_SinkConstructionId_matrix = VariantValidation.mod_SinkConstructionId(this, this);
    this.mod_SinkGraphicId_matrix = VariantValidation.mod_SinkGraphicId(this, this);
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Sink01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Sink01_NonNull implements cbp_mc_Sink01, adc_mc_Sink01 ,IPartParentsNonNull_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood {
  constructor(parent: OD_M_mc_Sink01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Sink01;
  ...
  #createBuildPlanInternal = mc_Sink01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Sink01_afterDataCompletion;
  ...
  parent: IModParents_mf_Sink;
  get mod_SinkConstructionId(): string  {
    return this.#internalParent.mod_SinkConstructionId!;
  }
  get mod_SinkGraphicId(): string  {
    return this.#internalParent.mod_SinkGraphicId!;
  }
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic {
