...
import { IP_part_Drawer_PartVarsWritable, P_part_Drawer } from '../parts/part_Drawer'
import { IP_part_Fliplift_PartVarsWritable, P_part_Fliplift } from '../parts/part_Fliplift'
import { IP_part_Door_PartVarsWritable, P_part_Door } from '../parts/part_Door'
import { IP_part_Filler_PartVarsWritable, P_part_Filler } from '../parts/part_Filler'
import { IP_part_Fixedfront_PartVarsWritable, P_part_Fixedfront } from '../parts/part_Fixedfront'
import { IP_part_ApplianceFront_PartVarsWritable, P_part_ApplianceFront } from '../parts/part_ApplianceFront'
import { IP_part_DishwasherPanel_PartVarsWritable, P_part_DishwasherPanel } from '../parts/part_DishwasherPanel'
import { IModuleNonNull_mc_FrontPanel01,IModParents_mc_FrontPanel01,IPartParentsNonNull_mc_FrontPanel01} from '../mod-interfaces'
import {IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_FrontId,IModVarNonNull_mod_FrontId,IModVar_mod_FrontType,IModVarNonNull_mod_FrontType,IModVar_mod_Height,IModVarNonNull_mod_Height,IModVar_mod_Width,IModVarNonNull_mod_Width,IModVar_mod_FrontColor,IModVarNonNull_mod_FrontColor,IModVar_mod_FrontEdgeColor,IModVarNonNull_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVarNonNull_mod_FrontEdgeThk,IModVar_mod_FrontProgram,IModVarNonNull_mod_FrontProgram,IModVar_mod_PartInfo,IModVarNonNull_mod_PartInfo,IModVar_mod_FrontDesign,IModVarNonNull_mod_FrontDesign,IModVar_mod_HandleDesign,IModVarNonNull_mod_HandleDesign,IModVar_mod_HandlePosType,IModVarNonNull_mod_HandlePosType,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_CornerunitStraightFillerConstruction,IModVarNonNull_mod_CornerunitStraightFillerConstruction,IModVar_mod_CarcaseDirection,IModVarNonNull_mod_CarcaseDirection,IModVar_mod_FrontpanelWeightCalculations,IModVarNonNull_mod_FrontpanelWeightCalculations,IModVar_mod_DoorDirection,IModVarNonNull_mod_DoorDirection,IModVar_mod_FlipliftType,IModVarNonNull_mod_FlipliftType,IModVar_mod_ParentName,IModVarNonNull_mod_ParentName,IModVar_mod_FillerHardwareInfo,IModVarNonNull_mod_FillerHardwareInfo} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_Depth, IMatrix_mod_FrontId, IMatrix_mod_FrontType, IMatrix_mod_Height, IMatrix_mod_Width, IMatrix_mod_FrontColor, IMatrix_mod_FrontEdgeColor, IMatrix_mod_FrontEdgeThk, IMatrix_mod_FrontProgram, IMatrix_mod_PartInfo, IMatrix_mod_FrontDesign, IMatrix_mod_HandleDesign, IMatrix_mod_HandlePosType, IMatrix_mod_ModuleName, IMatrix_mod_CornerunitStraightFillerConstruction, IMatrix_mod_CarcaseDirection, IMatrix_mod_DoorDirection, IMatrix_mod_FlipliftType, IMatrix_mod_ParentName} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_Drawer, IPartAdd_part_Fliplift, IPartAdd_part_Door, IPartAdd_part_Filler, IPartAdd_part_Fixedfront, IPartAdd_part_ApplianceFront, IPartAdd_part_DishwasherPanel } from '../part-add-interfaces';
import { mc_FrontPanel01_createBuildPlan, mc_FrontPanel01_afterDataCompletion, mc_FrontPanel01_manufacturerDataCompletion } from '../../modules/mc_FrontPanel01';

export interface cbp_mc_FrontPanel01 extends IModBaseProp
, IPartAdd_part_Drawer, IPartAdd_part_Fliplift, IPartAdd_part_Door, IPartAdd_part_Filler, IPartAdd_part_Fixedfront, IPartAdd_part_ApplianceFront, IPartAdd_part_DishwasherPanel, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_PartInfo, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_CornerunitStraightFillerConstruction, IModVarNonNull_mod_CarcaseDirection, IModVarNonNull_mod_FrontpanelWeightCalculations, IModVarNonNull_mod_DoorDirection, IModVarNonNull_mod_FlipliftType, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_FillerHardwareInfo {
...
export interface dc_mc_FrontPanel01 extends IModBaseProp
, IModVar_mod_Depth, IModVar_mod_FrontId, IModVar_mod_FrontType, IModVar_mod_Height, IModVar_mod_Width, IModVar_mod_FrontColor, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontProgram, IModVar_mod_PartInfo, IModVar_mod_FrontDesign, IModVar_mod_HandleDesign, IModVar_mod_HandlePosType, IModVar_mod_ModuleName, IModVar_mod_CornerunitStraightFillerConstruction, IModVar_mod_CarcaseDirection, IModVar_mod_FrontpanelWeightCalculations, IModVar_mod_DoorDirection, IModVar_mod_FlipliftType, IModVar_mod_ParentName, IModVar_mod_FillerHardwareInfo {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_FrontPanel01;
  parent: IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01;
}

export interface adc_mc_FrontPanel01 extends IModBaseProp
, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_PartInfo, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_CornerunitStraightFillerConstruction, IModVarNonNull_mod_CarcaseDirection, IModVarNonNull_mod_FrontpanelWeightCalculations, IModVarNonNull_mod_DoorDirection, IModVarNonNull_mod_FlipliftType, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_FillerHardwareInfo {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
}

export class OD_M_mc_FrontPanel01 extends OD_Base  implements dc_mc_FrontPanel01
,IModParents_mc_FrontPanel01
,IModVar_mod_Depth,IModVar_mod_FrontId,IModVar_mod_FrontType,IModVar_mod_Height,IModVar_mod_Width,IModVar_mod_FrontColor,IModVar_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVar_mod_FrontProgram,IModVar_mod_PartInfo,IModVar_mod_FrontDesign,IModVar_mod_HandleDesign,IModVar_mod_HandlePosType,IModVar_mod_ModuleName,IModVar_mod_CornerunitStraightFillerConstruction,IModVar_mod_CarcaseDirection,IModVar_mod_FrontpanelWeightCalculations,IModVar_mod_DoorDirection,IModVar_mod_FlipliftType,IModVar_mod_ParentName,IModVar_mod_FillerHardwareInfo
 {
  constructor(parent: IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01, manufacturerMode?:boolean) {
    super('mc_FrontPanel01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_FrontPanel01_NonNull(this);
  }
  parent: IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01;
  _selfNonNull: OD_M_mc_FrontPanel01_NonNull;

  override variants:string[] = ['mod_Depth','mod_FrontId','mod_FrontType','mod_Height','mod_Width','mod_FrontColor','mod_FrontEdgeColor','mod_FrontEdgeThk','mod_FrontProgram','mod_PartInfo','mod_FrontDesign','mod_HandleDesign','mod_HandlePosType','mod_ModuleName','mod_CornerunitStraightFillerConstruction','mod_CarcaseDirection','mod_FrontpanelWeightCalculations','mod_DoorDirection','mod_FlipliftType','mod_ParentName','mod_FillerHardwareInfo',];
  #mod_Depth?: number;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_FrontPanel01";
    }
    if (this.mod_CornerunitStraightFillerConstruction === undefined) {
      this.mod_CornerunitStraightFillerConstruction = "Construction01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_FrontPanel01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_FrontPanel01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_FrontPanel01{
    ...
    const adc = new OD_M_mc_FrontPanel01_NonNull(this);
    return adc;
  }
  ...
  addpart_ApplianceFront(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_ApplianceFront_PartVarsWritable {
    var c = new P_part_ApplianceFront(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_DishwasherPanel(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_DishwasherPanel_PartVarsWritable {
    var c = new P_part_DishwasherPanel(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_FrontPanel01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_FrontPanel01_NonNull implements cbp_mc_FrontPanel01, adc_mc_FrontPanel01 ,IPartParentsNonNull_mc_FrontPanel01 {
  constructor(parent: OD_M_mc_FrontPanel01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_FrontPanel01;
  ...
  #createBuildPlanInternal = mc_FrontPanel01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_FrontPanel01_afterDataCompletion;
  ...
  parent: IModParents_mc_CornerFillerFront01_mc_Dishwasher_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01;
  addpart_Drawer(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Drawer_PartVarsWritable {
    return this.#internalParent.addpart_Drawer(x, y, z, dimx, dimy, dimz);
  }
  addpart_Fliplift(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Fliplift_PartVarsWritable {
    return this.#internalParent.addpart_Fliplift(x, y, z, dimx, dimy, dimz);
  }
  addpart_Door(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Door_PartVarsWritable {
    return this.#internalParent.addpart_Door(x, y, z, dimx, dimy, dimz);
  }
  addpart_Filler(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Filler_PartVarsWritable {
    return this.#internalParent.addpart_Filler(x, y, z, dimx, dimy, dimz);
  }
  addpart_Fixedfront(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Fixedfront_PartVarsWritable {
    return this.#internalParent.addpart_Fixedfront(x, y, z, dimx, dimy, dimz);
  }
  addpart_ApplianceFront(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_ApplianceFront_PartVarsWritable {
    return this.#internalParent.addpart_ApplianceFront(x, y, z, dimx, dimy, dimz);
  }
  addpart_DishwasherPanel(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_DishwasherPanel_PartVarsWritable {
    return this.#internalParent.addpart_DishwasherPanel(x, y, z, dimx, dimy, dimz);
  }
