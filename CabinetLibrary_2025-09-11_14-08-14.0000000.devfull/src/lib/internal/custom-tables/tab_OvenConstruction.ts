...
export interface cti_tab_OvenConstruction {
  readonly in_ConstructionId? : string;
}

export interface ctm_tab_OvenConstruction {
}

export interface cto_tab_OvenConstruction extends ctm_tab_OvenConstruction {
  readonly _id : number;
  readonly SpaceWdtMin : number;
  readonly SpaceHgtMin : number;
  readonly SpaceDptMin : number;
  readonly LowerGapMin : number;
  readonly UpperGapMin : number;
  readonly FrontDistanceHgt : number;
  readonly OverhangBotMax : number;
  readonly OverhangTopMax : number;
  readonly ShelftopStacking? : boolean;
}

export interface ICT_tab_OvenConstruction
extends cti_tab_OvenConstruction, cto_tab_OvenConstruction {}

export class ct2_tab_OvenConstruction {

public findExactly(
     in_ConstructionId: string|undefined,
): cto_tab_OvenConstruction | undefined {
  const res = ct_tab_OvenConstruction.find((p) => 
...
public find(
predicate: (value: cti_tab_OvenConstruction) => boolean
): cto_tab_OvenConstruction | undefined {
  for (let index = 0; index < ct_tab_OvenConstruction.length; index++){
    const element = ct_tab_OvenConstruction[index];
...
export var ct_tab_OvenConstruction :ICT_tab_OvenConstruction[] = [
{
 _id: 57,
 in_ConstructionId: "BI510CNR0",
 SpaceWdtMin: 562,
 SpaceHgtMin: 140,
 SpaceDptMin: 500,
 LowerGapMin: 0,
 UpperGapMin: 0,
 FrontDistanceHgt: 140,
 OverhangBotMax: 0,
 OverhangTopMax: 0,
 ShelftopStacking: false
}
,{
 _id: 58,
 in_ConstructionId: "CM776GKB1",
 SpaceWdtMin: 562,
 SpaceHgtMin: 442,
 SpaceDptMin: 550,
 LowerGapMin: 0,
 UpperGapMin: 4,
 FrontDistanceHgt: 455,
 OverhangBotMax: 0,
 OverhangTopMax: 13,
 ShelftopStacking: true
}
,{
 _id: 59,
 in_ConstructionId: "BE732R1B1",
 SpaceWdtMin: 600,
 SpaceHgtMin: 362,
 SpaceDptMin: 300,
 LowerGapMin: 4,
 UpperGapMin: 4,
 FrontDistanceHgt: 382,
 OverhangBotMax: 14,
 OverhangTopMax: 6,
 ShelftopStacking: true
}
...
,{
 _id: 61,
 in_ConstructionId: "HB774G1B1",
 SpaceWdtMin: 562,
 SpaceHgtMin: 577,
 SpaceDptMin: 550,
 LowerGapMin: 0,
 UpperGapMin: 4,
 FrontDistanceHgt: 595,
 OverhangBotMax: 0,
 OverhangTopMax: 18,
 ShelftopStacking: true
}
