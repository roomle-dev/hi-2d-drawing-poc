...
export interface dc_mc_MetalFrame01 extends IModBaseProp
, IModVar_mod_Depth, IModVar_mod_FrontColor, IModVar_mod_FrontDesign, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontId, IModVar_mod_FrontProgram, IModVar_mod_FrontType, IModVar_mod_Height, IModVar_mod_PartInfo, IModVar_mod_Width, IModVar_mod_ModuleName, IModVar_mod_FrontpanelWeightCalculations, IModVar_mod_FrontpanelWeightLogic {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_MetalFrame01;
  parent: IModParents_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01;
}

export interface adc_mc_MetalFrame01 extends IModBaseProp
, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_Height, IModVarNonNull_mod_PartInfo, IModVarNonNull_mod_Width, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_FrontpanelWeightCalculations, IModVarNonNull_mod_FrontpanelWeightLogic {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
}

export class OD_M_mc_MetalFrame01 extends OD_Base  implements dc_mc_MetalFrame01
...
,IModVar_mod_Depth,IModVar_mod_FrontColor,IModVar_mod_FrontDesign,IModVar_mod_FrontEdgeColor,IModVar_mod_FrontEdgeThk,IModVar_mod_FrontId,IModVar_mod_FrontProgram,IModVar_mod_FrontType,IModVar_mod_Height,IModVar_mod_PartInfo,IModVar_mod_Width,IModVar_mod_ModuleName,IModVar_mod_FrontpanelWeightCalculations,IModVar_mod_FrontpanelWeightLogic
 {
  constructor(parent: IModParents_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01, manufacturerMode?:boolean) {
    super('mc_MetalFrame01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_MetalFrame01_NonNull(this);
  }
  parent: IModParents_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01;
  _selfNonNull: OD_M_mc_MetalFrame01_NonNull;

  override variants:string[] = ['mod_Depth','mod_FrontColor','mod_FrontDesign','mod_FrontEdgeColor','mod_FrontEdgeThk','mod_FrontId','mod_FrontProgram','mod_FrontType','mod_Height','mod_PartInfo','mod_Width','mod_ModuleName','mod_FrontpanelWeightCalculations','mod_FrontpanelWeightLogic',];
  #mod_Depth?: number;
  ...
  #mod_FrontpanelWeightLogic?: string;
  get mod_FrontpanelWeightLogic(): string | undefined { return this.#mod_FrontpanelWeightLogic}
  set mod_FrontpanelWeightLogic(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_FrontpanelWeightLogic' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_FrontpanelWeightLogic === value) return;
    this.#mod_FrontpanelWeightLogic = value;
  }

  mod_FrontpanelWeightLogic_matrix?: IMatrix_mod_FrontpanelWeightLogic;
  ...
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_FrontpanelWeightLogic');
    const val = _toString(json['attributes']['mod_FrontpanelWeightLogic'], 'mod_FrontpanelWeightLogic');
    internal_leaveValidateVariant();
    this.mod_FrontpanelWeightLogic = val; }
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_MetalFrame01";
    }
  ...
  #dataCompletionSetDefaultScripts() {
    internal_enterDataCompletionSetDefault(this.modId, this._id);
    try {
    if (this.mod_FrontpanelWeightLogic === undefined) {
      this.mod_FrontpanelWeightLogic = this.g.basic_FrontpanelWeightLogic;
    }
    } 
    catch (error) {
  ...
  #manufacturerDataCompletionInternal = mc_MetalFrame01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_MetalFrame01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_MetalFrame01{
    ...
    const adc = new OD_M_mc_MetalFrame01_NonNull(this);
    return adc;
  }
  ...
  override validateSelections():void {
    ...
    this.mod_FrontpanelWeightLogic_matrix = VariantValidation.mod_FrontpanelWeightLogic(this, this);
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_MetalFrame01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_MetalFrame01_NonNull implements cbp_mc_MetalFrame01, adc_mc_MetalFrame01  {
  constructor(parent: OD_M_mc_MetalFrame01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_MetalFrame01;
  ...
  #createBuildPlanInternal = mc_MetalFrame01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_MetalFrame01_afterDataCompletion;
  ...
  get mod_FrontpanelWeightLogic(): string  {
    return this.#internalParent.mod_FrontpanelWeightLogic!;
  }
}
