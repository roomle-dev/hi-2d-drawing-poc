...
export interface IP_part_CeilingFillerFittingPanel_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_Paneltop01;
}

export interface IP_part_CeilingFillerFittingPanel_PartVarsWritable extends IP_part_CeilingFillerFittingPanel_PartVarsReadOnly {
}

export class P_part_CeilingFillerFittingPanel extends PartBase implements IP_part_CeilingFillerFittingPanel_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Paneltop01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_CeilingFillerFittingPanel', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XZY';
  }
