...
import { IP_part_Shelffixed_PartVarsWritable, P_part_Shelffixed } from '../parts/part_Shelffixed'
import { IModuleNonNull_mc_ShelffixedGroup01,IModParents_mc_ShelffixedGroup01_mc_StorageunitShelffixed01,IPartParentsNonNull_mc_ShelffixedGroup01_mc_StorageunitShelffixed01} from '../mod-interfaces'
import {IModVar_mod_CarcaseColor,IModVarNonNull_mod_CarcaseColor,IModVar_mod_CarcaseId,IModVarNonNull_mod_CarcaseId,IModVar_mod_CarcaseProgram,IModVarNonNull_mod_CarcaseProgram,IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_FrontDesign,IModVarNonNull_mod_FrontDesign,IModVar_mod_FrontProgram,IModVarNonNull_mod_FrontProgram,IModVar_mod_HardwareId,IModVarNonNull_mod_HardwareId,IModVar_mod_Height,IModVarNonNull_mod_Height,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_TypeElement,IModVarNonNull_mod_TypeElement,IModVar_mod_Width,IModVarNonNull_mod_Width,IModVar_mod_ShelffixedOffsetFront,IModVarNonNull_mod_ShelffixedOffsetFront,IModVar_mod_CarcaseEdgeColor,IModVarNonNull_mod_CarcaseEdgeColor,IModVar_mod_CarcaseEdgeFrontColor,IModVarNonNull_mod_CarcaseEdgeFrontColor,IModVar_mod_CarcasePartConnectionBackHor,IModVarNonNull_mod_CarcasePartConnectionBackHor,IModVar_mod_CarcasePartConnectionLeftHor,IModVarNonNull_mod_CarcasePartConnectionLeftHor,IModVar_mod_CarcasePartConnectionRightHor,IModVarNonNull_mod_CarcasePartConnectionRightHor,IModVar_mod_EdgeBackType,IModVarNonNull_mod_EdgeBackType,IModVar_mod_EdgeFrontType,IModVarNonNull_mod_EdgeFrontType,IModVar_mod_EdgeJointType,IModVarNonNull_mod_EdgeJointType,IModVar_mod_EdgeLeftType,IModVarNonNull_mod_EdgeLeftType,IModVar_mod_EdgeRightType,IModVarNonNull_mod_EdgeRightType,IModVar_mod_FittingConnectionLeftHor,IModVarNonNull_mod_FittingConnectionLeftHor,IModVar_mod_FittingConnectionRightHor,IModVarNonNull_mod_FittingConnectionRightHor,IModVar_mod_HardwareColor,IModVarNonNull_mod_HardwareColor,IModVar_mod_ParentName,IModVarNonNull_mod_ParentName,IModVar_mod_ShelffixedPartParentName,IModVarNonNull_mod_ShelffixedPartParentName,IModVar_mod_ShelffixedPartParentType,IModVarNonNull_mod_ShelffixedPartParentType,IModVar_mod_ShelffixedThk,IModVarNonNull_mod_ShelffixedThk,IModVar_mod_ShelvesBackwallFittingConnection,IModVarNonNull_mod_ShelvesBackwallFittingConnection,IModVar_mod_CarcasePartConnectionBtmVert,IModVarNonNull_mod_CarcasePartConnectionBtmVert,IModVar_mod_CarcasePartConnectionTopVert,IModVarNonNull_mod_CarcasePartConnectionTopVert,IModVar_mod_FittingConnectionTopVert,IModVarNonNull_mod_FittingConnectionTopVert,IModVar_mod_FittingConnectionBtmVert,IModVarNonNull_mod_FittingConnectionBtmVert,IModVar_mod_CarcaseSpaceDimension,IModVarNonNull_mod_CarcaseSpaceDimension,IModVar_mod_GrainLogic,IModVarNonNull_mod_GrainLogic} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_CarcaseColor, IMatrix_mod_CarcaseId, IMatrix_mod_CarcaseProgram, IMatrix_mod_Depth, IMatrix_mod_FrontDesign, IMatrix_mod_FrontProgram, IMatrix_mod_HardwareId, IMatrix_mod_Height, IMatrix_mod_ModuleName, IMatrix_mod_TypeElement, IMatrix_mod_Width, IMatrix_mod_ShelffixedOffsetFront, IMatrix_mod_CarcaseEdgeColor, IMatrix_mod_CarcaseEdgeFrontColor, IMatrix_mod_CarcasePartConnectionBackHor, IMatrix_mod_CarcasePartConnectionLeftHor, IMatrix_mod_CarcasePartConnectionRightHor, IMatrix_mod_EdgeBackType, IMatrix_mod_EdgeFrontType, IMatrix_mod_EdgeJointType, IMatrix_mod_EdgeLeftType, IMatrix_mod_EdgeRightType, IMatrix_mod_FittingConnectionLeftHor, IMatrix_mod_FittingConnectionRightHor, IMatrix_mod_HardwareColor, IMatrix_mod_ParentName, IMatrix_mod_ShelffixedPartParentName, IMatrix_mod_ShelffixedPartParentType, IMatrix_mod_ShelffixedThk, IMatrix_mod_ShelvesBackwallFittingConnection, IMatrix_mod_CarcasePartConnectionBtmVert, IMatrix_mod_CarcasePartConnectionTopVert, IMatrix_mod_FittingConnectionTopVert, IMatrix_mod_FittingConnectionBtmVert, IMatrix_mod_GrainLogic} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_Shelffixed } from '../part-add-interfaces';
import { mc_ShelffixedGroup01_createBuildPlan, mc_ShelffixedGroup01_afterDataCompletion, mc_ShelffixedGroup01_manufacturerDataCompletion } from '../../modules/mc_ShelffixedGroup01';

export interface cbp_mc_ShelffixedGroup01 extends IModBaseProp
, IPartAdd_part_Shelffixed, IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_HardwareId, IModVarNonNull_mod_Height, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_Width, IModVarNonNull_mod_ShelffixedOffsetFront, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_CarcasePartConnectionBackHor, IModVarNonNull_mod_CarcasePartConnectionLeftHor, IModVarNonNull_mod_CarcasePartConnectionRightHor, IModVarNonNull_mod_EdgeBackType, IModVarNonNull_mod_EdgeFrontType, IModVarNonNull_mod_EdgeJointType, IModVarNonNull_mod_EdgeLeftType, IModVarNonNull_mod_EdgeRightType, IModVarNonNull_mod_FittingConnectionLeftHor, IModVarNonNull_mod_FittingConnectionRightHor, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_ShelffixedPartParentName, IModVarNonNull_mod_ShelffixedPartParentType, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_ShelvesBackwallFittingConnection, IModVarNonNull_mod_CarcasePartConnectionBtmVert, IModVarNonNull_mod_CarcasePartConnectionTopVert, IModVarNonNull_mod_FittingConnectionTopVert, IModVarNonNull_mod_FittingConnectionBtmVert, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_GrainLogic {
...
export interface dc_mc_ShelffixedGroup01 extends IModBaseProp
, IModVar_mod_CarcaseColor, IModVar_mod_CarcaseId, IModVar_mod_CarcaseProgram, IModVar_mod_Depth, IModVar_mod_FrontDesign, IModVar_mod_FrontProgram, IModVar_mod_HardwareId, IModVar_mod_Height, IModVar_mod_ModuleName, IModVar_mod_TypeElement, IModVar_mod_Width, IModVar_mod_ShelffixedOffsetFront, IModVar_mod_CarcaseEdgeColor, IModVar_mod_CarcaseEdgeFrontColor, IModVar_mod_CarcasePartConnectionBackHor, IModVar_mod_CarcasePartConnectionLeftHor, IModVar_mod_CarcasePartConnectionRightHor, IModVar_mod_EdgeBackType, IModVar_mod_EdgeFrontType, IModVar_mod_EdgeJointType, IModVar_mod_EdgeLeftType, IModVar_mod_EdgeRightType, IModVar_mod_FittingConnectionLeftHor, IModVar_mod_FittingConnectionRightHor, IModVar_mod_HardwareColor, IModVar_mod_ParentName, IModVar_mod_ShelffixedPartParentName, IModVar_mod_ShelffixedPartParentType, IModVar_mod_ShelffixedThk, IModVar_mod_ShelvesBackwallFittingConnection, IModVar_mod_CarcasePartConnectionBtmVert, IModVar_mod_CarcasePartConnectionTopVert, IModVar_mod_FittingConnectionTopVert, IModVar_mod_FittingConnectionBtmVert, IModVar_mod_CarcaseSpaceDimension, IModVar_mod_GrainLogic {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_ShelffixedGroup01;
  parent: IModParents_mf_RackArea;
}

export interface adc_mc_ShelffixedGroup01 extends IModBaseProp
, IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_HardwareId, IModVarNonNull_mod_Height, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_Width, IModVarNonNull_mod_ShelffixedOffsetFront, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_CarcasePartConnectionBackHor, IModVarNonNull_mod_CarcasePartConnectionLeftHor, IModVarNonNull_mod_CarcasePartConnectionRightHor, IModVarNonNull_mod_EdgeBackType, IModVarNonNull_mod_EdgeFrontType, IModVarNonNull_mod_EdgeJointType, IModVarNonNull_mod_EdgeLeftType, IModVarNonNull_mod_EdgeRightType, IModVarNonNull_mod_FittingConnectionLeftHor, IModVarNonNull_mod_FittingConnectionRightHor, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_ShelffixedPartParentName, IModVarNonNull_mod_ShelffixedPartParentType, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_ShelvesBackwallFittingConnection, IModVarNonNull_mod_CarcasePartConnectionBtmVert, IModVarNonNull_mod_CarcasePartConnectionTopVert, IModVarNonNull_mod_FittingConnectionTopVert, IModVarNonNull_mod_FittingConnectionBtmVert, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_GrainLogic {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
}

export class OD_M_mc_ShelffixedGroup01 extends OD_Base  implements dc_mc_ShelffixedGroup01
,IModParents_mc_ShelffixedGroup01_mc_StorageunitShelffixed01
,IModVar_mod_CarcaseColor,IModVar_mod_CarcaseId,IModVar_mod_CarcaseProgram,IModVar_mod_Depth,IModVar_mod_FrontDesign,IModVar_mod_FrontProgram,IModVar_mod_HardwareId,IModVar_mod_Height,IModVar_mod_ModuleName,IModVar_mod_TypeElement,IModVar_mod_Width,IModVar_mod_ShelffixedOffsetFront,IModVar_mod_CarcaseEdgeColor,IModVar_mod_CarcaseEdgeFrontColor,IModVar_mod_CarcasePartConnectionBackHor,IModVar_mod_CarcasePartConnectionLeftHor,IModVar_mod_CarcasePartConnectionRightHor,IModVar_mod_EdgeBackType,IModVar_mod_EdgeFrontType,IModVar_mod_EdgeJointType,IModVar_mod_EdgeLeftType,IModVar_mod_EdgeRightType,IModVar_mod_FittingConnectionLeftHor,IModVar_mod_FittingConnectionRightHor,IModVar_mod_HardwareColor,IModVar_mod_ParentName,IModVar_mod_ShelffixedPartParentName,IModVar_mod_ShelffixedPartParentType,IModVar_mod_ShelffixedThk,IModVar_mod_ShelvesBackwallFittingConnection,IModVar_mod_CarcasePartConnectionBtmVert,IModVar_mod_CarcasePartConnectionTopVert,IModVar_mod_FittingConnectionTopVert,IModVar_mod_FittingConnectionBtmVert,IModVar_mod_CarcaseSpaceDimension,IModVar_mod_GrainLogic
 {
  constructor(parent: IModParents_mf_RackArea, manufacturerMode?:boolean) {
    super('mc_ShelffixedGroup01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_ShelffixedGroup01_NonNull(this);
  }
  parent: IModParents_mf_RackArea;
  _selfNonNull: OD_M_mc_ShelffixedGroup01_NonNull;

  override variants:string[] = ['mod_CarcaseColor','mod_CarcaseId','mod_CarcaseProgram','mod_Depth','mod_FrontDesign','mod_FrontProgram','mod_HardwareId','mod_Height','mod_ModuleName','mod_TypeElement','mod_Width','mod_ShelffixedOffsetFront','mod_CarcaseEdgeColor','mod_CarcaseEdgeFrontColor','mod_CarcasePartConnectionBackHor','mod_CarcasePartConnectionLeftHor','mod_CarcasePartConnectionRightHor','mod_EdgeBackType','mod_EdgeFrontType','mod_EdgeJointType','mod_EdgeLeftType','mod_EdgeRightType','mod_FittingConnectionLeftHor','mod_FittingConnectionRightHor','mod_HardwareColor','mod_ParentName','mod_ShelffixedPartParentName','mod_ShelffixedPartParentType','mod_ShelffixedThk','mod_ShelvesBackwallFittingConnection','mod_CarcasePartConnectionBtmVert','mod_CarcasePartConnectionTopVert','mod_FittingConnectionTopVert','mod_FittingConnectionBtmVert','mod_CarcaseSpaceDimension','mod_GrainLogic',];
  ...
  #mod_ShelffixedPartParentName?: string;
  get mod_ShelffixedPartParentName(): string | undefined { return this.#mod_ShelffixedPartParentName}
  set mod_ShelffixedPartParentName(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_ShelffixedPartParentName' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_ShelffixedPartParentName === value) return;
    this.#mod_ShelffixedPartParentName = value;
  }

  mod_ShelffixedPartParentName_matrix?: IMatrix_mod_ShelffixedPartParentName;
  #mod_ShelffixedPartParentType?: string;
  get mod_ShelffixedPartParentType(): string | undefined { return this.#mod_ShelffixedPartParentType}
  set mod_ShelffixedPartParentType(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_ShelffixedPartParentType' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_ShelffixedPartParentType === value) return;
    this.#mod_ShelffixedPartParentType = value;
  }

  mod_ShelffixedPartParentType_matrix?: IMatrix_mod_ShelffixedPartParentType;
  ...
  res.set('mod_ShelffixedPartParentName', this.mod_ShelffixedPartParentName);
  res.set('mod_ShelffixedPartParentType', this.mod_ShelffixedPartParentType);
  ...
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_ShelffixedPartParentName');
    const val = _toString(json['attributes']['mod_ShelffixedPartParentName'], 'mod_ShelffixedPartParentName');
    internal_leaveValidateVariant();
    this.mod_ShelffixedPartParentName = val; }
    { internal_enterValidateVariant(this.modId, this._id, 'mod_ShelffixedPartParentType');
    const val = _toString(json['attributes']['mod_ShelffixedPartParentType'], 'mod_ShelffixedPartParentType');
    internal_leaveValidateVariant();
    this.mod_ShelffixedPartParentType = val; }
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_ShelvesBackwallFittingConnection === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_ShelvesBackwallFittingConnection')) {
          let pv = <IModVar_mod_ShelvesBackwallFittingConnection>s;
          if (pv.mod_ShelvesBackwallFittingConnection !== undefined) {
            this.mod_ShelvesBackwallFittingConnection = (<IModVar_mod_ShelvesBackwallFittingConnection>s).mod_ShelvesBackwallFittingConnection;
            break;
          };
        }
        s = s.parentBase;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_ShelffixedGroup01";
    }
    if (this.mod_Width === undefined) {
      this.mod_Width = 600;
    }
    if (this.mod_ShelffixedOffsetFront === undefined) {
      this.mod_ShelffixedOffsetFront = 10;
    }
    ...
    if (this.mod_ShelffixedPartParentName === undefined) {
      this.mod_ShelffixedPartParentName = "None";
    }
    if (this.mod_ShelffixedPartParentType === undefined) {
      this.mod_ShelffixedPartParentType = "None";
    }
  ...
  #manufacturerDataCompletionInternal = mc_ShelffixedGroup01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_ShelffixedGroup01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_ShelffixedGroup01{
    ...
    const adc = new OD_M_mc_ShelffixedGroup01_NonNull(this);
    return adc;
  }
  ...
  override validateSelections():void {
    ...
    this.mod_ShelffixedPartParentName_matrix = VariantValidation.mod_ShelffixedPartParentName(this, this);
    this.mod_ShelffixedPartParentType_matrix = VariantValidation.mod_ShelffixedPartParentType(this, this);
  ...
  addpart_Shelffixed(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Shelffixed_PartVarsWritable {
    var c = new P_part_Shelffixed(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_ShelffixedGroup01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_ShelffixedGroup01_NonNull implements cbp_mc_ShelffixedGroup01, adc_mc_ShelffixedGroup01 ,IPartParentsNonNull_mc_ShelffixedGroup01_mc_StorageunitShelffixed01 {
  constructor(parent: OD_M_mc_ShelffixedGroup01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_ShelffixedGroup01;
  ...
  #createBuildPlanInternal = mc_ShelffixedGroup01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_ShelffixedGroup01_afterDataCompletion;
  ...
  parent: IModParents_mf_RackArea;
  addpart_Shelffixed(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Shelffixed_PartVarsWritable {
    return this.#internalParent.addpart_Shelffixed(x, y, z, dimx, dimy, dimz);
  }
  ...
  get mod_ShelffixedPartParentName(): string  {
    return this.#internalParent.mod_ShelffixedPartParentName!;
  }
  get mod_ShelffixedPartParentType(): string  {
    return this.#internalParent.mod_ShelffixedPartParentType!;
  }
