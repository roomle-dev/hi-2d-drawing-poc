...
//#region Imports
import { cbp_mc_Backsplash, dc_mc_Backsplash, adc_mc_Backsplash } from '../internal/modules/mc_Backsplash'
...
export function mc_Backsplash_createBuildPlan(this: cbp_mc_Backsplash):void {
  internal_enterModuleCreateBuildPlan('mc_Backsplash', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Backsplash_CREATEBUILDPLAN
// Schuler Consulting
...
// 
  ...
  this.createPartGroup('Backsplash01', BacksplashGroup);
  BacksplashGroup.pa_BomId = BomIdname;
  ...
  this.assignPartGroup('Backsplash01', FinishPanel);
...
// ---------------------------------------------------------------
export function mc_Backsplash_afterDataCompletion(this: adc_mc_Backsplash):void {
  internal_enterModuleAfterDataCompletion('mc_Backsplash', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Backsplash_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Backsplash_manufacturerDataCompletion(this: dc_mc_Backsplash):void {
  internal_enterModuleManufacturerDataCompletion('mc_Backsplash', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Backsplash_MANUFACTURERDATACOMPLETION
