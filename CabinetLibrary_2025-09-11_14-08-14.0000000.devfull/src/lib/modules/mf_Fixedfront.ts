...
//#region Imports
import { cbp_mf_Fixedfront, dc_mf_Fixedfront, adc_mf_Fixedfront } from '../internal/modules/mf_Fixedfront'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_Fixedfront01, OD_M_mc_Fixedfront01 } from '../internal/modules/mc_Fixedfront01'
...
export function mf_Fixedfront_createBuildPlan(this: cbp_mf_Fixedfront):void {
  internal_enterModuleCreateBuildPlan('mf_Fixedfront', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mf_Fixedfront_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mf_Fixedfront_afterDataCompletion(this: adc_mf_Fixedfront):void {
  internal_enterModuleAfterDataCompletion('mf_Fixedfront', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_Fixedfront_AFTERDATACOMPLETION
  // Schuler Consulting
  // Create: Feb 2025
  // By Ludwig Weber
  ...
  //
  // Description:
  // AfterDataCompletion of mf_Fixedfront
  // Add module for the fixed front
  //
  // Revisions:
  // 
  //===================================================
  ...
  //===================================================
  //          Add module for fixed front
  //===================================================

  // Add the module
  let Elem = this.addOD_M_mc_Fixedfront01();
...
// ---------------------------------------------------------------
export function mf_Fixedfront_manufacturerDataCompletion(this: dc_mf_Fixedfront):void {
  internal_enterModuleManufacturerDataCompletion('mf_Fixedfront', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mf_Fixedfront_MANUFACTURERDATACOMPLETION
