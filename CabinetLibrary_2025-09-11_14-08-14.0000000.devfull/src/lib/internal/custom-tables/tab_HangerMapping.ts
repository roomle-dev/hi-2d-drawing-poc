...
export interface cti_tab_HangerMapping {
  readonly in_HangerType? : string;
  readonly in_CarcaseWidthMin? : number;
  readonly in_CarcaseWidthMax? : number;
  readonly in_Color? : string;
}

export interface ctm_tab_HangerMapping {
}

export interface cto_tab_HangerMapping extends ctm_tab_HangerMapping {
  readonly _id : number;
  readonly Object? : string;
  readonly IncludeWallPlateRight? : boolean;
  WallPlateRightLength(m: any /* WARNING: No parent found; assuming 'any' */,HorizontalFreeSpace: number):number;
  readonly IncludeWallPlateLeft? : boolean;
  WallPlateLeftLength(m: any /* WARNING: No parent found; assuming 'any' */,HorizontalFreeSpace: number):number;
  readonly VerticalOffset : number;
  readonly VerticalOffsetWallPlateToHanger? : number;
}

export interface ICT_tab_HangerMapping
extends cti_tab_HangerMapping, cto_tab_HangerMapping {}

export class ct2_tab_HangerMapping {

public findExactly(
     in_HangerType: string|undefined,
     in_CarcaseWidthMin: number|undefined,
     in_CarcaseWidthMax: number|undefined,
     in_Color: string|undefined,
): cto_tab_HangerMapping | undefined {
  const res = ct_tab_HangerMapping.find((p) => 
p.in_HangerType === in_HangerType
...
public find(
predicate: (value: cti_tab_HangerMapping) => boolean
): cto_tab_HangerMapping | undefined {
  for (let index = 0; index < ct_tab_HangerMapping.length; index++){
    const element = ct_tab_HangerMapping[index];
...
export var ct_tab_HangerMapping :ICT_tab_HangerMapping[] = [
{
 _id: 10,
 in_HangerType: "WallUnitVisibleHanger75kg",
 in_CarcaseWidthMin: 0,
 in_CarcaseWidthMax: 9999,
 in_Color: "All",
 Object: "WallUnitVisibleHanger75kgWhite",
 IncludeWallPlateRight: true,
  WallPlateRightLength(m: any /* WARNING: No parent found; assuming 'any' */,HorizontalFreeSpace: number):number {
    return 0;
  }
,
 IncludeWallPlateLeft: true,
  WallPlateLeftLength(m: any /* WARNING: No parent found; assuming 'any' */,HorizontalFreeSpace: number):number {
    return 0;
  }
,
 VerticalOffset: -50,
 VerticalOffsetWallPlateToHanger: -21
}
,{
 _id: 11,
 in_HangerType: "WallUnitVisibleHanger52kg",
 in_CarcaseWidthMin: 0,
 in_CarcaseWidthMax: 599,
 in_Color: "All",
 Object: "WallUnitVisibleHanger52kgNickelPlated",
 IncludeWallPlateRight: true,
  WallPlateRightLength(m: any /* WARNING: No parent found; assuming 'any' */,HorizontalFreeSpace: number):number {
    return 125;
  }
...
,
 VerticalOffset: -10,
 VerticalOffsetWallPlateToHanger: -16.5
}
,{
 _id: 12,
 in_HangerType: "WallUnitVisibleHanger52kg",
 in_CarcaseWidthMin: 600,
 in_CarcaseWidthMax: 600,
 in_Color: "All",
 Object: "WallUnitVisibleHanger52kgNickelPlated",
 IncludeWallPlateRight: true,
  WallPlateRightLength(m: any /* WARNING: No parent found; assuming 'any' */,HorizontalFreeSpace: number):number {
...
,{
 _id: 13,
 in_HangerType: "WallUnitVisibleHanger52kg",
 in_CarcaseWidthMin: 601,
 in_CarcaseWidthMax: 1255,
 in_Color: "All",
 Object: "WallUnitVisibleHanger52kgNickelPlated",
 IncludeWallPlateRight: true,
  WallPlateRightLength(m: any /* WARNING: No parent found; assuming 'any' */,HorizontalFreeSpace: number):number {
    return HorizontalFreeSpace - 5;
  }
,
 IncludeWallPlateLeft: false,
  WallPlateLeftLength(m: any /* WARNING: No parent found; assuming 'any' */,HorizontalFreeSpace: number):number {
...
,{
 _id: 14,
 in_HangerType: "BaseUnitVisibleHanger120kg",
 in_CarcaseWidthMin: 0,
 in_CarcaseWidthMax: 9999,
 in_Color: "All",
 Object: "BaseUnitVisibleHanger120kgWhite",
 IncludeWallPlateRight: true,
  WallPlateRightLength(m: any /* WARNING: No parent found; assuming 'any' */,HorizontalFreeSpace: number):number {
    return 0;
  }
...
,
 VerticalOffset: -10,
 VerticalOffsetWallPlateToHanger: 0
}
,{
 _id: 15,
 in_HangerType: "WallUnitHiddenHanger92kg",
 in_CarcaseWidthMin: 0,
 in_CarcaseWidthMax: 9999,
 in_Color: "All",
 Object: "WallUnitHiddenHanger92kgWhite",
 IncludeWallPlateRight: true,
  WallPlateRightLength(m: any /* WARNING: No parent found; assuming 'any' */,HorizontalFreeSpace: number):number {
    return 200;
  }
...
,
 VerticalOffset: -30,
 VerticalOffsetWallPlateToHanger: -13.5
}
,{
 _id: 16,
 in_HangerType: "WallUnitVisibleHanger52kg",
 in_CarcaseWidthMin: 1256,
 in_CarcaseWidthMax: 9999,
 in_Color: "All",
 Object: "WallUnitVisibleHanger52kgNickelPlated",
 IncludeWallPlateRight: true,
...
,{
 _id: 17,
 in_HangerType: "WallUnitVisibleHanger45kg",
 in_CarcaseWidthMin: 0,
 in_CarcaseWidthMax: 9999,
 in_Color: "DemoWhite",
 Object: "WallUnitVisibleHanger45kgWhite",
 IncludeWallPlateRight: true,
  WallPlateRightLength(m: any /* WARNING: No parent found; assuming 'any' */,HorizontalFreeSpace: number):number {
    return 120;
  }
...
,
 VerticalOffset: -5,
 VerticalOffsetWallPlateToHanger: -17
}
,{
 _id: 18,
 in_HangerType: "WallUnitVisibleHanger45kg",
 in_CarcaseWidthMin: 0,
 in_CarcaseWidthMax: 9999,
 in_Color: "DemoStainlessSteel",
 Object: "WallUnitVisibleHanger45kgGrey",
 IncludeWallPlateRight: true,
  WallPlateRightLength(m: any /* WARNING: No parent found; assuming 'any' */,HorizontalFreeSpace: number):number {
    return 120;
  }
