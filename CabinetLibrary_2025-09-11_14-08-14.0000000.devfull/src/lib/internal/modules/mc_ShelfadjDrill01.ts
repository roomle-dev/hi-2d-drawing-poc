...
import { IP_part_ShelfadjDrill_PartVarsWritable, P_part_ShelfadjDrill } from '../parts/part_ShelfadjDrill'
import { IModuleNonNull_mc_ShelfadjDrill01,IModParents_mc_ShelfadjDrill01,IPartParentsNonNull_mc_ShelfadjDrill01} from '../mod-interfaces'
import {IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_Rotation,IModVarNonNull_mod_Rotation,IModVar_mod_ShelfadjDrillDistance,IModVarNonNull_mod_ShelfadjDrillDistance,IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_Width,IModVarNonNull_mod_Width,IModVar_mod_Height,IModVarNonNull_mod_Height,IModVar_mod_ShelfadjSidepanelDrillDescriptor,IModVarNonNull_mod_ShelfadjSidepanelDrillDescriptor,IModVar_mod_ShelfadjBackwallDrillDescriptor,IModVarNonNull_mod_ShelfadjBackwallDrillDescriptor,IModVar_mod_ShelfadjBackwallProcessingId,IModVarNonNull_mod_ShelfadjBackwallProcessingId,IModVar_mod_ShelfadjSidepanelProcessingBackId,IModVarNonNull_mod_ShelfadjSidepanelProcessingBackId,IModVar_mod_ShelfadjSidepanelProcessingFrontId,IModVarNonNull_mod_ShelfadjSidepanelProcessingFrontId,IModVar_mod_ShelfadjSidepanelProcessingMiddleId,IModVarNonNull_mod_ShelfadjSidepanelProcessingMiddleId,IModVar_mod_ShelfadjVertDividerProcessingId,IModVarNonNull_mod_ShelfadjVertDividerProcessingId,IModVar_mod_ShelfadjVertdividerDrillDescriptor,IModVarNonNull_mod_ShelfadjVertdividerDrillDescriptor,IModVar_mod_VertDividerType,IModVarNonNull_mod_VertDividerType,IModVar_mod_VertDividerPosition,IModVarNonNull_mod_VertDividerPosition} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_ModuleName, IMatrix_mod_Rotation, IMatrix_mod_ShelfadjDrillDistance, IMatrix_mod_Depth, IMatrix_mod_Width, IMatrix_mod_Height, IMatrix_mod_ShelfadjSidepanelDrillDescriptor, IMatrix_mod_ShelfadjBackwallDrillDescriptor, IMatrix_mod_ShelfadjBackwallProcessingId, IMatrix_mod_ShelfadjSidepanelProcessingBackId, IMatrix_mod_ShelfadjSidepanelProcessingFrontId, IMatrix_mod_ShelfadjSidepanelProcessingMiddleId, IMatrix_mod_ShelfadjVertDividerProcessingId, IMatrix_mod_ShelfadjVertdividerDrillDescriptor, IMatrix_mod_VertDividerType, IMatrix_mod_VertDividerPosition} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_ShelfadjDrill } from '../part-add-interfaces';
import { mc_ShelfadjDrill01_createBuildPlan, mc_ShelfadjDrill01_afterDataCompletion, mc_ShelfadjDrill01_manufacturerDataCompletion } from '../../modules/mc_ShelfadjDrill01';

export interface cbp_mc_ShelfadjDrill01 extends IModBaseProp
, IPartAdd_part_ShelfadjDrill, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_Rotation, IModVarNonNull_mod_ShelfadjDrillDistance, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Width, IModVarNonNull_mod_Height, IModVarNonNull_mod_ShelfadjSidepanelDrillDescriptor, IModVarNonNull_mod_ShelfadjBackwallDrillDescriptor, IModVarNonNull_mod_ShelfadjBackwallProcessingId, IModVarNonNull_mod_ShelfadjSidepanelProcessingBackId, IModVarNonNull_mod_ShelfadjSidepanelProcessingFrontId, IModVarNonNull_mod_ShelfadjSidepanelProcessingMiddleId, IModVarNonNull_mod_ShelfadjVertDividerProcessingId, IModVarNonNull_mod_ShelfadjVertdividerDrillDescriptor, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_VertDividerPosition {
...
export interface dc_mc_ShelfadjDrill01 extends IModBaseProp
, IModVar_mod_ModuleName, IModVar_mod_Rotation, IModVar_mod_ShelfadjDrillDistance, IModVar_mod_Depth, IModVar_mod_Width, IModVar_mod_Height, IModVar_mod_ShelfadjSidepanelDrillDescriptor, IModVar_mod_ShelfadjBackwallDrillDescriptor, IModVar_mod_ShelfadjBackwallProcessingId, IModVar_mod_ShelfadjSidepanelProcessingBackId, IModVar_mod_ShelfadjSidepanelProcessingFrontId, IModVar_mod_ShelfadjSidepanelProcessingMiddleId, IModVar_mod_ShelfadjVertDividerProcessingId, IModVar_mod_ShelfadjVertdividerDrillDescriptor, IModVar_mod_VertDividerType, IModVar_mod_VertDividerPosition {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_ShelfadjDrill01;
  parent: IModParents_mc_ShelfadjGroup01;
}

export interface adc_mc_ShelfadjDrill01 extends IModBaseProp
, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_Rotation, IModVarNonNull_mod_ShelfadjDrillDistance, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Width, IModVarNonNull_mod_Height, IModVarNonNull_mod_ShelfadjSidepanelDrillDescriptor, IModVarNonNull_mod_ShelfadjBackwallDrillDescriptor, IModVarNonNull_mod_ShelfadjBackwallProcessingId, IModVarNonNull_mod_ShelfadjSidepanelProcessingBackId, IModVarNonNull_mod_ShelfadjSidepanelProcessingFrontId, IModVarNonNull_mod_ShelfadjSidepanelProcessingMiddleId, IModVarNonNull_mod_ShelfadjVertDividerProcessingId, IModVarNonNull_mod_ShelfadjVertdividerDrillDescriptor, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_VertDividerPosition {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
}

export class OD_M_mc_ShelfadjDrill01 extends OD_Base  implements dc_mc_ShelfadjDrill01
,IModParents_mc_ShelfadjDrill01
,IModVar_mod_ModuleName,IModVar_mod_Rotation,IModVar_mod_ShelfadjDrillDistance,IModVar_mod_Depth,IModVar_mod_Width,IModVar_mod_Height,IModVar_mod_ShelfadjSidepanelDrillDescriptor,IModVar_mod_ShelfadjBackwallDrillDescriptor,IModVar_mod_ShelfadjBackwallProcessingId,IModVar_mod_ShelfadjSidepanelProcessingBackId,IModVar_mod_ShelfadjSidepanelProcessingFrontId,IModVar_mod_ShelfadjSidepanelProcessingMiddleId,IModVar_mod_ShelfadjVertDividerProcessingId,IModVar_mod_ShelfadjVertdividerDrillDescriptor,IModVar_mod_VertDividerType,IModVar_mod_VertDividerPosition
 {
  constructor(parent: IModParents_mc_ShelfadjGroup01, manufacturerMode?:boolean) {
    super('mc_ShelfadjDrill01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_ShelfadjDrill01_NonNull(this);
  }
  parent: IModParents_mc_ShelfadjGroup01;
  _selfNonNull: OD_M_mc_ShelfadjDrill01_NonNull;

  override variants:string[] = ['mod_ModuleName','mod_Rotation','mod_ShelfadjDrillDistance','mod_Depth','mod_Width','mod_Height','mod_ShelfadjSidepanelDrillDescriptor','mod_ShelfadjBackwallDrillDescriptor','mod_ShelfadjBackwallProcessingId','mod_ShelfadjSidepanelProcessingBackId','mod_ShelfadjSidepanelProcessingFrontId','mod_ShelfadjSidepanelProcessingMiddleId','mod_ShelfadjVertDividerProcessingId','mod_ShelfadjVertdividerDrillDescriptor','mod_VertDividerType','mod_VertDividerPosition',];
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_ShelfadjDrill01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_ShelfadjDrill01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_ShelfadjDrill01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_ShelfadjDrill01{
    ...
    const adc = new OD_M_mc_ShelfadjDrill01_NonNull(this);
    return adc;
  }
  ...
  addpart_ShelfadjDrill(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_ShelfadjDrill_PartVarsWritable {
    var c = new P_part_ShelfadjDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_ShelfadjDrill01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_ShelfadjDrill01_NonNull implements cbp_mc_ShelfadjDrill01, adc_mc_ShelfadjDrill01 ,IPartParentsNonNull_mc_ShelfadjDrill01 {
  constructor(parent: OD_M_mc_ShelfadjDrill01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_ShelfadjDrill01;
  ...
  #createBuildPlanInternal = mc_ShelfadjDrill01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_ShelfadjDrill01_afterDataCompletion;
  ...
  parent: IModParents_mc_ShelfadjGroup01;
  addpart_ShelfadjDrill(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_ShelfadjDrill_PartVarsWritable {
    return this.#internalParent.addpart_ShelfadjDrill(x, y, z, dimx, dimy, dimz);
  }
