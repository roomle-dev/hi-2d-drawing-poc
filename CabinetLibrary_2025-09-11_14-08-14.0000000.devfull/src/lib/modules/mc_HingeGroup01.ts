...
//#region Imports
import { cbp_mc_HingeGroup01, dc_mc_HingeGroup01, adc_mc_HingeGroup01 } from '../internal/modules/mc_HingeGroup01'
...
export function mc_HingeGroup01_createBuildPlan(this: cbp_mc_HingeGroup01):void {
  internal_enterModuleCreateBuildPlan('mc_HingeGroup01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_HingeGroup01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_HingeGroup01_afterDataCompletion(this: adc_mc_HingeGroup01):void {
  internal_enterModuleAfterDataCompletion('mc_HingeGroup01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_HingeGroup01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_HingeGroup01_manufacturerDataCompletion(this: dc_mc_HingeGroup01):void {
  internal_enterModuleManufacturerDataCompletion('mc_HingeGroup01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_HingeGroup01_MANUFACTURERDATACOMPLETION
