...
export interface IP_part_FixedfrontPanelWoodFrame_PartVarsReadOnly extends IPartBase {
...
export interface IP_part_FixedfrontPanelWoodFrame_PartVarsWritable extends IP_part_FixedfrontPanelWoodFrame_PartVarsReadOnly {
...
export class P_part_FixedfrontPanelWoodFrame extends PartBase implements IP_part_FixedfrontPanelWoodFrame_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_PanelWoodFrame01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_FixedfrontPanelWoodFrame', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  ...
  setAttributes() {
    ...
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // part_FixedfrontPanelWoodFrame_ValueScript
  ...
  checkAttributes() {
    ...
    if (this.#pa_AdditionalInfo1 === undefined) {
      logError('Attribute pa_AdditionalInfo1 not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_BomId === undefined) {
      logError('Attribute pa_BomId not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_BtmColor === undefined) {
      logError('Attribute pa_BtmColor not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackColor === undefined) {
      logError('Attribute pa_EdgeBackColor not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackType === undefined) {
      logError('Attribute pa_EdgeBackType not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightType === undefined) {
      logError('Attribute pa_EdgeRightType not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftType === undefined) {
      logError('Attribute pa_EdgeLeftType not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontType === undefined) {
      logError('Attribute pa_EdgeFrontType not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeJointType === undefined) {
      logError('Attribute pa_EdgeJointType not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      logError('Attribute pa_EdgeFrontColor not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftColor === undefined) {
      logError('Attribute pa_EdgeLeftColor not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightColor === undefined) {
      logError('Attribute pa_EdgeRightColor not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrameFillingMaterial === undefined) {
      logError('Attribute pa_FrameFillingMaterial not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrameFillingThk === undefined) {
      logError('Attribute pa_FrameFillingThk not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FramePartsWidthHor === undefined) {
      logError('Attribute pa_FramePartsWidthHor not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FramePartsWidthVert === undefined) {
      logError('Attribute pa_FramePartsWidthVert not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_GrainDirection === undefined) {
      logError('Attribute pa_GrainDirection not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_PanelWoodFrameType === undefined) {
      logError('Attribute pa_PanelWoodFrameType not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_Program === undefined) {
      logError('Attribute pa_Program not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_TopColor === undefined) {
      logError('Attribute pa_TopColor not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_Weight === undefined) {
      logError('Attribute pa_Weight not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrameFillingWoodColor === undefined) {
      logError('Attribute pa_FrameFillingWoodColor not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
    if (this.#pa_FrontGlassColor === undefined) {
      logError('Attribute pa_FrontGlassColor not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
  ...
  createBomElements() {
    ...
    const partSelf = this;
      ...
      if (partSelf._g?.basic_CreateBom == 'Library') { // ####################### CUSTOM SCRIPTS ########################
        ...
        const _bom = new class BOM209 extends BOM_ElementType_bomout_Group {
          constructor() { super(partSelf); }
          set(partSelf: IP_part_FixedfrontPanelWoodFrame_PartVarsReadOnly) {
            const part = partSelf;
  ...
  override createBomTouchElementsEnd() : void { 
      try {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          ...
          const _bom = new class BOMT538 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_FixedfrontPanelWoodFrame_PartVarsReadOnly) {
