...
export interface cti_tab_CarcaseShelfbtmSettings {
  readonly in_ModuleName? : string;
  readonly in_ShelfbtmConstruction? : string;
  readonly in_AdditionalInfo01? : string;
}

export interface ctm_tab_CarcaseShelfbtmSettings {
}

export interface cto_tab_CarcaseShelfbtmSettings extends ctm_tab_CarcaseShelfbtmSettings {
  readonly _id : number;
...
export interface ICT_tab_CarcaseShelfbtmSettings
extends cti_tab_CarcaseShelfbtmSettings, cto_tab_CarcaseShelfbtmSettings {}

export class ct2_tab_CarcaseShelfbtmSettings {

public findExactly(
     in_ModuleName: string|undefined,
     in_ShelfbtmConstruction: string|undefined,
     in_AdditionalInfo01: string|undefined,
): cto_tab_CarcaseShelfbtmSettings | undefined {
  const res = ct_tab_CarcaseShelfbtmSettings.find((p) => 
p.in_ModuleName === in_ModuleName
 && p.in_ShelfbtmConstruction === in_ShelfbtmConstruction
...
public find(
predicate: (value: cti_tab_CarcaseShelfbtmSettings) => boolean
): cto_tab_CarcaseShelfbtmSettings | undefined {
  for (let index = 0; index < ct_tab_CarcaseShelfbtmSettings.length; index++){
    const element = ct_tab_CarcaseShelfbtmSettings[index];
...
export var ct_tab_CarcaseShelfbtmSettings :ICT_tab_CarcaseShelfbtmSettings[] = [
{
 _id: 5,
 in_ModuleName: "mc_Storageunit01",
 in_ShelfbtmConstruction: "ShelfBtm",
 in_AdditionalInfo01: "All",
 LibrarySolution: true,
 UsedModule: "mc_StorageunitShelfbtm01",
 ConstructionTablePartName: "part_Shelfbtm",
 InsertModule: true
}
,{
 _id: 6,
 in_ModuleName: "mc_Storageunit01",
 in_ShelfbtmConstruction: "ShelfBtmHandleRail",
 in_AdditionalInfo01: "All",
 LibrarySolution: true,
 UsedModule: "mc_StorageunitShelfbtm01",
 ConstructionTablePartName: "part_Shelfbtm",
...
,{
 _id: 7,
 in_ModuleName: "mc_Storageunit01",
 in_ShelfbtmConstruction: "ShelfBtmAddLightBoard",
 in_AdditionalInfo01: "All",
 LibrarySolution: true,
 UsedModule: "mc_StorageunitShelfbtm01",
 ConstructionTablePartName: "part_Shelfbtm",
...
,{
 _id: 8,
 in_ModuleName: "mc_Storageunit01",
 in_ShelfbtmConstruction: "NoShelfBtm",
 in_AdditionalInfo01: "All",
 LibrarySolution: true,
 UsedModule: "mc_StorageunitShelfbtm01",
 ConstructionTablePartName: "part_Shelfbtm",
