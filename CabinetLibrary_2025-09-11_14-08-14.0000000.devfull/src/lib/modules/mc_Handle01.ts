...
//#region Imports
import { cbp_mc_Handle01, dc_mc_Handle01, adc_mc_Handle01 } from '../internal/modules/mc_Handle01'
...
export function mc_Handle01_createBuildPlan(this: cbp_mc_Handle01):void {
  internal_enterModuleCreateBuildPlan('mc_Handle01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Handle01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_Handle01_afterDataCompletion(this: adc_mc_Handle01):void {
  internal_enterModuleAfterDataCompletion('mc_Handle01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Handle01_AFTERDATACOMPLETION
  // Schuler Consulting
  // Create: Feb 2025
  // By Ludwig Weber
...
// ---------------------------------------------------------------
export function mc_Handle01_manufacturerDataCompletion(this: dc_mc_Handle01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Handle01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Handle01_MANUFACTURERDATACOMPLETION
