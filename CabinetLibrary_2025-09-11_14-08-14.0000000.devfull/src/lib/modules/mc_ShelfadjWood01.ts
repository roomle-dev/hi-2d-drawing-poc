...
//#region Imports
import { cbp_mc_ShelfadjWood01, dc_mc_ShelfadjWood01, adc_mc_ShelfadjWood01 } from '../internal/modules/mc_ShelfadjWood01'
...
export function mc_ShelfadjWood01_createBuildPlan(this: cbp_mc_ShelfadjWood01):void {
  internal_enterModuleCreateBuildPlan('mc_ShelfadjWood01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_ShelfadjWood01_CREATEBUILDPLAN
  ...
  let Elem = this.addpart_ShelfadjWood(0, 0, 0, this.mod_Width, this.mod_ShelfadjThk, this.mod_Depth);
...
// ---------------------------------------------------------------
export function mc_ShelfadjWood01_afterDataCompletion(this: adc_mc_ShelfadjWood01):void {
  internal_enterModuleAfterDataCompletion('mc_ShelfadjWood01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_ShelfadjWood01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_ShelfadjWood01_manufacturerDataCompletion(this: dc_mc_ShelfadjWood01):void {
  internal_enterModuleManufacturerDataCompletion('mc_ShelfadjWood01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_ShelfadjWood01_MANUFACTURERDATACOMPLETION
