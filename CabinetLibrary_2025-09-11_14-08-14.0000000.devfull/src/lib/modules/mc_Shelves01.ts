...
//#region Imports
import { cbp_mc_Shelves01, dc_mc_Shelves01, adc_mc_Shelves01 } from '../internal/modules/mc_Shelves01'
...
export function mc_Shelves01_createBuildPlan(this: cbp_mc_Shelves01):void {
  internal_enterModuleCreateBuildPlan('mc_Shelves01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Shelves01_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: May 2025
  // By Stefano Cortese
  ...
  let Shelfpart = this.addpart_Shelves(0, 0, 0, this.mod_Width, this.mod_ShelvesThk, this.mod_Depth);
...
// ---------------------------------------------------------------
export function mc_Shelves01_afterDataCompletion(this: adc_mc_Shelves01):void {
  internal_enterModuleAfterDataCompletion('mc_Shelves01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Shelves01_AFTERDATACOMPLETION
logInfo("Part");
// ###############################################################
// ################### END CUSTOM SCRIPTS ########################
// ###############################################################
...
// ---------------------------------------------------------------
export function mc_Shelves01_manufacturerDataCompletion(this: dc_mc_Shelves01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Shelves01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Shelves01_MANUFACTURERDATACOMPLETION
