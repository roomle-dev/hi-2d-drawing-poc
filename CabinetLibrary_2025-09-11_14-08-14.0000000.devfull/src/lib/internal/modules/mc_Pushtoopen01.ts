...
import { IP_part_Pushtoopen_PartVarsWritable, P_part_Pushtoopen } from '../parts/part_Pushtoopen'
import { IP_part_PushtoopenDrill_PartVarsWritable, P_part_PushtoopenDrill } from '../parts/part_PushtoopenDrill'
import { IP_part_PushtoopenBom_PartVarsWritable, P_part_PushtoopenBom } from '../parts/part_PushtoopenBom'
import { IP_part_PushtoopenMountingPlateDrill_PartVarsWritable, P_part_PushtoopenMountingPlateDrill } from '../parts/part_PushtoopenMountingPlateDrill'
import { IModuleNonNull_mc_Pushtoopen01,IModParents_mc_Pushtoopen01,IPartParentsNonNull_mc_Pushtoopen01} from '../mod-interfaces'
import {IModVar_mod_PushtoopenInfo,IModVarNonNull_mod_PushtoopenInfo,IModVar_mod_FrontGapCarcase,IModVarNonNull_mod_FrontGapCarcase,IModVar_mod_CarcasePartInfo,IModVarNonNull_mod_CarcasePartInfo,IModVar_mod_FrontPosStart,IModVarNonNull_mod_FrontPosStart,IModVar_mod_PushtoopenLine,IModVarNonNull_mod_PushtoopenLine,IModVar_mod_Originpos,IModVarNonNull_mod_Originpos,IModVar_mod_FrontGapVert,IModVarNonNull_mod_FrontGapVert} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_FrontGapCarcase, IMatrix_mod_FrontPosStart, IMatrix_mod_PushtoopenLine, IMatrix_mod_FrontGapVert} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_Pushtoopen, IPartAdd_part_PushtoopenDrill, IPartAdd_part_PushtoopenBom, IPartAdd_part_PushtoopenMountingPlateDrill } from '../part-add-interfaces';
import { mc_Pushtoopen01_createBuildPlan, mc_Pushtoopen01_afterDataCompletion, mc_Pushtoopen01_manufacturerDataCompletion } from '../../modules/mc_Pushtoopen01';

export interface cbp_mc_Pushtoopen01 extends IModBaseProp
, IPartAdd_part_Pushtoopen, IPartAdd_part_PushtoopenDrill, IPartAdd_part_PushtoopenBom, IPartAdd_part_PushtoopenMountingPlateDrill, IModVarNonNull_mod_PushtoopenInfo, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_CarcasePartInfo, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_PushtoopenLine, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_FrontGapVert {
...
export interface dc_mc_Pushtoopen01 extends IModBaseProp
, IModVar_mod_PushtoopenInfo, IModVar_mod_FrontGapCarcase, IModVar_mod_CarcasePartInfo, IModVar_mod_FrontPosStart, IModVar_mod_PushtoopenLine, IModVar_mod_Originpos, IModVar_mod_FrontGapVert {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Pushtoopen01;
  parent: IModParents_mc_Door01_mc_Fliplift01;
}

export interface adc_mc_Pushtoopen01 extends IModBaseProp
...
export class OD_M_mc_Pushtoopen01 extends OD_Base  implements dc_mc_Pushtoopen01
,IModParents_mc_Pushtoopen01
,IModVar_mod_PushtoopenInfo,IModVar_mod_FrontGapCarcase,IModVar_mod_CarcasePartInfo,IModVar_mod_FrontPosStart,IModVar_mod_PushtoopenLine,IModVar_mod_Originpos,IModVar_mod_FrontGapVert
 {
  constructor(parent: IModParents_mc_Door01_mc_Fliplift01, manufacturerMode?:boolean) {
    super('mc_Pushtoopen01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Pushtoopen01_NonNull(this);
  }
  parent: IModParents_mc_Door01_mc_Fliplift01;
  _selfNonNull: OD_M_mc_Pushtoopen01_NonNull;

  override variants:string[] = ['mod_PushtoopenInfo','mod_FrontGapCarcase','mod_CarcasePartInfo','mod_FrontPosStart','mod_PushtoopenLine','mod_Originpos','mod_FrontGapVert',];
  #mod_PushtoopenInfo: string[] = [];
  get mod_PushtoopenInfo(): string[] { return this.#mod_PushtoopenInfo;}
  ...
  res.set('mod_PushtoopenInfo', JSON.stringify(this.mod_PushtoopenInfo));
  ...
  #manufacturerDataCompletionInternal = mc_Pushtoopen01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Pushtoopen01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Pushtoopen01{
    ...
    const adc = new OD_M_mc_Pushtoopen01_NonNull(this);
    return adc;
  }
  ...
  addpart_Pushtoopen(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Pushtoopen_PartVarsWritable {
    var c = new P_part_Pushtoopen(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_PushtoopenDrill(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PushtoopenDrill_PartVarsWritable {
    var c = new P_part_PushtoopenDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_PushtoopenBom(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PushtoopenBom_PartVarsWritable {
    var c = new P_part_PushtoopenBom(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }
  addpart_PushtoopenMountingPlateDrill(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PushtoopenMountingPlateDrill_PartVarsWritable {
    var c = new P_part_PushtoopenMountingPlateDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz);
    this.p.push(c);
    return c;
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Pushtoopen01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Pushtoopen01_NonNull implements cbp_mc_Pushtoopen01, adc_mc_Pushtoopen01 ,IPartParentsNonNull_mc_Pushtoopen01 {
  constructor(parent: OD_M_mc_Pushtoopen01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Pushtoopen01;
  ...
  #createBuildPlanInternal = mc_Pushtoopen01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Pushtoopen01_afterDataCompletion;
  ...
  parent: IModParents_mc_Door01_mc_Fliplift01;
  addpart_Pushtoopen(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_Pushtoopen_PartVarsWritable {
    return this.#internalParent.addpart_Pushtoopen(x, y, z, dimx, dimy, dimz);
  }
  addpart_PushtoopenDrill(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PushtoopenDrill_PartVarsWritable {
    return this.#internalParent.addpart_PushtoopenDrill(x, y, z, dimx, dimy, dimz);
  }
  addpart_PushtoopenBom(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PushtoopenBom_PartVarsWritable {
    return this.#internalParent.addpart_PushtoopenBom(x, y, z, dimx, dimy, dimz);
  }
  addpart_PushtoopenMountingPlateDrill(x:number, y:number, z:number, dimx:number, dimy:number, dimz:number): IP_part_PushtoopenMountingPlateDrill_PartVarsWritable {
    return this.#internalParent.addpart_PushtoopenMountingPlateDrill(x, y, z, dimx, dimy, dimz);
  }
  get mod_PushtoopenInfo(): string [] {
    return this.#internalParent.mod_PushtoopenInfo!;
  }
