...
import { OD_M_mc_Bracket01, dc_mc_Bracket01 } from './mc_Bracket01'
import { IModuleNonNull_mr_Shelves,IModParents_mr_Shelves,IPartParentsNonNull_mr_Shelves} from '../mod-interfaces'
import {IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_Width,IModVarNonNull_mod_Width,IModVar_mod_ShelvesThk,IModVarNonNull_mod_ShelvesThk,IModVar_mod_ShelvesColor,IModVarNonNull_mod_ShelvesColor,IModVar_mod_ShelvesBrackets,IModVarNonNull_mod_ShelvesBrackets,IModVar_mod_ShelvesBracketsColor,IModVarNonNull_mod_ShelvesBracketsColor} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_ModuleName, IMatrix_mod_Depth, IMatrix_mod_Width, IMatrix_mod_ShelvesThk, IMatrix_mod_ShelvesColor, IMatrix_mod_ShelvesBrackets, IMatrix_mod_ShelvesBracketsColor} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'
import { IGlobalVarsParent } from '../global-vars-parent'

import { mr_Shelves_createBuildPlan, mr_Shelves_afterDataCompletion, mr_Shelves_manufacturerDataCompletion } from '../../modules/mr_Shelves';
...
export interface dc_mr_Shelves extends IModBaseProp
...
export interface adc_mr_Shelves extends IModBaseProp
, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Width, IModVarNonNull_mod_ShelvesThk, IModVarNonNull_mod_ShelvesColor, IModVarNonNull_mod_ShelvesBrackets, IModVarNonNull_mod_ShelvesBracketsColor {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  addOD_M_mc_Shelves01(index?: number): dc_mc_Shelves01;
...
,IModVar_mod_ModuleName,IModVar_mod_Depth,IModVar_mod_Width,IModVar_mod_ShelvesThk,IModVar_mod_ShelvesColor,IModVar_mod_ShelvesBrackets,IModVar_mod_ShelvesBracketsColor
 {
  constructor(parent?: OD_Base, manufacturerMode?:boolean) {
    super('mr_Shelves', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this._g = new GlobalVars();
    this._openGroups = new Map<string, OpenGroup>();
    this._partGroups = new Map<string, PartGroup>();
    this._selfNonNull = new OD_M_mr_Shelves_NonNull(this);
  }
  _selfNonNull: OD_M_mr_Shelves_NonNull;
  ...
  override variants:string[] = ['mod_ModuleName','mod_Depth','mod_Width','mod_ShelvesThk','mod_ShelvesColor','mod_ShelvesBrackets','mod_ShelvesBracketsColor',];
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mr_Shelves";
    }
  ...
  #manufacturerDataCompletionInternal = mr_Shelves_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mr_Shelves_NonNull(this);
  ...
  addOD_M_mc_Shelves01(index?: number): dc_mc_Shelves01 {
    var m = new OD_M_mc_Shelves01(this);
    m.dataCompletion();
  ...
  addOD_M_mc_Bracket01(index?: number): dc_mc_Bracket01 {
    var m = new OD_M_mc_Bracket01(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  override createBuildPlan():void {
    var cbp = new OD_M_mr_Shelves_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mr_Shelves_NonNull implements cbp_mr_Shelves, adc_mr_Shelves ,IPartParentsNonNull_mr_Shelves {
  constructor(parent: OD_M_mr_Shelves) {
    this.#internalParent = parent;
  }
  #internalParent: OD_M_mr_Shelves;
  ...
  #createBuildPlanInternal = mr_Shelves_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mr_Shelves_afterDataCompletion;
...
addInsertLevelHeight(height:number, isDefault: boolean|undefined = undefined) : IInsertLevelInfo  { return this.#internalParent.addInsertLevelHeight(height, isDefault); }
  ...
  addOD_M_mc_Shelves01(index?: number): dc_mc_Shelves01 {
    return this.#internalParent.addOD_M_mc_Shelves01(index);
  }
  addOD_M_mc_Bracket01(index?: number): dc_mc_Bracket01 {
    return this.#internalParent.addOD_M_mc_Bracket01(index);
  }
}
