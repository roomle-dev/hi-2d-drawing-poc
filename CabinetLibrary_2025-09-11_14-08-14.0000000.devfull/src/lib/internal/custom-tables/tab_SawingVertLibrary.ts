...
export interface cti_tab_SawingVertLibrary {
  readonly in_ProcessingId? : string;
  readonly in_Part2Position? : string;
}

export interface ctm_tab_SawingVertLibrary {
  readonly matrix_KO? : string;
}

export interface cto_tab_SawingVertLibrary extends ctm_tab_SawingVertLibrary {
  readonly _id : number;
  readonly Side? : string;
  XA(partSelf: any, part2: any, posRel: any):number;
  YA(partSelf: any, part2: any, posRel: any):number;
  XE(partSelf: any, part2: any, posRel: any):number;
  YE(partSelf: any, part2: any, posRel: any):number;
  TI(partSelf: any, part2: any, posRel: any):number;
  NB(partSelf: any, part2: any, posRel: any):number;
  readonly EM? : string;
  readonly RK? : string;
}

export interface ICT_tab_SawingVertLibrary
extends cti_tab_SawingVertLibrary, cto_tab_SawingVertLibrary {}

export class ct2_tab_SawingVertLibrary {

public findExactly(
     in_ProcessingId: string|undefined,
     in_Part2Position: string|undefined,
): cto_tab_SawingVertLibrary | undefined {
  const res = ct_tab_SawingVertLibrary.find((p) => 
p.in_ProcessingId === in_ProcessingId
 && p.in_Part2Position === in_Part2Position
);
return res;
}

public find(
predicate: (value: cti_tab_SawingVertLibrary) => boolean
): cto_tab_SawingVertLibrary | undefined {
  for (let index = 0; index < ct_tab_SawingVertLibrary.length; index++){
    const element = ct_tab_SawingVertLibrary[index];
...
export var ct_tab_SawingVertLibrary :ICT_tab_SawingVertLibrary[] = [
{
 _id: 98,
 in_ProcessingId: "BackwallGrooveSidepanelleft",
 in_Part2Position: "Right",
 Side: "Top",
  XA(partSelf: any, part2: any, posRel: any):number {
    return partSelf._dimy - posRel.y - part2._dimy - partSelf.g.basic_BackwallGrooveGapDepth;
  }
,
  YA(partSelf: any, part2: any, posRel: any):number {
    return partSelf._dimz - posRel.z - part2._dimz;
  }
,
  XE(partSelf: any, part2: any, posRel: any):number {
    return partSelf._dimy - posRel.y + partSelf.g.basic_BackwallGrooveGapDepth;
  }
,
  YE(partSelf: any, part2: any, posRel: any):number {
    return partSelf._dimz - posRel.z - part2._dimz;
...
,
  TI(partSelf: any, part2: any, posRel: any):number {
    return partSelf._dimx - posRel.x + partSelf.g.basic_BackwallGrooveGapDepth;
  }
,
  NB(partSelf: any, part2: any, posRel: any):number {
    return part2._dimz + partSelf.g.basic_BackwallGrooveGapThk;
  }
,
 EM: "MOD1",
 RK: "WRKL",
...
,{
 _id: 99,
 in_ProcessingId: "BackwallGrooveSidepanelright",
 in_Part2Position: "Left",
 Side: "Top",
  XA(partSelf: any, part2: any, posRel: any):number {
    return posRel.y - partSelf.g.basic_BackwallGrooveGapDepth;
  }
,
  YA(partSelf: any, part2: any, posRel: any):number {
    return partSelf._dimz - posRel.z - part2._dimz;
...
,
  XE(partSelf: any, part2: any, posRel: any):number {
    return posRel.y + part2._dimy + partSelf.g.basic_BackwallGrooveGapDepth;
  }
,
  YE(partSelf: any, part2: any, posRel: any):number {
    return partSelf._dimz - posRel.z - part2._dimz;
...
,
  TI(partSelf: any, part2: any, posRel: any):number {
    return part2._dimx + posRel.x + partSelf.g.basic_BackwallGrooveGapDepth;
  }
,
  NB(partSelf: any, part2: any, posRel: any):number {
    return part2._dimz + partSelf.g.basic_BackwallGrooveGapThk;
...
,{
 _id: 100,
 in_ProcessingId: "BackwallGrooveSidepanelmiddle",
 in_Part2Position: "Left",
 Side: "Top",
  XA(partSelf: any, part2: any, posRel: any):number {
    return posRel.y - partSelf.g.basic_BackwallGrooveGapDepth;
...
,{
 _id: 102,
 in_ProcessingId: "BackwallGrooveShelfbtm",
 in_Part2Position: "Top",
 Side: "Top",
  XA(partSelf: any, part2: any, posRel: any):number {
    return posRel.x - partSelf.g.basic_BackwallGrooveGapDepth;
  }
,
  YA(partSelf: any, part2: any, posRel: any):number {
    return partSelf._dimz - posRel.z - part2._dimz;
...
,
  XE(partSelf: any, part2: any, posRel: any):number {
    return posRel.x + part2._dimx + partSelf.g.basic_BackwallGrooveGapDepth;
  }
,
  YE(partSelf: any, part2: any, posRel: any):number {
    return partSelf._dimz - posRel.z - part2._dimz;
...
,{
 _id: 103,
 in_ProcessingId: "BackwallGrooveShelftop",
 in_Part2Position: "Btm",
 Side: "Top",
  XA(partSelf: any, part2: any, posRel: any):number {
    return posRel.x - partSelf.g.basic_BackwallGrooveGapDepth;
  }
...
,
  TI(partSelf: any, part2: any, posRel: any):number {
    return part2._dimy + posRel.y + partSelf.g.basic_BackwallGrooveGapDepth;
  }
,
  NB(partSelf: any, part2: any, posRel: any):number {
    return part2._dimz + partSelf.g.basic_BackwallGrooveGapThk;
...
,{
 _id: 104,
 in_ProcessingId: "BackwallGrooveShelffixed",
 in_Part2Position: "Btm",
 Side: "Top",
  XA(partSelf: any, part2: any, posRel: any):number {
    return posRel.x - partSelf.g.basic_BackwallGrooveGapDepth;
...
,{
 _id: 106,
 in_ProcessingId: "SlopedCeilingShapeSidepanelleft",
 in_Part2Position: "All",
 Side: "Top",
  XA(partSelf: any, part2: any, posRel: any):number {
    return 0;
  }
,
  YA(partSelf: any, part2: any, posRel: any):number {
    return partSelf.pa_TopDepth;
  }
,
  XE(partSelf: any, part2: any, posRel: any):number {
    return partSelf._dimy - partSelf.pa_BackHeight;
  }
,
  YE(partSelf: any, part2: any, posRel: any):number {
    return partSelf._dimz;
  }
,
  TI(partSelf: any, part2: any, posRel: any):number {
    return partSelf._dimx + 2;
  }
,
  NB(partSelf: any, part2: any, posRel: any):number {
    return 5;
...
,{
 _id: 107,
 in_ProcessingId: "SlopedCeilingShapeSidepanelright",
 in_Part2Position: "All",
 Side: "Top",
  XA(partSelf: any, part2: any, posRel: any):number {
    return partSelf.pa_BackHeight;
  }
,
  YA(partSelf: any, part2: any, posRel: any):number {
    return partSelf._dimz;
...
,{
 _id: 108,
 in_ProcessingId: "SlopedCeilingShapeSidepanelmiddle",
 in_Part2Position: "All",
 Side: "Top",
  XA(partSelf: any, part2: any, posRel: any):number {
    return partSelf.pa_BackHeight;
