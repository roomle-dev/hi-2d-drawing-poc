...
//#region Imports
import { cbp_mr_IslandBackwall, dc_mr_IslandBackwall, adc_mr_IslandBackwall } from '../internal/modules/mr_IslandBackwall'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_Panel01, OD_M_mc_Panel01 } from '../internal/modules/mc_Panel01'
...
export function mr_IslandBackwall_createBuildPlan(this: cbp_mr_IslandBackwall):void {
  internal_enterModuleCreateBuildPlan('mr_IslandBackwall', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mr_IslandBackwall_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mr_IslandBackwall_afterDataCompletion(this: adc_mr_IslandBackwall):void {
  internal_enterModuleAfterDataCompletion('mr_IslandBackwall', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mr_IslandBackwall_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mr_IslandBackwall_manufacturerDataCompletion(this: dc_mr_IslandBackwall):void {
  internal_enterModuleManufacturerDataCompletion('mr_IslandBackwall', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mr_IslandBackwall_MANUFACTURERDATACOMPLETION
