...
//#region Imports
import { cbp_mc_StorageunitSidepanel01, dc_mc_StorageunitSidepanel01, adc_mc_StorageunitSidepanel01 } from '../internal/modules/mc_StorageunitSidepanel01'
...
export function mc_StorageunitSidepanel01_createBuildPlan(this: cbp_mc_StorageunitSidepanel01):void {
  internal_enterModuleCreateBuildPlan('mc_StorageunitSidepanel01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_StorageunitSidepanel01_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: Nov 2022
  // By Ludwig Weber
  ...
  try {
    if ((this.mod_ParentName ?? 'no parent name') === 'mr_CornerunitStraight') {
      if (this.mod_CarcaseDirection === this.mod_SidepanelType) {
...
// ---------------------------------------------------------------
export function mc_StorageunitSidepanel01_afterDataCompletion(this: adc_mc_StorageunitSidepanel01):void {
  internal_enterModuleAfterDataCompletion('mc_StorageunitSidepanel01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitSidepanel01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_StorageunitSidepanel01_manufacturerDataCompletion(this: dc_mc_StorageunitSidepanel01):void {
  internal_enterModuleManufacturerDataCompletion('mc_StorageunitSidepanel01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitSidepanel01_MANUFACTURERDATACOMPLETION
