...
import { IModParents_mf_Fridge } from '../mod-interfaces'
import { OD_M_mc_ApplianceGraphic, dc_mc_ApplianceGraphic } from './mc_ApplianceGraphic'
import { IModuleNonNull_mc_Fridge01,IModParents_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood,IPartParentsNonNull_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood} from '../mod-interfaces'
import {IModVar_mod_CarcaseDepth,IModVarNonNull_mod_CarcaseDepth,IModVar_mod_CarcaseWidth,IModVarNonNull_mod_CarcaseWidth,IModVar_mod_CarcaseHeight,IModVarNonNull_mod_CarcaseHeight,IModVar_mod_Originpos,IModVarNonNull_mod_Originpos,IModVar_mod_FridgeGraphicId,IModVarNonNull_mod_FridgeGraphicId} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_CarcaseDepth, IMatrix_mod_CarcaseWidth, IMatrix_mod_CarcaseHeight, IMatrix_mod_FridgeGraphicId} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { mc_Fridge01_createBuildPlan, mc_Fridge01_afterDataCompletion, mc_Fridge01_manufacturerDataCompletion } from '../../modules/mc_Fridge01';

export interface cbp_mc_Fridge01 extends IModBaseProp
...
export interface dc_mc_Fridge01 extends IModBaseProp
, IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseWidth, IModVar_mod_CarcaseHeight, IModVar_mod_Originpos, IModVar_mod_FridgeGraphicId {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_Fridge01;
  parent: IModParents_mf_Fridge;
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
}

export interface adc_mc_Fridge01 extends IModBaseProp
, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_FridgeGraphicId {
  get m(): OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
...
export class OD_M_mc_Fridge01 extends OD_Base  implements dc_mc_Fridge01
,IModParents_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood
,IModVar_mod_CarcaseDepth,IModVar_mod_CarcaseWidth,IModVar_mod_CarcaseHeight,IModVar_mod_Originpos,IModVar_mod_FridgeGraphicId
 {
  constructor(parent: IModParents_mf_Fridge, manufacturerMode?:boolean) {
    super('mc_Fridge01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Fridge01_NonNull(this);
  }
  parent: IModParents_mf_Fridge;
  _selfNonNull: OD_M_mc_Fridge01_NonNull;

  override variants:string[] = ['mod_CarcaseDepth','mod_CarcaseWidth','mod_CarcaseHeight','mod_Originpos','mod_FridgeGraphicId',];
  ...
  #mod_FridgeGraphicId?: string;
  get mod_FridgeGraphicId(): string | undefined { return this.#mod_FridgeGraphicId}
  set mod_FridgeGraphicId(value: string | undefined) {
    if(this._adcFinished){
      logError("The property 'mod_FridgeGraphicId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if(this.#mod_FridgeGraphicId === value) return;
    this.#mod_FridgeGraphicId = value;
  }

  mod_FridgeGraphicId_matrix?: IMatrix_mod_FridgeGraphicId;
  ...
  res.set('mod_FridgeGraphicId', this.mod_FridgeGraphicId);
    return res;
  }
  override loadJson(json:any, withSubModules:boolean = true, manufacturerMode:boolean) {
    ...
    { internal_enterValidateVariant(this.modId, this._id, 'mod_FridgeGraphicId');
    const val = _toString(json['attributes']['mod_FridgeGraphicId'], 'mod_FridgeGraphicId');
    internal_leaveValidateVariant();
    this.mod_FridgeGraphicId = val; }
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_FridgeGraphicId === undefined) {
      this.mod_FridgeGraphicId = "None";
    }
  ...
  #manufacturerDataCompletionInternal = mc_Fridge01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Fridge01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_Fridge01{
    ...
    const adc = new OD_M_mc_Fridge01_NonNull(this);
    return adc;
  }
  ...
  override validateSelections():void {
    ...
    this.mod_FridgeGraphicId_matrix = VariantValidation.mod_FridgeGraphicId(this, this);
  }

  override createBuildPlan():void {
    var cbp = new OD_M_mc_Fridge01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Fridge01_NonNull implements cbp_mc_Fridge01, adc_mc_Fridge01 ,IPartParentsNonNull_mc_Dishwasher_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_mf_Sink_mr_Hood {
  constructor(parent: OD_M_mc_Fridge01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Fridge01;
  ...
  #createBuildPlanInternal = mc_Fridge01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Fridge01_afterDataCompletion;
  ...
  get mod_FridgeGraphicId(): string  {
    return this.#internalParent.mod_FridgeGraphicId!;
  }
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic {
