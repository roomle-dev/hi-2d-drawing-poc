...
//#region Imports
import { cbp_mc_Cornerunit01, dc_mc_Cornerunit01, adc_mc_Cornerunit01 } from '../internal/modules/mc_Cornerunit01'
...
export function mc_Cornerunit01_createBuildPlan(this: cbp_mc_Cornerunit01):void {
  internal_enterModuleCreateBuildPlan('mc_Cornerunit01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_Cornerunit01_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: May 2025
  // By Joao Lisboa
...
// ---------------------------------------------------------------
export function mc_Cornerunit01_afterDataCompletion(this: adc_mc_Cornerunit01):void {
  internal_enterModuleAfterDataCompletion('mc_Cornerunit01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Cornerunit01_AFTERDATACOMPLETION
  // Schuler Consulting
	// Create: May 2025
	// By Joao Lisboa
	// Purpose: CabinetLibrary
...
// ---------------------------------------------------------------
export function mc_Cornerunit01_manufacturerDataCompletion(this: dc_mc_Cornerunit01):void {
  internal_enterModuleManufacturerDataCompletion('mc_Cornerunit01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_Cornerunit01_MANUFACTURERDATACOMPLETION
