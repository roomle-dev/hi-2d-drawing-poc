...
export interface IP_part_CeilingFillerPanel_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_Paneltop01;
}

export interface IP_part_CeilingFillerPanel_PartVarsWritable extends IP_part_CeilingFillerPanel_PartVarsReadOnly {
}

export class P_part_CeilingFillerPanel extends PartBase implements IP_part_CeilingFillerPanel_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Paneltop01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_CeilingFillerPanel', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
