...
import { ITableParents_mc_Fliplift01 } from '../var-interfaces';

export interface cti_tab_FlipliftConstruction {
  readonly in_ConstructionId? : string;
}

export interface ctm_tab_FlipliftConstruction {
}

export interface cto_tab_FlipliftConstruction extends ctm_tab_FlipliftConstruction {
  readonly _id : number;
  readonly CarcasePosY : number;
  readonly CarcasePosZ : number;
  readonly CarcaseConnection? : string;
  readonly FrontPosX : number;
  readonly FrontPosY : number;
  readonly MechanismPosX : number;
  readonly MechanismPosY : number;
  readonly MechanismPosZ : number;
  readonly MechanismDimY : number;
}

export interface ICT_tab_FlipliftConstruction
extends cti_tab_FlipliftConstruction, cto_tab_FlipliftConstruction {}

export class ct2_tab_FlipliftConstruction {

public findExactly(
     in_ConstructionId: string|undefined,
): cto_tab_FlipliftConstruction | undefined {
  const res = ct_tab_FlipliftConstruction.find((p) => 
...
public find(
predicate: (value: cti_tab_FlipliftConstruction) => boolean
): cto_tab_FlipliftConstruction | undefined {
  for (let index = 0; index < ct_tab_FlipliftConstruction.length; index++){
    const element = ct_tab_FlipliftConstruction[index];
...
export var ct_tab_FlipliftConstruction :ICT_tab_FlipliftConstruction[] = [
{
 _id: 296,
 in_ConstructionId: "Aventos_HF_top",
 CarcasePosY: 116,
 CarcasePosZ: 101,
 CarcaseConnection: "Side",
 FrontPosX: 12.5,
 FrontPosY: 189,
 MechanismPosX: 0,
 MechanismPosY: 41,
...
,{
 _id: 297,
 in_ConstructionId: "Aventos_HK_top",
 CarcasePosY: 36,
 CarcasePosZ: 39,
 CarcaseConnection: "Side",
 FrontPosX: 12.5,
...
,{
 _id: 298,
 in_ConstructionId: "Aventos_HS_top",
 CarcasePosY: 63,
 CarcasePosZ: 103,
 CarcaseConnection: "Side",
 FrontPosX: 12.5,
...
,{
 _id: 299,
 in_ConstructionId: "Aventos_HL_top_1",
 CarcasePosY: 63,
 CarcasePosZ: 103,
 CarcaseConnection: "Side",
 FrontPosX: 12.5,
...
,{
 _id: 300,
 in_ConstructionId: "Aventos_HL_top_2",
 CarcasePosY: 63,
 CarcasePosZ: 103,
 CarcaseConnection: "Side",
 FrontPosX: 12.5,
...
,{
 _id: 301,
 in_ConstructionId: "Aventos_HL_top_3",
 CarcasePosY: 63,
 CarcasePosZ: 103,
 CarcaseConnection: "Side",
 FrontPosX: 12.5,
...
,{
 _id: 302,
 in_ConstructionId: "Aventos_HL_top_4",
 CarcasePosY: 63,
 CarcasePosZ: 103,
 CarcaseConnection: "Side",
 FrontPosX: 12.5,
...
,{
 _id: 303,
 in_ConstructionId: "DropDownHinge",
 CarcasePosY: 0,
 CarcasePosZ: 50,
 CarcaseConnection: "Top",
 FrontPosX: 7.5,
 FrontPosY: 8,
 MechanismPosX: 0,
 MechanismPosY: 0,
...
,{
 _id: 304,
 in_ConstructionId: "Aventos_HK_XS",
 CarcasePosY: 137,
 CarcasePosZ: 39,
 CarcaseConnection: "Side",
 FrontPosX: 15.5,
