...
//#region Imports
import { cbp_mc_StorageunitShelfbtm01, dc_mc_StorageunitShelfbtm01, adc_mc_StorageunitShelfbtm01 } from '../internal/modules/mc_StorageunitShelfbtm01'
...
export function mc_StorageunitShelfbtm01_createBuildPlan(this: cbp_mc_StorageunitShelfbtm01):void {
  internal_enterModuleCreateBuildPlan('mc_StorageunitShelfbtm01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_StorageunitShelfbtm01_CREATEBUILDPLAN
  // Schuler Consulting
  // Create: Nov 2022
  // By Ludwig Weber
...
// ---------------------------------------------------------------
export function mc_StorageunitShelfbtm01_afterDataCompletion(this: adc_mc_StorageunitShelfbtm01):void {
  internal_enterModuleAfterDataCompletion('mc_StorageunitShelfbtm01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitShelfbtm01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_StorageunitShelfbtm01_manufacturerDataCompletion(this: dc_mc_StorageunitShelfbtm01):void {
  internal_enterModuleManufacturerDataCompletion('mc_StorageunitShelfbtm01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_StorageunitShelfbtm01_MANUFACTURERDATACOMPLETION
