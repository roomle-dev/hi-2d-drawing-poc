...
//#region Imports
import { cbp_mc_PlinthArea01, dc_mc_PlinthArea01, adc_mc_PlinthArea01 } from '../internal/modules/mc_PlinthArea01'
...
export function mc_PlinthArea01_createBuildPlan(this: cbp_mc_PlinthArea01):void {
  internal_enterModuleCreateBuildPlan('mc_PlinthArea01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_PlinthArea01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_PlinthArea01_afterDataCompletion(this: adc_mc_PlinthArea01):void {
  internal_enterModuleAfterDataCompletion('mc_PlinthArea01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_PlinthArea01_AFTERDATACOMPLETION
  // Schuler Consulting
  // Create: Dez 2023
  // By Ludwig Weber
...
// ---------------------------------------------------------------
export function mc_PlinthArea01_manufacturerDataCompletion(this: dc_mc_PlinthArea01):void {
  internal_enterModuleManufacturerDataCompletion('mc_PlinthArea01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_PlinthArea01_MANUFACTURERDATACOMPLETION
