...
//#region Imports
import { cbp_mc_ThermoformedPanel01, dc_mc_ThermoformedPanel01, adc_mc_ThermoformedPanel01 } from '../internal/modules/mc_ThermoformedPanel01'
...
export function mc_ThermoformedPanel01_createBuildPlan(this: cbp_mc_ThermoformedPanel01):void {
  internal_enterModuleCreateBuildPlan('mc_ThermoformedPanel01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_ThermoformedPanel01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_ThermoformedPanel01_afterDataCompletion(this: adc_mc_ThermoformedPanel01):void {
  internal_enterModuleAfterDataCompletion('mc_ThermoformedPanel01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_ThermoformedPanel01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_ThermoformedPanel01_manufacturerDataCompletion(this: dc_mc_ThermoformedPanel01):void {
  internal_enterModuleManufacturerDataCompletion('mc_ThermoformedPanel01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_ThermoformedPanel01_MANUFACTURERDATACOMPLETION
