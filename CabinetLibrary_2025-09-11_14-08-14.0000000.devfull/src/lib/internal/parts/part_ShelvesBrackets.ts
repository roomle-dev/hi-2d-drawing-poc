...
import { IPartParentsNonNull_mc_Bracket01 } from '../mod-interfaces'

export interface IP_part_ShelvesBrackets_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_Bracket01;
}

export interface IP_part_ShelvesBrackets_PartVarsWritable extends IP_part_ShelvesBrackets_PartVarsReadOnly {
}

export class P_part_ShelvesBrackets extends PartBase implements IP_part_ShelvesBrackets_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Bracket01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_ShelvesBrackets', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
  parent: IPartParentsNonNull_mc_Bracket01; // module which created this part
