...
//#region Imports
import { cbp_mr_Upright, dc_mr_Upright, adc_mr_Upright } from '../internal/modules/mr_Upright'
...
export function mr_Upright_createBuildPlan(this: cbp_mr_Upright):void {
  internal_enterModuleCreateBuildPlan('mr_Upright', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mr_Upright_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mr_Upright_afterDataCompletion(this: adc_mr_Upright):void {
  internal_enterModuleAfterDataCompletion('mr_Upright', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mr_Upright_AFTERDATACOMPLETION
  // Schuler Consulting
  ...
  if (this.mod_UprightConstruction === "ToFloor") {
    Upright.mod_Height = this.mod_UprightHeight + this.mod_PlinthAreaHeight;
    ElementHeight += this.mod_PlinthAreaHeight;
  }
  else {
    Upright.mod_Height = this.mod_UprightHeight
  }
  ...
  // Left Dockings
  this.addDockingInfo(Dock.LeftBottom, new Vector3(0, 0, 0), new Vector3(0, 0, this.mod_UprightDepth + this.mod_UprightOverhang));
  this.addDockingInfo(Dock.LeftTop, new Vector3(0, ElementHeight, 0), new Vector3(0, ElementHeight, this.mod_UprightDepth + this.mod_UprightOverhang));

  // Right Dockings
  this.addDockingInfo(Dock.RightBottom, new Vector3(this.mod_UprightThk, 0, 0), new Vector3(this.mod_UprightThk, 0, this.mod_UprightDepth + this.mod_UprightOverhang));
  this.addDockingInfo(Dock.RightTop, new Vector3(this.mod_UprightThk, ElementHeight, 0), new Vector3(this.mod_UprightThk, ElementHeight, this.mod_UprightDepth + this.mod_UprightOverhang));
...
// ---------------------------------------------------------------
export function mr_Upright_manufacturerDataCompletion(this: dc_mr_Upright):void {
  internal_enterModuleManufacturerDataCompletion('mr_Upright', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mr_Upright_MANUFACTURERDATACOMPLETION
