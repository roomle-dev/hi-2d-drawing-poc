...
import { IPartParentsNonNull_mc_ShelfadjGlass01 } from '../mod-interfaces'

export interface IP_part_ShelfadjGlass_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_ShelfadjGlass01;
...
export interface IP_part_ShelfadjGlass_PartVarsWritable extends IP_part_ShelfadjGlass_PartVarsReadOnly {
...
export class P_part_ShelfadjGlass extends PartBase implements IP_part_ShelfadjGlass_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_ShelfadjGlass01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_ShelfadjGlass', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XZY';
  }
  parent: IPartParentsNonNull_mc_ShelfadjGlass01; // module which created this part
  ...
  setAttributes() {
    ...
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // part_ShelfadjGlass_ValueScript
  ...
  checkAttributes() {
    ...
    if (this.#pa_BtmColor === undefined) {
      logError('Attribute pa_BtmColor not set in part part_ShelfadjGlass (id: ' + this._id + ')');
    }
    if (this.#pa_TopColor === undefined) {
      logError('Attribute pa_TopColor not set in part part_ShelfadjGlass (id: ' + this._id + ')');
    }
    if (this.#pa_ColorGrainGroup === undefined) {
      logError('Attribute pa_ColorGrainGroup not set in part part_ShelfadjGlass (id: ' + this._id + ')');
    }
    if (this.#pa_GrainLogic === undefined) {
      logError('Attribute pa_GrainLogic not set in part part_ShelfadjGlass (id: ' + this._id + ')');
    }
    if (this.#pa_Program === undefined) {
      logError('Attribute pa_Program not set in part part_ShelfadjGlass (id: ' + this._id + ')');
    }
    if (this.#pa_ProgramGrainGroup === undefined) {
      logError('Attribute pa_ProgramGrainGroup not set in part part_ShelfadjGlass (id: ' + this._id + ')');
    }
    if (this.#pa_AdditionalInfo1 === undefined) {
      logError('Attribute pa_AdditionalInfo1 not set in part part_ShelfadjGlass (id: ' + this._id + ')');
    }
    if (this.#pa_BomId === undefined) {
      logError('Attribute pa_BomId not set in part part_ShelfadjGlass (id: ' + this._id + ')');
    }
