...
import { IPartParentsNonNull_mc_ShelfadjFitting01 } from '../mod-interfaces'

export interface IP_part_HardwareShelfadjDrill_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_ShelfadjFitting01;
}

export interface IP_part_HardwareShelfadjDrill_PartVarsWritable extends IP_part_HardwareShelfadjDrill_PartVarsReadOnly {
}

export class P_part_HardwareShelfadjDrill extends PartBase implements IP_part_HardwareShelfadjDrill_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_ShelfadjFitting01, 
x:number, y:number, z:number, dimx:number, dimy:number, dimz:number) {
    super(parent, 'part_HardwareShelfadjDrill', x, y, z, dimx, dimy, dimz);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  parent: IPartParentsNonNull_mc_ShelfadjFitting01; // module which created this part
