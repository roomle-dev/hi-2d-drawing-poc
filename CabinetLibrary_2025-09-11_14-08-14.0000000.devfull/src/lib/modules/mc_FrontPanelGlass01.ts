...
//#region Imports
import { cbp_mc_FrontPanelGlass01, dc_mc_FrontPanelGlass01, adc_mc_FrontPanelGlass01 } from '../internal/modules/mc_FrontPanelGlass01'
...
export function mc_FrontPanelGlass01_createBuildPlan(this: cbp_mc_FrontPanelGlass01):void {
  internal_enterModuleCreateBuildPlan('mc_FrontPanelGlass01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
// CUSTOMSCRIPT_mc_FrontPanelGlass01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_FrontPanelGlass01_afterDataCompletion(this: adc_mc_FrontPanelGlass01):void {
  internal_enterModuleAfterDataCompletion('mc_FrontPanelGlass01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_FrontPanelGlass01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_FrontPanelGlass01_manufacturerDataCompletion(this: dc_mc_FrontPanelGlass01):void {
  internal_enterModuleManufacturerDataCompletion('mc_FrontPanelGlass01', this._id);
  try {
// ###############################################################
// ####################### CUSTOM SCRIPTS ########################
// ###############################################################
 // CUSTOMSCRIPT_mc_FrontPanelGlass01_MANUFACTURERDATACOMPLETION
