...
import { IModuleNonNull_mc_StorageunitShelffixed01,IModParents_mc_ShelffixedGroup01_mc_StorageunitShelffixed01,IPartParentsNonNull_mc_ShelffixedGroup01_mc_StorageunitShelffixed01} from '../mod-interfaces'
import {IModVar_mod_CarcaseId,IModVarNonNull_mod_CarcaseId,IModVar_mod_Depth,IModVarNonNull_mod_Depth,IModVar_mod_ShelffixedThk,IModVarNonNull_mod_ShelffixedThk,IModVar_mod_Width,IModVarNonNull_mod_Width,IModVar_mod_CarcaseColor,IModVarNonNull_mod_CarcaseColor,IModVar_mod_CarcaseEdgeColor,IModVarNonNull_mod_CarcaseEdgeColor,IModVar_mod_CarcaseEdgeFrontColor,IModVarNonNull_mod_CarcaseEdgeFrontColor,IModVar_mod_EdgeFrontType,IModVarNonNull_mod_EdgeFrontType,IModVar_mod_EdgeLeftType,IModVarNonNull_mod_EdgeLeftType,IModVar_mod_EdgeBackType,IModVarNonNull_mod_EdgeBackType,IModVar_mod_EdgeRightType,IModVarNonNull_mod_EdgeRightType,IModVar_mod_EdgeJointType,IModVarNonNull_mod_EdgeJointType,IModVar_mod_CarcaseProgram,IModVarNonNull_mod_CarcaseProgram,IModVar_mod_ModuleName,IModVarNonNull_mod_ModuleName,IModVar_mod_ShelvesBackwallFittingConnection,IModVarNonNull_mod_ShelvesBackwallFittingConnection,IModVar_mod_TypeElement,IModVarNonNull_mod_TypeElement,IModVar_mod_HardwareColor,IModVarNonNull_mod_HardwareColor,IModVar_mod_ParentName,IModVarNonNull_mod_ParentName,IModVar_mod_CarcasePartConnectionBackHor,IModVarNonNull_mod_CarcasePartConnectionBackHor,IModVar_mod_CarcasePartConnectionLeftHor,IModVarNonNull_mod_CarcasePartConnectionLeftHor,IModVar_mod_CarcasePartConnectionRightHor,IModVarNonNull_mod_CarcasePartConnectionRightHor,IModVar_mod_FittingConnectionLeftHor,IModVarNonNull_mod_FittingConnectionLeftHor,IModVar_mod_FittingConnectionRightHor,IModVarNonNull_mod_FittingConnectionRightHor,IModVar_mod_CarcasePartConnectionTopVert,IModVarNonNull_mod_CarcasePartConnectionTopVert,IModVar_mod_CarcasePartConnectionBtmVert,IModVarNonNull_mod_CarcasePartConnectionBtmVert,IModVar_mod_FittingConnectionBtmVert,IModVarNonNull_mod_FittingConnectionBtmVert,IModVar_mod_FittingConnectionTopVert,IModVarNonNull_mod_FittingConnectionTopVert,IModVar_mod_SlopeAngle,IModVarNonNull_mod_SlopeAngle,IModVar_mod_GrainLogic,IModVarNonNull_mod_GrainLogic} from '../var-interfaces'
import { VariantValidation, IMatrix_mod_CarcaseId, IMatrix_mod_Depth, IMatrix_mod_ShelffixedThk, IMatrix_mod_Width, IMatrix_mod_CarcaseColor, IMatrix_mod_CarcaseEdgeColor, IMatrix_mod_CarcaseEdgeFrontColor, IMatrix_mod_EdgeFrontType, IMatrix_mod_EdgeLeftType, IMatrix_mod_EdgeBackType, IMatrix_mod_EdgeRightType, IMatrix_mod_EdgeJointType, IMatrix_mod_CarcaseProgram, IMatrix_mod_ModuleName, IMatrix_mod_ShelvesBackwallFittingConnection, IMatrix_mod_TypeElement, IMatrix_mod_HardwareColor, IMatrix_mod_ParentName, IMatrix_mod_CarcasePartConnectionBackHor, IMatrix_mod_CarcasePartConnectionLeftHor, IMatrix_mod_CarcasePartConnectionRightHor, IMatrix_mod_FittingConnectionLeftHor, IMatrix_mod_FittingConnectionRightHor, IMatrix_mod_CarcasePartConnectionTopVert, IMatrix_mod_CarcasePartConnectionBtmVert, IMatrix_mod_FittingConnectionBtmVert, IMatrix_mod_FittingConnectionTopVert, IMatrix_mod_SlopeAngle, IMatrix_mod_GrainLogic} from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_Shelffixed } from '../part-add-interfaces';
import { mc_StorageunitShelffixed01_createBuildPlan, mc_StorageunitShelffixed01_afterDataCompletion, mc_StorageunitShelffixed01_manufacturerDataCompletion } from '../../modules/mc_StorageunitShelffixed01';

export interface cbp_mc_StorageunitShelffixed01 extends IModBaseProp
, IPartAdd_part_Shelffixed, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_Depth, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_Width, IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_EdgeFrontType, IModVarNonNull_mod_EdgeLeftType, IModVarNonNull_mod_EdgeBackType, IModVarNonNull_mod_EdgeRightType, IModVarNonNull_mod_EdgeJointType, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_ShelvesBackwallFittingConnection, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_CarcasePartConnectionBackHor, IModVarNonNull_mod_CarcasePartConnectionLeftHor, IModVarNonNull_mod_CarcasePartConnectionRightHor, IModVarNonNull_mod_FittingConnectionLeftHor, IModVarNonNull_mod_FittingConnectionRightHor, IModVarNonNull_mod_CarcasePartConnectionTopVert, IModVarNonNull_mod_CarcasePartConnectionBtmVert, IModVarNonNull_mod_FittingConnectionBtmVert, IModVarNonNull_mod_FittingConnectionTopVert, IModVarNonNull_mod_SlopeAngle, IModVarNonNull_mod_GrainLogic {
...
export interface dc_mc_StorageunitShelffixed01 extends IModBaseProp
, IModVar_mod_CarcaseId, IModVar_mod_Depth, IModVar_mod_ShelffixedThk, IModVar_mod_Width, IModVar_mod_CarcaseColor, IModVar_mod_CarcaseEdgeColor, IModVar_mod_CarcaseEdgeFrontColor, IModVar_mod_EdgeFrontType, IModVar_mod_EdgeLeftType, IModVar_mod_EdgeBackType, IModVar_mod_EdgeRightType, IModVar_mod_EdgeJointType, IModVar_mod_CarcaseProgram, IModVar_mod_ModuleName, IModVar_mod_ShelvesBackwallFittingConnection, IModVar_mod_TypeElement, IModVar_mod_HardwareColor, IModVar_mod_ParentName, IModVar_mod_CarcasePartConnectionBackHor, IModVar_mod_CarcasePartConnectionLeftHor, IModVar_mod_CarcasePartConnectionRightHor, IModVar_mod_FittingConnectionLeftHor, IModVar_mod_FittingConnectionRightHor, IModVar_mod_CarcasePartConnectionTopVert, IModVar_mod_CarcasePartConnectionBtmVert, IModVar_mod_FittingConnectionBtmVert, IModVar_mod_FittingConnectionTopVert, IModVar_mod_SlopeAngle, IModVar_mod_GrainLogic {
  m:OD_Base[];
  setOrigin(x:number|Matrix4,y?:number,z?:number):void;
  seal():IModuleNonNull_mc_StorageunitShelffixed01;
  parent: IModParents_mc_Storageunit01;
}

export interface adc_mc_StorageunitShelffixed01 extends IModBaseProp
...
export class OD_M_mc_StorageunitShelffixed01 extends OD_Base  implements dc_mc_StorageunitShelffixed01
...
,IModVar_mod_CarcaseId,IModVar_mod_Depth,IModVar_mod_ShelffixedThk,IModVar_mod_Width,IModVar_mod_CarcaseColor,IModVar_mod_CarcaseEdgeColor,IModVar_mod_CarcaseEdgeFrontColor,IModVar_mod_EdgeFrontType,IModVar_mod_EdgeLeftType,IModVar_mod_EdgeBackType,IModVar_mod_EdgeRightType,IModVar_mod_EdgeJointType,IModVar_mod_CarcaseProgram,IModVar_mod_ModuleName,IModVar_mod_ShelvesBackwallFittingConnection,IModVar_mod_TypeElement,IModVar_mod_HardwareColor,IModVar_mod_ParentName,IModVar_mod_CarcasePartConnectionBackHor,IModVar_mod_CarcasePartConnectionLeftHor,IModVar_mod_CarcasePartConnectionRightHor,IModVar_mod_FittingConnectionLeftHor,IModVar_mod_FittingConnectionRightHor,IModVar_mod_CarcasePartConnectionTopVert,IModVar_mod_CarcasePartConnectionBtmVert,IModVar_mod_FittingConnectionBtmVert,IModVar_mod_FittingConnectionTopVert,IModVar_mod_SlopeAngle,IModVar_mod_GrainLogic
 {
  constructor(parent: IModParents_mc_Storageunit01, manufacturerMode?:boolean) {
    super('mc_StorageunitShelffixed01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_StorageunitShelffixed01_NonNull(this);
  }
  parent: IModParents_mc_Storageunit01;
  _selfNonNull: OD_M_mc_StorageunitShelffixed01_NonNull;

  override variants:string[] = ['mod_CarcaseId','mod_Depth','mod_ShelffixedThk','mod_Width','mod_CarcaseColor','mod_CarcaseEdgeColor','mod_CarcaseEdgeFrontColor','mod_EdgeFrontType','mod_EdgeLeftType','mod_EdgeBackType','mod_EdgeRightType','mod_EdgeJointType','mod_CarcaseProgram','mod_ModuleName','mod_ShelvesBackwallFittingConnection','mod_TypeElement','mod_HardwareColor','mod_ParentName','mod_CarcasePartConnectionBackHor','mod_CarcasePartConnectionLeftHor','mod_CarcasePartConnectionRightHor','mod_FittingConnectionLeftHor','mod_FittingConnectionRightHor','mod_CarcasePartConnectionTopVert','mod_CarcasePartConnectionBtmVert','mod_FittingConnectionBtmVert','mod_FittingConnectionTopVert','mod_SlopeAngle','mod_GrainLogic',];
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_StorageunitShelffixed01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_StorageunitShelffixed01_manufacturerDataCompletion;
  override afterDataCompletion():void {
    if(this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_StorageunitShelffixed01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_StorageunitShelffixed01{
    ...
    const adc = new OD_M_mc_StorageunitShelffixed01_NonNull(this);
    return adc;
  }
  ...
  override createBuildPlan():void {
    var cbp = new OD_M_mc_StorageunitShelffixed01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_StorageunitShelffixed01_NonNull implements cbp_mc_StorageunitShelffixed01, adc_mc_StorageunitShelffixed01 ,IPartParentsNonNull_mc_ShelffixedGroup01_mc_StorageunitShelffixed01 {
  constructor(parent: OD_M_mc_StorageunitShelffixed01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_StorageunitShelffixed01;
  ...
  #createBuildPlanInternal = mc_StorageunitShelffixed01_createBuildPlan;
  afterDataCompletion():void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_StorageunitShelffixed01_afterDataCompletion;
